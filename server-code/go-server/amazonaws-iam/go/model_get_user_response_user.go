...
// AssertGetUserResponseUserRequired checks if the required fields are not zero-ed
func AssertGetUserResponseUserRequired(obj GetUserResponseUser) error {
...
// AssertGetUserResponseUserConstraints checks if the values respects the defined constraints
func AssertGetUserResponseUserConstraints(obj GetUserResponseUser) error {
	return nil
}
