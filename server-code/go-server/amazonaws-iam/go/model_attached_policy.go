...
// AssertAttachedPolicyRequired checks if the required fields are not zero-ed
func AssertAttachedPolicyRequired(obj AttachedPolicy) error {
...
// AssertAttachedPolicyConstraints checks if the values respects the defined constraints
func AssertAttachedPolicyConstraints(obj AttachedPolicy) error {
	return nil
}
