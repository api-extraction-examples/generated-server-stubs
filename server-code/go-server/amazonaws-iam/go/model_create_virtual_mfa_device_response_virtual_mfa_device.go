...
// AssertCreateVirtualMfaDeviceResponseVirtualMfaDeviceRequired checks if the required fields are not zero-ed
func AssertCreateVirtualMfaDeviceResponseVirtualMfaDeviceRequired(obj CreateVirtualMfaDeviceResponseVirtualMfaDevice) error {
...
// AssertCreateVirtualMfaDeviceResponseVirtualMfaDeviceConstraints checks if the values respects the defined constraints
func AssertCreateVirtualMfaDeviceResponseVirtualMfaDeviceConstraints(obj CreateVirtualMfaDeviceResponseVirtualMfaDevice) error {
	return nil
}
