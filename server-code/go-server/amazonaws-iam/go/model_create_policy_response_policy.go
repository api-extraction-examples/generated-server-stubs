...
// AssertCreatePolicyResponsePolicyRequired checks if the required fields are not zero-ed
func AssertCreatePolicyResponsePolicyRequired(obj CreatePolicyResponsePolicy) error {
...
// AssertCreatePolicyResponsePolicyConstraints checks if the values respects the defined constraints
func AssertCreatePolicyResponsePolicyConstraints(obj CreatePolicyResponsePolicy) error {
	return nil
}
