...
// AssertServiceSpecificCredentialMetadataRequired checks if the required fields are not zero-ed
func AssertServiceSpecificCredentialMetadataRequired(obj ServiceSpecificCredentialMetadata) error {
...
// AssertServiceSpecificCredentialMetadataConstraints checks if the values respects the defined constraints
func AssertServiceSpecificCredentialMetadataConstraints(obj ServiceSpecificCredentialMetadata) error {
	return nil
}
