...
// AssertSshPublicKeyRequired checks if the required fields are not zero-ed
func AssertSshPublicKeyRequired(obj SshPublicKey) error {
...
// AssertSshPublicKeyConstraints checks if the values respects the defined constraints
func AssertSshPublicKeyConstraints(obj SshPublicKey) error {
	return nil
}
