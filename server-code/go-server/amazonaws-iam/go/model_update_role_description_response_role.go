...
// AssertUpdateRoleDescriptionResponseRoleRequired checks if the required fields are not zero-ed
func AssertUpdateRoleDescriptionResponseRoleRequired(obj UpdateRoleDescriptionResponseRole) error {
...
// AssertUpdateRoleDescriptionResponseRoleConstraints checks if the values respects the defined constraints
func AssertUpdateRoleDescriptionResponseRoleConstraints(obj UpdateRoleDescriptionResponseRole) error {
	return nil
}
