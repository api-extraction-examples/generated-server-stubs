...
// AssertCreateRoleResponseRoleRequired checks if the required fields are not zero-ed
func AssertCreateRoleResponseRoleRequired(obj CreateRoleResponseRole) error {
...
// AssertCreateRoleResponseRoleConstraints checks if the values respects the defined constraints
func AssertCreateRoleResponseRoleConstraints(obj CreateRoleResponseRole) error {
	return nil
}
