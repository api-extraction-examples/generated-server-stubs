...
// AssertRoleLastUsedRequired checks if the required fields are not zero-ed
func AssertRoleLastUsedRequired(obj RoleLastUsed) error {
...
// AssertRoleLastUsedConstraints checks if the values respects the defined constraints
func AssertRoleLastUsedConstraints(obj RoleLastUsed) error {
	return nil
}
