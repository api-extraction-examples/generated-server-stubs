...
// AssertCreateServiceLinkedRoleResponseRoleRequired checks if the required fields are not zero-ed
func AssertCreateServiceLinkedRoleResponseRoleRequired(obj CreateServiceLinkedRoleResponseRole) error {
...
// AssertCreateServiceLinkedRoleResponseRoleConstraints checks if the values respects the defined constraints
func AssertCreateServiceLinkedRoleResponseRoleConstraints(obj CreateServiceLinkedRoleResponseRole) error {
	return nil
}
