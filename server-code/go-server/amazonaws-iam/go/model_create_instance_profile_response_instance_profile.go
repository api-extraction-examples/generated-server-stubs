...
// AssertCreateInstanceProfileResponseInstanceProfileRequired checks if the required fields are not zero-ed
func AssertCreateInstanceProfileResponseInstanceProfileRequired(obj CreateInstanceProfileResponseInstanceProfile) error {
...
// AssertCreateInstanceProfileResponseInstanceProfileConstraints checks if the values respects the defined constraints
func AssertCreateInstanceProfileResponseInstanceProfileConstraints(obj CreateInstanceProfileResponseInstanceProfile) error {
	return nil
}
