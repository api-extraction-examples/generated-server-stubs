...
// AssertGetRoleResponseRoleRequired checks if the required fields are not zero-ed
func AssertGetRoleResponseRoleRequired(obj GetRoleResponseRole) error {
...
// AssertGetRoleResponseRoleConstraints checks if the values respects the defined constraints
func AssertGetRoleResponseRoleConstraints(obj GetRoleResponseRole) error {
	return nil
}
