...
// AssertUploadServerCertificateRequestRequired checks if the required fields are not zero-ed
func AssertUploadServerCertificateRequestRequired(obj UploadServerCertificateRequest) error {
	...
	if err := AssertstringRequired(obj.PrivateKey); err != nil {
		return err
	}
...
// AssertUploadServerCertificateRequestConstraints checks if the values respects the defined constraints
func AssertUploadServerCertificateRequestConstraints(obj UploadServerCertificateRequest) error {
	return nil
}
