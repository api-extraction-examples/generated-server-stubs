...
type GetSshPublicKeyResponseSshPublicKey struct {
...
// AssertGetSshPublicKeyResponseSshPublicKeyRequired checks if the required fields are not zero-ed
func AssertGetSshPublicKeyResponseSshPublicKeyRequired(obj GetSshPublicKeyResponseSshPublicKey) error {
...
// AssertGetSshPublicKeyResponseSshPublicKeyConstraints checks if the values respects the defined constraints
func AssertGetSshPublicKeyResponseSshPublicKeyConstraints(obj GetSshPublicKeyResponseSshPublicKey) error {
	return nil
}
