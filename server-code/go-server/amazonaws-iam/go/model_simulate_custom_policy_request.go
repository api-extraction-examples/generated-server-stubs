...
// AssertSimulateCustomPolicyRequestRequired checks if the required fields are not zero-ed
func AssertSimulateCustomPolicyRequestRequired(obj SimulateCustomPolicyRequest) error {
...
// AssertSimulateCustomPolicyRequestConstraints checks if the values respects the defined constraints
func AssertSimulateCustomPolicyRequestConstraints(obj SimulateCustomPolicyRequest) error {
	return nil
}
