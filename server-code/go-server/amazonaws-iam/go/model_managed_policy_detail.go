...
// AssertManagedPolicyDetailRequired checks if the required fields are not zero-ed
func AssertManagedPolicyDetailRequired(obj ManagedPolicyDetail) error {
	...
	if err := AssertarrayRequired(obj.PolicyVersionList); err != nil {
		return err
	}
	return nil
}

// AssertManagedPolicyDetailConstraints checks if the values respects the defined constraints
func AssertManagedPolicyDetailConstraints(obj ManagedPolicyDetail) error {
	return nil
}
