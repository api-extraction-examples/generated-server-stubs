...
// AssertCreateUserResponseUserRequired checks if the required fields are not zero-ed
func AssertCreateUserResponseUserRequired(obj CreateUserResponseUser) error {
...
// AssertCreateUserResponseUserConstraints checks if the values respects the defined constraints
func AssertCreateUserResponseUserConstraints(obj CreateUserResponseUser) error {
	return nil
}
