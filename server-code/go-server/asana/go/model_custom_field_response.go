...
// AssertCustomFieldResponseRequired checks if the required fields are not zero-ed
func AssertCustomFieldResponseRequired(obj CustomFieldResponse) error {
...
// AssertCustomFieldResponseConstraints checks if the values respects the defined constraints
func AssertCustomFieldResponseConstraints(obj CustomFieldResponse) error {
	return nil
}
