...
// AssertAuditLogEventContextRequired checks if the required fields are not zero-ed
func AssertAuditLogEventContextRequired(obj AuditLogEventContext) error {
	return nil
}

// AssertAuditLogEventContextConstraints checks if the values respects the defined constraints
func AssertAuditLogEventContextConstraints(obj AuditLogEventContext) error {
	return nil
}
