...
// AssertStoryResponseRequired checks if the required fields are not zero-ed
func AssertStoryResponseRequired(obj StoryResponse) error {
	if err := AssertUserCompactRequired(obj.Assignee); err != nil {
		return err
	}
	if err := AssertUserCompactRequired(obj.CreatedBy); err != nil {
		return err
	}
	if err := AssertCustomFieldCompactRequired(obj.CustomField); err != nil {
		return err
	}
	if err := AssertTaskCompactRequired(obj.Dependency); err != nil {
		return err
	}
	if err := AssertTaskCompactRequired(obj.DuplicateOf); err != nil {
		return err
	}
	if err := AssertTaskCompactRequired(obj.DuplicatedFrom); err != nil {
		return err
	}
	if err := AssertUserCompactRequired(obj.Follower); err != nil {
		return err
	}
	...
	if err := AssertStoryResponseAllOfNewDateValueRequired(obj.NewDateValue); err != nil {
		return err
	}
	if err := AssertStoryResponseDatesRequired(obj.NewDates); err != nil {
		return err
	}
	if err := AssertEnumOptionRequired(obj.NewEnumValue); err != nil {
		return err
	}
	for _, el := range obj.NewMultiEnumValues {
		if err := AssertEnumOptionRequired(el); err != nil {
			return err
		}
	}
	for _, el := range obj.NewPeopleValue {
		if err := AssertUserCompactRequired(el); err != nil {
			return err
		}
	}
	if err := AssertSectionCompactRequired(obj.NewSection); err != nil {
		return err
	}
	if err := AssertStoryResponseAllOfOldDateValueRequired(obj.OldDateValue); err != nil {
		return err
	}
	if err := AssertStoryResponseDatesRequired(obj.OldDates); err != nil {
		return err
	}
	if err := AssertEnumOptionRequired(obj.OldEnumValue); err != nil {
		return err
	}
	for _, el := range obj.OldMultiEnumValues {
		if err := AssertEnumOptionRequired(el); err != nil {
			return err
		}
	}
	for _, el := range obj.OldPeopleValue {
		if err := AssertUserCompactRequired(el); err != nil {
			return err
		}
	}
	if err := AssertSectionCompactRequired(obj.OldSection); err != nil {
		return err
	}
	for _, el := range obj.Previews {
		if err := AssertPreviewRequired(el); err != nil {
			return err
		}
	}
	...
	if err := AssertStoryCompactRequired(obj.Story); err != nil {
		return err
	}
	if err := AssertTagCompactRequired(obj.Tag); err != nil {
		return err
	}
	if err := AssertStoryResponseAllOfTargetRequired(obj.Target); err != nil {
		return err
	}
	if err := AssertTaskCompactRequired(obj.Task); err != nil {
		return err
	}
	return nil
}

// AssertStoryResponseConstraints checks if the values respects the defined constraints
func AssertStoryResponseConstraints(obj StoryResponse) error {
	return nil
}
