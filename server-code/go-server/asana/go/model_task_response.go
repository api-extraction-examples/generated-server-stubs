...
func AssertTaskResponseRequired(obj TaskResponse) error {
	...
	if obj.Assignee != nil {
		if err := AssertTaskResponseAllOfAssigneeRequired(*obj.Assignee); err != nil {
			return err
		}
	}
	if obj.AssigneeSection != nil {
		if err := AssertTaskResponseAllOfAssigneeSectionRequired(*obj.AssigneeSection); err != nil {
			return err
		}
	}
	...
	if err := AssertTaskResponseAllOfParentRequired(obj.Parent); err != nil {
		return err
	}
	...
	if err := AssertTaskResponseAllOfWorkspaceRequired(obj.Workspace); err != nil {
		return err
	}
	return nil
}
