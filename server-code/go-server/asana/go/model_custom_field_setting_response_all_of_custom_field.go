...
// AssertCustomFieldSettingResponseAllOfCustomFieldRequired checks if the required fields are not zero-ed
func AssertCustomFieldSettingResponseAllOfCustomFieldRequired(obj CustomFieldSettingResponseAllOfCustomField) error {
	...
	for _, el := range obj.PeopleValue {
...
// AssertCustomFieldSettingResponseAllOfCustomFieldConstraints checks if the values respects the defined constraints
func AssertCustomFieldSettingResponseAllOfCustomFieldConstraints(obj CustomFieldSettingResponseAllOfCustomField) error {
	return nil
}
