...
// AssertCustomFieldRequestRequired checks if the required fields are not zero-ed
func AssertCustomFieldRequestRequired(obj CustomFieldRequest) error {
...
// AssertCustomFieldRequestConstraints checks if the values respects the defined constraints
func AssertCustomFieldRequestConstraints(obj CustomFieldRequest) error {
	return nil
}
