...
type WebhookResponseAllOfFilters struct {
...
// AssertWebhookResponseAllOfFiltersRequired checks if the required fields are not zero-ed
func AssertWebhookResponseAllOfFiltersRequired(obj WebhookResponseAllOfFilters) error {
	return nil
}

// AssertWebhookResponseAllOfFiltersConstraints checks if the values respects the defined constraints
func AssertWebhookResponseAllOfFiltersConstraints(obj WebhookResponseAllOfFilters) error {
	return nil
}
