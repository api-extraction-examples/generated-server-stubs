...
// AssertAddCustomFieldSettingRequestRequired checks if the required fields are not zero-ed
func AssertAddCustomFieldSettingRequestRequired(obj AddCustomFieldSettingRequest) error {
...
// AssertAddCustomFieldSettingRequestConstraints checks if the values respects the defined constraints
func AssertAddCustomFieldSettingRequestConstraints(obj AddCustomFieldSettingRequest) error {
	return nil
}
