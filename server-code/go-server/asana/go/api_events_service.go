...
func (s *EventsAPIService) GetEvents(ctx context.Context, resource string, sync string, optPretty bool, optFields []string) (ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(200, GetEvents200Response{}) or use other options such as http.Ok ...
	// return Response(200, GetEvents200Response{}), nil
