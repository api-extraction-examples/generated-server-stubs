...
// AssertTimePeriodBaseRequired checks if the required fields are not zero-ed
func AssertTimePeriodBaseRequired(obj TimePeriodBase) error {
...
// AssertTimePeriodBaseConstraints checks if the values respects the defined constraints
func AssertTimePeriodBaseConstraints(obj TimePeriodBase) error {
	return nil
}
