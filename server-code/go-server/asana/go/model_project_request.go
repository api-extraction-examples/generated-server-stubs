...
// AssertProjectRequestRequired checks if the required fields are not zero-ed
func AssertProjectRequestRequired(obj ProjectRequest) error {
...
// AssertProjectRequestConstraints checks if the values respects the defined constraints
func AssertProjectRequestConstraints(obj ProjectRequest) error {
	return nil
}
