...
// AssertStatusUpdateBaseRequired checks if the required fields are not zero-ed
func AssertStatusUpdateBaseRequired(obj StatusUpdateBase) error {
...
// AssertStatusUpdateBaseConstraints checks if the values respects the defined constraints
func AssertStatusUpdateBaseConstraints(obj StatusUpdateBase) error {
	return nil
}
