...
// AssertEventResponseChangeRequired checks if the required fields are not zero-ed
func AssertEventResponseChangeRequired(obj EventResponseChange) error {
	return nil
}

// AssertEventResponseChangeConstraints checks if the values respects the defined constraints
func AssertEventResponseChangeConstraints(obj EventResponseChange) error {
	return nil
}
