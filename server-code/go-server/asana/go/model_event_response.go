...
func AssertEventResponseRequired(obj EventResponse) error {
	if err := AssertEventResponseChangeRequired(obj.Change); err != nil {
		return err
	}
	if err := AssertEventResponseParentRequired(obj.Parent); err != nil {
		return err
	}
	if err := AssertEventResponseResourceRequired(obj.Resource); err != nil {
		return err
	}
	if err := AssertEventResponseUserRequired(obj.User); err != nil {
		return err
	}
	return nil
}
