...
// AssertGoalRequestRequired checks if the required fields are not zero-ed
func AssertGoalRequestRequired(obj GoalRequest) error {
	return nil
}

// AssertGoalRequestConstraints checks if the values respects the defined constraints
func AssertGoalRequestConstraints(obj GoalRequest) error {
	return nil
}
