...
// AssertTaskBaseRequired checks if the required fields are not zero-ed
func AssertTaskBaseRequired(obj TaskBase) error {
...
// AssertTaskBaseConstraints checks if the values respects the defined constraints
func AssertTaskBaseConstraints(obj TaskBase) error {
	return nil
}
