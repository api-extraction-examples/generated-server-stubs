...
// AssertProjectStatusResponseRequired checks if the required fields are not zero-ed
func AssertProjectStatusResponseRequired(obj ProjectStatusResponse) error {
...
// AssertProjectStatusResponseConstraints checks if the values respects the defined constraints
func AssertProjectStatusResponseConstraints(obj ProjectStatusResponse) error {
	return nil
}
