...
// AssertTimePeriodResponseRequired checks if the required fields are not zero-ed
func AssertTimePeriodResponseRequired(obj TimePeriodResponse) error {
	if err := AssertTimePeriodCompactRequired(obj.Parent); err != nil {
		return err
	}
	return nil
}

// AssertTimePeriodResponseConstraints checks if the values respects the defined constraints
func AssertTimePeriodResponseConstraints(obj TimePeriodResponse) error {
	return nil
}
