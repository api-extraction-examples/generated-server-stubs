...
// AssertCustomFieldBaseRequired checks if the required fields are not zero-ed
func AssertCustomFieldBaseRequired(obj CustomFieldBase) error {
...
// AssertCustomFieldBaseConstraints checks if the values respects the defined constraints
func AssertCustomFieldBaseConstraints(obj CustomFieldBase) error {
	return nil
}
