...
// AssertProjectDuplicateRequestScheduleDatesRequired checks if the required fields are not zero-ed
func AssertProjectDuplicateRequestScheduleDatesRequired(obj ProjectDuplicateRequestScheduleDates) error {
	elements := map[string]interface{}{
		"should_skip_weekends": obj.ShouldSkipWeekends,
	}
...
// AssertProjectDuplicateRequestScheduleDatesConstraints checks if the values respects the defined constraints
func AssertProjectDuplicateRequestScheduleDatesConstraints(obj ProjectDuplicateRequestScheduleDates) error {
	return nil
}
