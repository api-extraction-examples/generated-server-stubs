...
// AssertProjectTemplateBaseRequired checks if the required fields are not zero-ed
func AssertProjectTemplateBaseRequired(obj ProjectTemplateBase) error {
	if obj.Owner != nil {
...
// AssertProjectTemplateBaseConstraints checks if the values respects the defined constraints
func AssertProjectTemplateBaseConstraints(obj ProjectTemplateBase) error {
	return nil
}
