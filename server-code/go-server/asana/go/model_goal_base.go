...
// AssertGoalBaseRequired checks if the required fields are not zero-ed
func AssertGoalBaseRequired(obj GoalBase) error {
	return nil
}

// AssertGoalBaseConstraints checks if the values respects the defined constraints
func AssertGoalBaseConstraints(obj GoalBase) error {
	return nil
}
