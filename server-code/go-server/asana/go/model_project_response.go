...
type ProjectResponse struct {
	...
	CreatedFromTemplate ProjectResponseAllOfCreatedFromTemplate `json:"created_from_template,omitempty"`
	...
	Owner *ProjectResponseAllOfOwner `json:"owner,omitempty"`

	// A url that points directly to the object within Asana.
	PermalinkUrl string `json:"permalink_url,omitempty"`

	ProjectBrief ProjectResponseAllOfProjectBrief `json:"project_brief,omitempty"`

	Team ProjectResponseAllOfTeam `json:"team,omitempty"`
}

// AssertProjectResponseRequired checks if the required fields are not zero-ed
func AssertProjectResponseRequired(obj ProjectResponse) error {
	...
	if err := AssertProjectResponseAllOfCreatedFromTemplateRequired(obj.CreatedFromTemplate); err != nil {
		return err
	}
	...
	if obj.Owner != nil {
		if err := AssertProjectResponseAllOfOwnerRequired(*obj.Owner); err != nil {
			return err
		}
	}
	if err := AssertProjectResponseAllOfProjectBriefRequired(obj.ProjectBrief); err != nil {
		return err
	}
	if err := AssertProjectResponseAllOfTeamRequired(obj.Team); err != nil {
		return err
	}
	return nil
}

// AssertProjectResponseConstraints checks if the values respects the defined constraints
func AssertProjectResponseConstraints(obj ProjectResponse) error {
	return nil
}
