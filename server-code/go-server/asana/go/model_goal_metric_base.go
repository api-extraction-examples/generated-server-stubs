...
// AssertGoalMetricBaseRequired checks if the required fields are not zero-ed
func AssertGoalMetricBaseRequired(obj GoalMetricBase) error {
	return nil
}

// AssertGoalMetricBaseConstraints checks if the values respects the defined constraints
func AssertGoalMetricBaseConstraints(obj GoalMetricBase) error {
	return nil
}
