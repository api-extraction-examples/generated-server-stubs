...
// AssertGoalResponseAllOfMetricRequired checks if the required fields are not zero-ed
func AssertGoalResponseAllOfMetricRequired(obj GoalResponseAllOfMetric) error {
	return nil
}

// AssertGoalResponseAllOfMetricConstraints checks if the values respects the defined constraints
func AssertGoalResponseAllOfMetricConstraints(obj GoalResponseAllOfMetric) error {
	return nil
}
