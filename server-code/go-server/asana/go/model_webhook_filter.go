...
// WebhookFilter - A WebhookFilter can be passed on creation of a webhook in order to filter the types of actions that trigger delivery of an [Event](/docs/tocS_Event)
...
// AssertWebhookFilterRequired checks if the required fields are not zero-ed
func AssertWebhookFilterRequired(obj WebhookFilter) error {
	return nil
}

// AssertWebhookFilterConstraints checks if the values respects the defined constraints
func AssertWebhookFilterConstraints(obj WebhookFilter) error {
	return nil
}
