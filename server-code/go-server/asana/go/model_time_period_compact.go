...
// AssertTimePeriodCompactRequired checks if the required fields are not zero-ed
func AssertTimePeriodCompactRequired(obj TimePeriodCompact) error {
	return nil
}

// AssertTimePeriodCompactConstraints checks if the values respects the defined constraints
func AssertTimePeriodCompactConstraints(obj TimePeriodCompact) error {
	return nil
}
