...
// AssertWebhookRequestFiltersInnerRequired checks if the required fields are not zero-ed
func AssertWebhookRequestFiltersInnerRequired(obj WebhookRequestFiltersInner) error {
	return nil
}

// AssertWebhookRequestFiltersInnerConstraints checks if the values respects the defined constraints
func AssertWebhookRequestFiltersInnerConstraints(obj WebhookRequestFiltersInner) error {
	return nil
}
