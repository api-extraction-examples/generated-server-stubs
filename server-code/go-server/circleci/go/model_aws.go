...
// AssertAwsRequired checks if the required fields are not zero-ed
func AssertAwsRequired(obj Aws) error {
	return nil
}

// AssertAwsConstraints checks if the values respects the defined constraints
func AssertAwsConstraints(obj Aws) error {
	return nil
}
