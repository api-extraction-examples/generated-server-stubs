...
// AssertBuildSummaryRequired checks if the required fields are not zero-ed
func AssertBuildSummaryRequired(obj BuildSummary) error {
	return nil
}

// AssertBuildSummaryConstraints checks if the values respects the defined constraints
func AssertBuildSummaryConstraints(obj BuildSummary) error {
	return nil
}
