...
// AssertAdminReportRequired checks if the required fields are not zero-ed
func AssertAdminReportRequired(obj AdminReport) error {
	if err := AssertAccountRequired(obj.Account); err != nil {
		return err
	}
	if err := AssertAccountRequired(obj.AssignedAccount); err != nil {
		return err
	}
...
// AssertAdminReportConstraints checks if the values respects the defined constraints
func AssertAdminReportConstraints(obj AdminReport) error {
	return nil
}
