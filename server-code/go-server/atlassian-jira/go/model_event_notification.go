...
func AssertEventNotificationRequired(obj EventNotification) error {
	if err := AssertFieldDetailsRequired(obj.Field); err != nil {
		return err
	}
	if err := AssertGroupNameRequired(obj.Group); err != nil {
		return err
	}
	if err := AssertProjectRoleRequired(obj.ProjectRole); err != nil {
		return err
	}
	if err := AssertUserDetailsRequired(obj.User); err != nil {
		return err
	}
	return nil
}
