...
// AssertActorInputBeanRequired checks if the required fields are not zero-ed
func AssertActorInputBeanRequired(obj ActorInputBean) error {
	return nil
}

// AssertActorInputBeanConstraints checks if the values respects the defined constraints
func AssertActorInputBeanConstraints(obj ActorInputBean) error {
	return nil
}
