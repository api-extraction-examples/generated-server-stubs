...
// AssertMultipleCustomFieldValuesUpdateRequired checks if the required fields are not zero-ed
func AssertMultipleCustomFieldValuesUpdateRequired(obj MultipleCustomFieldValuesUpdate) error {
...
// AssertMultipleCustomFieldValuesUpdateConstraints checks if the values respects the defined constraints
func AssertMultipleCustomFieldValuesUpdateConstraints(obj MultipleCustomFieldValuesUpdate) error {
	return nil
}
