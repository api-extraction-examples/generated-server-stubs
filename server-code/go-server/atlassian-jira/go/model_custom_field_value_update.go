...
// AssertCustomFieldValueUpdateRequired checks if the required fields are not zero-ed
func AssertCustomFieldValueUpdateRequired(obj CustomFieldValueUpdate) error {
...
// AssertCustomFieldValueUpdateConstraints checks if the values respects the defined constraints
func AssertCustomFieldValueUpdateConstraints(obj CustomFieldValueUpdate) error {
	return nil
}
