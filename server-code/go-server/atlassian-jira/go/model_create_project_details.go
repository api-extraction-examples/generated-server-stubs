...
// AssertCreateProjectDetailsRequired checks if the required fields are not zero-ed
func AssertCreateProjectDetailsRequired(obj CreateProjectDetails) error {
...
// AssertCreateProjectDetailsConstraints checks if the values respects the defined constraints
func AssertCreateProjectDetailsConstraints(obj CreateProjectDetails) error {
	return nil
}
