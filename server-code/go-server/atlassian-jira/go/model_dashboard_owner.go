...
// AssertDashboardOwnerRequired checks if the required fields are not zero-ed
func AssertDashboardOwnerRequired(obj DashboardOwner) error {
...
// AssertDashboardOwnerConstraints checks if the values respects the defined constraints
func AssertDashboardOwnerConstraints(obj DashboardOwner) error {
	return nil
}
