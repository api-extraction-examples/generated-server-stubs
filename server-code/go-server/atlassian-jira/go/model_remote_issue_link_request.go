...
// AssertRemoteIssueLinkRequestRequired checks if the required fields are not zero-ed
func AssertRemoteIssueLinkRequestRequired(obj RemoteIssueLinkRequest) error {
...
// AssertRemoteIssueLinkRequestConstraints checks if the values respects the defined constraints
func AssertRemoteIssueLinkRequestConstraints(obj RemoteIssueLinkRequest) error {
	return nil
}
