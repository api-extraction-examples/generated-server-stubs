...
// AssertFieldReferenceDataRequired checks if the required fields are not zero-ed
func AssertFieldReferenceDataRequired(obj FieldReferenceData) error {
	return nil
}

// AssertFieldReferenceDataConstraints checks if the values respects the defined constraints
func AssertFieldReferenceDataConstraints(obj FieldReferenceData) error {
	return nil
}
