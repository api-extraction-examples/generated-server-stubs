...
// AssertSimplifiedHierarchyLevelRequired checks if the required fields are not zero-ed
func AssertSimplifiedHierarchyLevelRequired(obj SimplifiedHierarchyLevel) error {
	return nil
}

// AssertSimplifiedHierarchyLevelConstraints checks if the values respects the defined constraints
func AssertSimplifiedHierarchyLevelConstraints(obj SimplifiedHierarchyLevel) error {
	return nil
}
