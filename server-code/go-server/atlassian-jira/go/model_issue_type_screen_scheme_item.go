...
// AssertIssueTypeScreenSchemeItemRequired checks if the required fields are not zero-ed
func AssertIssueTypeScreenSchemeItemRequired(obj IssueTypeScreenSchemeItem) error {
	elements := map[string]interface{}{
		"issueTypeId": obj.IssueTypeId,
		"issueTypeScreenSchemeId": obj.IssueTypeScreenSchemeId,
...
// AssertIssueTypeScreenSchemeItemConstraints checks if the values respects the defined constraints
func AssertIssueTypeScreenSchemeItemConstraints(obj IssueTypeScreenSchemeItem) error {
	return nil
}
