...
// AssertTimeTrackingDetailsRequired checks if the required fields are not zero-ed
func AssertTimeTrackingDetailsRequired(obj TimeTrackingDetails) error {
	return nil
}

// AssertTimeTrackingDetailsConstraints checks if the values respects the defined constraints
func AssertTimeTrackingDetailsConstraints(obj TimeTrackingDetails) error {
	return nil
}
