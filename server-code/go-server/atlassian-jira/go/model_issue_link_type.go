...
// AssertIssueLinkTypeRequired checks if the required fields are not zero-ed
func AssertIssueLinkTypeRequired(obj IssueLinkType) error {
	return nil
}

// AssertIssueLinkTypeConstraints checks if the values respects the defined constraints
func AssertIssueLinkTypeConstraints(obj IssueLinkType) error {
	return nil
}
