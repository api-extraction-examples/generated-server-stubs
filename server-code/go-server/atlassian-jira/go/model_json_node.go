...
// AssertJsonNodeRequired checks if the required fields are not zero-ed
func AssertJsonNodeRequired(obj JsonNode) error {
	return nil
}

// AssertJsonNodeConstraints checks if the values respects the defined constraints
func AssertJsonNodeConstraints(obj JsonNode) error {
	return nil
}
