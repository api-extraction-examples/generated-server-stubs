...
// AssertHistoryMetadataRequired checks if the required fields are not zero-ed
func AssertHistoryMetadataRequired(obj HistoryMetadata) error {
	return nil
}

// AssertHistoryMetadataConstraints checks if the values respects the defined constraints
func AssertHistoryMetadataConstraints(obj HistoryMetadata) error {
	return nil
}
