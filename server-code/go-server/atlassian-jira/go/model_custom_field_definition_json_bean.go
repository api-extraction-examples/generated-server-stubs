...
// AssertCustomFieldDefinitionJsonBeanRequired checks if the required fields are not zero-ed
func AssertCustomFieldDefinitionJsonBeanRequired(obj CustomFieldDefinitionJsonBean) error {
...
// AssertCustomFieldDefinitionJsonBeanConstraints checks if the values respects the defined constraints
func AssertCustomFieldDefinitionJsonBeanConstraints(obj CustomFieldDefinitionJsonBean) error {
	return nil
}
