...
// AssertWorkflowSchemeRequired checks if the required fields are not zero-ed
func AssertWorkflowSchemeRequired(obj WorkflowScheme) error {
	if err := AssertWorkflowSchemeLastModifiedUserRequired(obj.LastModifiedUser); err != nil {
		return err
	}
	return nil
}

// AssertWorkflowSchemeConstraints checks if the values respects the defined constraints
func AssertWorkflowSchemeConstraints(obj WorkflowScheme) error {
	return nil
}
