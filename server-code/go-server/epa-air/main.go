...
func main() {
	...
	FacilitiesAPIService := openapi.NewFacilitiesAPIService()
	FacilitiesAPIController := openapi.NewFacilitiesAPIController(FacilitiesAPIService)
	...
	router := openapi.NewRouter(FacilitiesAPIController, MetadataAPIController)
