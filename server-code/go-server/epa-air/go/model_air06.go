...
// AssertAir06Required checks if the required fields are not zero-ed
func AssertAir06Required(obj Air06) error {
...
// AssertAir06Constraints checks if the values respects the defined constraints
func AssertAir06Constraints(obj Air06) error {
	return nil
}
