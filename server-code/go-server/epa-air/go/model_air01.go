...
// Air01 - Cluster Output Object
type Air01 struct {

	// An array of state, county, or zip code cluster information
	ClusterData []Air00 `json:"ClusterData,omitempty"`
}

// AssertAir01Required checks if the required fields are not zero-ed
func AssertAir01Required(obj Air01) error {
	for _, el := range obj.ClusterData {
		if err := AssertAir00Required(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertAir01Constraints checks if the values respects the defined constraints
func AssertAir01Constraints(obj Air01) error {
	return nil
}
