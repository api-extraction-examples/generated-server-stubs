...
// Meta1 - Results Object
type Meta1 struct {

	// Field to record messages (typically performance-related) about packet processing
	Message string `json:"Message"`

	ResultColumns []Meta3 `json:"ResultColumns,omitempty"`
}

// AssertMeta1Required checks if the required fields are not zero-ed
func AssertMeta1Required(obj Meta1) error {
	...
	for _, el := range obj.ResultColumns {
		if err := AssertMeta3Required(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertMeta1Constraints checks if the values respects the defined constraints
func AssertMeta1Constraints(obj Meta1) error {
	return nil
}
