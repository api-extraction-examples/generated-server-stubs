...
// Air10 - GeoJSON Properties Object
type Air10 struct {
	...
	AIRDaysLastEval float32 `json:"AIRDaysLastEval"`
	...
	AIREvalCnt float32 `json:"AIREvalCnt"`
	...
	AIRMnthsWithHpv float32 `json:"AIRMnthsWithHpv"`
	...
	CalculatedAccuracyMeters float32 `json:"CalculatedAccuracyMeters"`
	...
	CurrSvFlag float32 `json:"CurrSvFlag"`

	// Indicates if the facility has a current violation. 1 = Yes
	CurrVioFlag float32 `json:"CurrVioFlag"`
	...
	Ea5yrFlag float32 `json:"Ea5yrFlag"`
	...
	FacPercentMinority float32 `json:"FacPercentMinority"`

	// The number of persons per square mile in the profiled area.
	FacPopulationDensity float32 `json:"FacPopulationDensity"`
	...
	Infea5yrFlag float32 `json:"Infea5yrFlag"`

	// Indicates if the facility has an inspection within the last 5 years. 1 = Yes
	Insp5yrFlag float32 `json:"Insp5yrFlag"`
	...
	MaxPctileUs float32 `json:"MaxPctileUs"`
...
// AssertAir10Constraints checks if the values respects the defined constraints
func AssertAir10Constraints(obj Air10) error {
	return nil
}
