...
// AssertGeoRequired checks if the required fields are not zero-ed
func AssertGeoRequired(obj Geo) error {
...
// AssertGeoConstraints checks if the values respects the defined constraints
func AssertGeoConstraints(obj Geo) error {
	return nil
}
