...
// AssertAir04Required checks if the required fields are not zero-ed
func AssertAir04Required(obj Air04) error {
...
// AssertAir04Constraints checks if the values respects the defined constraints
func AssertAir04Constraints(obj Air04) error {
	return nil
}
