...
// AssertQp0Required checks if the required fields are not zero-ed
func AssertQp0Required(obj Qp0) error {
...
// AssertQp0Constraints checks if the values respects the defined constraints
func AssertQp0Constraints(obj Qp0) error {
	return nil
}
