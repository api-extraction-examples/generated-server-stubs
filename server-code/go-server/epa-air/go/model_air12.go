...
// Air12 - Results Object
type Air12 struct {

	// A complex array of facility information.
	Facilities []Air03 `json:"Facilities"`
...
// AssertAir12Required checks if the required fields are not zero-ed
func AssertAir12Required(obj Air12) error {
...
// AssertAir12Constraints checks if the values respects the defined constraints
func AssertAir12Constraints(obj Air12) error {
	return nil
}
