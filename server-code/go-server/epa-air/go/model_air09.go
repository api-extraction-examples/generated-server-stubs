...
// Air09 - GeoJSON Feature Object
type Air09 struct {

	Geometry Geo `json:"geometry"`

	Properties Air10 `json:"properties"`

	// Static marker indicating object is a GeoJSON Feature.
	Type string `json:"type"`
}

// AssertAir09Required checks if the required fields are not zero-ed
func AssertAir09Required(obj Air09) error {
	...
	if err := AssertGeoRequired(obj.Geometry); err != nil {
		return err
	}
	if err := AssertAir10Required(obj.Properties); err != nil {
		return err
	}
	return nil
}

// AssertAir09Constraints checks if the values respects the defined constraints
func AssertAir09Constraints(obj Air09) error {
	return nil
}
