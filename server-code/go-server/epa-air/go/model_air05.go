...
// AssertAir05Required checks if the required fields are not zero-ed
func AssertAir05Required(obj Air05) error {
	...
	for _, el := range obj.Facilities {
		if err := AssertAir03Required(el); err != nil {
			return err
		}
	}
	if err := AssertAir04Required(obj.MapOutput); err != nil {
		return err
	}
	return nil
}

// AssertAir05Constraints checks if the values respects the defined constraints
func AssertAir05Constraints(obj Air05) error {
	return nil
}
