...
type Air08 struct {
	...
	ClusterOutput Air01 `json:"ClusterOutput,omitempty"`

	// Number of clusters returned.
	ClusterRecords string `json:"ClusterRecords,omitempty"`
	...
	Facilities []Air06 `json:"Facilities,omitempty"`
	...
	IconBaseURL string `json:"IconBaseURL"`
...
// AssertAir08Required checks if the required fields are not zero-ed
func AssertAir08Required(obj Air08) error {
	elements := map[string]interface{}{
		"BadSystemIDs": obj.BadSystemIDs,
		"CVRows": obj.CVRows,
		"FEARows": obj.FEARows,
		"INSPRows": obj.INSPRows,
		"IconBaseURL": obj.IconBaseURL,
		"IndianCountryRows": obj.IndianCountryRows,
		"InfFEARows": obj.InfFEARows,
		"Message": obj.Message,
		"PopUpBaseURL": obj.PopUpBaseURL,
		"QueryID": obj.QueryID,
		"QueryParameters": obj.QueryParameters,
		"QueryRows": obj.QueryRows,
		"SVRows": obj.SVRows,
	...
	if err := AssertAir01Required(obj.ClusterOutput); err != nil {
		return err
	}
	for _, el := range obj.Facilities {
		if err := AssertAir06Required(el); err != nil {
			return err
		}
	}
	for _, el := range obj.QueryParameters {
		if err := AssertQp0Required(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertAir08Constraints checks if the values respects the defined constraints
func AssertAir08Constraints(obj Air08) error {
	return nil
}
