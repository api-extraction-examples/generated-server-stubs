...
// AssertAir11Required checks if the required fields are not zero-ed
func AssertAir11Required(obj Air11) error {
	...
	for _, el := range obj.MapData {
		if err := AssertAir02Required(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertAir11Constraints checks if the values respects the defined constraints
func AssertAir11Constraints(obj Air11) error {
	return nil
}
