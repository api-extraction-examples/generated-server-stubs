...
// AssertMeta3Required checks if the required fields are not zero-ed
func AssertMeta3Required(obj Meta3) error {
...
// AssertMeta3Constraints checks if the values respects the defined constraints
func AssertMeta3Constraints(obj Meta3) error {
	return nil
}
