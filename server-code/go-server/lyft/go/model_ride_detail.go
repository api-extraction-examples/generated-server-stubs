...
// AssertRideDetailRequired checks if the required fields are not zero-ed
func AssertRideDetailRequired(obj RideDetail) error {
	if err := AssertCancellationCostRequired(obj.CancellationPrice); err != nil {
		return err
	}
	if err := AssertRideLocationRequired(obj.Destination); err != nil {
		return err
	}
	if err := AssertDriverDetailRequired(obj.Driver); err != nil {
		return err
	}
	if err := AssertPickupDropoffLocationRequired(obj.Dropoff); err != nil {
		return err
	}
	...
	if err := AssertCurrentRideLocationRequired(obj.Location); err != nil {
		return err
	}
	if err := AssertRideLocationRequired(obj.Origin); err != nil {
		return err
	}
	if err := AssertPassengerDetailRequired(obj.Passenger); err != nil {
		return err
	}
	if err := AssertPickupDropoffLocationRequired(obj.Pickup); err != nil {
		return err
	}
	if err := AssertCostRequired(obj.Price); err != nil {
		return err
	}
	if err := AssertVehicleDetailRequired(obj.Vehicle); err != nil {
		return err
	}
	return nil
}

// AssertRideDetailConstraints checks if the values respects the defined constraints
func AssertRideDetailConstraints(obj RideDetail) error {
	return nil
}
