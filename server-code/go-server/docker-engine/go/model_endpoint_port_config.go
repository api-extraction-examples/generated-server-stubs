...
// AssertEndpointPortConfigRequired checks if the required fields are not zero-ed
func AssertEndpointPortConfigRequired(obj EndpointPortConfig) error {
	return nil
}

// AssertEndpointPortConfigConstraints checks if the values respects the defined constraints
func AssertEndpointPortConfigConstraints(obj EndpointPortConfig) error {
	return nil
}
