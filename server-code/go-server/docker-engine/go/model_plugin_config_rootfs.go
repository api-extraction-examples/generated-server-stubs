...
// AssertPluginConfigRootfsRequired checks if the required fields are not zero-ed
func AssertPluginConfigRootfsRequired(obj PluginConfigRootfs) error {
	return nil
}

// AssertPluginConfigRootfsConstraints checks if the values respects the defined constraints
func AssertPluginConfigRootfsConstraints(obj PluginConfigRootfs) error {
	return nil
}
