...
// AssertThrottleDeviceRequired checks if the required fields are not zero-ed
func AssertThrottleDeviceRequired(obj ThrottleDevice) error {
	return nil
}

// AssertThrottleDeviceConstraints checks if the values respects the defined constraints
func AssertThrottleDeviceConstraints(obj ThrottleDevice) error {
	if obj.Rate < 0 {
