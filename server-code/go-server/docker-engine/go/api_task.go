...
func NewTaskAPIController(s TaskAPIServicer, opts ...TaskAPIOption) Router {
...
func (c *TaskAPIController) TaskInspect(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.TaskInspect(r.Context(), idParam)
...
func (c *TaskAPIController) TaskList(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.TaskList(r.Context(), filtersParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
