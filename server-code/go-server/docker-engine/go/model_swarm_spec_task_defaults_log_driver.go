...
// AssertSwarmSpecTaskDefaultsLogDriverRequired checks if the required fields are not zero-ed
func AssertSwarmSpecTaskDefaultsLogDriverRequired(obj SwarmSpecTaskDefaultsLogDriver) error {
	return nil
}

// AssertSwarmSpecTaskDefaultsLogDriverConstraints checks if the values respects the defined constraints
func AssertSwarmSpecTaskDefaultsLogDriverConstraints(obj SwarmSpecTaskDefaultsLogDriver) error {
	return nil
}
