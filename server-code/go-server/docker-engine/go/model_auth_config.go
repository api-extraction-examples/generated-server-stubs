...
// AssertAuthConfigRequired checks if the required fields are not zero-ed
func AssertAuthConfigRequired(obj AuthConfig) error {
	return nil
}

// AssertAuthConfigConstraints checks if the values respects the defined constraints
func AssertAuthConfigConstraints(obj AuthConfig) error {
	return nil
}
