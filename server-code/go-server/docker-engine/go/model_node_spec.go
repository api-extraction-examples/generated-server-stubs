...
// AssertNodeSpecRequired checks if the required fields are not zero-ed
func AssertNodeSpecRequired(obj NodeSpec) error {
	return nil
}

// AssertNodeSpecConstraints checks if the values respects the defined constraints
func AssertNodeSpecConstraints(obj NodeSpec) error {
	return nil
}
