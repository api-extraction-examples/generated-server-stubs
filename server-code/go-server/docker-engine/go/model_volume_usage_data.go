...
// AssertVolumeUsageDataRequired checks if the required fields are not zero-ed
func AssertVolumeUsageDataRequired(obj VolumeUsageData) error {
...
// AssertVolumeUsageDataConstraints checks if the values respects the defined constraints
func AssertVolumeUsageDataConstraints(obj VolumeUsageData) error {
	return nil
}
