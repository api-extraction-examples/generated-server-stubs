...
// AssertConfigSpecRequired checks if the required fields are not zero-ed
func AssertConfigSpecRequired(obj ConfigSpec) error {
	return nil
}

// AssertConfigSpecConstraints checks if the values respects the defined constraints
func AssertConfigSpecConstraints(obj ConfigSpec) error {
	return nil
}
