...
// AssertTaskSpecContainerSpecPrivilegesRequired checks if the required fields are not zero-ed
func AssertTaskSpecContainerSpecPrivilegesRequired(obj TaskSpecContainerSpecPrivileges) error {
	if err := AssertTaskSpecContainerSpecPrivilegesCredentialSpecRequired(obj.CredentialSpec); err != nil {
		return err
	}
	if err := AssertTaskSpecContainerSpecPrivilegesSeLinuxContextRequired(obj.SELinuxContext); err != nil {
		return err
	}
	return nil
}

// AssertTaskSpecContainerSpecPrivilegesConstraints checks if the values respects the defined constraints
func AssertTaskSpecContainerSpecPrivilegesConstraints(obj TaskSpecContainerSpecPrivileges) error {
	return nil
}
