...
// AssertPluginConfigUserRequired checks if the required fields are not zero-ed
func AssertPluginConfigUserRequired(obj PluginConfigUser) error {
	return nil
}

// AssertPluginConfigUserConstraints checks if the values respects the defined constraints
func AssertPluginConfigUserConstraints(obj PluginConfigUser) error {
	return nil
}
