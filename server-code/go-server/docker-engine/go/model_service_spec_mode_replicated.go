...
// AssertServiceSpecModeReplicatedRequired checks if the required fields are not zero-ed
func AssertServiceSpecModeReplicatedRequired(obj ServiceSpecModeReplicated) error {
	return nil
}

// AssertServiceSpecModeReplicatedConstraints checks if the values respects the defined constraints
func AssertServiceSpecModeReplicatedConstraints(obj ServiceSpecModeReplicated) error {
	return nil
}
