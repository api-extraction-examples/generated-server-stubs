...
// AssertNetworkConnectRequestRequired checks if the required fields are not zero-ed
func AssertNetworkConnectRequestRequired(obj NetworkConnectRequest) error {
	if err := AssertEndpointSettingsRequired(obj.EndpointConfig); err != nil {
		return err
	}
	return nil
}

// AssertNetworkConnectRequestConstraints checks if the values respects the defined constraints
func AssertNetworkConnectRequestConstraints(obj NetworkConnectRequest) error {
	return nil
}
