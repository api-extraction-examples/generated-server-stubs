...
// AssertGraphDriverDataRequired checks if the required fields are not zero-ed
func AssertGraphDriverDataRequired(obj GraphDriverData) error {
...
// AssertGraphDriverDataConstraints checks if the values respects the defined constraints
func AssertGraphDriverDataConstraints(obj GraphDriverData) error {
	return nil
}
