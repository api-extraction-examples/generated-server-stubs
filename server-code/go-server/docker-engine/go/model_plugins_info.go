...
// AssertPluginsInfoRequired checks if the required fields are not zero-ed
func AssertPluginsInfoRequired(obj PluginsInfo) error {
	return nil
}

// AssertPluginsInfoConstraints checks if the values respects the defined constraints
func AssertPluginsInfoConstraints(obj PluginsInfo) error {
	return nil
}
