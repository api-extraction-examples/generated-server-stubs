...
// AssertSecretRequired checks if the required fields are not zero-ed
func AssertSecretRequired(obj Secret) error {
	if err := AssertSecretSpecRequired(obj.Spec); err != nil {
		return err
	}
...
// AssertSecretConstraints checks if the values respects the defined constraints
func AssertSecretConstraints(obj Secret) error {
	return nil
}
