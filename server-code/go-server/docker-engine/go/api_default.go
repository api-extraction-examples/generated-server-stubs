...
func (c *DefaultAPIController) TaskLogs(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	idParam := params["id"]
	if idParam == "" {
	...
	result, err := c.service.TaskLogs(r.Context(), idParam, detailsParam, followParam, stdoutParam, stderrParam, sinceParam, timestampsParam, tailParam)
