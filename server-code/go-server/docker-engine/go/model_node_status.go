...
// AssertNodeStatusRequired checks if the required fields are not zero-ed
func AssertNodeStatusRequired(obj NodeStatus) error {
	return nil
}

// AssertNodeStatusConstraints checks if the values respects the defined constraints
func AssertNodeStatusConstraints(obj NodeStatus) error {
	return nil
}
