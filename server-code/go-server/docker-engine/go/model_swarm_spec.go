...
// AssertSwarmSpecRequired checks if the required fields are not zero-ed
func AssertSwarmSpecRequired(obj SwarmSpec) error {
	if obj.CAConfig != nil {
		if err := AssertSwarmSpecCaConfigRequired(*obj.CAConfig); err != nil {
			return err
		}
	}
	if obj.Dispatcher != nil {
		if err := AssertSwarmSpecDispatcherRequired(*obj.Dispatcher); err != nil {
			return err
		}
	}
	if err := AssertSwarmSpecEncryptionConfigRequired(obj.EncryptionConfig); err != nil {
		return err
	}
	if obj.Orchestration != nil {
		if err := AssertSwarmSpecOrchestrationRequired(*obj.Orchestration); err != nil {
			return err
		}
	}
	if err := AssertSwarmSpecRaftRequired(obj.Raft); err != nil {
		return err
	}
	if err := AssertSwarmSpecTaskDefaultsRequired(obj.TaskDefaults); err != nil {
		return err
	}
	return nil
}

// AssertSwarmSpecConstraints checks if the values respects the defined constraints
func AssertSwarmSpecConstraints(obj SwarmSpec) error {
	return nil
}
