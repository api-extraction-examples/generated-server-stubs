...
func NewNodeAPIController(s NodeAPIServicer, opts ...NodeAPIOption) Router {
...
func (c *NodeAPIController) NodeDelete(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.NodeDelete(r.Context(), idParam, forceParam)
...
func (c *NodeAPIController) NodeInspect(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.NodeInspect(r.Context(), idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *NodeAPIController) NodeList(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.NodeList(r.Context(), filtersParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *NodeAPIController) NodeUpdate(w http.ResponseWriter, r *http.Request) {
	...
	nodeSpecParam := NodeSpec{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&nodeSpecParam); err != nil && !errors.Is(err, io.EOF) {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertNodeSpecRequired(nodeSpecParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertNodeSpecConstraints(nodeSpecParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.NodeUpdate(r.Context(), idParam, versionParam, nodeSpecParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
