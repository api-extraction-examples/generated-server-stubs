...
// AssertContainerUpdateRequestRequired checks if the required fields are not zero-ed
func AssertContainerUpdateRequestRequired(obj ContainerUpdateRequest) error {
...
// AssertContainerUpdateRequestConstraints checks if the values respects the defined constraints
func AssertContainerUpdateRequestConstraints(obj ContainerUpdateRequest) error {
