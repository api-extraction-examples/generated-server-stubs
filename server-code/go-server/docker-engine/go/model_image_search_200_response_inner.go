...
type ImageSearch200ResponseInner struct {
...
// AssertImageSearch200ResponseInnerRequired checks if the required fields are not zero-ed
func AssertImageSearch200ResponseInnerRequired(obj ImageSearch200ResponseInner) error {
	return nil
}

// AssertImageSearch200ResponseInnerConstraints checks if the values respects the defined constraints
func AssertImageSearch200ResponseInnerConstraints(obj ImageSearch200ResponseInner) error {
	return nil
}
