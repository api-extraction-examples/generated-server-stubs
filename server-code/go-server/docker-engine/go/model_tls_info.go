...
// AssertTlsInfoRequired checks if the required fields are not zero-ed
func AssertTlsInfoRequired(obj TlsInfo) error {
	return nil
}

// AssertTlsInfoConstraints checks if the values respects the defined constraints
func AssertTlsInfoConstraints(obj TlsInfo) error {
	return nil
}
