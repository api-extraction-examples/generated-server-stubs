...
// AssertTaskSpecContainerSpecPrivilegesCredentialSpecRequired checks if the required fields are not zero-ed
func AssertTaskSpecContainerSpecPrivilegesCredentialSpecRequired(obj TaskSpecContainerSpecPrivilegesCredentialSpec) error {
	return nil
}

// AssertTaskSpecContainerSpecPrivilegesCredentialSpecConstraints checks if the values respects the defined constraints
func AssertTaskSpecContainerSpecPrivilegesCredentialSpecConstraints(obj TaskSpecContainerSpecPrivilegesCredentialSpec) error {
	return nil
}
