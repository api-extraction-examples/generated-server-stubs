...
// AssertSwarmJoinRequestRequired checks if the required fields are not zero-ed
func AssertSwarmJoinRequestRequired(obj SwarmJoinRequest) error {
	return nil
}

// AssertSwarmJoinRequestConstraints checks if the values respects the defined constraints
func AssertSwarmJoinRequestConstraints(obj SwarmJoinRequest) error {
	return nil
}
