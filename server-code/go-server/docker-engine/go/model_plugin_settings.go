...
// AssertPluginSettingsRequired checks if the required fields are not zero-ed
func AssertPluginSettingsRequired(obj PluginSettings) error {
...
// AssertPluginSettingsConstraints checks if the values respects the defined constraints
func AssertPluginSettingsConstraints(obj PluginSettings) error {
	return nil
}
