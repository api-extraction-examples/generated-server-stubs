...
func AssertImageRequired(obj Image) error {
	...
	if err := AssertContainerConfigRequired(obj.ContainerConfig); err != nil {
		return err
	}
	if err := AssertGraphDriverDataRequired(obj.GraphDriver); err != nil {
		return err
	}
	if err := AssertImageMetadataRequired(obj.Metadata); err != nil {
		return err
	}
	if err := AssertImageRootFsRequired(obj.RootFS); err != nil {
		return err
	}
	return nil
}
