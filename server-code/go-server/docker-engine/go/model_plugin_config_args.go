...
// AssertPluginConfigArgsRequired checks if the required fields are not zero-ed
func AssertPluginConfigArgsRequired(obj PluginConfigArgs) error {
...
// AssertPluginConfigArgsConstraints checks if the values respects the defined constraints
func AssertPluginConfigArgsConstraints(obj PluginConfigArgs) error {
	return nil
}
