...
type NetworkPrune200Response struct {

	// Networks that were deleted
	NetworksDeleted []string `json:"NetworksDeleted,omitempty"`
}

// AssertNetworkPrune200ResponseRequired checks if the required fields are not zero-ed
func AssertNetworkPrune200ResponseRequired(obj NetworkPrune200Response) error {
	return nil
}

// AssertNetworkPrune200ResponseConstraints checks if the values respects the defined constraints
func AssertNetworkPrune200ResponseConstraints(obj NetworkPrune200Response) error {
	return nil
}
