...
type ConfigCreate201Response struct {

	// The ID of the created config.
	ID string `json:"ID,omitempty"`
}

// AssertConfigCreate201ResponseRequired checks if the required fields are not zero-ed
func AssertConfigCreate201ResponseRequired(obj ConfigCreate201Response) error {
	return nil
}

// AssertConfigCreate201ResponseConstraints checks if the values respects the defined constraints
func AssertConfigCreate201ResponseConstraints(obj ConfigCreate201Response) error {
	return nil
}
