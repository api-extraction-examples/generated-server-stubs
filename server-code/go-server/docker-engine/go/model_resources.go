...
// AssertResourcesRequired checks if the required fields are not zero-ed
func AssertResourcesRequired(obj Resources) error {
...
// AssertResourcesConstraints checks if the values respects the defined constraints
func AssertResourcesConstraints(obj Resources) error {
