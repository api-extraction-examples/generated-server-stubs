...
// AssertProcessConfigRequired checks if the required fields are not zero-ed
func AssertProcessConfigRequired(obj ProcessConfig) error {
	return nil
}

// AssertProcessConfigConstraints checks if the values respects the defined constraints
func AssertProcessConfigConstraints(obj ProcessConfig) error {
	return nil
}
