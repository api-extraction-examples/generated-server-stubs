...
// AssertServiceUpdateStatusRequired checks if the required fields are not zero-ed
func AssertServiceUpdateStatusRequired(obj ServiceUpdateStatus) error {
	return nil
}

// AssertServiceUpdateStatusConstraints checks if the values respects the defined constraints
func AssertServiceUpdateStatusConstraints(obj ServiceUpdateStatus) error {
	return nil
}
