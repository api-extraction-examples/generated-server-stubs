...
// AssertMountVolumeOptionsRequired checks if the required fields are not zero-ed
func AssertMountVolumeOptionsRequired(obj MountVolumeOptions) error {
	if err := AssertMountVolumeOptionsDriverConfigRequired(obj.DriverConfig); err != nil {
		return err
	}
	return nil
}

// AssertMountVolumeOptionsConstraints checks if the values respects the defined constraints
func AssertMountVolumeOptionsConstraints(obj MountVolumeOptions) error {
	return nil
}
