...
// AssertPushImageInfoRequired checks if the required fields are not zero-ed
func AssertPushImageInfoRequired(obj PushImageInfo) error {
...
// AssertPushImageInfoConstraints checks if the values respects the defined constraints
func AssertPushImageInfoConstraints(obj PushImageInfo) error {
	return nil
}
