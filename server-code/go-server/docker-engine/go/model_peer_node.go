...
// AssertPeerNodeRequired checks if the required fields are not zero-ed
func AssertPeerNodeRequired(obj PeerNode) error {
	return nil
}

// AssertPeerNodeConstraints checks if the values respects the defined constraints
func AssertPeerNodeConstraints(obj PeerNode) error {
	return nil
}
