...
// AssertNodeDescriptionRequired checks if the required fields are not zero-ed
func AssertNodeDescriptionRequired(obj NodeDescription) error {
	if err := AssertEngineDescriptionRequired(obj.Engine); err != nil {
		return err
	}
	if err := AssertPlatformRequired(obj.Platform); err != nil {
		return err
	}
	if err := AssertResourceObjectRequired(obj.Resources); err != nil {
		return err
	}
	if err := AssertTlsInfoRequired(obj.TLSInfo); err != nil {
		return err
	}
	return nil
}

// AssertNodeDescriptionConstraints checks if the values respects the defined constraints
func AssertNodeDescriptionConstraints(obj NodeDescription) error {
	return nil
}
