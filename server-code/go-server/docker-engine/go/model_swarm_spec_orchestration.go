...
// AssertSwarmSpecOrchestrationRequired checks if the required fields are not zero-ed
func AssertSwarmSpecOrchestrationRequired(obj SwarmSpecOrchestration) error {
	return nil
}

// AssertSwarmSpecOrchestrationConstraints checks if the values respects the defined constraints
func AssertSwarmSpecOrchestrationConstraints(obj SwarmSpecOrchestration) error {
	return nil
}
