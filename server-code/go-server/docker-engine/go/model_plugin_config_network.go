...
// AssertPluginConfigNetworkRequired checks if the required fields are not zero-ed
func AssertPluginConfigNetworkRequired(obj PluginConfigNetwork) error {
...
// AssertPluginConfigNetworkConstraints checks if the values respects the defined constraints
func AssertPluginConfigNetworkConstraints(obj PluginConfigNetwork) error {
	return nil
}
