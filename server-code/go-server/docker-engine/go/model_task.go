...
type Task struct {
	...
	AssignedGenericResources []GenericResourcesInner `json:"AssignedGenericResources,omitempty"`
...
func AssertTaskRequired(obj Task) error {
	for _, el := range obj.AssignedGenericResources {
		if err := AssertGenericResourcesInnerRequired(el); err != nil {
			return err
		}
	}
	if err := AssertTaskSpecRequired(obj.Spec); err != nil {
		return err
	}
	if err := AssertTaskStatusRequired(obj.Status); err != nil {
		return err
	}
