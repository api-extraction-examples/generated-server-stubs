...
// AssertPortBindingRequired checks if the required fields are not zero-ed
func AssertPortBindingRequired(obj PortBinding) error {
	return nil
}

// AssertPortBindingConstraints checks if the values respects the defined constraints
func AssertPortBindingConstraints(obj PortBinding) error {
	return nil
}
