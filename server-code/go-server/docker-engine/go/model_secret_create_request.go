...
// AssertSecretCreateRequestRequired checks if the required fields are not zero-ed
func AssertSecretCreateRequestRequired(obj SecretCreateRequest) error {
	if err := AssertDriverRequired(obj.Driver); err != nil {
		return err
	}
	return nil
}

// AssertSecretCreateRequestConstraints checks if the values respects the defined constraints
func AssertSecretCreateRequestConstraints(obj SecretCreateRequest) error {
	return nil
}
