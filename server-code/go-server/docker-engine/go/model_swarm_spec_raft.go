...
// AssertSwarmSpecRaftRequired checks if the required fields are not zero-ed
func AssertSwarmSpecRaftRequired(obj SwarmSpecRaft) error {
	return nil
}

// AssertSwarmSpecRaftConstraints checks if the values respects the defined constraints
func AssertSwarmSpecRaftConstraints(obj SwarmSpecRaft) error {
	return nil
}
