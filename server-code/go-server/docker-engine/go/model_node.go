...
func AssertNodeRequired(obj Node) error {
	if err := AssertNodeDescriptionRequired(obj.Description); err != nil {
		return err
	}
	if obj.ManagerStatus != nil {
		if err := AssertManagerStatusRequired(*obj.ManagerStatus); err != nil {
			return err
		}
	}
	if err := AssertNodeSpecRequired(obj.Spec); err != nil {
		return err
	}
	if err := AssertNodeStatusRequired(obj.Status); err != nil {
		return err
	}
