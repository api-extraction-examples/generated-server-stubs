...
// AssertTaskStatusContainerStatusRequired checks if the required fields are not zero-ed
func AssertTaskStatusContainerStatusRequired(obj TaskStatusContainerStatus) error {
	return nil
}

// AssertTaskStatusContainerStatusConstraints checks if the values respects the defined constraints
func AssertTaskStatusContainerStatusConstraints(obj TaskStatusContainerStatus) error {
	return nil
}
