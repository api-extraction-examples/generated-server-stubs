...
type EngineDescription struct {
	...
	Plugins []EngineDescriptionPluginsInner `json:"Plugins,omitempty"`
}

// AssertEngineDescriptionRequired checks if the required fields are not zero-ed
func AssertEngineDescriptionRequired(obj EngineDescription) error {
	for _, el := range obj.Plugins {
		if err := AssertEngineDescriptionPluginsInnerRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertEngineDescriptionConstraints checks if the values respects the defined constraints
func AssertEngineDescriptionConstraints(obj EngineDescription) error {
	return nil
}
