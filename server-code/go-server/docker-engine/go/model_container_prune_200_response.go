...
type ContainerPrune200Response struct {
...
// AssertContainerPrune200ResponseRequired checks if the required fields are not zero-ed
func AssertContainerPrune200ResponseRequired(obj ContainerPrune200Response) error {
	return nil
}

// AssertContainerPrune200ResponseConstraints checks if the values respects the defined constraints
func AssertContainerPrune200ResponseConstraints(obj ContainerPrune200Response) error {
	return nil
}
