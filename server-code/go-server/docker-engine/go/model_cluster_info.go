...
// AssertClusterInfoRequired checks if the required fields are not zero-ed
func AssertClusterInfoRequired(obj ClusterInfo) error {
...
// AssertClusterInfoConstraints checks if the values respects the defined constraints
func AssertClusterInfoConstraints(obj ClusterInfo) error {
	return nil
}
