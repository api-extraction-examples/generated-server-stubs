...
// AssertNetworkCreateRequestRequired checks if the required fields are not zero-ed
func AssertNetworkCreateRequestRequired(obj NetworkCreateRequest) error {
	...
	if err := AssertIpamRequired(obj.IPAM); err != nil {
		return err
	}
	return nil
}

// AssertNetworkCreateRequestConstraints checks if the values respects the defined constraints
func AssertNetworkCreateRequestConstraints(obj NetworkCreateRequest) error {
	return nil
}
