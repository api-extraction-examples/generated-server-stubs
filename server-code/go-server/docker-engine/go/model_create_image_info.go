...
// AssertCreateImageInfoRequired checks if the required fields are not zero-ed
func AssertCreateImageInfoRequired(obj CreateImageInfo) error {
...
// AssertCreateImageInfoConstraints checks if the values respects the defined constraints
func AssertCreateImageInfoConstraints(obj CreateImageInfo) error {
	return nil
}
