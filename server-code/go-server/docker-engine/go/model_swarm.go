...
// AssertSwarmRequired checks if the required fields are not zero-ed
func AssertSwarmRequired(obj Swarm) error {
	if err := AssertSwarmSpecRequired(obj.Spec); err != nil {
		return err
	}
	if err := AssertTlsInfoRequired(obj.TLSInfo); err != nil {
		return err
	}
	if err := AssertObjectVersionRequired(obj.Version); err != nil {
		return err
	}
	if err := AssertJoinTokensRequired(obj.JoinTokens); err != nil {
		return err
	}
	return nil
}

// AssertSwarmConstraints checks if the values respects the defined constraints
func AssertSwarmConstraints(obj Swarm) error {
	return nil
}
