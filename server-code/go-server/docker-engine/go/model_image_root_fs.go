...
// AssertImageRootFsRequired checks if the required fields are not zero-ed
func AssertImageRootFsRequired(obj ImageRootFs) error {
...
// AssertImageRootFsConstraints checks if the values respects the defined constraints
func AssertImageRootFsConstraints(obj ImageRootFs) error {
	return nil
}
