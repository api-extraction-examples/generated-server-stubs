...
// AssertServiceSpecModeRequired checks if the required fields are not zero-ed
func AssertServiceSpecModeRequired(obj ServiceSpecMode) error {
	if err := AssertServiceSpecModeReplicatedRequired(obj.Replicated); err != nil {
		return err
	}
	return nil
}

// AssertServiceSpecModeConstraints checks if the values respects the defined constraints
func AssertServiceSpecModeConstraints(obj ServiceSpecMode) error {
	return nil
}
