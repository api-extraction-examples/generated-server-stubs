...
// AssertServiceSpecRequired checks if the required fields are not zero-ed
func AssertServiceSpecRequired(obj ServiceSpec) error {
...
// AssertServiceSpecConstraints checks if the values respects the defined constraints
func AssertServiceSpecConstraints(obj ServiceSpec) error {
	return nil
}
