...
// AssertEndpointSettingsRequired checks if the required fields are not zero-ed
func AssertEndpointSettingsRequired(obj EndpointSettings) error {
	if obj.IPAMConfig != nil {
		if err := AssertEndpointIpamConfigRequired(*obj.IPAMConfig); err != nil {
			return err
		}
	}
	return nil
...
// AssertEndpointSettingsConstraints checks if the values respects the defined constraints
func AssertEndpointSettingsConstraints(obj EndpointSettings) error {
	return nil
}
