...
// AssertServiceSpecUpdateConfigRequired checks if the required fields are not zero-ed
func AssertServiceSpecUpdateConfigRequired(obj ServiceSpecUpdateConfig) error {
	return nil
}

// AssertServiceSpecUpdateConfigConstraints checks if the values respects the defined constraints
func AssertServiceSpecUpdateConfigConstraints(obj ServiceSpecUpdateConfig) error {
	return nil
}
