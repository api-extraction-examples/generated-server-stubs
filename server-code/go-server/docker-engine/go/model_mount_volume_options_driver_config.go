...
// AssertMountVolumeOptionsDriverConfigRequired checks if the required fields are not zero-ed
func AssertMountVolumeOptionsDriverConfigRequired(obj MountVolumeOptionsDriverConfig) error {
	return nil
}

// AssertMountVolumeOptionsDriverConfigConstraints checks if the values respects the defined constraints
func AssertMountVolumeOptionsDriverConfigConstraints(obj MountVolumeOptionsDriverConfig) error {
	return nil
}
