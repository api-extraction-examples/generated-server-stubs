...
// AssertTaskSpecContainerSpecPrivilegesSeLinuxContextRequired checks if the required fields are not zero-ed
func AssertTaskSpecContainerSpecPrivilegesSeLinuxContextRequired(obj TaskSpecContainerSpecPrivilegesSeLinuxContext) error {
	return nil
}

// AssertTaskSpecContainerSpecPrivilegesSeLinuxContextConstraints checks if the values respects the defined constraints
func AssertTaskSpecContainerSpecPrivilegesSeLinuxContextConstraints(obj TaskSpecContainerSpecPrivilegesSeLinuxContext) error {
	return nil
}
