...
func (s *VolumeAPIService) VolumeCreate(ctx context.Context, volumeCreateRequest VolumeCreateRequest) (ImplResponse, error) {
...
func (s *VolumeAPIService) VolumeList(ctx context.Context, filters string) (ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(200, VolumeList200Response{}) or use other options such as http.Ok ...
	// return Response(200, VolumeList200Response{}), nil
...
func (s *VolumeAPIService) VolumePrune(ctx context.Context, filters string) (ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(200, VolumePrune200Response{}) or use other options such as http.Ok ...
	// return Response(200, VolumePrune200Response{}), nil
