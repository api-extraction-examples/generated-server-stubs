...
// AssertIdResponseRequired checks if the required fields are not zero-ed
func AssertIdResponseRequired(obj IdResponse) error {
...
// AssertIdResponseConstraints checks if the values respects the defined constraints
func AssertIdResponseConstraints(obj IdResponse) error {
	return nil
}
