...
// AssertNetworkContainerRequired checks if the required fields are not zero-ed
func AssertNetworkContainerRequired(obj NetworkContainer) error {
	return nil
}

// AssertNetworkContainerConstraints checks if the values respects the defined constraints
func AssertNetworkContainerConstraints(obj NetworkContainer) error {
	return nil
}
