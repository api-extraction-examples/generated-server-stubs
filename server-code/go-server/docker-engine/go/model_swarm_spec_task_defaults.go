...
// AssertSwarmSpecTaskDefaultsRequired checks if the required fields are not zero-ed
func AssertSwarmSpecTaskDefaultsRequired(obj SwarmSpecTaskDefaults) error {
	if err := AssertSwarmSpecTaskDefaultsLogDriverRequired(obj.LogDriver); err != nil {
		return err
	}
	return nil
}

// AssertSwarmSpecTaskDefaultsConstraints checks if the values respects the defined constraints
func AssertSwarmSpecTaskDefaultsConstraints(obj SwarmSpecTaskDefaults) error {
	return nil
}
