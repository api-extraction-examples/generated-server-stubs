...
type ResourcesUlimitsInner struct {
...
// AssertResourcesUlimitsInnerRequired checks if the required fields are not zero-ed
func AssertResourcesUlimitsInnerRequired(obj ResourcesUlimitsInner) error {
	return nil
}

// AssertResourcesUlimitsInnerConstraints checks if the values respects the defined constraints
func AssertResourcesUlimitsInnerConstraints(obj ResourcesUlimitsInner) error {
	return nil
}
