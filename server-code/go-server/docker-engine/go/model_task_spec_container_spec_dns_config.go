...
// AssertTaskSpecContainerSpecDnsConfigRequired checks if the required fields are not zero-ed
func AssertTaskSpecContainerSpecDnsConfigRequired(obj TaskSpecContainerSpecDnsConfig) error {
	return nil
}

// AssertTaskSpecContainerSpecDnsConfigConstraints checks if the values respects the defined constraints
func AssertTaskSpecContainerSpecDnsConfigConstraints(obj TaskSpecContainerSpecDnsConfig) error {
	return nil
}
