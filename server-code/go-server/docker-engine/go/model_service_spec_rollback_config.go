...
// AssertServiceSpecRollbackConfigRequired checks if the required fields are not zero-ed
func AssertServiceSpecRollbackConfigRequired(obj ServiceSpecRollbackConfig) error {
	return nil
}

// AssertServiceSpecRollbackConfigConstraints checks if the values respects the defined constraints
func AssertServiceSpecRollbackConfigConstraints(obj ServiceSpecRollbackConfig) error {
	return nil
}
