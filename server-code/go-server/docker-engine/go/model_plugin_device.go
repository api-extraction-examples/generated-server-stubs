...
// AssertPluginDeviceRequired checks if the required fields are not zero-ed
func AssertPluginDeviceRequired(obj PluginDevice) error {
...
// AssertPluginDeviceConstraints checks if the values respects the defined constraints
func AssertPluginDeviceConstraints(obj PluginDevice) error {
	return nil
}
