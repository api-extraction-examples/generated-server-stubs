...
// AssertMountBindOptionsRequired checks if the required fields are not zero-ed
func AssertMountBindOptionsRequired(obj MountBindOptions) error {
	return nil
}

// AssertMountBindOptionsConstraints checks if the values respects the defined constraints
func AssertMountBindOptionsConstraints(obj MountBindOptions) error {
	return nil
}
