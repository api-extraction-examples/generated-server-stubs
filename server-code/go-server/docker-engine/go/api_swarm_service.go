...
// SwarmAPIService is a service that implements the logic for the SwarmAPIServicer
...
func (s *SwarmAPIService) SwarmInit(ctx context.Context, swarmInitRequest SwarmInitRequest) (ImplResponse, error) {
	// TODO - update SwarmInit with the required logic for this service method.
	// Add api_swarm_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
...
func (s *SwarmAPIService) SwarmJoin(ctx context.Context, swarmJoinRequest SwarmJoinRequest) (ImplResponse, error) {
...
func (s *SwarmAPIService) SwarmUnlock(ctx context.Context, swarmUnlockRequest SwarmUnlockRequest) (ImplResponse, error) {
...
func (s *SwarmAPIService) SwarmUnlockkey(ctx context.Context) (ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(200, SwarmUnlockRequest{}) or use other options such as http.Ok ...
	// return Response(200, SwarmUnlockRequest{}), nil
...
func (s *SwarmAPIService) SwarmUpdate(ctx context.Context, version int64, swarmSpec SwarmSpec, rotateWorkerToken bool, rotateManagerToken bool, rotateManagerUnlockKey bool) (ImplResponse, error) {
