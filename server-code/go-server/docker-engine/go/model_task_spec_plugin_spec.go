...
type TaskSpecPluginSpec struct {
	...
	PluginPrivilege []PluginPullRequestInner `json:"PluginPrivilege,omitempty"`

	// The plugin image reference to use.
	Remote string `json:"Remote,omitempty"`
}

// AssertTaskSpecPluginSpecRequired checks if the required fields are not zero-ed
func AssertTaskSpecPluginSpecRequired(obj TaskSpecPluginSpec) error {
	for _, el := range obj.PluginPrivilege {
...
// AssertTaskSpecPluginSpecConstraints checks if the values respects the defined constraints
func AssertTaskSpecPluginSpecConstraints(obj TaskSpecPluginSpec) error {
	return nil
}
