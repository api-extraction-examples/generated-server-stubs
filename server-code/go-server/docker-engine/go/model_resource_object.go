...
// AssertResourceObjectRequired checks if the required fields are not zero-ed
func AssertResourceObjectRequired(obj ResourceObject) error {
...
// AssertResourceObjectConstraints checks if the values respects the defined constraints
func AssertResourceObjectConstraints(obj ResourceObject) error {
	return nil
}
