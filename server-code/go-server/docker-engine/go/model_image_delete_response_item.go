...
// AssertImageDeleteResponseItemRequired checks if the required fields are not zero-ed
func AssertImageDeleteResponseItemRequired(obj ImageDeleteResponseItem) error {
	return nil
}

// AssertImageDeleteResponseItemConstraints checks if the values respects the defined constraints
func AssertImageDeleteResponseItemConstraints(obj ImageDeleteResponseItem) error {
	return nil
}
