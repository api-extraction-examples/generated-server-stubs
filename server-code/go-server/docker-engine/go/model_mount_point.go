...
// AssertMountPointRequired checks if the required fields are not zero-ed
func AssertMountPointRequired(obj MountPoint) error {
	return nil
}

// AssertMountPointConstraints checks if the values respects the defined constraints
func AssertMountPointConstraints(obj MountPoint) error {
	return nil
}
