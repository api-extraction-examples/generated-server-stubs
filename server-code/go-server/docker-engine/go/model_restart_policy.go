...
// AssertRestartPolicyRequired checks if the required fields are not zero-ed
func AssertRestartPolicyRequired(obj RestartPolicy) error {
	return nil
}

// AssertRestartPolicyConstraints checks if the values respects the defined constraints
func AssertRestartPolicyConstraints(obj RestartPolicy) error {
	return nil
}
