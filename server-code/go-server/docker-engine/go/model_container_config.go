...
// AssertContainerConfigRequired checks if the required fields are not zero-ed
func AssertContainerConfigRequired(obj ContainerConfig) error {
...
// AssertContainerConfigConstraints checks if the values respects the defined constraints
func AssertContainerConfigConstraints(obj ContainerConfig) error {
	return nil
}
