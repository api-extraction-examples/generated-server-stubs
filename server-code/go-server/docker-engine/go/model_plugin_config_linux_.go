...
// AssertPluginConfigLinuxRequired checks if the required fields are not zero-ed
func AssertPluginConfigLinuxRequired(obj PluginConfigLinux) error {
	elements := map[string]interface{}{
		"AllowAllDevices": obj.AllowAllDevices,
	...
	for _, el := range obj.Devices {
		if err := AssertPluginDeviceRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertPluginConfigLinuxConstraints checks if the values respects the defined constraints
func AssertPluginConfigLinuxConstraints(obj PluginConfigLinux) error {
	return nil
}
