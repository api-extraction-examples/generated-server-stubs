...
// AssertPluginInterfaceTypeRequired checks if the required fields are not zero-ed
func AssertPluginInterfaceTypeRequired(obj PluginInterfaceType) error {
...
// AssertPluginInterfaceTypeConstraints checks if the values respects the defined constraints
func AssertPluginInterfaceTypeConstraints(obj PluginInterfaceType) error {
	return nil
}
