...
type BuildPrune200Response struct {

	// Disk space reclaimed in bytes
	SpaceReclaimed int64 `json:"SpaceReclaimed,omitempty"`
}

// AssertBuildPrune200ResponseRequired checks if the required fields are not zero-ed
func AssertBuildPrune200ResponseRequired(obj BuildPrune200Response) error {
	return nil
}

// AssertBuildPrune200ResponseConstraints checks if the values respects the defined constraints
func AssertBuildPrune200ResponseConstraints(obj BuildPrune200Response) error {
	return nil
}
