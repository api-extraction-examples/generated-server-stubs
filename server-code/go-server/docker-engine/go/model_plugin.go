...
// AssertPluginRequired checks if the required fields are not zero-ed
func AssertPluginRequired(obj Plugin) error {
	...
	if err := AssertPluginConfigRequired(obj.Config); err != nil {
		return err
	}
	if err := AssertPluginSettingsRequired(obj.Settings); err != nil {
		return err
	}
	return nil
}

// AssertPluginConstraints checks if the values respects the defined constraints
func AssertPluginConstraints(obj Plugin) error {
	return nil
}
