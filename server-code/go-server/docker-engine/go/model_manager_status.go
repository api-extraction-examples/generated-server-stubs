...
// AssertManagerStatusRequired checks if the required fields are not zero-ed
func AssertManagerStatusRequired(obj ManagerStatus) error {
	return nil
}

// AssertManagerStatusConstraints checks if the values respects the defined constraints
func AssertManagerStatusConstraints(obj ManagerStatus) error {
	return nil
}
