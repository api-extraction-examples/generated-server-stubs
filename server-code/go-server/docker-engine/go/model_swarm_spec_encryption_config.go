...
// AssertSwarmSpecEncryptionConfigRequired checks if the required fields are not zero-ed
func AssertSwarmSpecEncryptionConfigRequired(obj SwarmSpecEncryptionConfig) error {
	return nil
}

// AssertSwarmSpecEncryptionConfigConstraints checks if the values respects the defined constraints
func AssertSwarmSpecEncryptionConfigConstraints(obj SwarmSpecEncryptionConfig) error {
	return nil
}
