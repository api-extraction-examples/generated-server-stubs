...
// AssertTaskSpecRequired checks if the required fields are not zero-ed
func AssertTaskSpecRequired(obj TaskSpec) error {
	if err := AssertTaskSpecContainerSpecRequired(obj.ContainerSpec); err != nil {
		return err
	}
	if err := AssertTaskSpecLogDriverRequired(obj.LogDriver); err != nil {
		return err
	}
	...
	if err := AssertTaskSpecPlacementRequired(obj.Placement); err != nil {
		return err
	}
	if err := AssertTaskSpecPluginSpecRequired(obj.PluginSpec); err != nil {
		return err
	}
	if err := AssertTaskSpecResourcesRequired(obj.Resources); err != nil {
		return err
	}
	if err := AssertTaskSpecRestartPolicyRequired(obj.RestartPolicy); err != nil {
		return err
	}
	return nil
}

// AssertTaskSpecConstraints checks if the values respects the defined constraints
func AssertTaskSpecConstraints(obj TaskSpec) error {
	return nil
}
