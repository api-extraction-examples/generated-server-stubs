...
// AssertProgressDetailRequired checks if the required fields are not zero-ed
func AssertProgressDetailRequired(obj ProgressDetail) error {
	return nil
}

// AssertProgressDetailConstraints checks if the values respects the defined constraints
func AssertProgressDetailConstraints(obj ProgressDetail) error {
	return nil
}
