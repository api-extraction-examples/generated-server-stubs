...
// AssertMountTmpfsOptionsRequired checks if the required fields are not zero-ed
func AssertMountTmpfsOptionsRequired(obj MountTmpfsOptions) error {
	return nil
}

// AssertMountTmpfsOptionsConstraints checks if the values respects the defined constraints
func AssertMountTmpfsOptionsConstraints(obj MountTmpfsOptions) error {
	return nil
}
