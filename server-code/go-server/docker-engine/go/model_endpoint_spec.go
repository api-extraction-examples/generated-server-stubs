...
// AssertEndpointSpecRequired checks if the required fields are not zero-ed
func AssertEndpointSpecRequired(obj EndpointSpec) error {
...
// AssertEndpointSpecConstraints checks if the values respects the defined constraints
func AssertEndpointSpecConstraints(obj EndpointSpec) error {
	return nil
}
