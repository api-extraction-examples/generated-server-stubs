...
// AssertIndexInfoRequired checks if the required fields are not zero-ed
func AssertIndexInfoRequired(obj IndexInfo) error {
	return nil
}

// AssertIndexInfoConstraints checks if the values respects the defined constraints
func AssertIndexInfoConstraints(obj IndexInfo) error {
	return nil
}
