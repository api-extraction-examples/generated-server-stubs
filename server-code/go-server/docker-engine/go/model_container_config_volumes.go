...
// AssertContainerConfigVolumesRequired checks if the required fields are not zero-ed
func AssertContainerConfigVolumesRequired(obj ContainerConfigVolumes) error {
	return nil
}

// AssertContainerConfigVolumesConstraints checks if the values respects the defined constraints
func AssertContainerConfigVolumesConstraints(obj ContainerConfigVolumes) error {
	return nil
}
