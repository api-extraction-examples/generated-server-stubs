...
func AssertServiceRequired(obj Service) error {
	if err := AssertServiceEndpointRequired(obj.Endpoint); err != nil {
		return err
	}
	if err := AssertServiceSpecRequired(obj.Spec); err != nil {
		return err
	}
	if err := AssertServiceUpdateStatusRequired(obj.UpdateStatus); err != nil {
		return err
	}
