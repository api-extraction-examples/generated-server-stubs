...
func (c *VolumeAPIController) VolumeCreate(w http.ResponseWriter, r *http.Request) {
	volumeCreateRequestParam := VolumeCreateRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&volumeCreateRequestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertVolumeCreateRequestRequired(volumeCreateRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertVolumeCreateRequestConstraints(volumeCreateRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.VolumeCreate(r.Context(), volumeCreateRequestParam)
...
func (c *VolumeAPIController) VolumeDelete(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.VolumeDelete(r.Context(), nameParam, forceParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *VolumeAPIController) VolumeInspect(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.VolumeInspect(r.Context(), nameParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *VolumeAPIController) VolumeList(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.VolumeList(r.Context(), filtersParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *VolumeAPIController) VolumePrune(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.VolumePrune(r.Context(), filtersParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
