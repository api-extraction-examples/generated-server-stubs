...
// AssertDriverRequired checks if the required fields are not zero-ed
func AssertDriverRequired(obj Driver) error {
...
// AssertDriverConstraints checks if the values respects the defined constraints
func AssertDriverConstraints(obj Driver) error {
	return nil
}
