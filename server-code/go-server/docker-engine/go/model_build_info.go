...
// AssertBuildInfoRequired checks if the required fields are not zero-ed
func AssertBuildInfoRequired(obj BuildInfo) error {
	if err := AssertErrorDetailRequired(obj.ErrorDetail); err != nil {
		return err
	}
	if err := AssertProgressDetailRequired(obj.ProgressDetail); err != nil {
		return err
	}
	return nil
}

// AssertBuildInfoConstraints checks if the values respects the defined constraints
func AssertBuildInfoConstraints(obj BuildInfo) error {
	return nil
}
