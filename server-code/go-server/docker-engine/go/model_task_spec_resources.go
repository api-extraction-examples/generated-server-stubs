...
// AssertTaskSpecResourcesRequired checks if the required fields are not zero-ed
func AssertTaskSpecResourcesRequired(obj TaskSpecResources) error {
	if err := AssertResourceObjectRequired(obj.Limits); err != nil {
		return err
	}
	if err := AssertResourceObjectRequired(obj.Reservation); err != nil {
		return err
	}
	return nil
}

// AssertTaskSpecResourcesConstraints checks if the values respects the defined constraints
func AssertTaskSpecResourcesConstraints(obj TaskSpecResources) error {
	return nil
}
