...
// AssertRuntimeRequired checks if the required fields are not zero-ed
func AssertRuntimeRequired(obj Runtime) error {
	return nil
}

// AssertRuntimeConstraints checks if the values respects the defined constraints
func AssertRuntimeConstraints(obj Runtime) error {
	return nil
}
