...
type SwarmSpecCaConfig struct {
	...
	ExternalCAs []SwarmSpecCaConfigExternalCasInner `json:"ExternalCAs,omitempty"`
...
// AssertSwarmSpecCaConfigRequired checks if the required fields are not zero-ed
func AssertSwarmSpecCaConfigRequired(obj SwarmSpecCaConfig) error {
	for _, el := range obj.ExternalCAs {
		if err := AssertSwarmSpecCaConfigExternalCasInnerRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertSwarmSpecCaConfigConstraints checks if the values respects the defined constraints
func AssertSwarmSpecCaConfigConstraints(obj SwarmSpecCaConfig) error {
	return nil
}
