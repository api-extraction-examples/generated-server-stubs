...
// AssertSecretSpecRequired checks if the required fields are not zero-ed
func AssertSecretSpecRequired(obj SecretSpec) error {
...
// AssertSecretSpecConstraints checks if the values respects the defined constraints
func AssertSecretSpecConstraints(obj SecretSpec) error {
	return nil
}
