...
// AssertHealthConfigRequired checks if the required fields are not zero-ed
func AssertHealthConfigRequired(obj HealthConfig) error {
	return nil
}

// AssertHealthConfigConstraints checks if the values respects the defined constraints
func AssertHealthConfigConstraints(obj HealthConfig) error {
	return nil
}
