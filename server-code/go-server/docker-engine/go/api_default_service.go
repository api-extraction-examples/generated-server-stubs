...
func (s *DefaultAPIService) TaskLogs(ctx context.Context, id string, details bool, follow bool, stdout bool, stderr bool, since int32, timestamps bool, tail string) (ImplResponse, error) {
