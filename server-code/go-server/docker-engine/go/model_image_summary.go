...
// AssertImageSummaryRequired checks if the required fields are not zero-ed
func AssertImageSummaryRequired(obj ImageSummary) error {
	elements := map[string]interface{}{
		...
		"RepoDigests": obj.RepoDigests,
		"RepoTags": obj.RepoTags,
...
// AssertImageSummaryConstraints checks if the values respects the defined constraints
func AssertImageSummaryConstraints(obj ImageSummary) error {
	return nil
}
