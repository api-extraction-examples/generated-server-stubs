...
// AssertPluginEnvRequired checks if the required fields are not zero-ed
func AssertPluginEnvRequired(obj PluginEnv) error {
...
// AssertPluginEnvConstraints checks if the values respects the defined constraints
func AssertPluginEnvConstraints(obj PluginEnv) error {
	return nil
}
