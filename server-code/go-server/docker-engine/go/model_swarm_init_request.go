...
// AssertSwarmInitRequestRequired checks if the required fields are not zero-ed
func AssertSwarmInitRequestRequired(obj SwarmInitRequest) error {
...
// AssertSwarmInitRequestConstraints checks if the values respects the defined constraints
func AssertSwarmInitRequestConstraints(obj SwarmInitRequest) error {
	return nil
}
