...
// AssertEndpointIpamConfigRequired checks if the required fields are not zero-ed
func AssertEndpointIpamConfigRequired(obj EndpointIpamConfig) error {
	return nil
}

// AssertEndpointIpamConfigConstraints checks if the values respects the defined constraints
func AssertEndpointIpamConfigConstraints(obj EndpointIpamConfig) error {
	return nil
}
