...
// AssertTaskSpecLogDriverRequired checks if the required fields are not zero-ed
func AssertTaskSpecLogDriverRequired(obj TaskSpecLogDriver) error {
	return nil
}

// AssertTaskSpecLogDriverConstraints checks if the values respects the defined constraints
func AssertTaskSpecLogDriverConstraints(obj TaskSpecLogDriver) error {
	return nil
}
