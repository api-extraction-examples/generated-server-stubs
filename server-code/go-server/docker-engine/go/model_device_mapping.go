...
// AssertDeviceMappingRequired checks if the required fields are not zero-ed
func AssertDeviceMappingRequired(obj DeviceMapping) error {
	return nil
}

// AssertDeviceMappingConstraints checks if the values respects the defined constraints
func AssertDeviceMappingConstraints(obj DeviceMapping) error {
	return nil
}
