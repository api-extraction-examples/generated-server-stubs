...
// AssertVolumeCreateRequestRequired checks if the required fields are not zero-ed
func AssertVolumeCreateRequestRequired(obj VolumeCreateRequest) error {
	return nil
}

// AssertVolumeCreateRequestConstraints checks if the values respects the defined constraints
func AssertVolumeCreateRequestConstraints(obj VolumeCreateRequest) error {
	return nil
}
