...
type ContainerSummaryInnerNetworkSettings struct {

	Networks map[string]EndpointSettings `json:"Networks,omitempty"`
}

// AssertContainerSummaryInnerNetworkSettingsRequired checks if the required fields are not zero-ed
func AssertContainerSummaryInnerNetworkSettingsRequired(obj ContainerSummaryInnerNetworkSettings) error {
	return nil
}

// AssertContainerSummaryInnerNetworkSettingsConstraints checks if the values respects the defined constraints
func AssertContainerSummaryInnerNetworkSettingsConstraints(obj ContainerSummaryInnerNetworkSettings) error {
	return nil
}
