...
// AssertPluginMountRequired checks if the required fields are not zero-ed
func AssertPluginMountRequired(obj PluginMount) error {
...
// AssertPluginMountConstraints checks if the values respects the defined constraints
func AssertPluginMountConstraints(obj PluginMount) error {
	return nil
}
