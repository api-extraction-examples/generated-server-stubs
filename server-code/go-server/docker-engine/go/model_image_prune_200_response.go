...
type ImagePrune200Response struct {
...
// AssertImagePrune200ResponseRequired checks if the required fields are not zero-ed
func AssertImagePrune200ResponseRequired(obj ImagePrune200Response) error {
	for _, el := range obj.ImagesDeleted {
		if err := AssertImageDeleteResponseItemRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertImagePrune200ResponseConstraints checks if the values respects the defined constraints
func AssertImagePrune200ResponseConstraints(obj ImagePrune200Response) error {
	return nil
}
