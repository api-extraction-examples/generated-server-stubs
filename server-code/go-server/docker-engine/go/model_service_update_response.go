...
// AssertServiceUpdateResponseRequired checks if the required fields are not zero-ed
func AssertServiceUpdateResponseRequired(obj ServiceUpdateResponse) error {
	return nil
}

// AssertServiceUpdateResponseConstraints checks if the values respects the defined constraints
func AssertServiceUpdateResponseConstraints(obj ServiceUpdateResponse) error {
	return nil
}
