...
// AssertTaskSpecRestartPolicyRequired checks if the required fields are not zero-ed
func AssertTaskSpecRestartPolicyRequired(obj TaskSpecRestartPolicy) error {
	return nil
}

// AssertTaskSpecRestartPolicyConstraints checks if the values respects the defined constraints
func AssertTaskSpecRestartPolicyConstraints(obj TaskSpecRestartPolicy) error {
	return nil
}
