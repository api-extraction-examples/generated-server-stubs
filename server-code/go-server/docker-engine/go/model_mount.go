...
// AssertMountRequired checks if the required fields are not zero-ed
func AssertMountRequired(obj Mount) error {
	if err := AssertMountBindOptionsRequired(obj.BindOptions); err != nil {
		return err
	}
	if err := AssertMountTmpfsOptionsRequired(obj.TmpfsOptions); err != nil {
		return err
	}
	if err := AssertMountVolumeOptionsRequired(obj.VolumeOptions); err != nil {
		return err
	}
	return nil
}

// AssertMountConstraints checks if the values respects the defined constraints
func AssertMountConstraints(obj Mount) error {
	return nil
}
