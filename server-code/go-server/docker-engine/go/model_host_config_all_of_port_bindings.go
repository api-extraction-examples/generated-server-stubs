...
type HostConfigAllOfPortBindings struct {
...
// AssertHostConfigAllOfPortBindingsRequired checks if the required fields are not zero-ed
func AssertHostConfigAllOfPortBindingsRequired(obj HostConfigAllOfPortBindings) error {
	return nil
}

// AssertHostConfigAllOfPortBindingsConstraints checks if the values respects the defined constraints
func AssertHostConfigAllOfPortBindingsConstraints(obj HostConfigAllOfPortBindings) error {
	return nil
}
