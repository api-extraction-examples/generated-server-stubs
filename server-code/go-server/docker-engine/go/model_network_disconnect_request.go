...
// AssertNetworkDisconnectRequestRequired checks if the required fields are not zero-ed
func AssertNetworkDisconnectRequestRequired(obj NetworkDisconnectRequest) error {
	return nil
}

// AssertNetworkDisconnectRequestConstraints checks if the values respects the defined constraints
func AssertNetworkDisconnectRequestConstraints(obj NetworkDisconnectRequest) error {
	return nil
}
