...
// AssertSwarmSpecDispatcherRequired checks if the required fields are not zero-ed
func AssertSwarmSpecDispatcherRequired(obj SwarmSpecDispatcher) error {
	return nil
}

// AssertSwarmSpecDispatcherConstraints checks if the values respects the defined constraints
func AssertSwarmSpecDispatcherConstraints(obj SwarmSpecDispatcher) error {
	return nil
}
