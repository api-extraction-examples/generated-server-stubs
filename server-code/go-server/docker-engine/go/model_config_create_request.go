...
// AssertConfigCreateRequestRequired checks if the required fields are not zero-ed
func AssertConfigCreateRequestRequired(obj ConfigCreateRequest) error {
	return nil
}

// AssertConfigCreateRequestConstraints checks if the values respects the defined constraints
func AssertConfigCreateRequestConstraints(obj ConfigCreateRequest) error {
	return nil
}
