...
// AssertJoinTokensRequired checks if the required fields are not zero-ed
func AssertJoinTokensRequired(obj JoinTokens) error {
	return nil
}

// AssertJoinTokensConstraints checks if the values respects the defined constraints
func AssertJoinTokensConstraints(obj JoinTokens) error {
	return nil
}
