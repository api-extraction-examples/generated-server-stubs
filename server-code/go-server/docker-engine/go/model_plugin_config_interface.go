...
// AssertPluginConfigInterfaceRequired checks if the required fields are not zero-ed
func AssertPluginConfigInterfaceRequired(obj PluginConfigInterface) error {
	...
	for _, el := range obj.Types {
		if err := AssertPluginInterfaceTypeRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertPluginConfigInterfaceConstraints checks if the values respects the defined constraints
func AssertPluginConfigInterfaceConstraints(obj PluginConfigInterface) error {
	return nil
}
