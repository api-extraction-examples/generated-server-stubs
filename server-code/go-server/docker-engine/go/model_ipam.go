...
// AssertIpamRequired checks if the required fields are not zero-ed
func AssertIpamRequired(obj Ipam) error {
	return nil
}

// AssertIpamConstraints checks if the values respects the defined constraints
func AssertIpamConstraints(obj Ipam) error {
	return nil
}
