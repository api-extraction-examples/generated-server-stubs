...
type ContainerCreateRequest struct {
	...
	NetworkingConfig ContainerCreateRequestAllOfNetworkingConfig `json:"NetworkingConfig,omitempty"`
}

// AssertContainerCreateRequestRequired checks if the required fields are not zero-ed
func AssertContainerCreateRequestRequired(obj ContainerCreateRequest) error {
	if err := AssertHealthConfigRequired(obj.Healthcheck); err != nil {
		return err
	}
	if err := AssertContainerConfigVolumesRequired(obj.Volumes); err != nil {
		return err
	}
	if err := AssertHostConfigRequired(obj.HostConfig); err != nil {
		return err
	}
	if err := AssertContainerCreateRequestAllOfNetworkingConfigRequired(obj.NetworkingConfig); err != nil {
		return err
	}
	return nil
}

// AssertContainerCreateRequestConstraints checks if the values respects the defined constraints
func AssertContainerCreateRequestConstraints(obj ContainerCreateRequest) error {
	return nil
}
