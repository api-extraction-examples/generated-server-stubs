...
type VolumePrune200Response struct {
...
// AssertVolumePrune200ResponseRequired checks if the required fields are not zero-ed
func AssertVolumePrune200ResponseRequired(obj VolumePrune200Response) error {
	return nil
}

// AssertVolumePrune200ResponseConstraints checks if the values respects the defined constraints
func AssertVolumePrune200ResponseConstraints(obj VolumePrune200Response) error {
	return nil
}
