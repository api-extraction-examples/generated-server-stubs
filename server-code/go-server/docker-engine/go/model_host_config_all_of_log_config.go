...
// AssertHostConfigAllOfLogConfigRequired checks if the required fields are not zero-ed
func AssertHostConfigAllOfLogConfigRequired(obj HostConfigAllOfLogConfig) error {
	return nil
}

// AssertHostConfigAllOfLogConfigConstraints checks if the values respects the defined constraints
func AssertHostConfigAllOfLogConfigConstraints(obj HostConfigAllOfLogConfig) error {
	return nil
}
