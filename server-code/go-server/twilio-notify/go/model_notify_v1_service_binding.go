...
// AssertNotifyV1ServiceBindingRequired checks if the required fields are not zero-ed
func AssertNotifyV1ServiceBindingRequired(obj NotifyV1ServiceBinding) error {
	return nil
}

// AssertNotifyV1ServiceBindingConstraints checks if the values respects the defined constraints
func AssertNotifyV1ServiceBindingConstraints(obj NotifyV1ServiceBinding) error {
	return nil
}
