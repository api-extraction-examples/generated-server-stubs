...
// AssertNotifyV1ServiceRequired checks if the required fields are not zero-ed
func AssertNotifyV1ServiceRequired(obj NotifyV1Service) error {
	return nil
}

// AssertNotifyV1ServiceConstraints checks if the values respects the defined constraints
func AssertNotifyV1ServiceConstraints(obj NotifyV1Service) error {
	return nil
}
