...
// AssertNotifyV1ServiceNotificationRequired checks if the required fields are not zero-ed
func AssertNotifyV1ServiceNotificationRequired(obj NotifyV1ServiceNotification) error {
	return nil
}

// AssertNotifyV1ServiceNotificationConstraints checks if the values respects the defined constraints
func AssertNotifyV1ServiceNotificationConstraints(obj NotifyV1ServiceNotification) error {
	return nil
}
