...
func (s *MetricsAPIService) GetPrometheusMetrics(ctx context.Context) (ImplResponse, error) {
	// TODO - update GetPrometheusMetrics with the required logic for this service method.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetPrometheusMetrics method not implemented")
}
