...
// AssertEpisodeSummaryRequired checks if the required fields are not zero-ed
func AssertEpisodeSummaryRequired(obj EpisodeSummary) error {
...
// AssertEpisodeSummaryConstraints checks if the values respects the defined constraints
func AssertEpisodeSummaryConstraints(obj EpisodeSummary) error {
	return nil
}
