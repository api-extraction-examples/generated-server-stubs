...
// AssertPublicationPublicationIdGet200ResponseRequired checks if the required fields are not zero-ed
func AssertPublicationPublicationIdGet200ResponseRequired(obj PublicationPublicationIdGet200Response) error {
	return nil
}

// AssertPublicationPublicationIdGet200ResponseConstraints checks if the values respects the defined constraints
func AssertPublicationPublicationIdGet200ResponseConstraints(obj PublicationPublicationIdGet200Response) error {
	return nil
}
