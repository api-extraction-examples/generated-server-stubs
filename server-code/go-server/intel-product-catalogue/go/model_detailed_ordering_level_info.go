...
// AssertDetailedOrderingLevelInfoRequired checks if the required fields are not zero-ed
func AssertDetailedOrderingLevelInfoRequired(obj DetailedOrderingLevelInfo) error {
	for _, el := range obj.Result {
		if err := AssertDetailedOrderingLevelInfoResultInnerRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertDetailedOrderingLevelInfoConstraints checks if the values respects the defined constraints
func AssertDetailedOrderingLevelInfoConstraints(obj DetailedOrderingLevelInfo) error {
	return nil
}
