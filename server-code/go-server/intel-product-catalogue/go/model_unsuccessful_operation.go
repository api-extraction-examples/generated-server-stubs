...
type UnsuccessfulOperation struct {
...
// AssertUnsuccessfulOperationRequired checks if the required fields are not zero-ed
func AssertUnsuccessfulOperationRequired(obj UnsuccessfulOperation) error {
	return nil
}

// AssertUnsuccessfulOperationConstraints checks if the values respects the defined constraints
func AssertUnsuccessfulOperationConstraints(obj UnsuccessfulOperation) error {
	return nil
}
