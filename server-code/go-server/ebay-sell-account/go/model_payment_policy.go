...
// AssertPaymentPolicyRequired checks if the required fields are not zero-ed
func AssertPaymentPolicyRequired(obj PaymentPolicy) error {
...
// AssertPaymentPolicyConstraints checks if the values respects the defined constraints
func AssertPaymentPolicyConstraints(obj PaymentPolicy) error {
	return nil
}
