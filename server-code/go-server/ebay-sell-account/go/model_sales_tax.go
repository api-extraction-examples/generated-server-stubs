...
// AssertSalesTaxRequired checks if the required fields are not zero-ed
func AssertSalesTaxRequired(obj SalesTax) error {
	return nil
}

// AssertSalesTaxConstraints checks if the values respects the defined constraints
func AssertSalesTaxConstraints(obj SalesTax) error {
	return nil
}
