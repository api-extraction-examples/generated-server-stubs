...
// AssertSalesTaxBaseRequired checks if the required fields are not zero-ed
func AssertSalesTaxBaseRequired(obj SalesTaxBase) error {
	return nil
}

// AssertSalesTaxBaseConstraints checks if the values respects the defined constraints
func AssertSalesTaxBaseConstraints(obj SalesTaxBase) error {
	return nil
}
