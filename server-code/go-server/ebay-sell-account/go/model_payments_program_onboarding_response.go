...
// AssertPaymentsProgramOnboardingResponseRequired checks if the required fields are not zero-ed
func AssertPaymentsProgramOnboardingResponseRequired(obj PaymentsProgramOnboardingResponse) error {
	for _, el := range obj.Steps {
		if err := AssertPaymentsProgramOnboardingStepsRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertPaymentsProgramOnboardingResponseConstraints checks if the values respects the defined constraints
func AssertPaymentsProgramOnboardingResponseConstraints(obj PaymentsProgramOnboardingResponse) error {
	return nil
}
