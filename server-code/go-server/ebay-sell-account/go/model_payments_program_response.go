...
// AssertPaymentsProgramResponseRequired checks if the required fields are not zero-ed
func AssertPaymentsProgramResponseRequired(obj PaymentsProgramResponse) error {
	return nil
}

// AssertPaymentsProgramResponseConstraints checks if the values respects the defined constraints
func AssertPaymentsProgramResponseConstraints(obj PaymentsProgramResponse) error {
	return nil
}
