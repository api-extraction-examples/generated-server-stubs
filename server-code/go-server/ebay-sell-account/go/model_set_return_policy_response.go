...
// AssertSetReturnPolicyResponseRequired checks if the required fields are not zero-ed
func AssertSetReturnPolicyResponseRequired(obj SetReturnPolicyResponse) error {
...
// AssertSetReturnPolicyResponseConstraints checks if the values respects the defined constraints
func AssertSetReturnPolicyResponseConstraints(obj SetReturnPolicyResponse) error {
	return nil
}
