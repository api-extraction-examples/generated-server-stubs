...
// AssertInternationalReturnOverrideTypeRequired checks if the required fields are not zero-ed
func AssertInternationalReturnOverrideTypeRequired(obj InternationalReturnOverrideType) error {
...
// AssertInternationalReturnOverrideTypeConstraints checks if the values respects the defined constraints
func AssertInternationalReturnOverrideTypeConstraints(obj InternationalReturnOverrideType) error {
	return nil
}
