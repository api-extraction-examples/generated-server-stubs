...
// AssertKycCheckRequired checks if the required fields are not zero-ed
func AssertKycCheckRequired(obj KycCheck) error {
	return nil
}

// AssertKycCheckConstraints checks if the values respects the defined constraints
func AssertKycCheckConstraints(obj KycCheck) error {
	return nil
}
