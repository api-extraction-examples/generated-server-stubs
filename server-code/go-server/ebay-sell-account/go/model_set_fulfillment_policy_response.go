...
// AssertSetFulfillmentPolicyResponseRequired checks if the required fields are not zero-ed
func AssertSetFulfillmentPolicyResponseRequired(obj SetFulfillmentPolicyResponse) error {
...
// AssertSetFulfillmentPolicyResponseConstraints checks if the values respects the defined constraints
func AssertSetFulfillmentPolicyResponseConstraints(obj SetFulfillmentPolicyResponse) error {
	return nil
}
