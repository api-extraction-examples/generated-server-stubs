...
// AssertFulfillmentPolicyRequired checks if the required fields are not zero-ed
func AssertFulfillmentPolicyRequired(obj FulfillmentPolicy) error {
...
// AssertFulfillmentPolicyConstraints checks if the values respects the defined constraints
func AssertFulfillmentPolicyConstraints(obj FulfillmentPolicy) error {
	return nil
}
