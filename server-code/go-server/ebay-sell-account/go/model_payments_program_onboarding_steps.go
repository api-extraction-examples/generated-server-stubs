...
// AssertPaymentsProgramOnboardingStepsRequired checks if the required fields are not zero-ed
func AssertPaymentsProgramOnboardingStepsRequired(obj PaymentsProgramOnboardingSteps) error {
	return nil
}

// AssertPaymentsProgramOnboardingStepsConstraints checks if the values respects the defined constraints
func AssertPaymentsProgramOnboardingStepsConstraints(obj PaymentsProgramOnboardingSteps) error {
	return nil
}
