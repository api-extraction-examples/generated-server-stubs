...
// AssertReturnPolicyRequired checks if the required fields are not zero-ed
func AssertReturnPolicyRequired(obj ReturnPolicy) error {
...
// AssertReturnPolicyConstraints checks if the values respects the defined constraints
func AssertReturnPolicyConstraints(obj ReturnPolicy) error {
	return nil
}
