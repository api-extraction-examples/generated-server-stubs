...
// AssertCustomPolicyRequestRequired checks if the required fields are not zero-ed
func AssertCustomPolicyRequestRequired(obj CustomPolicyRequest) error {
	return nil
}

// AssertCustomPolicyRequestConstraints checks if the values respects the defined constraints
func AssertCustomPolicyRequestConstraints(obj CustomPolicyRequest) error {
	return nil
}
