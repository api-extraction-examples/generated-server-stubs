...
// NaicsAPIService is a service that implements the logic for the NaicsAPIServicer
// This service should implement the business logic for every endpoint for the NaicsAPI API.
// Include any external packages or services that will be required by this service.
type NaicsAPIService struct {
}

// NewNaicsAPIService creates a default api service
func NewNaicsAPIService() NaicsAPIServicer {
	return &NaicsAPIService{}
}

// ListNaicsGET - This endpoint lists all of the NAICS codes that are relevant to the OASIS family of vehicles
func (s *NaicsAPIService) ListNaicsGET(ctx context.Context) (ImplResponse, error) {
	// TODO - update ListNaicsGET with the required logic for this service method.
	// Add api_naics_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("ListNaicsGET method not implemented")
}
