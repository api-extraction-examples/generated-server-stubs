...
type AssetsAPIService struct {
}

// NewAssetsAPIService creates a default api service
func NewAssetsAPIService() AssetsAPIServicer {
	return &AssetsAPIService{}
}

// TargetsTargetIdAssetsGet - List target&#39;s assets
func (s *AssetsAPIService) TargetsTargetIdAssetsGet(ctx context.Context, targetId string, page int32, length int32, ordering string, search string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdAssetsGet with the required logic for this service method.
	...
	// TODO: Uncomment the next line to return response Response(200, TargetsTargetIdAssetsGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsTargetIdAssetsGet200Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdAssetsGet method not implemented")
}

// TargetsTargetIdAssetsIdDelete - Delete asset
func (s *AssetsAPIService) TargetsTargetIdAssetsIdDelete(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdAssetsIdDelete with the required logic for this service method.
	// Add api_assets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdAssetsIdDelete method not implemented")
}

// TargetsTargetIdAssetsIdGet - Retrieve asset
func (s *AssetsAPIService) TargetsTargetIdAssetsIdGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdAssetsIdGet with the required logic for this service method.
	// Add api_assets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdAssetsIdGet method not implemented")
}

// TargetsTargetIdAssetsIdPatch - Partial update assets
func (s *AssetsAPIService) TargetsTargetIdAssetsIdPatch(ctx context.Context, targetId string, id string, asset Asset) (ImplResponse, error) {
	// TODO - update TargetsTargetIdAssetsIdPatch with the required logic for this service method.
	// Add api_assets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdAssetsIdPatch method not implemented")
}

// TargetsTargetIdAssetsIdPut - Update asset
func (s *AssetsAPIService) TargetsTargetIdAssetsIdPut(ctx context.Context, targetId string, id string, asset Asset) (ImplResponse, error) {
	// TODO - update TargetsTargetIdAssetsIdPut with the required logic for this service method.
	// Add api_assets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdAssetsIdPut method not implemented")
}

// TargetsTargetIdAssetsIdVerifyPost - Verify asset ownership
func (s *AssetsAPIService) TargetsTargetIdAssetsIdVerifyPost(ctx context.Context, targetId string, id string, targetsTargetIdAssetsIdVerifyPostRequest TargetsTargetIdAssetsIdVerifyPostRequest) (ImplResponse, error) {
	// TODO - update TargetsTargetIdAssetsIdVerifyPost with the required logic for this service method.
	// Add api_assets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, CheckPost200Response{}) or use other options such as http.Ok ...
	// return Response(200, CheckPost200Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdAssetsIdVerifyPost method not implemented")
}

// TargetsTargetIdAssetsPost - Create new asset
func (s *AssetsAPIService) TargetsTargetIdAssetsPost(ctx context.Context, targetId string, asset Asset) (ImplResponse, error) {
	// TODO - update TargetsTargetIdAssetsPost with the required logic for this service method.
	// Add api_assets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(201, Asset{}) or use other options such as http.Ok ...
	// return Response(201, Asset{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdAssetsPost method not implemented")
}
