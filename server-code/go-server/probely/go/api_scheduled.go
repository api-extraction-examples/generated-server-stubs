...
// ScheduledAPIController binds http requests to an api service and writes the service results to the http response
type ScheduledAPIController struct {
	service ScheduledAPIServicer
	errorHandler ErrorHandler
}

// ScheduledAPIOption for how the controller is set up.
type ScheduledAPIOption func(*ScheduledAPIController)

// WithScheduledAPIErrorHandler inject ErrorHandler into controller
func WithScheduledAPIErrorHandler(h ErrorHandler) ScheduledAPIOption {
	return func(c *ScheduledAPIController) {
		c.errorHandler = h
	}
}

// NewScheduledAPIController creates a default api controller
func NewScheduledAPIController(s ScheduledAPIServicer, opts ...ScheduledAPIOption) Router {
	controller := &ScheduledAPIController{
		service:      s,
...
// Routes returns all the api routes for the ScheduledAPIController
func (c *ScheduledAPIController) Routes() Routes {
	return Routes{
		"TargetsAllScheduledscansExpandedGet": Route{
			strings.ToUpper("Get"),
			"/targets/all/scheduledscans/expanded/",
			c.TargetsAllScheduledscansExpandedGet,
		},
		"TargetsTargetIdScheduledscansExpandedGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/scheduledscans/expanded/",
			c.TargetsTargetIdScheduledscansExpandedGet,
		},
		"TargetsTargetIdScheduledscansGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/scheduledscans/",
			c.TargetsTargetIdScheduledscansGet,
		},
		"TargetsTargetIdScheduledscansIdDelete": Route{
			strings.ToUpper("Delete"),
			"/targets/{target_id}/scheduledscans/{id}/",
			c.TargetsTargetIdScheduledscansIdDelete,
		},
		"TargetsTargetIdScheduledscansIdGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/scheduledscans/{id}/",
			c.TargetsTargetIdScheduledscansIdGet,
		},
		"TargetsTargetIdScheduledscansIdPatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/scheduledscans/{id}/",
			c.TargetsTargetIdScheduledscansIdPatch,
		},
		"TargetsTargetIdScheduledscansIdPut": Route{
			strings.ToUpper("Put"),
			"/targets/{target_id}/scheduledscans/{id}/",
			c.TargetsTargetIdScheduledscansIdPut,
		},
		"TargetsTargetIdScheduledscansPost": Route{
			strings.ToUpper("Post"),
			"/targets/{target_id}/scheduledscans/",
			c.TargetsTargetIdScheduledscansPost,
		},
	}
}

// TargetsAllScheduledscansExpandedGet - List scheduled scans for all targets expanding recurrence
func (c *ScheduledAPIController) TargetsAllScheduledscansExpandedGet(w http.ResponseWriter, r *http.Request) {
	query := r.URL.Query()
	...
	result, err := c.service.TargetsAllScheduledscansExpandedGet(r.Context(), lengthParam)
...
func (c *ScheduledAPIController) TargetsTargetIdScheduledscansExpandedGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	...
	result, err := c.service.TargetsTargetIdScheduledscansExpandedGet(r.Context(), targetIdParam, lengthParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ScheduledAPIController) TargetsTargetIdScheduledscansGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
	...
	result, err := c.service.TargetsTargetIdScheduledscansGet(r.Context(), targetIdParam, pageParam, lengthParam, orderingParam, searchParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ScheduledAPIController) TargetsTargetIdScheduledscansIdDelete(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdScheduledscansIdDelete(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ScheduledAPIController) TargetsTargetIdScheduledscansIdGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdScheduledscansIdGet(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ScheduledAPIController) TargetsTargetIdScheduledscansIdPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	targetsTargetIdScheduledscansPostRequestParam := TargetsTargetIdScheduledscansPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&targetsTargetIdScheduledscansPostRequestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertTargetsTargetIdScheduledscansPostRequestRequired(targetsTargetIdScheduledscansPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertTargetsTargetIdScheduledscansPostRequestConstraints(targetsTargetIdScheduledscansPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdScheduledscansIdPatch(r.Context(), targetIdParam, idParam, targetsTargetIdScheduledscansPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ScheduledAPIController) TargetsTargetIdScheduledscansIdPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdScheduledscansIdPut(r.Context(), targetIdParam, idParam, targetsTargetIdScheduledscansPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ScheduledAPIController) TargetsTargetIdScheduledscansPost(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdScheduledscansPost(r.Context(), targetIdParam, targetsTargetIdScheduledscansPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
