...
// TargetsTargetIdSiteGet - Retrieve target&#39;s site
// Deprecated
func (s *SiteAPIService) TargetsTargetIdSiteGet(ctx context.Context, targetId string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdSiteGet with the required logic for this service method.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdSiteGet method not implemented")
}

// TargetsTargetIdSitePatch - Partial update target&#39;s site
// Deprecated
func (s *SiteAPIService) TargetsTargetIdSitePatch(ctx context.Context, targetId string, site Site) (ImplResponse, error) {
	// TODO - update TargetsTargetIdSitePatch with the required logic for this service method.
	// Add api_site_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdSitePatch method not implemented")
}

// TargetsTargetIdSitePut - Update target&#39;s site
// Deprecated
func (s *SiteAPIService) TargetsTargetIdSitePut(ctx context.Context, targetId string, site Site) (ImplResponse, error) {
	// TODO - update TargetsTargetIdSitePut with the required logic for this service method.
	// Add api_site_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdSitePut method not implemented")
}

// TargetsTargetIdSiteVerifyPost - Verify site ownership
// Deprecated
func (s *SiteAPIService) TargetsTargetIdSiteVerifyPost(ctx context.Context, targetId string, targetsTargetIdAssetsIdVerifyPostRequest TargetsTargetIdAssetsIdVerifyPostRequest) (ImplResponse, error) {
	// TODO - update TargetsTargetIdSiteVerifyPost with the required logic for this service method.
	// Add api_site_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdSiteVerifyPost method not implemented")
}
