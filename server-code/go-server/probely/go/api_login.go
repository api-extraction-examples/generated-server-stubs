...
func (c *LoginAPIController) Routes() Routes {
	return Routes{
		"AuthObtainPost": Route{
			strings.ToUpper("Post"),
			"/auth/obtain/",
			c.AuthObtainPost,
		},
		"AuthRefreshPost": Route{
			strings.ToUpper("Post"),
			"/auth/refresh/",
			c.AuthRefreshPost,
		},
		"AuthRevokePost": Route{
			strings.ToUpper("Post"),
			"/auth/revoke/",
			c.AuthRevokePost,
		},
		"AuthVerifyPost": Route{
			strings.ToUpper("Post"),
			"/auth/verify/",
			c.AuthVerifyPost,
		},
		"EnterpriseAuthObtainPost": Route{
			strings.ToUpper("Post"),
			"/enterprise/auth/obtain/",
			c.EnterpriseAuthObtainPost,
		},
		"EnterpriseAuthRefreshPost": Route{
			strings.ToUpper("Post"),
			"/enterprise/auth/refresh/",
			c.EnterpriseAuthRefreshPost,
		},
		"EnterpriseAuthRevokePost": Route{
			strings.ToUpper("Post"),
			"/enterprise/auth/revoke/",
			c.EnterpriseAuthRevokePost,
		},
		"EnterpriseAuthVerifyPost": Route{
			strings.ToUpper("Post"),
			"/enterprise/auth/verify/",
			c.EnterpriseAuthVerifyPost,
		},
	}
}

// AuthObtainPost - Authenticate user
func (c *LoginAPIController) AuthObtainPost(w http.ResponseWriter, r *http.Request) {
	loginParam := Login{}
	...
	result, err := c.service.AuthObtainPost(r.Context(), loginParam)
...
func (c *LoginAPIController) AuthRefreshPost(w http.ResponseWriter, r *http.Request) {
	authRefreshPostRequestParam := AuthRefreshPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&authRefreshPostRequestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertAuthRefreshPostRequestRequired(authRefreshPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertAuthRefreshPostRequestConstraints(authRefreshPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.AuthRefreshPost(r.Context(), authRefreshPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *LoginAPIController) AuthRevokePost(w http.ResponseWriter, r *http.Request) {
	authRefreshPostRequestParam := AuthRefreshPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&authRefreshPostRequestParam); err != nil {
	...
	result, err := c.service.AuthRevokePost(r.Context(), authRefreshPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *LoginAPIController) AuthVerifyPost(w http.ResponseWriter, r *http.Request) {
	authRefreshPostRequestParam := AuthRefreshPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&authRefreshPostRequestParam); err != nil {
	...
	result, err := c.service.AuthVerifyPost(r.Context(), authRefreshPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *LoginAPIController) EnterpriseAuthObtainPost(w http.ResponseWriter, r *http.Request) {
	loginParam := Login{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&loginParam); err != nil {
	...
	result, err := c.service.EnterpriseAuthObtainPost(r.Context(), loginParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *LoginAPIController) EnterpriseAuthRefreshPost(w http.ResponseWriter, r *http.Request) {
	authRefreshPostRequestParam := AuthRefreshPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&authRefreshPostRequestParam); err != nil {
	...
	result, err := c.service.EnterpriseAuthRefreshPost(r.Context(), authRefreshPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *LoginAPIController) EnterpriseAuthRevokePost(w http.ResponseWriter, r *http.Request) {
	authRefreshPostRequestParam := AuthRefreshPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&authRefreshPostRequestParam); err != nil {
	...
	result, err := c.service.EnterpriseAuthRevokePost(r.Context(), authRefreshPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *LoginAPIController) EnterpriseAuthVerifyPost(w http.ResponseWriter, r *http.Request) {
	authRefreshPostRequestParam := AuthRefreshPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&authRefreshPostRequestParam); err != nil {
	...
	result, err := c.service.EnterpriseAuthVerifyPost(r.Context(), authRefreshPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
