...
// AssertFindingRequired checks if the required fields are not zero-ed
func AssertFindingRequired(obj Finding) error {
...
// AssertFindingConstraints checks if the values respects the defined constraints
func AssertFindingConstraints(obj Finding) error {
	return nil
}
