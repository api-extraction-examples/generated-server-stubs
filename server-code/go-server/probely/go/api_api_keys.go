...
func (c *APIKeysAPIController) Routes() Routes {
	return Routes{
		...
		"TargetsTargetIdKeysGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/keys/",
			c.TargetsTargetIdKeysGet,
		},
		"TargetsTargetIdKeysIdDelete": Route{
			strings.ToUpper("Delete"),
			"/targets/{target_id}/keys/{id}/",
			c.TargetsTargetIdKeysIdDelete,
		},
		"TargetsTargetIdKeysIdGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/keys/{id}/",
			c.TargetsTargetIdKeysIdGet,
		},
		"TargetsTargetIdKeysPost": Route{
			strings.ToUpper("Post"),
			"/targets/{target_id}/keys/",
			c.TargetsTargetIdKeysPost,
		},
	}
}

// KeysGet - List API keys allowed to operate on account
func (c *APIKeysAPIController) KeysGet(w http.ResponseWriter, r *http.Request) {
	query := r.URL.Query()
	var pageParam int32
	if query.Has("page") {
	...
	result, err := c.service.KeysGet(r.Context(), pageParam, lengthParam, orderingParam, searchParam)
...
func (c *APIKeysAPIController) KeysIdDelete(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
	...
	result, err := c.service.KeysIdDelete(r.Context(), idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *APIKeysAPIController) KeysIdGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
		c.errorHandler(w, r, &RequiredError{"id"}, nil)
	...
	result, err := c.service.KeysIdGet(r.Context(), idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *APIKeysAPIController) KeysPost(w http.ResponseWriter, r *http.Request) {
	apiKeyParam := ApiKey{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&apiKeyParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertApiKeyRequired(apiKeyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertApiKeyConstraints(apiKeyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.KeysPost(r.Context(), apiKeyParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *APIKeysAPIController) TargetsTargetIdKeysGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	...
	result, err := c.service.TargetsTargetIdKeysGet(r.Context(), targetIdParam, pageParam, lengthParam, orderingParam, searchParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *APIKeysAPIController) TargetsTargetIdKeysIdDelete(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdKeysIdDelete(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *APIKeysAPIController) TargetsTargetIdKeysIdGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdKeysIdGet(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *APIKeysAPIController) TargetsTargetIdKeysPost(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdKeysPost(r.Context(), targetIdParam, apiKeyParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
