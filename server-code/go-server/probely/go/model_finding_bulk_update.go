...
// AssertFindingBulkUpdateRequired checks if the required fields are not zero-ed
func AssertFindingBulkUpdateRequired(obj FindingBulkUpdate) error {
...
// AssertFindingBulkUpdateConstraints checks if the values respects the defined constraints
func AssertFindingBulkUpdateConstraints(obj FindingBulkUpdate) error {
	return nil
}
