...
// AuthObtainPost - Authenticate user
func (s *LoginAPIService) AuthObtainPost(ctx context.Context, login Login) (ImplResponse, error) {
	// TODO - update AuthObtainPost with the required logic for this service method.
	...
	// TODO: Uncomment the next line to return response Response(200, AuthObtainPost200Response{}) or use other options such as http.Ok ...
	// return Response(200, AuthObtainPost200Response{}), nil
	...
	// TODO: Uncomment the next line to return response Response(500, AuthObtainPost500Response{}) or use other options such as http.Ok ...
	// return Response(500, AuthObtainPost500Response{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("AuthObtainPost method not implemented")
}

// AuthRefreshPost - Replace token with a new one
func (s *LoginAPIService) AuthRefreshPost(ctx context.Context, authRefreshPostRequest AuthRefreshPostRequest) (ImplResponse, error) {
	// TODO - update AuthRefreshPost with the required logic for this service method.
	// Add api_login_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("AuthRefreshPost method not implemented")
}

// AuthRevokePost - Revoke a token
func (s *LoginAPIService) AuthRevokePost(ctx context.Context, authRefreshPostRequest AuthRefreshPostRequest) (ImplResponse, error) {
	// TODO - update AuthRevokePost with the required logic for this service method.
	// Add api_login_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("AuthRevokePost method not implemented")
}

// AuthVerifyPost - Verify a token
func (s *LoginAPIService) AuthVerifyPost(ctx context.Context, authRefreshPostRequest AuthRefreshPostRequest) (ImplResponse, error) {
	// TODO - update AuthVerifyPost with the required logic for this service method.
	// Add api_login_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("AuthVerifyPost method not implemented")
}

// EnterpriseAuthObtainPost - Enterprise user authentication
func (s *LoginAPIService) EnterpriseAuthObtainPost(ctx context.Context, login Login) (ImplResponse, error) {
	// TODO - update EnterpriseAuthObtainPost with the required logic for this service method.
	// Add api_login_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("EnterpriseAuthObtainPost method not implemented")
}

// EnterpriseAuthRefreshPost - Enterprise token refresh
func (s *LoginAPIService) EnterpriseAuthRefreshPost(ctx context.Context, authRefreshPostRequest AuthRefreshPostRequest) (ImplResponse, error) {
	// TODO - update EnterpriseAuthRefreshPost with the required logic for this service method.
	// Add api_login_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("EnterpriseAuthRefreshPost method not implemented")
}

// EnterpriseAuthRevokePost - Enterprise token revokation
func (s *LoginAPIService) EnterpriseAuthRevokePost(ctx context.Context, authRefreshPostRequest AuthRefreshPostRequest) (ImplResponse, error) {
	// TODO - update EnterpriseAuthRevokePost with the required logic for this service method.
	// Add api_login_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("EnterpriseAuthRevokePost method not implemented")
}

// EnterpriseAuthVerifyPost - Enterprise token verification
func (s *LoginAPIService) EnterpriseAuthVerifyPost(ctx context.Context, authRefreshPostRequest AuthRefreshPostRequest) (ImplResponse, error) {
	// TODO - update EnterpriseAuthVerifyPost with the required logic for this service method.
	// Add api_login_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("EnterpriseAuthVerifyPost method not implemented")
}
