...
func (c *EventsAPIController) Routes() Routes {
	return Routes{
		...
		"TargetsTargetIdEventsGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/events/",
			c.TargetsTargetIdEventsGet,
		},
		"TargetsTargetIdEventsIdGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/events/{id}/",
			c.TargetsTargetIdEventsIdGet,
		},
		"TargetsTargetIdWebhooksGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/webhooks/",
			c.TargetsTargetIdWebhooksGet,
		},
		"TargetsTargetIdWebhooksIdDelete": Route{
			strings.ToUpper("Delete"),
			"/targets/{target_id}/webhooks/{id}/",
			c.TargetsTargetIdWebhooksIdDelete,
		},
		"TargetsTargetIdWebhooksIdGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/webhooks/{id}/",
			c.TargetsTargetIdWebhooksIdGet,
		},
		"TargetsTargetIdWebhooksIdPatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/webhooks/{id}/",
			c.TargetsTargetIdWebhooksIdPatch,
		},
		"TargetsTargetIdWebhooksIdPut": Route{
			strings.ToUpper("Put"),
			"/targets/{target_id}/webhooks/{id}/",
			c.TargetsTargetIdWebhooksIdPut,
		},
		"TargetsTargetIdWebhooksPost": Route{
			strings.ToUpper("Post"),
			"/targets/{target_id}/webhooks/",
			c.TargetsTargetIdWebhooksPost,
		},
		"WebhooksGet": Route{
			strings.ToUpper("Get"),
			"/webhooks/",
...
func (c *EventsAPIController) EventsIdGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
	...
	result, err := c.service.EventsIdGet(r.Context(), idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) TargetsTargetIdEventsGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	...
	result, err := c.service.TargetsTargetIdEventsGet(r.Context(), targetIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) TargetsTargetIdEventsIdGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdEventsIdGet(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) TargetsTargetIdWebhooksGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdWebhooksGet(r.Context(), targetIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) TargetsTargetIdWebhooksIdDelete(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdWebhooksIdDelete(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) TargetsTargetIdWebhooksIdGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdWebhooksIdGet(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) TargetsTargetIdWebhooksIdPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	webhookParam := Webhook{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&webhookParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertWebhookRequired(webhookParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertWebhookConstraints(webhookParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdWebhooksIdPatch(r.Context(), targetIdParam, idParam, webhookParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) TargetsTargetIdWebhooksIdPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdWebhooksIdPut(r.Context(), targetIdParam, idParam, webhookParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) TargetsTargetIdWebhooksPost(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdWebhooksPost(r.Context(), targetIdParam, webhookParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) WebhooksGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.WebhooksGet(r.Context())
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) WebhooksIdDelete(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
		c.errorHandler(w, r, &RequiredError{"id"}, nil)
	...
	result, err := c.service.WebhooksIdDelete(r.Context(), idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) WebhooksIdGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
		c.errorHandler(w, r, &RequiredError{"id"}, nil)
	...
	result, err := c.service.WebhooksIdGet(r.Context(), idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) WebhooksIdPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
		c.errorHandler(w, r, &RequiredError{"id"}, nil)
	...
	result, err := c.service.WebhooksIdPatch(r.Context(), idParam, webhookParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) WebhooksIdPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
		c.errorHandler(w, r, &RequiredError{"id"}, nil)
	...
	result, err := c.service.WebhooksIdPut(r.Context(), idParam, webhookParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *EventsAPIController) WebhooksPost(w http.ResponseWriter, r *http.Request) {
	webhookParam := Webhook{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&webhookParam); err != nil {
	...
	result, err := c.service.WebhooksPost(r.Context(), webhookParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
