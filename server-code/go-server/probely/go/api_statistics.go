...
func (c *StatisticsAPIController) Routes() Routes {
	return Routes{
		"TargetsAllAverageFixTimeGet": Route{
			strings.ToUpper("Get"),
			"/targets/all/average_fix_time/",
			c.TargetsAllAverageFixTimeGet,
		},
		"TargetsAllNeedsAttentionPieGet": Route{
			strings.ToUpper("Get"),
			"/targets/all/needs_attention_pie/",
			c.TargetsAllNeedsAttentionPieGet,
		},
		"TargetsAllNeedsAttentionTopGet": Route{
			strings.ToUpper("Get"),
			"/targets/all/needs_attention_top/",
			c.TargetsAllNeedsAttentionTopGet,
		},
		"TargetsAllRiskTrendGet": Route{
			strings.ToUpper("Get"),
			"/targets/all/risk_trend/",
			c.TargetsAllRiskTrendGet,
		},
		"TargetsAllSeverityTrendGet": Route{
			strings.ToUpper("Get"),
			"/targets/all/severity_trend/",
			c.TargetsAllSeverityTrendGet,
		},
		"TargetsAllTopVulnsGet": Route{
			strings.ToUpper("Get"),
			"/targets/all/top_vulns/",
			c.TargetsAllTopVulnsGet,
		},
		"TargetsTargetIdAverageFixTimeGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/average_fix_time/",
			c.TargetsTargetIdAverageFixTimeGet,
		},
		"TargetsTargetIdRiskTrendGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/risk_trend/",
			c.TargetsTargetIdRiskTrendGet,
		},
		"TargetsTargetIdSeverityTrendGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/severity_trend/",
			c.TargetsTargetIdSeverityTrendGet,
		},
		"TargetsTargetIdTopVulnsGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/top_vulns/",
			c.TargetsTargetIdTopVulnsGet,
		},
	}
}

// TargetsAllAverageFixTimeGet - Average fix time graph data (all targets)
func (c *StatisticsAPIController) TargetsAllAverageFixTimeGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.TargetsAllAverageFixTimeGet(r.Context())
...
func (c *StatisticsAPIController) TargetsAllNeedsAttentionPieGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.TargetsAllNeedsAttentionPieGet(r.Context())
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *StatisticsAPIController) TargetsAllNeedsAttentionTopGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.TargetsAllNeedsAttentionTopGet(r.Context())
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *StatisticsAPIController) TargetsAllRiskTrendGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.TargetsAllRiskTrendGet(r.Context())
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *StatisticsAPIController) TargetsAllSeverityTrendGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.TargetsAllSeverityTrendGet(r.Context())
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *StatisticsAPIController) TargetsAllTopVulnsGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.TargetsAllTopVulnsGet(r.Context())
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *StatisticsAPIController) TargetsTargetIdAverageFixTimeGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	...
	result, err := c.service.TargetsTargetIdAverageFixTimeGet(r.Context(), targetIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *StatisticsAPIController) TargetsTargetIdRiskTrendGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdRiskTrendGet(r.Context(), targetIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *StatisticsAPIController) TargetsTargetIdSeverityTrendGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdSeverityTrendGet(r.Context(), targetIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *StatisticsAPIController) TargetsTargetIdTopVulnsGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdTopVulnsGet(r.Context(), targetIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
