...
// TargetsAPIService is a service that implements the logic for the TargetsAPIServicer
...
// TargetsGet - List targets
func (s *TargetsAPIService) TargetsGet(ctx context.Context, page int32, length int32, ordering string, search string) (ImplResponse, error) {
	// TODO - update TargetsGet with the required logic for this service method.
	...
	// TODO: Uncomment the next line to return response Response(200, TargetsGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsGet200Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsGet method not implemented")
}

// TargetsIdDelete - Delete target
func (s *TargetsAPIService) TargetsIdDelete(ctx context.Context, id string) (ImplResponse, error) {
	// TODO - update TargetsIdDelete with the required logic for this service method.
	// Add api_targets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsIdDelete method not implemented")
}

// TargetsIdGet - Retrieve target
func (s *TargetsAPIService) TargetsIdGet(ctx context.Context, id string) (ImplResponse, error) {
	// TODO - update TargetsIdGet with the required logic for this service method.
	// Add api_targets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, Target{}) or use other options such as http.Ok ...
	// return Response(200, Target{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsIdGet method not implemented")
}

// TargetsIdPatch - Partial update target
func (s *TargetsAPIService) TargetsIdPatch(ctx context.Context, id string, target Target) (ImplResponse, error) {
	// TODO - update TargetsIdPatch with the required logic for this service method.
	// Add api_targets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsIdPatch method not implemented")
}

// TargetsIdPut - Update target
func (s *TargetsAPIService) TargetsIdPut(ctx context.Context, id string, target Target) (ImplResponse, error) {
	// TODO - update TargetsIdPut with the required logic for this service method.
	// Add api_targets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsIdPut method not implemented")
}

// TargetsPost - Create target
func (s *TargetsAPIService) TargetsPost(ctx context.Context, target Target) (ImplResponse, error) {
	// TODO - update TargetsPost with the required logic for this service method.
	// Add api_targets_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(201, Target{}) or use other options such as http.Ok ...
	// return Response(201, Target{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsPost method not implemented")
}
