...
// JiraCloudIntegrationAPIController binds http requests to an api service and writes the service results to the http response
type JiraCloudIntegrationAPIController struct {
	service JiraCloudIntegrationAPIServicer
	errorHandler ErrorHandler
}

// JiraCloudIntegrationAPIOption for how the controller is set up.
type JiraCloudIntegrationAPIOption func(*JiraCloudIntegrationAPIController)

// WithJiraCloudIntegrationAPIErrorHandler inject ErrorHandler into controller
func WithJiraCloudIntegrationAPIErrorHandler(h ErrorHandler) JiraCloudIntegrationAPIOption {
	return func(c *JiraCloudIntegrationAPIController) {
		c.errorHandler = h
	}
}

// NewJiraCloudIntegrationAPIController creates a default api controller
func NewJiraCloudIntegrationAPIController(s JiraCloudIntegrationAPIServicer, opts ...JiraCloudIntegrationAPIOption) Router {
	controller := &JiraCloudIntegrationAPIController{
		service:      s,
...
// Routes returns all the api routes for the JiraCloudIntegrationAPIController
func (c *JiraCloudIntegrationAPIController) Routes() Routes {
	return Routes{
		"IntegrationsJiraCloudProjectsGet": Route{
			strings.ToUpper("Get"),
			"/integrations/jira-cloud/projects/",
			c.IntegrationsJiraCloudProjectsGet,
		},
		"IntegrationsJiraCloudProjectsProjectIdIssueTypesGet": Route{
			strings.ToUpper("Get"),
			"/integrations/jira-cloud/projects/{project_id}/issue_types/",
			c.IntegrationsJiraCloudProjectsProjectIdIssueTypesGet,
		},
		"IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet": Route{
			strings.ToUpper("Get"),
			"/integrations/jira-cloud/projects/{project_id}/issue_types/{issue_type_id}/priorities/",
			c.IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet,
		},
		"IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdStatusGet": Route{
			strings.ToUpper("Get"),
			"/integrations/jira-cloud/projects/{project_id}/issue_types/{issue_type_id}/status/",
			c.IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdStatusGet,
		},
		"TargetsTargetIdFindingsIdIntegrationsJiraCloudGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/findings/{id}/integrations/jira-cloud/",
			c.TargetsTargetIdFindingsIdIntegrationsJiraCloudGet,
		},
		"TargetsTargetIdFindingsIdIntegrationsJiraCloudPatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/findings/{id}/integrations/jira-cloud/",
			c.TargetsTargetIdFindingsIdIntegrationsJiraCloudPatch,
		},
		"TargetsTargetIdFindingsIdIntegrationsJiraCloudPut": Route{
			strings.ToUpper("Put"),
			"/targets/{target_id}/findings/{id}/integrations/jira-cloud/",
			c.TargetsTargetIdFindingsIdIntegrationsJiraCloudPut,
		},
		"TargetsTargetIdIntegrationsJiraCloudGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/integrations/jira-cloud/",
			c.TargetsTargetIdIntegrationsJiraCloudGet,
		},
		"TargetsTargetIdIntegrationsJiraCloudPatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/integrations/jira-cloud/",
			c.TargetsTargetIdIntegrationsJiraCloudPatch,
		},
		"TargetsTargetIdIntegrationsJiraCloudPut": Route{
			strings.ToUpper("Put"),
			"/targets/{target_id}/integrations/jira-cloud/",
			c.TargetsTargetIdIntegrationsJiraCloudPut,
		},
	}
}

// IntegrationsJiraCloudProjectsGet - List Jira Projects
func (c *JiraCloudIntegrationAPIController) IntegrationsJiraCloudProjectsGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.IntegrationsJiraCloudProjectsGet(r.Context())
...
func (c *JiraCloudIntegrationAPIController) IntegrationsJiraCloudProjectsProjectIdIssueTypesGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	...
	result, err := c.service.IntegrationsJiraCloudProjectsProjectIdIssueTypesGet(r.Context(), projectIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraCloudIntegrationAPIController) IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	projectIdParam := params["project_id"]
	if projectIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"project_id"}, nil)
	...
	result, err := c.service.IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet(r.Context(), projectIdParam, issueTypeIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraCloudIntegrationAPIController) IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdStatusGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	projectIdParam := params["project_id"]
	if projectIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"project_id"}, nil)
	...
	result, err := c.service.IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdStatusGet(r.Context(), projectIdParam, issueTypeIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraCloudIntegrationAPIController) TargetsTargetIdFindingsIdIntegrationsJiraCloudGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	...
	result, err := c.service.TargetsTargetIdFindingsIdIntegrationsJiraCloudGet(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraCloudIntegrationAPIController) TargetsTargetIdFindingsIdIntegrationsJiraCloudPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdFindingsIdIntegrationsJiraCloudPatch(r.Context(), targetIdParam, idParam, jiraFindingParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraCloudIntegrationAPIController) TargetsTargetIdFindingsIdIntegrationsJiraCloudPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdFindingsIdIntegrationsJiraCloudPut(r.Context(), targetIdParam, idParam, jiraFindingParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraCloudIntegrationAPIController) TargetsTargetIdIntegrationsJiraCloudGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdIntegrationsJiraCloudGet(r.Context(), targetIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraCloudIntegrationAPIController) TargetsTargetIdIntegrationsJiraCloudPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdIntegrationsJiraCloudPatch(r.Context(), targetIdParam, jiraScopeParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraCloudIntegrationAPIController) TargetsTargetIdIntegrationsJiraCloudPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdIntegrationsJiraCloudPut(r.Context(), targetIdParam, jiraScopeParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
