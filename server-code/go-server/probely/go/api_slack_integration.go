...
// SlackIntegrationAPIController binds http requests to an api service and writes the service results to the http response
type SlackIntegrationAPIController struct {
	service SlackIntegrationAPIServicer
	errorHandler ErrorHandler
}

// SlackIntegrationAPIOption for how the controller is set up.
type SlackIntegrationAPIOption func(*SlackIntegrationAPIController)

// WithSlackIntegrationAPIErrorHandler inject ErrorHandler into controller
func WithSlackIntegrationAPIErrorHandler(h ErrorHandler) SlackIntegrationAPIOption {
	return func(c *SlackIntegrationAPIController) {
		c.errorHandler = h
	}
}

// NewSlackIntegrationAPIController creates a default api controller
func NewSlackIntegrationAPIController(s SlackIntegrationAPIServicer, opts ...SlackIntegrationAPIOption) Router {
	controller := &SlackIntegrationAPIController{
		service:      s,
...
// Routes returns all the api routes for the SlackIntegrationAPIController
func (c *SlackIntegrationAPIController) Routes() Routes {
	return Routes{
		"TargetsTargetIdIntegrationsSlackGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/integrations/slack/",
			c.TargetsTargetIdIntegrationsSlackGet,
		},
		"TargetsTargetIdIntegrationsSlackPatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/integrations/slack/",
			c.TargetsTargetIdIntegrationsSlackPatch,
		},
		"TargetsTargetIdIntegrationsSlackPut": Route{
			strings.ToUpper("Put"),
			"/targets/{target_id}/integrations/slack/",
			c.TargetsTargetIdIntegrationsSlackPut,
		},
	}
}

// TargetsTargetIdIntegrationsSlackGet - Retrieve slack integration data
func (c *SlackIntegrationAPIController) TargetsTargetIdIntegrationsSlackGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	...
	result, err := c.service.TargetsTargetIdIntegrationsSlackGet(r.Context(), targetIdParam)
...
// TargetsTargetIdIntegrationsSlackPatch - Update slack integration data
func (c *SlackIntegrationAPIController) TargetsTargetIdIntegrationsSlackPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	if err := d.Decode(&slackParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertSlackRequired(slackParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertSlackConstraints(slackParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdIntegrationsSlackPatch(r.Context(), targetIdParam, slackParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
// TargetsTargetIdIntegrationsSlackPut - Update slack integration data
func (c *SlackIntegrationAPIController) TargetsTargetIdIntegrationsSlackPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdIntegrationsSlackPut(r.Context(), targetIdParam, slackParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
