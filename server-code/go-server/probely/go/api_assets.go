...
func NewAssetsAPIController(s AssetsAPIServicer, opts ...AssetsAPIOption) Router {
...
func (c *AssetsAPIController) Routes() Routes {
	return Routes{
		"TargetsTargetIdAssetsGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/assets/",
			c.TargetsTargetIdAssetsGet,
		},
		"TargetsTargetIdAssetsIdDelete": Route{
			strings.ToUpper("Delete"),
			"/targets/{target_id}/assets/{id}/",
			c.TargetsTargetIdAssetsIdDelete,
		},
		"TargetsTargetIdAssetsIdGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/assets/{id}/",
			c.TargetsTargetIdAssetsIdGet,
		},
		"TargetsTargetIdAssetsIdPatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/assets/{id}/",
			c.TargetsTargetIdAssetsIdPatch,
		},
		"TargetsTargetIdAssetsIdPut": Route{
			strings.ToUpper("Put"),
			"/targets/{target_id}/assets/{id}/",
			c.TargetsTargetIdAssetsIdPut,
		},
		"TargetsTargetIdAssetsIdVerifyPost": Route{
			strings.ToUpper("Post"),
			"/targets/{target_id}/assets/{id}/verify/",
			c.TargetsTargetIdAssetsIdVerifyPost,
		},
		"TargetsTargetIdAssetsPost": Route{
			strings.ToUpper("Post"),
			"/targets/{target_id}/assets/",
			c.TargetsTargetIdAssetsPost,
		},
	}
}

// TargetsTargetIdAssetsGet - List target's assets
func (c *AssetsAPIController) TargetsTargetIdAssetsGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	...
	result, err := c.service.TargetsTargetIdAssetsGet(r.Context(), targetIdParam, pageParam, lengthParam, orderingParam, searchParam)
...
func (c *AssetsAPIController) TargetsTargetIdAssetsIdDelete(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdAssetsIdDelete(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AssetsAPIController) TargetsTargetIdAssetsIdGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdAssetsIdGet(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AssetsAPIController) TargetsTargetIdAssetsIdPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	if err := d.Decode(&assetParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertAssetRequired(assetParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertAssetConstraints(assetParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdAssetsIdPatch(r.Context(), targetIdParam, idParam, assetParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AssetsAPIController) TargetsTargetIdAssetsIdPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdAssetsIdPut(r.Context(), targetIdParam, idParam, assetParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AssetsAPIController) TargetsTargetIdAssetsIdVerifyPost(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	targetsTargetIdAssetsIdVerifyPostRequestParam := TargetsTargetIdAssetsIdVerifyPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&targetsTargetIdAssetsIdVerifyPostRequestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertTargetsTargetIdAssetsIdVerifyPostRequestRequired(targetsTargetIdAssetsIdVerifyPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertTargetsTargetIdAssetsIdVerifyPostRequestConstraints(targetsTargetIdAssetsIdVerifyPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdAssetsIdVerifyPost(r.Context(), targetIdParam, idParam, targetsTargetIdAssetsIdVerifyPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AssetsAPIController) TargetsTargetIdAssetsPost(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdAssetsPost(r.Context(), targetIdParam, assetParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
