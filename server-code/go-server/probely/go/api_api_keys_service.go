...
// KeysGet - List API keys allowed to operate on account
func (s *APIKeysAPIService) KeysGet(ctx context.Context, page int32, length int32, ordering string, search string) (ImplResponse, error) {
	// TODO - update KeysGet with the required logic for this service method.
	...
	// TODO: Uncomment the next line to return response Response(200, KeysGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, KeysGet200Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("KeysGet method not implemented")
}

// KeysIdDelete - Delete account API key
func (s *APIKeysAPIService) KeysIdDelete(ctx context.Context, id string) (ImplResponse, error) {
	// TODO - update KeysIdDelete with the required logic for this service method.
	// Add api_api_keys_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("KeysIdDelete method not implemented")
}

// KeysIdGet - Retrieve account API key
func (s *APIKeysAPIService) KeysIdGet(ctx context.Context, id string) (ImplResponse, error) {
	// TODO - update KeysIdGet with the required logic for this service method.
	// Add api_api_keys_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("KeysIdGet method not implemented")
}

// KeysPost - Create account API key
func (s *APIKeysAPIService) KeysPost(ctx context.Context, apiKey ApiKey) (ImplResponse, error) {
	// TODO - update KeysPost with the required logic for this service method.
	// Add api_api_keys_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("KeysPost method not implemented")
}

// TargetsTargetIdKeysGet - List target specific API keys
func (s *APIKeysAPIService) TargetsTargetIdKeysGet(ctx context.Context, targetId string, page int32, length int32, ordering string, search string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdKeysGet with the required logic for this service method.
	// Add api_api_keys_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdKeysGet method not implemented")
}

// TargetsTargetIdKeysIdDelete - Delete target API key
func (s *APIKeysAPIService) TargetsTargetIdKeysIdDelete(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdKeysIdDelete with the required logic for this service method.
	// Add api_api_keys_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdKeysIdDelete method not implemented")
}

// TargetsTargetIdKeysIdGet - Retrieve target API key
func (s *APIKeysAPIService) TargetsTargetIdKeysIdGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdKeysIdGet with the required logic for this service method.
	// Add api_api_keys_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdKeysIdGet method not implemented")
}

// TargetsTargetIdKeysPost - Create target API key
func (s *APIKeysAPIService) TargetsTargetIdKeysPost(ctx context.Context, targetId string, apiKey ApiKey) (ImplResponse, error) {
	// TODO - update TargetsTargetIdKeysPost with the required logic for this service method.
	// Add api_api_keys_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdKeysPost method not implemented")
}
