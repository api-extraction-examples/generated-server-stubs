...
// ScansAPIService is a service that implements the logic for the ScansAPIServicer
// This service should implement the business logic for every endpoint for the ScansAPI API.
// Include any external packages or services that will be required by this service.
type ScansAPIService struct {
}

// NewScansAPIService creates a default api service
func NewScansAPIService() ScansAPIServicer {
	return &ScansAPIService{}
}

// TargetsAllScansGet - List scans for all targets
func (s *ScansAPIService) TargetsAllScansGet(ctx context.Context, page int32, length int32, ordering string, search string, started []string, status ScanStatus) (ImplResponse, error) {
	// TODO - update TargetsAllScansGet with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, TargetsAllScansGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsAllScansGet200Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsAllScansGet method not implemented")
}

// TargetsTargetIdScanNowPost - Start a scan on the target
func (s *ScansAPIService) TargetsTargetIdScanNowPost(ctx context.Context, targetId string, targetsTargetIdScanNowPostRequest TargetsTargetIdScanNowPostRequest) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScanNowPost with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, Scan{}) or use other options such as http.Ok ...
	// return Response(200, Scan{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScanNowPost method not implemented")
}

// TargetsTargetIdScansDatesGet - Dates where scans have ocurred
func (s *ScansAPIService) TargetsTargetIdScansDatesGet(ctx context.Context, targetId string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScansDatesGet with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScansDatesGet method not implemented")
}

// TargetsTargetIdScansGet - List scans
func (s *ScansAPIService) TargetsTargetIdScansGet(ctx context.Context, targetId string, page int32, length int32, ordering string, search string, started []string, status ScanStatus) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScansGet with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScansGet method not implemented")
}

// TargetsTargetIdScansIdCancelPost - Cancel running scan
func (s *ScansAPIService) TargetsTargetIdScansIdCancelPost(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScansIdCancelPost with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScansIdCancelPost method not implemented")
}

// TargetsTargetIdScansIdEndpointsGet - Scan endpoints file
func (s *ScansAPIService) TargetsTargetIdScansIdEndpointsGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScansIdEndpointsGet with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScansIdEndpointsGet method not implemented")
}

// TargetsTargetIdScansIdGet - Retrieve scan
func (s *ScansAPIService) TargetsTargetIdScansIdGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScansIdGet with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScansIdGet method not implemented")
}

// TargetsTargetIdScansIdReportDefaultGet - Scan report PDF, using the default report type
func (s *ScansAPIService) TargetsTargetIdScansIdReportDefaultGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScansIdReportDefaultGet with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScansIdReportDefaultGet method not implemented")
}

// TargetsTargetIdScansIdReportGet - Scan report PDF, using the report type specified for the target
func (s *ScansAPIService) TargetsTargetIdScansIdReportGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScansIdReportGet with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScansIdReportGet method not implemented")
}

// TargetsTargetIdScansIdReportOwaspGet - Scan report PDF, using the OWASP report type
func (s *ScansAPIService) TargetsTargetIdScansIdReportOwaspGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScansIdReportOwaspGet with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScansIdReportOwaspGet method not implemented")
}

// TargetsTargetIdScansIdReportPciGet - Scan report PDF, using the PCI report type
func (s *ScansAPIService) TargetsTargetIdScansIdReportPciGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScansIdReportPciGet with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScansIdReportPciGet method not implemented")
}

// TargetsTargetIdScansRetrievePageGet - Scan page
func (s *ScansAPIService) TargetsTargetIdScansRetrievePageGet(ctx context.Context, targetId string, date string, length int32) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScansRetrievePageGet with the required logic for this service method.
	// Add api_scans_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, TargetsTargetIdScansRetrievePageGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsTargetIdScansRetrievePageGet200Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScansRetrievePageGet method not implemented")
}
