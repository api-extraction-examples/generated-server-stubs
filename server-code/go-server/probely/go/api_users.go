...
func (c *UsersAPIController) Routes() Routes {
	return Routes{
		"ProfileChangePasswordPost": Route{
			strings.ToUpper("Post"),
			"/profile/change_password/",
			c.ProfileChangePasswordPost,
		},
		"ProfileGet": Route{
			strings.ToUpper("Get"),
			"/profile/",
...
func (c *UsersAPIController) ProfileChangePasswordPost(w http.ResponseWriter, r *http.Request) {
	profileChangePasswordPostRequestParam := ProfileChangePasswordPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&profileChangePasswordPostRequestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertProfileChangePasswordPostRequestRequired(profileChangePasswordPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertProfileChangePasswordPostRequestConstraints(profileChangePasswordPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.ProfileChangePasswordPost(r.Context(), profileChangePasswordPostRequestParam)
...
func (c *UsersAPIController) ProfileGet(w http.ResponseWriter, r *http.Request) {
	query := r.URL.Query()
	var pageParam int32
	if query.Has("page") {
	...
	result, err := c.service.ProfileGet(r.Context(), pageParam, lengthParam, orderingParam, searchParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *UsersAPIController) UsersGet(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.UsersGet(r.Context(), pageParam, lengthParam, orderingParam, searchParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *UsersAPIController) UsersIdDelete(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.UsersIdDelete(r.Context(), idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *UsersAPIController) UsersIdGet(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.UsersIdGet(r.Context(), idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *UsersAPIController) UsersIdPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
		c.errorHandler(w, r, &RequiredError{"id"}, nil)
	...
	usersPostRequestParam := UsersPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&usersPostRequestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertUsersPostRequestRequired(usersPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertUsersPostRequestConstraints(usersPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.UsersIdPatch(r.Context(), idParam, usersPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *UsersAPIController) UsersIdPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
		c.errorHandler(w, r, &RequiredError{"id"}, nil)
	...
	result, err := c.service.UsersIdPut(r.Context(), idParam, usersPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *UsersAPIController) UsersPost(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.UsersPost(r.Context(), usersPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
