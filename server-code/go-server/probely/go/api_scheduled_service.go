...
// ScheduledAPIService is a service that implements the logic for the ScheduledAPIServicer
// This service should implement the business logic for every endpoint for the ScheduledAPI API.
// Include any external packages or services that will be required by this service.
type ScheduledAPIService struct {
}

// NewScheduledAPIService creates a default api service
func NewScheduledAPIService() ScheduledAPIServicer {
	return &ScheduledAPIService{}
}

// TargetsAllScheduledscansExpandedGet - List scheduled scans for all targets expanding recurrence
func (s *ScheduledAPIService) TargetsAllScheduledscansExpandedGet(ctx context.Context, length int32) (ImplResponse, error) {
	// TODO - update TargetsAllScheduledscansExpandedGet with the required logic for this service method.
	// Add api_scheduled_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, TargetsAllScheduledscansExpandedGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsAllScheduledscansExpandedGet200Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsAllScheduledscansExpandedGet method not implemented")
}

// TargetsTargetIdScheduledscansExpandedGet - List scheduled scans expanding recurrence
func (s *ScheduledAPIService) TargetsTargetIdScheduledscansExpandedGet(ctx context.Context, targetId string, length int32) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScheduledscansExpandedGet with the required logic for this service method.
	// Add api_scheduled_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScheduledscansExpandedGet method not implemented")
}

// TargetsTargetIdScheduledscansGet - List scheduled scans
func (s *ScheduledAPIService) TargetsTargetIdScheduledscansGet(ctx context.Context, targetId string, page int32, length int32, ordering string, search string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScheduledscansGet with the required logic for this service method.
	// Add api_scheduled_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, TargetsTargetIdScheduledscansGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsTargetIdScheduledscansGet200Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScheduledscansGet method not implemented")
}

// TargetsTargetIdScheduledscansIdDelete - Delete
func (s *ScheduledAPIService) TargetsTargetIdScheduledscansIdDelete(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScheduledscansIdDelete with the required logic for this service method.
	// Add api_scheduled_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScheduledscansIdDelete method not implemented")
}

// TargetsTargetIdScheduledscansIdGet - Retrieve a scheduled scan
func (s *ScheduledAPIService) TargetsTargetIdScheduledscansIdGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScheduledscansIdGet with the required logic for this service method.
	// Add api_scheduled_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, Scheduled{}) or use other options such as http.Ok ...
	// return Response(200, Scheduled{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScheduledscansIdGet method not implemented")
}

// TargetsTargetIdScheduledscansIdPatch - Partial update
func (s *ScheduledAPIService) TargetsTargetIdScheduledscansIdPatch(ctx context.Context, targetId string, id string, targetsTargetIdScheduledscansPostRequest TargetsTargetIdScheduledscansPostRequest) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScheduledscansIdPatch with the required logic for this service method.
	// Add api_scheduled_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScheduledscansIdPatch method not implemented")
}

// TargetsTargetIdScheduledscansIdPut - Update a scheduled scan
func (s *ScheduledAPIService) TargetsTargetIdScheduledscansIdPut(ctx context.Context, targetId string, id string, targetsTargetIdScheduledscansPostRequest TargetsTargetIdScheduledscansPostRequest) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScheduledscansIdPut with the required logic for this service method.
	// Add api_scheduled_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScheduledscansIdPut method not implemented")
}

// TargetsTargetIdScheduledscansPost - Create new scheduled scan
func (s *ScheduledAPIService) TargetsTargetIdScheduledscansPost(ctx context.Context, targetId string, targetsTargetIdScheduledscansPostRequest TargetsTargetIdScheduledscansPostRequest) (ImplResponse, error) {
	// TODO - update TargetsTargetIdScheduledscansPost with the required logic for this service method.
	// Add api_scheduled_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(201, Scheduled{}) or use other options such as http.Ok ...
	// return Response(201, Scheduled{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdScheduledscansPost method not implemented")
}
