...
func (c *SiteAPIController) Routes() Routes {
	return Routes{
		"TargetsTargetIdSiteGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/site/",
			c.TargetsTargetIdSiteGet,
		},
		"TargetsTargetIdSitePatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/site/",
			c.TargetsTargetIdSitePatch,
		},
		"TargetsTargetIdSitePut": Route{
			strings.ToUpper("Put"),
			"/targets/{target_id}/site/",
			c.TargetsTargetIdSitePut,
		},
		"TargetsTargetIdSiteVerifyPost": Route{
			strings.ToUpper("Post"),
			"/targets/{target_id}/site/verify/",
			c.TargetsTargetIdSiteVerifyPost,
		},
	}
}
...
// Deprecated
func (c *SiteAPIController) TargetsTargetIdSiteGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	...
	result, err := c.service.TargetsTargetIdSiteGet(r.Context(), targetIdParam)
...
// Deprecated
func (c *SiteAPIController) TargetsTargetIdSitePatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	if err := AssertSiteRequired(siteParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertSiteConstraints(siteParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdSitePatch(r.Context(), targetIdParam, siteParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
// Deprecated
func (c *SiteAPIController) TargetsTargetIdSitePut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdSitePut(r.Context(), targetIdParam, siteParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
// Deprecated
func (c *SiteAPIController) TargetsTargetIdSiteVerifyPost(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdSiteVerifyPost(r.Context(), targetIdParam, targetsTargetIdAssetsIdVerifyPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
