...
// FindingsAPIController binds http requests to an api service and writes the service results to the http response
type FindingsAPIController struct {
	service FindingsAPIServicer
	errorHandler ErrorHandler
}

// FindingsAPIOption for how the controller is set up.
type FindingsAPIOption func(*FindingsAPIController)

// WithFindingsAPIErrorHandler inject ErrorHandler into controller
func WithFindingsAPIErrorHandler(h ErrorHandler) FindingsAPIOption {
	return func(c *FindingsAPIController) {
		c.errorHandler = h
	}
}

// NewFindingsAPIController creates a default api controller
func NewFindingsAPIController(s FindingsAPIServicer, opts ...FindingsAPIOption) Router {
	controller := &FindingsAPIController{
		service:      s,
...
// Routes returns all the api routes for the FindingsAPIController
func (c *FindingsAPIController) Routes() Routes {
	return Routes{
		"TargetsTargetIdFindingsBulkReportPost": Route{
			strings.ToUpper("Post"),
			"/targets/{target_id}/findings/bulk/report/",
			c.TargetsTargetIdFindingsBulkReportPost,
		},
		"TargetsTargetIdFindingsBulkRetestPost": Route{
			strings.ToUpper("Post"),
			"/targets/{target_id}/findings/bulk/retest/",
			c.TargetsTargetIdFindingsBulkRetestPost,
		},
		"TargetsTargetIdFindingsBulkUpdatePatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/findings/bulk/update/",
			c.TargetsTargetIdFindingsBulkUpdatePatch,
		},
		"TargetsTargetIdFindingsGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/findings/",
			c.TargetsTargetIdFindingsGet,
		},
		"TargetsTargetIdFindingsIdGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/findings/{id}/",
			c.TargetsTargetIdFindingsIdGet,
		},
		"TargetsTargetIdFindingsIdLogGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/findings/{id}/log/",
			c.TargetsTargetIdFindingsIdLogGet,
		},
		"TargetsTargetIdFindingsIdPatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/findings/{id}/",
			c.TargetsTargetIdFindingsIdPatch,
		},
		"TargetsTargetIdFindingsIdPut": Route{
			strings.ToUpper("Put"),
			"/targets/{target_id}/findings/{id}/",
			c.TargetsTargetIdFindingsIdPut,
		},
		"TargetsTargetIdFindingsIdRetestPost": Route{
			strings.ToUpper("Post"),
			"/targets/{target_id}/findings/{id}/retest/",
			c.TargetsTargetIdFindingsIdRetestPost,
		},
		"TargetsTargetIdFindingsReportGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/findings/report/",
			c.TargetsTargetIdFindingsReportGet,
		},
	}
}

// TargetsTargetIdFindingsBulkReportPost - Finding report
func (c *FindingsAPIController) TargetsTargetIdFindingsBulkReportPost(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	...
	findingBulkIdsParam := FindingBulkIds{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&findingBulkIdsParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertFindingBulkIdsRequired(findingBulkIdsParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertFindingBulkIdsConstraints(findingBulkIdsParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdFindingsBulkReportPost(r.Context(), targetIdParam, findingBulkIdsParam)
...
func (c *FindingsAPIController) TargetsTargetIdFindingsBulkRetestPost(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	findingBulkRetestParam := FindingBulkRetest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&findingBulkRetestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertFindingBulkRetestRequired(findingBulkRetestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertFindingBulkRetestConstraints(findingBulkRetestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdFindingsBulkRetestPost(r.Context(), targetIdParam, findingBulkRetestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *FindingsAPIController) TargetsTargetIdFindingsBulkUpdatePatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	findingBulkUpdateParam := FindingBulkUpdate{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&findingBulkUpdateParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertFindingBulkUpdateRequired(findingBulkUpdateParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertFindingBulkUpdateConstraints(findingBulkUpdateParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdFindingsBulkUpdatePatch(r.Context(), targetIdParam, findingBulkUpdateParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *FindingsAPIController) TargetsTargetIdFindingsGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
	...
	if query.Has("scan") {
		scanParam = strings.Split(query.Get("scan"), ",")
	}
	var severityParam FindingSeverity
	if query.Has("severity") {
		param := FindingSeverity(query.Get("severity"))

		severityParam = param
	} else {
	}
	var stateParam FindingState
	if query.Has("state") {
		param := FindingState(query.Get("state"))
	...
	if query.Has("assignee") {
		assigneeParam = strings.Split(query.Get("assignee"), ",")
	}
	var labelParam []string
	if query.Has("label") {
		labelParam = strings.Split(query.Get("label"), ",")
	}
	var pageParam int32
	if query.Has("page") {
	...
	result, err := c.service.TargetsTargetIdFindingsGet(r.Context(), targetIdParam, scanParam, severityParam, stateParam, assigneeParam, labelParam, pageParam, lengthParam, orderingParam, searchParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *FindingsAPIController) TargetsTargetIdFindingsIdGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdFindingsIdGet(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *FindingsAPIController) TargetsTargetIdFindingsIdLogGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdFindingsIdLogGet(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *FindingsAPIController) TargetsTargetIdFindingsIdPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	findingUpdateParam := FindingUpdate{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&findingUpdateParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertFindingUpdateRequired(findingUpdateParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertFindingUpdateConstraints(findingUpdateParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdFindingsIdPatch(r.Context(), targetIdParam, idParam, findingUpdateParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *FindingsAPIController) TargetsTargetIdFindingsIdPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdFindingsIdPut(r.Context(), targetIdParam, idParam, findingUpdateParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *FindingsAPIController) TargetsTargetIdFindingsIdRetestPost(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdFindingsIdRetestPost(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *FindingsAPIController) TargetsTargetIdFindingsReportGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
	...
	result, err := c.service.TargetsTargetIdFindingsReportGet(r.Context(), targetIdParam, tokenParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
