...
// AccountGet - Retrieve account information
func (s *AccountAPIService) AccountGet(ctx context.Context) (ImplResponse, error) {
...
// BillingActionsPost - Action that should be taken to enable the selected targets
func (s *AccountAPIService) BillingActionsPost(ctx context.Context, requestBody []string) (ImplResponse, error) {
	// TODO - update BillingActionsPost with the required logic for this service method.
	// Add api_account_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("BillingActionsPost method not implemented")
}

// BillingEstimatePost - Estimate costs of updating a subscription
func (s *AccountAPIService) BillingEstimatePost(ctx context.Context, subscription Subscription) (ImplResponse, error) {
	// TODO - update BillingEstimatePost with the required logic for this service method.
	// Add api_account_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("BillingEstimatePost method not implemented")
}

// BillingGet - Retrieve billing information
func (s *AccountAPIService) BillingGet(ctx context.Context) (ImplResponse, error) {
	// TODO - update BillingGet with the required logic for this service method.
	// Add api_account_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, Billing{}) or use other options such as http.Ok ...
	// return Response(200, Billing{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("BillingGet method not implemented")
}

// BillingPatch - Partial update billing information
func (s *AccountAPIService) BillingPatch(ctx context.Context, billing Billing) (ImplResponse, error) {
	// TODO - update BillingPatch with the required logic for this service method.
	// Add api_account_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("BillingPatch method not implemented")
}

// BillingPut - Update billing information
func (s *AccountAPIService) BillingPut(ctx context.Context, billing Billing) (ImplResponse, error) {
	// TODO - update BillingPut with the required logic for this service method.
	// Add api_account_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("BillingPut method not implemented")
}

// BillingSubscribePost - Update a subscription
func (s *AccountAPIService) BillingSubscribePost(ctx context.Context, subscription Subscription) (ImplResponse, error) {
	// TODO - update BillingSubscribePost with the required logic for this service method.
	// Add api_account_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("BillingSubscribePost method not implemented")
}

// TargetActionsPost - Available actions for the selected targets
func (s *AccountAPIService) TargetActionsPost(ctx context.Context, requestBody []string) (ImplResponse, error) {
	// TODO - update TargetActionsPost with the required logic for this service method.
	// Add api_account_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, []ActionsInner{}) or use other options such as http.Ok ...
	// return Response(200, []ActionsInner{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetActionsPost method not implemented")
}
