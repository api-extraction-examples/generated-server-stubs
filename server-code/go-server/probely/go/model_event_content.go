...
type EventContent struct {
	...
	AllowedScanProfiles []TargetAllowedScanProfilesInner `json:"allowed_scan_profiles,omitempty"`
	...
	Highs int32 `json:"highs,omitempty"`

	// Number of low severity findings in this scan
	Lows int32 `json:"lows,omitempty"`

	// Number of medium severity findings in this scan
	Mediums int32 `json:"mediums,omitempty"`
...
// AssertEventContentRequired checks if the required fields are not zero-ed
func AssertEventContentRequired(obj EventContent) error {
	if err := AssertChangedByRequired(obj.ChangedBy); err != nil {
		return err
	}
	for _, el := range obj.AllowedScanProfiles {
		if err := AssertTargetAllowedScanProfilesInnerRequired(el); err != nil {
			return err
		}
	}
	...
	if err := AssertScanCrawlerRequired(obj.Crawler); err != nil {
		return err
	}
	if err := AssertCreatedByRequired(obj.CreatedBy); err != nil {
		return err
	}
	if err := AssertScanFingerprinterRequired(obj.Fingerprinter); err != nil {
		return err
	}
	if err := AssertScanScannerRequired(obj.Scanner); err != nil {
		return err
	}
...
// AssertEventContentConstraints checks if the values respects the defined constraints
func AssertEventContentConstraints(obj EventContent) error {
	return nil
}
