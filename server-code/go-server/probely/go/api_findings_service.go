...
// FindingsAPIService is a service that implements the logic for the FindingsAPIServicer
// This service should implement the business logic for every endpoint for the FindingsAPI API.
// Include any external packages or services that will be required by this service.
type FindingsAPIService struct {
}

// NewFindingsAPIService creates a default api service
func NewFindingsAPIService() FindingsAPIServicer {
	return &FindingsAPIService{}
}

// TargetsTargetIdFindingsBulkReportPost - Finding report
func (s *FindingsAPIService) TargetsTargetIdFindingsBulkReportPost(ctx context.Context, targetId string, findingBulkIds FindingBulkIds) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsBulkReportPost with the required logic for this service method.
	// Add api_findings_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, {}) or use other options such as http.Ok ...
	// return Response(200, nil),nil

	// TODO: Uncomment the next line to return response Response(400, CheckPost400Response{}) or use other options such as http.Ok ...
	// return Response(400, CheckPost400Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsBulkReportPost method not implemented")
}

// TargetsTargetIdFindingsBulkRetestPost - Bulk retest findings
func (s *FindingsAPIService) TargetsTargetIdFindingsBulkRetestPost(ctx context.Context, targetId string, findingBulkRetest FindingBulkRetest) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsBulkRetestPost with the required logic for this service method.
	// Add api_findings_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsBulkRetestPost method not implemented")
}

// TargetsTargetIdFindingsBulkUpdatePatch - Bulk update findings
func (s *FindingsAPIService) TargetsTargetIdFindingsBulkUpdatePatch(ctx context.Context, targetId string, findingBulkUpdate FindingBulkUpdate) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsBulkUpdatePatch with the required logic for this service method.
	// Add api_findings_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsBulkUpdatePatch method not implemented")
}

// TargetsTargetIdFindingsGet - List target findings
func (s *FindingsAPIService) TargetsTargetIdFindingsGet(ctx context.Context, targetId string, scan []string, severity FindingSeverity, state FindingState, assignee []string, label []string, page int32, length int32, ordering string, search string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsGet with the required logic for this service method.
	// Add api_findings_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, TargetsTargetIdFindingsGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsTargetIdFindingsGet200Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsGet method not implemented")
}

// TargetsTargetIdFindingsIdGet - Retrieve finding
func (s *FindingsAPIService) TargetsTargetIdFindingsIdGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsIdGet with the required logic for this service method.
	// Add api_findings_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, Finding{}) or use other options such as http.Ok ...
	// return Response(200, Finding{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsIdGet method not implemented")
}

// TargetsTargetIdFindingsIdLogGet - Finding activity log.
func (s *FindingsAPIService) TargetsTargetIdFindingsIdLogGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsIdLogGet with the required logic for this service method.
	// Add api_findings_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsIdLogGet method not implemented")
}

// TargetsTargetIdFindingsIdPatch - Partial update finding
func (s *FindingsAPIService) TargetsTargetIdFindingsIdPatch(ctx context.Context, targetId string, id string, findingUpdate FindingUpdate) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsIdPatch with the required logic for this service method.
	// Add api_findings_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsIdPatch method not implemented")
}

// TargetsTargetIdFindingsIdPut - Update finding
func (s *FindingsAPIService) TargetsTargetIdFindingsIdPut(ctx context.Context, targetId string, id string, findingUpdate FindingUpdate) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsIdPut with the required logic for this service method.
	// Add api_findings_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsIdPut method not implemented")
}

// TargetsTargetIdFindingsIdRetestPost - Retest finding
func (s *FindingsAPIService) TargetsTargetIdFindingsIdRetestPost(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsIdRetestPost with the required logic for this service method.
	// Add api_findings_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(201, Scan{}) or use other options such as http.Ok ...
	// return Response(201, Scan{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsIdRetestPost method not implemented")
}

// TargetsTargetIdFindingsReportGet - Retrieve finding report PDF format
func (s *FindingsAPIService) TargetsTargetIdFindingsReportGet(ctx context.Context, targetId string, token string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsReportGet with the required logic for this service method.
	// Add api_findings_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsReportGet method not implemented")
}
