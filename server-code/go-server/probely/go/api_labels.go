...
func (c *LabelsAPIController) LabelsGet(w http.ResponseWriter, r *http.Request) {
	query := r.URL.Query()
	var pageParam int32
	if query.Has("page") {
	...
	result, err := c.service.LabelsGet(r.Context(), pageParam, lengthParam, orderingParam, searchParam)
...
func (c *LabelsAPIController) LabelsIdDelete(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
	...
	result, err := c.service.LabelsIdDelete(r.Context(), idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *LabelsAPIController) LabelsIdGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
		c.errorHandler(w, r, &RequiredError{"id"}, nil)
	...
	result, err := c.service.LabelsIdGet(r.Context(), idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *LabelsAPIController) LabelsIdPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
		c.errorHandler(w, r, &RequiredError{"id"}, nil)
	...
	if err := d.Decode(&labelParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertLabelRequired(labelParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertLabelConstraints(labelParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.LabelsIdPatch(r.Context(), idParam, labelParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *LabelsAPIController) LabelsIdPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	idParam := params["id"]
	if idParam == "" {
		c.errorHandler(w, r, &RequiredError{"id"}, nil)
	...
	result, err := c.service.LabelsIdPut(r.Context(), idParam, labelParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *LabelsAPIController) LabelsPost(w http.ResponseWriter, r *http.Request) {
	labelParam := Label{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&labelParam); err != nil {
	...
	result, err := c.service.LabelsPost(r.Context(), labelParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
