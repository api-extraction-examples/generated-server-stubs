...
func (c *AccountAPIController) Routes() Routes {
	return Routes{
		...
		"BillingActionsPost": Route{
			strings.ToUpper("Post"),
			"/billing/actions/",
			c.BillingActionsPost,
		},
		"BillingEstimatePost": Route{
			strings.ToUpper("Post"),
			"/billing/estimate/",
			c.BillingEstimatePost,
		},
		"BillingGet": Route{
			strings.ToUpper("Get"),
			"/billing/",
		...
		"BillingSubscribePost": Route{
			strings.ToUpper("Post"),
			"/billing/subscribe/",
			c.BillingSubscribePost,
		},
		"TargetActionsPost": Route{
			strings.ToUpper("Post"),
			"/target-actions/",
			c.TargetActionsPost,
		},
...
func (c *AccountAPIController) AccountGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.AccountGet(r.Context())
...
func (c *AccountAPIController) BillingActionsPost(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.BillingActionsPost(r.Context(), requestBodyParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AccountAPIController) BillingEstimatePost(w http.ResponseWriter, r *http.Request) {
	subscriptionParam := Subscription{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&subscriptionParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertSubscriptionRequired(subscriptionParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertSubscriptionConstraints(subscriptionParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.BillingEstimatePost(r.Context(), subscriptionParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AccountAPIController) BillingGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.BillingGet(r.Context())
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AccountAPIController) BillingPatch(w http.ResponseWriter, r *http.Request) {
	billingParam := Billing{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&billingParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertBillingRequired(billingParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertBillingConstraints(billingParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.BillingPatch(r.Context(), billingParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AccountAPIController) BillingPut(w http.ResponseWriter, r *http.Request) {
	billingParam := Billing{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&billingParam); err != nil {
	...
	result, err := c.service.BillingPut(r.Context(), billingParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AccountAPIController) BillingSubscribePost(w http.ResponseWriter, r *http.Request) {
	subscriptionParam := Subscription{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&subscriptionParam); err != nil {
	...
	result, err := c.service.BillingSubscribePost(r.Context(), subscriptionParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AccountAPIController) TargetActionsPost(w http.ResponseWriter, r *http.Request) {
	requestBodyParam := []string{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&requestBodyParam); err != nil {
	...
	result, err := c.service.TargetActionsPost(r.Context(), requestBodyParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
