...
// PasswordResetAPIController binds http requests to an api service and writes the service results to the http response
type PasswordResetAPIController struct {
	service PasswordResetAPIServicer
	errorHandler ErrorHandler
}

// PasswordResetAPIOption for how the controller is set up.
type PasswordResetAPIOption func(*PasswordResetAPIController)

// WithPasswordResetAPIErrorHandler inject ErrorHandler into controller
func WithPasswordResetAPIErrorHandler(h ErrorHandler) PasswordResetAPIOption {
	return func(c *PasswordResetAPIController) {
		c.errorHandler = h
	}
}

// NewPasswordResetAPIController creates a default api controller
func NewPasswordResetAPIController(s PasswordResetAPIServicer, opts ...PasswordResetAPIOption) Router {
	controller := &PasswordResetAPIController{
		service:      s,
...
// Routes returns all the api routes for the PasswordResetAPIController
func (c *PasswordResetAPIController) Routes() Routes {
	return Routes{
		"CheckPost": Route{
...
// CheckPost - Check validity of password reset token
func (c *PasswordResetAPIController) CheckPost(w http.ResponseWriter, r *http.Request) {
	checkPostRequestParam := CheckPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&checkPostRequestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertCheckPostRequestRequired(checkPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertCheckPostRequestConstraints(checkPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.CheckPost(r.Context(), checkPostRequestParam)
...
// ResetPost - Send reset password email
func (c *PasswordResetAPIController) ResetPost(w http.ResponseWriter, r *http.Request) {
	resetPostRequestParam := ResetPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&resetPostRequestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertResetPostRequestRequired(resetPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertResetPostRequestConstraints(resetPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.ResetPost(r.Context(), resetPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
// SetpasswordPost - Reset password after asking for a reset (with the token sent by email). 
func (c *PasswordResetAPIController) SetpasswordPost(w http.ResponseWriter, r *http.Request) {
	setpasswordPostRequestParam := SetpasswordPostRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&setpasswordPostRequestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertSetpasswordPostRequestRequired(setpasswordPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertSetpasswordPostRequestConstraints(setpasswordPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.SetpasswordPost(r.Context(), setpasswordPostRequestParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
