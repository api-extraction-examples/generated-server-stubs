...
func NewStatisticsAPIService() StatisticsAPIServicer {
	return &StatisticsAPIService{}
}

// TargetsAllAverageFixTimeGet - Average fix time graph data (all targets)
func (s *StatisticsAPIService) TargetsAllAverageFixTimeGet(ctx context.Context) (ImplResponse, error) {
	// TODO - update TargetsAllAverageFixTimeGet with the required logic for this service method.
	...
	// TODO: Uncomment the next line to return response Response(200, TargetsAllAverageFixTimeGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsAllAverageFixTimeGet200Response{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetsAllAverageFixTimeGet method not implemented")
}

// TargetsAllNeedsAttentionPieGet - Targets with open vulnerabilities pie chart data
func (s *StatisticsAPIService) TargetsAllNeedsAttentionPieGet(ctx context.Context) (ImplResponse, error) {
	// TODO - update TargetsAllNeedsAttentionPieGet with the required logic for this service method.
	// Add api_statistics_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, TargetsAllNeedsAttentionPieGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsAllNeedsAttentionPieGet200Response{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetsAllNeedsAttentionPieGet method not implemented")
}

// TargetsAllNeedsAttentionTopGet - Targets with open vulnerabilities
func (s *StatisticsAPIService) TargetsAllNeedsAttentionTopGet(ctx context.Context) (ImplResponse, error) {
	// TODO - update TargetsAllNeedsAttentionTopGet with the required logic for this service method.
	// Add api_statistics_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, []TargetsAllNeedsAttentionTopGet200ResponseInner{}) or use other options such as http.Ok ...
	// return Response(200, []TargetsAllNeedsAttentionTopGet200ResponseInner{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetsAllNeedsAttentionTopGet method not implemented")
}

// TargetsAllRiskTrendGet - Risk trend graph data (all targets)
func (s *StatisticsAPIService) TargetsAllRiskTrendGet(ctx context.Context) (ImplResponse, error) {
	// TODO - update TargetsAllRiskTrendGet with the required logic for this service method.
	// Add api_statistics_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, []TargetsAllRiskTrendGet200ResponseInner{}) or use other options such as http.Ok ...
	// return Response(200, []TargetsAllRiskTrendGet200ResponseInner{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetsAllRiskTrendGet method not implemented")
}

// TargetsAllSeverityTrendGet - Severity trend graph data (all targets)
func (s *StatisticsAPIService) TargetsAllSeverityTrendGet(ctx context.Context) (ImplResponse, error) {
	// TODO - update TargetsAllSeverityTrendGet with the required logic for this service method.
	// Add api_statistics_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, TargetsAllSeverityTrendGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsAllSeverityTrendGet200Response{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetsAllSeverityTrendGet method not implemented")
}

// TargetsAllTopVulnsGet - Top 5 vulnerabilities (all targets).
func (s *StatisticsAPIService) TargetsAllTopVulnsGet(ctx context.Context) (ImplResponse, error) {
	// TODO - update TargetsAllTopVulnsGet with the required logic for this service method.
	// Add api_statistics_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, []TargetsAllTopVulnsGet200ResponseInner{}) or use other options such as http.Ok ...
	// return Response(200, []TargetsAllTopVulnsGet200ResponseInner{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetsAllTopVulnsGet method not implemented")
}

// TargetsTargetIdAverageFixTimeGet - Average vulnerability trend graph data
func (s *StatisticsAPIService) TargetsTargetIdAverageFixTimeGet(ctx context.Context, targetId string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdAverageFixTimeGet with the required logic for this service method.
	// Add api_statistics_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, TargetsAllAverageFixTimeGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsAllAverageFixTimeGet200Response{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdAverageFixTimeGet method not implemented")
}

// TargetsTargetIdRiskTrendGet - Risk trend graph data
func (s *StatisticsAPIService) TargetsTargetIdRiskTrendGet(ctx context.Context, targetId string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdRiskTrendGet with the required logic for this service method.
	// Add api_statistics_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, []TargetsAllRiskTrendGet200ResponseInner{}) or use other options such as http.Ok ...
	// return Response(200, []TargetsAllRiskTrendGet200ResponseInner{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdRiskTrendGet method not implemented")
}

// TargetsTargetIdSeverityTrendGet - Severity trend graph data.
func (s *StatisticsAPIService) TargetsTargetIdSeverityTrendGet(ctx context.Context, targetId string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdSeverityTrendGet with the required logic for this service method.
	// Add api_statistics_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, TargetsAllSeverityTrendGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, TargetsAllSeverityTrendGet200Response{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdSeverityTrendGet method not implemented")
}

// TargetsTargetIdTopVulnsGet - Top 5 vulnerabilities
func (s *StatisticsAPIService) TargetsTargetIdTopVulnsGet(ctx context.Context, targetId string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdTopVulnsGet with the required logic for this service method.
	// Add api_statistics_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, []TargetsAllTopVulnsGet200ResponseInner{}) or use other options such as http.Ok ...
	// return Response(200, []TargetsAllTopVulnsGet200ResponseInner{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdTopVulnsGet method not implemented")
}
