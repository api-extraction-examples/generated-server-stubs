...
// JiraServerIntegrationAPIService is a service that implements the logic for the JiraServerIntegrationAPIServicer
// This service should implement the business logic for every endpoint for the JiraServerIntegrationAPI API.
// Include any external packages or services that will be required by this service.
type JiraServerIntegrationAPIService struct {
}

// NewJiraServerIntegrationAPIService creates a default api service
func NewJiraServerIntegrationAPIService() JiraServerIntegrationAPIServicer {
	return &JiraServerIntegrationAPIService{}
}

// IntegrationsJiraServerProjectsGet - List Jira Projects
func (s *JiraServerIntegrationAPIService) IntegrationsJiraServerProjectsGet(ctx context.Context) (ImplResponse, error) {
	// TODO - update IntegrationsJiraServerProjectsGet with the required logic for this service method.
	// Add api_jira_server_integration_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, []JiraProject{}) or use other options such as http.Ok ...
	// return Response(200, []JiraProject{}), nil

	// TODO: Uncomment the next line to return response Response(401, AccountGet401Response{}) or use other options such as http.Ok ...
	// return Response(401, AccountGet401Response{}), nil

	// TODO: Uncomment the next line to return response Response(403, BillingPut403Response{}) or use other options such as http.Ok ...
	// return Response(403, BillingPut403Response{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("IntegrationsJiraServerProjectsGet method not implemented")
}

// IntegrationsJiraServerProjectsProjectIdIssueTypesGet - Retrieve project issue types
func (s *JiraServerIntegrationAPIService) IntegrationsJiraServerProjectsProjectIdIssueTypesGet(ctx context.Context, projectId string) (ImplResponse, error) {
	// TODO - update IntegrationsJiraServerProjectsProjectIdIssueTypesGet with the required logic for this service method.
	// Add api_jira_server_integration_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, []JiraIssueType{}) or use other options such as http.Ok ...
	// return Response(200, []JiraIssueType{}), nil
	...
	// TODO: Uncomment the next line to return response Response(404, EventsIdGet404Response{}) or use other options such as http.Ok ...
	// return Response(404, EventsIdGet404Response{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("IntegrationsJiraServerProjectsProjectIdIssueTypesGet method not implemented")
}

// IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet - Retrieve issue priorities
func (s *JiraServerIntegrationAPIService) IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet(ctx context.Context, projectId string, issueTypeId string) (ImplResponse, error) {
	// TODO - update IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet with the required logic for this service method.
	// Add api_jira_server_integration_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, []JiraIssuePriority{}) or use other options such as http.Ok ...
	// return Response(200, []JiraIssuePriority{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet method not implemented")
}

// IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdStatusGet - Retrieve issue statuses
func (s *JiraServerIntegrationAPIService) IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdStatusGet(ctx context.Context, projectId string, issueTypeId string) (ImplResponse, error) {
	// TODO - update IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdStatusGet with the required logic for this service method.
	// Add api_jira_server_integration_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, []JiraIssueStatus{}) or use other options such as http.Ok ...
	// return Response(200, []JiraIssueStatus{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdStatusGet method not implemented")
}

// TargetsTargetIdFindingsIdIntegrationsJiraServerGet - Retrieve Jira Server finding configuration
func (s *JiraServerIntegrationAPIService) TargetsTargetIdFindingsIdIntegrationsJiraServerGet(ctx context.Context, targetId string, id string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsIdIntegrationsJiraServerGet with the required logic for this service method.
	// Add api_jira_server_integration_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, JiraFinding{}) or use other options such as http.Ok ...
	// return Response(200, JiraFinding{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsIdIntegrationsJiraServerGet method not implemented")
}

// TargetsTargetIdFindingsIdIntegrationsJiraServerPatch - Update Jira Server finding configuration
func (s *JiraServerIntegrationAPIService) TargetsTargetIdFindingsIdIntegrationsJiraServerPatch(ctx context.Context, targetId string, id string, jiraFinding JiraFinding) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsIdIntegrationsJiraServerPatch with the required logic for this service method.
	// Add api_jira_server_integration_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsIdIntegrationsJiraServerPatch method not implemented")
}

// TargetsTargetIdFindingsIdIntegrationsJiraServerPut - Update Jira Server finding configuration
func (s *JiraServerIntegrationAPIService) TargetsTargetIdFindingsIdIntegrationsJiraServerPut(ctx context.Context, targetId string, id string, jiraFinding JiraFinding) (ImplResponse, error) {
	// TODO - update TargetsTargetIdFindingsIdIntegrationsJiraServerPut with the required logic for this service method.
	// Add api_jira_server_integration_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdFindingsIdIntegrationsJiraServerPut method not implemented")
}

// TargetsTargetIdIntegrationsJiraServerGet - Retrieve Jira Server Target configuration
func (s *JiraServerIntegrationAPIService) TargetsTargetIdIntegrationsJiraServerGet(ctx context.Context, targetId string) (ImplResponse, error) {
	// TODO - update TargetsTargetIdIntegrationsJiraServerGet with the required logic for this service method.
	// Add api_jira_server_integration_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, JiraScope{}) or use other options such as http.Ok ...
	// return Response(200, JiraScope{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdIntegrationsJiraServerGet method not implemented")
}

// TargetsTargetIdIntegrationsJiraServerPatch - Update Jira Server target configuration
func (s *JiraServerIntegrationAPIService) TargetsTargetIdIntegrationsJiraServerPatch(ctx context.Context, targetId string, jiraScope JiraScope) (ImplResponse, error) {
	// TODO - update TargetsTargetIdIntegrationsJiraServerPatch with the required logic for this service method.
	// Add api_jira_server_integration_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdIntegrationsJiraServerPatch method not implemented")
}

// TargetsTargetIdIntegrationsJiraServerPut - Update Jira Server target configuration
func (s *JiraServerIntegrationAPIService) TargetsTargetIdIntegrationsJiraServerPut(ctx context.Context, targetId string, jiraScope JiraScope) (ImplResponse, error) {
	// TODO - update TargetsTargetIdIntegrationsJiraServerPut with the required logic for this service method.
	// Add api_jira_server_integration_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("TargetsTargetIdIntegrationsJiraServerPut method not implemented")
}
