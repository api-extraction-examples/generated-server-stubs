...
func (s *LabelsAPIService) LabelsGet(ctx context.Context, page int32, length int32, ordering string, search string) (ImplResponse, error) {
	// TODO - update LabelsGet with the required logic for this service method.
	...
	// TODO: Uncomment the next line to return response Response(200, LabelsGet200Response{}) or use other options such as http.Ok ...
	// return Response(200, LabelsGet200Response{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("LabelsGet method not implemented")
}

// LabelsIdDelete - Delete label
func (s *LabelsAPIService) LabelsIdDelete(ctx context.Context, id string) (ImplResponse, error) {
	// TODO - update LabelsIdDelete with the required logic for this service method.
	// Add api_labels_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("LabelsIdDelete method not implemented")
}

// LabelsIdGet - Retrieve framework
func (s *LabelsAPIService) LabelsIdGet(ctx context.Context, id string) (ImplResponse, error) {
	// TODO - update LabelsIdGet with the required logic for this service method.
	// Add api_labels_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, Label{}) or use other options such as http.Ok ...
	// return Response(200, Label{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("LabelsIdGet method not implemented")
}

// LabelsIdPatch - Partial update
func (s *LabelsAPIService) LabelsIdPatch(ctx context.Context, id string, label Label) (ImplResponse, error) {
	// TODO - update LabelsIdPatch with the required logic for this service method.
	// Add api_labels_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("LabelsIdPatch method not implemented")
}

// LabelsIdPut - Update label
func (s *LabelsAPIService) LabelsIdPut(ctx context.Context, id string, label Label) (ImplResponse, error) {
	// TODO - update LabelsIdPut with the required logic for this service method.
	// Add api_labels_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("LabelsIdPut method not implemented")
}

// LabelsPost - Create label
func (s *LabelsAPIService) LabelsPost(ctx context.Context, label Label) (ImplResponse, error) {
	// TODO - update LabelsPost with the required logic for this service method.
	// Add api_labels_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(201, Label{}) or use other options such as http.Ok ...
	// return Response(201, Label{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("LabelsPost method not implemented")
}
