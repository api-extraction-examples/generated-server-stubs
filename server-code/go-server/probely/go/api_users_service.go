...
// ProfileChangePasswordPost - Change user password
func (s *UsersAPIService) ProfileChangePasswordPost(ctx context.Context, profileChangePasswordPostRequest ProfileChangePasswordPostRequest) (ImplResponse, error) {
	// TODO - update ProfileChangePasswordPost with the required logic for this service method.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("ProfileChangePasswordPost method not implemented")
}

// ProfileGet - User data
func (s *UsersAPIService) ProfileGet(ctx context.Context, page int32, length int32, ordering string, search string) (ImplResponse, error) {
...
// UsersGet - List users
func (s *UsersAPIService) UsersGet(ctx context.Context, page int32, length int32, ordering string, search string) (ImplResponse, error) {
...
// UsersIdDelete - Deactivate a user
func (s *UsersAPIService) UsersIdDelete(ctx context.Context, id string) (ImplResponse, error) {
...
// UsersIdGet - Retrieve user
func (s *UsersAPIService) UsersIdGet(ctx context.Context, id string) (ImplResponse, error) {
...
// UsersIdPatch - Partial update user
func (s *UsersAPIService) UsersIdPatch(ctx context.Context, id string, usersPostRequest UsersPostRequest) (ImplResponse, error) {
	// TODO - update UsersIdPatch with the required logic for this service method.
	// Add api_users_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("UsersIdPatch method not implemented")
}

// UsersIdPut - Update user
func (s *UsersAPIService) UsersIdPut(ctx context.Context, id string, usersPostRequest UsersPostRequest) (ImplResponse, error) {
	// TODO - update UsersIdPut with the required logic for this service method.
	// Add api_users_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("UsersIdPut method not implemented")
}

// UsersPost - Create/Reactivate a user.
func (s *UsersAPIService) UsersPost(ctx context.Context, usersPostRequest UsersPostRequest) (ImplResponse, error) {
