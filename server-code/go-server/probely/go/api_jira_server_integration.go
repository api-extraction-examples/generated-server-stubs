...
// JiraServerIntegrationAPIController binds http requests to an api service and writes the service results to the http response
type JiraServerIntegrationAPIController struct {
	service JiraServerIntegrationAPIServicer
	errorHandler ErrorHandler
}

// JiraServerIntegrationAPIOption for how the controller is set up.
type JiraServerIntegrationAPIOption func(*JiraServerIntegrationAPIController)

// WithJiraServerIntegrationAPIErrorHandler inject ErrorHandler into controller
func WithJiraServerIntegrationAPIErrorHandler(h ErrorHandler) JiraServerIntegrationAPIOption {
	return func(c *JiraServerIntegrationAPIController) {
		c.errorHandler = h
	}
}

// NewJiraServerIntegrationAPIController creates a default api controller
func NewJiraServerIntegrationAPIController(s JiraServerIntegrationAPIServicer, opts ...JiraServerIntegrationAPIOption) Router {
	controller := &JiraServerIntegrationAPIController{
		service:      s,
...
// Routes returns all the api routes for the JiraServerIntegrationAPIController
func (c *JiraServerIntegrationAPIController) Routes() Routes {
	return Routes{
		"IntegrationsJiraServerProjectsGet": Route{
			strings.ToUpper("Get"),
			"/integrations/jira-server/projects/",
			c.IntegrationsJiraServerProjectsGet,
		},
		"IntegrationsJiraServerProjectsProjectIdIssueTypesGet": Route{
			strings.ToUpper("Get"),
			"/integrations/jira-server/projects/{project_id}/issue_types/",
			c.IntegrationsJiraServerProjectsProjectIdIssueTypesGet,
		},
		"IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet": Route{
			strings.ToUpper("Get"),
			"/integrations/jira-server/projects/{project_id}/issue_types/{issue_type_id}/priorities/",
			c.IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet,
		},
		"IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdStatusGet": Route{
			strings.ToUpper("Get"),
			"/integrations/jira-server/projects/{project_id}/issue_types/{issue_type_id}/status/",
			c.IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdStatusGet,
		},
		"TargetsTargetIdFindingsIdIntegrationsJiraServerGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/findings/{id}/integrations/jira-server/",
			c.TargetsTargetIdFindingsIdIntegrationsJiraServerGet,
		},
		"TargetsTargetIdFindingsIdIntegrationsJiraServerPatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/findings/{id}/integrations/jira-server/",
			c.TargetsTargetIdFindingsIdIntegrationsJiraServerPatch,
		},
		"TargetsTargetIdFindingsIdIntegrationsJiraServerPut": Route{
			strings.ToUpper("Put"),
			"/targets/{target_id}/findings/{id}/integrations/jira-server/",
			c.TargetsTargetIdFindingsIdIntegrationsJiraServerPut,
		},
		"TargetsTargetIdIntegrationsJiraServerGet": Route{
			strings.ToUpper("Get"),
			"/targets/{target_id}/integrations/jira-server/",
			c.TargetsTargetIdIntegrationsJiraServerGet,
		},
		"TargetsTargetIdIntegrationsJiraServerPatch": Route{
			strings.ToUpper("Patch"),
			"/targets/{target_id}/integrations/jira-server/",
			c.TargetsTargetIdIntegrationsJiraServerPatch,
		},
		"TargetsTargetIdIntegrationsJiraServerPut": Route{
			strings.ToUpper("Put"),
			"/targets/{target_id}/integrations/jira-server/",
			c.TargetsTargetIdIntegrationsJiraServerPut,
		},
	}
}

// IntegrationsJiraServerProjectsGet - List Jira Projects
func (c *JiraServerIntegrationAPIController) IntegrationsJiraServerProjectsGet(w http.ResponseWriter, r *http.Request) {
	result, err := c.service.IntegrationsJiraServerProjectsGet(r.Context())
...
func (c *JiraServerIntegrationAPIController) IntegrationsJiraServerProjectsProjectIdIssueTypesGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	...
	result, err := c.service.IntegrationsJiraServerProjectsProjectIdIssueTypesGet(r.Context(), projectIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraServerIntegrationAPIController) IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	projectIdParam := params["project_id"]
	if projectIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"project_id"}, nil)
	...
	issueTypeIdParam := params["issue_type_id"]
	if issueTypeIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"issue_type_id"}, nil)
		return
	}
	result, err := c.service.IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet(r.Context(), projectIdParam, issueTypeIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraServerIntegrationAPIController) IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdStatusGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	projectIdParam := params["project_id"]
	if projectIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"project_id"}, nil)
	...
	result, err := c.service.IntegrationsJiraServerProjectsProjectIdIssueTypesIssueTypeIdStatusGet(r.Context(), projectIdParam, issueTypeIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraServerIntegrationAPIController) TargetsTargetIdFindingsIdIntegrationsJiraServerGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	...
	result, err := c.service.TargetsTargetIdFindingsIdIntegrationsJiraServerGet(r.Context(), targetIdParam, idParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraServerIntegrationAPIController) TargetsTargetIdFindingsIdIntegrationsJiraServerPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	jiraFindingParam := JiraFinding{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&jiraFindingParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertJiraFindingRequired(jiraFindingParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertJiraFindingConstraints(jiraFindingParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdFindingsIdIntegrationsJiraServerPatch(r.Context(), targetIdParam, idParam, jiraFindingParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraServerIntegrationAPIController) TargetsTargetIdFindingsIdIntegrationsJiraServerPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdFindingsIdIntegrationsJiraServerPut(r.Context(), targetIdParam, idParam, jiraFindingParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraServerIntegrationAPIController) TargetsTargetIdIntegrationsJiraServerGet(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdIntegrationsJiraServerGet(r.Context(), targetIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraServerIntegrationAPIController) TargetsTargetIdIntegrationsJiraServerPatch(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	jiraScopeParam := JiraScope{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&jiraScopeParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertJiraScopeRequired(jiraScopeParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertJiraScopeConstraints(jiraScopeParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.TargetsTargetIdIntegrationsJiraServerPatch(r.Context(), targetIdParam, jiraScopeParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *JiraServerIntegrationAPIController) TargetsTargetIdIntegrationsJiraServerPut(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	targetIdParam := params["target_id"]
	if targetIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"target_id"}, nil)
	...
	result, err := c.service.TargetsTargetIdIntegrationsJiraServerPut(r.Context(), targetIdParam, jiraScopeParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
