...
// AssertApprovalRequestRequired checks if the required fields are not zero-ed
func AssertApprovalRequestRequired(obj ApprovalRequest) error {
	for _, el := range obj.AllReviews {
		if err := AssertApprovalRequestReviewRequired(el); err != nil {
			return err
		}
	}
...
// AssertApprovalRequestConstraints checks if the values respects the defined constraints
func AssertApprovalRequestConstraints(obj ApprovalRequest) error {
	return nil
}
