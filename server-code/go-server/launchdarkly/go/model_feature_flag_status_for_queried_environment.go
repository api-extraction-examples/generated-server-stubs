...
// AssertFeatureFlagStatusForQueriedEnvironmentRequired checks if the required fields are not zero-ed
func AssertFeatureFlagStatusForQueriedEnvironmentRequired(obj FeatureFlagStatusForQueriedEnvironment) error {
	return nil
}

// AssertFeatureFlagStatusForQueriedEnvironmentConstraints checks if the values respects the defined constraints
func AssertFeatureFlagStatusForQueriedEnvironmentConstraints(obj FeatureFlagStatusForQueriedEnvironment) error {
	return nil
}
