...
// AssertCoachSeasonsInnerRequired checks if the required fields are not zero-ed
func AssertCoachSeasonsInnerRequired(obj CoachSeasonsInner) error {
	return nil
}

// AssertCoachSeasonsInnerConstraints checks if the values respects the defined constraints
func AssertCoachSeasonsInnerConstraints(obj CoachSeasonsInner) error {
	return nil
}
