...
// AssertTeamSeasonRequired checks if the required fields are not zero-ed
func AssertTeamSeasonRequired(obj TeamSeason) error {
	return nil
}

// AssertTeamSeasonConstraints checks if the values respects the defined constraints
func AssertTeamSeasonConstraints(obj TeamSeason) error {
	return nil
}
