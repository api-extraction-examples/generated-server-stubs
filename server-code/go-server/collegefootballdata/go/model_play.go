...
// AssertPlayRequired checks if the required fields are not zero-ed
func AssertPlayRequired(obj Play) error {
...
// AssertPlayConstraints checks if the values respects the defined constraints
func AssertPlayConstraints(obj Play) error {
	return nil
}
