...
// AssertConferenceSpRatingOffenseRequired checks if the required fields are not zero-ed
func AssertConferenceSpRatingOffenseRequired(obj ConferenceSpRatingOffense) error {
	return nil
}

// AssertConferenceSpRatingOffenseConstraints checks if the values respects the defined constraints
func AssertConferenceSpRatingOffenseConstraints(obj ConferenceSpRatingOffense) error {
	return nil
}
