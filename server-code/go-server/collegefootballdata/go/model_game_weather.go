...
// AssertGameWeatherRequired checks if the required fields are not zero-ed
func AssertGameWeatherRequired(obj GameWeather) error {
	return nil
}

// AssertGameWeatherConstraints checks if the values respects the defined constraints
func AssertGameWeatherConstraints(obj GameWeather) error {
	return nil
}
