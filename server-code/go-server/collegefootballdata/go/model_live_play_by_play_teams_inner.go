...
// AssertLivePlayByPlayTeamsInnerRequired checks if the required fields are not zero-ed
func AssertLivePlayByPlayTeamsInnerRequired(obj LivePlayByPlayTeamsInner) error {
	return nil
}

// AssertLivePlayByPlayTeamsInnerConstraints checks if the values respects the defined constraints
func AssertLivePlayByPlayTeamsInnerConstraints(obj LivePlayByPlayTeamsInner) error {
	return nil
}
