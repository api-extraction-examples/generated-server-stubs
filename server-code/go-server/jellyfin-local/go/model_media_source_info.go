...
// AssertMediaSourceInfoRequired checks if the required fields are not zero-ed
func AssertMediaSourceInfoRequired(obj MediaSourceInfo) error {
	if obj.MediaAttachments != nil {
		for _, el := range *obj.MediaAttachments {
			if err := AssertMediaAttachmentRequired(el); err != nil {
				return err
			}
		}
	}
...
// AssertMediaSourceInfoConstraints checks if the values respects the defined constraints
func AssertMediaSourceInfoConstraints(obj MediaSourceInfo) error {
	return nil
}
