...
// AssertGetProgramsDtoRequired checks if the required fields are not zero-ed
func AssertGetProgramsDtoRequired(obj GetProgramsDto) error {
	return nil
}

// AssertGetProgramsDtoConstraints checks if the values respects the defined constraints
func AssertGetProgramsDtoConstraints(obj GetProgramsDto) error {
	return nil
}
