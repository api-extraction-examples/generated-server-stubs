...
// AssertMediaStreamRequired checks if the required fields are not zero-ed
func AssertMediaStreamRequired(obj MediaStream) error {
	return nil
}

// AssertMediaStreamConstraints checks if the values respects the defined constraints
func AssertMediaStreamConstraints(obj MediaStream) error {
	return nil
}
