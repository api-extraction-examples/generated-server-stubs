...
func (c *AudioAPIController) Routes() Routes {
	return Routes{
		"GetAudioStream": Route{
			strings.ToUpper("Get"),
			"/Audio/{itemId}/stream",
			c.GetAudioStream,
		},
		"GetAudioStreamByContainer": Route{
			strings.ToUpper("Get"),
			"/Audio/{itemId}/stream.{container}",
			c.GetAudioStreamByContainer,
		},
		"HeadAudioStream": Route{
			strings.ToUpper("Head"),
			"/Audio/{itemId}/stream",
			c.HeadAudioStream,
		},
		"HeadAudioStreamByContainer": Route{
			strings.ToUpper("Head"),
			"/Audio/{itemId}/stream.{container}",
			c.HeadAudioStreamByContainer,
		},
	}
}

// GetAudioStream - Gets an audio stream.
func (c *AudioAPIController) GetAudioStream(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
...
func (c *AudioAPIController) GetAudioStreamByContainer(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	itemIdParam := params["itemId"]
	if itemIdParam == "" {
	...
	result, err := c.service.GetAudioStreamByContainer(r.Context(), itemIdParam, containerParam, staticParam, paramsParam, tagParam, deviceProfileIdParam, playSessionIdParam, segmentContainerParam, segmentLengthParam, minSegmentsParam, mediaSourceIdParam, deviceIdParam, audioCodecParam, enableAutoStreamCopyParam, allowVideoStreamCopyParam, allowAudioStreamCopyParam, breakOnNonKeyFramesParam, audioSampleRateParam, maxAudioBitDepthParam, audioBitRateParam, audioChannelsParam, maxAudioChannelsParam, profileParam, levelParam, framerateParam, maxFramerateParam, copyTimestampsParam, startTimeTicksParam, widthParam, heightParam, videoBitRateParam, subtitleStreamIndexParam, subtitleMethodParam, maxRefFramesParam, maxVideoBitDepthParam, requireAvcParam, deInterlaceParam, requireNonAnamorphicParam, transcodingMaxAudioChannelsParam, cpuCoreLimitParam, liveStreamIdParam, enableMpegtsM2TsModeParam, videoCodecParam, subtitleCodecParam, transcodeReasonsParam, audioStreamIndexParam, videoStreamIndexParam, contextParam, streamOptionsParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AudioAPIController) HeadAudioStream(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	itemIdParam := params["itemId"]
	if itemIdParam == "" {
	...
	result, err := c.service.HeadAudioStream(r.Context(), itemIdParam, containerParam, staticParam, paramsParam, tagParam, deviceProfileIdParam, playSessionIdParam, segmentContainerParam, segmentLengthParam, minSegmentsParam, mediaSourceIdParam, deviceIdParam, audioCodecParam, enableAutoStreamCopyParam, allowVideoStreamCopyParam, allowAudioStreamCopyParam, breakOnNonKeyFramesParam, audioSampleRateParam, maxAudioBitDepthParam, audioBitRateParam, audioChannelsParam, maxAudioChannelsParam, profileParam, levelParam, framerateParam, maxFramerateParam, copyTimestampsParam, startTimeTicksParam, widthParam, heightParam, videoBitRateParam, subtitleStreamIndexParam, subtitleMethodParam, maxRefFramesParam, maxVideoBitDepthParam, requireAvcParam, deInterlaceParam, requireNonAnamorphicParam, transcodingMaxAudioChannelsParam, cpuCoreLimitParam, liveStreamIdParam, enableMpegtsM2TsModeParam, videoCodecParam, subtitleCodecParam, transcodeReasonsParam, audioStreamIndexParam, videoStreamIndexParam, contextParam, streamOptionsParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *AudioAPIController) HeadAudioStreamByContainer(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	itemIdParam := params["itemId"]
	if itemIdParam == "" {
	...
	result, err := c.service.HeadAudioStreamByContainer(r.Context(), itemIdParam, containerParam, staticParam, paramsParam, tagParam, deviceProfileIdParam, playSessionIdParam, segmentContainerParam, segmentLengthParam, minSegmentsParam, mediaSourceIdParam, deviceIdParam, audioCodecParam, enableAutoStreamCopyParam, allowVideoStreamCopyParam, allowAudioStreamCopyParam, breakOnNonKeyFramesParam, audioSampleRateParam, maxAudioBitDepthParam, audioBitRateParam, audioChannelsParam, maxAudioChannelsParam, profileParam, levelParam, framerateParam, maxFramerateParam, copyTimestampsParam, startTimeTicksParam, widthParam, heightParam, videoBitRateParam, subtitleStreamIndexParam, subtitleMethodParam, maxRefFramesParam, maxVideoBitDepthParam, requireAvcParam, deInterlaceParam, requireNonAnamorphicParam, transcodingMaxAudioChannelsParam, cpuCoreLimitParam, liveStreamIdParam, enableMpegtsM2TsModeParam, videoCodecParam, subtitleCodecParam, transcodeReasonsParam, audioStreamIndexParam, videoStreamIndexParam, contextParam, streamOptionsParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
