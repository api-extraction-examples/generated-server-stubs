...
// AssertPlaybackStartInfoRequired checks if the required fields are not zero-ed
func AssertPlaybackStartInfoRequired(obj PlaybackStartInfo) error {
...
// AssertPlaybackStartInfoConstraints checks if the values respects the defined constraints
func AssertPlaybackStartInfoConstraints(obj PlaybackStartInfo) error {
	return nil
}
