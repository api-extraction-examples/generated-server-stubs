...
// AssertSearchHintRequired checks if the required fields are not zero-ed
func AssertSearchHintRequired(obj SearchHint) error {
	return nil
}

// AssertSearchHintConstraints checks if the values respects the defined constraints
func AssertSearchHintConstraints(obj SearchHint) error {
	return nil
}
