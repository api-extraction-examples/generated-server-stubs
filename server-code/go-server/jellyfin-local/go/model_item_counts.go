...
// AssertItemCountsRequired checks if the required fields are not zero-ed
func AssertItemCountsRequired(obj ItemCounts) error {
	return nil
}

// AssertItemCountsConstraints checks if the values respects the defined constraints
func AssertItemCountsConstraints(obj ItemCounts) error {
	return nil
}
