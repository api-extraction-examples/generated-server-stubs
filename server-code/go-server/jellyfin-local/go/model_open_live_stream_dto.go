...
// AssertOpenLiveStreamDtoRequired checks if the required fields are not zero-ed
func AssertOpenLiveStreamDtoRequired(obj OpenLiveStreamDto) error {
...
// AssertOpenLiveStreamDtoConstraints checks if the values respects the defined constraints
func AssertOpenLiveStreamDtoConstraints(obj OpenLiveStreamDto) error {
	return nil
}
