...
// AssertUserDtoRequired checks if the required fields are not zero-ed
func AssertUserDtoRequired(obj UserDto) error {
	if err := AssertUserConfigurationRequired(obj.Configuration); err != nil {
		return err
	}
	if err := AssertUserPolicyRequired(obj.Policy); err != nil {
		return err
	}
	return nil
}

// AssertUserDtoConstraints checks if the values respects the defined constraints
func AssertUserDtoConstraints(obj UserDto) error {
	return nil
}
