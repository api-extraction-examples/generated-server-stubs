...
// AssertSeriesTimerInfoDtoRequired checks if the required fields are not zero-ed
func AssertSeriesTimerInfoDtoRequired(obj SeriesTimerInfoDto) error {
	return nil
}

// AssertSeriesTimerInfoDtoConstraints checks if the values respects the defined constraints
func AssertSeriesTimerInfoDtoConstraints(obj SeriesTimerInfoDto) error {
	return nil
}
