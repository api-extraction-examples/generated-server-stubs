...
// AssertClientCapabilitiesDtoRequired checks if the required fields are not zero-ed
func AssertClientCapabilitiesDtoRequired(obj ClientCapabilitiesDto) error {
...
// AssertClientCapabilitiesDtoConstraints checks if the values respects the defined constraints
func AssertClientCapabilitiesDtoConstraints(obj ClientCapabilitiesDto) error {
	return nil
}
