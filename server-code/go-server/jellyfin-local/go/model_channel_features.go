...
// AssertChannelFeaturesRequired checks if the required fields are not zero-ed
func AssertChannelFeaturesRequired(obj ChannelFeatures) error {
	return nil
}

// AssertChannelFeaturesConstraints checks if the values respects the defined constraints
func AssertChannelFeaturesConstraints(obj ChannelFeatures) error {
	return nil
}
