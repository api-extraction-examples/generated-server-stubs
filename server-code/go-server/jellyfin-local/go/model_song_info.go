...
// AssertSongInfoRequired checks if the required fields are not zero-ed
func AssertSongInfoRequired(obj SongInfo) error {
	return nil
}

// AssertSongInfoConstraints checks if the values respects the defined constraints
func AssertSongInfoConstraints(obj SongInfo) error {
	return nil
}
