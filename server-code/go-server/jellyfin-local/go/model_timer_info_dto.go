...
// AssertTimerInfoDtoRequired checks if the required fields are not zero-ed
func AssertTimerInfoDtoRequired(obj TimerInfoDto) error {
	if err := AssertBaseItemDtoRequired(obj.ProgramInfo); err != nil {
		return err
	}
	return nil
}

// AssertTimerInfoDtoConstraints checks if the values respects the defined constraints
func AssertTimerInfoDtoConstraints(obj TimerInfoDto) error {
	return nil
}
