...
// AssertUpdateTaskInstancesStateRequired checks if the required fields are not zero-ed
func AssertUpdateTaskInstancesStateRequired(obj UpdateTaskInstancesState) error {
	return nil
}

// AssertUpdateTaskInstancesStateConstraints checks if the values respects the defined constraints
func AssertUpdateTaskInstancesStateConstraints(obj UpdateTaskInstancesState) error {
	return nil
}
