...
// AssertBasicDagRunRequired checks if the required fields are not zero-ed
func AssertBasicDagRunRequired(obj BasicDagRun) error {
	return nil
}

// AssertBasicDagRunConstraints checks if the values respects the defined constraints
func AssertBasicDagRunConstraints(obj BasicDagRun) error {
	return nil
}
