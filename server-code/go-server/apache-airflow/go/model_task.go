...
type Task struct {
	...
	ExtraLinks []TaskExtraLinksInner `json:"extra_links,omitempty"`
...
func AssertTaskRequired(obj Task) error {
	if err := AssertClassReferenceRequired(obj.ClassRef); err != nil {
		return err
	}
	if err := AssertTimeDeltaRequired(obj.ExecutionTimeout); err != nil {
		return err
	}
	for _, el := range obj.ExtraLinks {
		if err := AssertTaskExtraLinksInnerRequired(el); err != nil {
			return err
		}
	}
	if err := AssertTimeDeltaRequired(obj.RetryDelay); err != nil {
		return err
	}
	if err := AssertDagRequired(obj.SubDag); err != nil {
		return err
	}
	return nil
}
