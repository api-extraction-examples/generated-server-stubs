...
func (c *MonitoringAPIController) GetHealth(w http.ResponseWriter, r *http.Request) {
...
func (c *MonitoringAPIController) GetVersion(w http.ResponseWriter, r *http.Request) {
