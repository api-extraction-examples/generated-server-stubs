...
// AssertDagRunRequired checks if the required fields are not zero-ed
func AssertDagRunRequired(obj DagRun) error {
	return nil
}

// AssertDagRunConstraints checks if the values respects the defined constraints
func AssertDagRunConstraints(obj DagRun) error {
	return nil
}
