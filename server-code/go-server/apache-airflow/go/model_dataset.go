...
func AssertDatasetRequired(obj Dataset) error {
	for _, el := range obj.ConsumingDags {
		if err := AssertDagScheduleDatasetReferenceRequired(el); err != nil {
			return err
		}
	}
	for _, el := range obj.ProducingTasks {
		if err := AssertTaskOutletDatasetReferenceRequired(el); err != nil {
			return err
		}
	}
	return nil
...
func AssertDatasetConstraints(obj Dataset) error {
	return nil
}
