...
func (c *ConnectionAPIController) DeleteConnection(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	connectionIdParam := params["connection_id"]
	if connectionIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"connection_id"}, nil)
		return
	}
	result, err := c.service.DeleteConnection(r.Context(), connectionIdParam)
...
func (c *ConnectionAPIController) GetConnection(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	connectionIdParam := params["connection_id"]
	if connectionIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"connection_id"}, nil)
	...
	result, err := c.service.GetConnection(r.Context(), connectionIdParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ConnectionAPIController) GetConnections(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.GetConnections(r.Context(), limitParam, offsetParam, orderByParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ConnectionAPIController) PatchConnection(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	connectionIdParam := params["connection_id"]
	if connectionIdParam == "" {
	...
	if err := AssertConnectionConstraints(connectionParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	...
	result, err := c.service.PatchConnection(r.Context(), connectionIdParam, connectionParam, updateMaskParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ConnectionAPIController) PostConnection(w http.ResponseWriter, r *http.Request) {
	connectionParam := Connection{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&connectionParam); err != nil {
	...
	result, err := c.service.PostConnection(r.Context(), connectionParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ConnectionAPIController) TestConnection(w http.ResponseWriter, r *http.Request) {
	connectionParam := Connection{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&connectionParam); err != nil {
	...
	result, err := c.service.TestConnection(r.Context(), connectionParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
