...
// AssertListTaskInstanceFormRequired checks if the required fields are not zero-ed
func AssertListTaskInstanceFormRequired(obj ListTaskInstanceForm) error {
	return nil
}

// AssertListTaskInstanceFormConstraints checks if the values respects the defined constraints
func AssertListTaskInstanceFormConstraints(obj ListTaskInstanceForm) error {
	return nil
}
