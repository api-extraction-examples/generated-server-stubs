...
// AssertEventLogRequired checks if the required fields are not zero-ed
func AssertEventLogRequired(obj EventLog) error {
	return nil
}

// AssertEventLogConstraints checks if the values respects the defined constraints
func AssertEventLogConstraints(obj EventLog) error {
	return nil
}
