...
// GetUser - Get a user
func (s *UserAPIService) GetUser(ctx context.Context, username string) (ImplResponse, error) {
	// TODO - update GetUser with the required logic for this service method.
	// Add api_user_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, UserCollectionItem{}) or use other options such as http.Ok ...
	// return Response(200, UserCollectionItem{}), nil
...
// GetUsers - List users
func (s *UserAPIService) GetUsers(ctx context.Context, limit int32, offset int32, orderBy string) (ImplResponse, error) {
	// TODO - update GetUsers with the required logic for this service method.
	// Add api_user_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, UserCollection{}) or use other options such as http.Ok ...
	// return Response(200, UserCollection{}), nil
...
func (s *UserAPIService) PatchUser(ctx context.Context, username string, user User, updateMask []string) (ImplResponse, error) {
...
func (s *UserAPIService) PostUser(ctx context.Context, user User) (ImplResponse, error) {
