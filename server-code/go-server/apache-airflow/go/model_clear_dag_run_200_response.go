...
// AssertClearDagRun200ResponseRequired checks if the required fields are not zero-ed
func AssertClearDagRun200ResponseRequired(obj ClearDagRun200Response) error {
	for _, el := range obj.TaskInstances {
		if err := AssertTaskInstanceRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertClearDagRun200ResponseConstraints checks if the values respects the defined constraints
func AssertClearDagRun200ResponseConstraints(obj ClearDagRun200Response) error {
	return nil
}
