...
// AssertPluginCollectionItemRequired checks if the required fields are not zero-ed
func AssertPluginCollectionItemRequired(obj PluginCollectionItem) error {
	return nil
}

// AssertPluginCollectionItemConstraints checks if the values respects the defined constraints
func AssertPluginCollectionItemConstraints(obj PluginCollectionItem) error {
	return nil
}
