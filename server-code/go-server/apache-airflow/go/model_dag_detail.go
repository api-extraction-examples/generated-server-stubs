...
type DagDetail struct {
	...
	MaxActiveTasks *int32 `json:"max_active_tasks,omitempty"`
...
// AssertDagDetailRequired checks if the required fields are not zero-ed
func AssertDagDetailRequired(obj DagDetail) error {
	if obj.ScheduleInterval != nil {
		if err := AssertScheduleIntervalRequired(*obj.ScheduleInterval); err != nil {
			return err
		}
	}
	if obj.Tags != nil {
	...
	if err := AssertTimeDeltaRequired(obj.DagRunTimeout); err != nil {
		return err
	}
	return nil
}

// AssertDagDetailConstraints checks if the values respects the defined constraints
func AssertDagDetailConstraints(obj DagDetail) error {
	return nil
}
