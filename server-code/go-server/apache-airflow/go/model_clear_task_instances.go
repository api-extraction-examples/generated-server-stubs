...
// AssertClearTaskInstancesRequired checks if the required fields are not zero-ed
func AssertClearTaskInstancesRequired(obj ClearTaskInstances) error {
	return nil
}

// AssertClearTaskInstancesConstraints checks if the values respects the defined constraints
func AssertClearTaskInstancesConstraints(obj ClearTaskInstances) error {
	return nil
}
