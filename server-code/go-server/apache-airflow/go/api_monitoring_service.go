...
func (s *MonitoringAPIService) GetHealth(ctx context.Context) (ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(200, HealthInfo{}) or use other options such as http.Ok ...
	// return Response(200, HealthInfo{}), nil
...
func (s *MonitoringAPIService) GetVersion(ctx context.Context) (ImplResponse, error) {
	// TODO - update GetVersion with the required logic for this service method.
	// Add api_monitoring_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, VersionInfo{}) or use other options such as http.Ok ...
	// return Response(200, VersionInfo{}), nil
