...
// AssertPoolRequired checks if the required fields are not zero-ed
func AssertPoolRequired(obj Pool) error {
	return nil
}

// AssertPoolConstraints checks if the values respects the defined constraints
func AssertPoolConstraints(obj Pool) error {
	return nil
}
