...
// AssertListDagRunsFormRequired checks if the required fields are not zero-ed
func AssertListDagRunsFormRequired(obj ListDagRunsForm) error {
	return nil
}

// AssertListDagRunsFormConstraints checks if the values respects the defined constraints
func AssertListDagRunsFormConstraints(obj ListDagRunsForm) error {
	if obj.PageLimit < 1 {
