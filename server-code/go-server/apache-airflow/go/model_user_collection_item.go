...
// AssertUserCollectionItemRequired checks if the required fields are not zero-ed
func AssertUserCollectionItemRequired(obj UserCollectionItem) error {
	for _, el := range obj.Roles {
		if err := AssertUserCollectionItemRolesInnerRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertUserCollectionItemConstraints checks if the values respects the defined constraints
func AssertUserCollectionItemConstraints(obj UserCollectionItem) error {
	return nil
}
