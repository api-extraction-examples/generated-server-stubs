...
// AssertScheduleIntervalRequired checks if the required fields are not zero-ed
func AssertScheduleIntervalRequired(obj ScheduleInterval) error {
...
// AssertScheduleIntervalConstraints checks if the values respects the defined constraints
func AssertScheduleIntervalConstraints(obj ScheduleInterval) error {
	return nil
}
