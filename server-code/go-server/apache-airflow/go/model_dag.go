...
// AssertDagRequired checks if the required fields are not zero-ed
func AssertDagRequired(obj Dag) error {
...
// AssertDagConstraints checks if the values respects the defined constraints
func AssertDagConstraints(obj Dag) error {
	return nil
}
