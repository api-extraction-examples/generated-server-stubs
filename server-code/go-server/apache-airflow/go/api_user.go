...
func (c *UserAPIController) GetUser(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.GetUser(r.Context(), usernameParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *UserAPIController) GetUsers(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.GetUsers(r.Context(), limitParam, offsetParam, orderByParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *UserAPIController) PatchUser(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	query := r.URL.Query()
	usernameParam := params["username"]
	if usernameParam == "" {
	...
	result, err := c.service.PatchUser(r.Context(), usernameParam, userParam, updateMaskParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *UserAPIController) PostUser(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.PostUser(r.Context(), userParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
