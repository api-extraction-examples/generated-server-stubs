...
// AssertTaskInstanceRequired checks if the required fields are not zero-ed
func AssertTaskInstanceRequired(obj TaskInstance) error {
	if obj.SlaMiss != nil {
		if err := AssertSlaMissRequired(*obj.SlaMiss); err != nil {
			return err
		}
	}
	...
	if err := AssertJobRequired(obj.TriggererJob); err != nil {
		return err
	}
	return nil
}

// AssertTaskInstanceConstraints checks if the values respects the defined constraints
func AssertTaskInstanceConstraints(obj TaskInstance) error {
	return nil
}
