...
// AssertSiteSetupRequired checks if the required fields are not zero-ed
func AssertSiteSetupRequired(obj SiteSetup) error {
	...
	if err := AssertRepoInfoRequired(obj.Repo); err != nil {
		return err
	}
	return nil
}

// AssertSiteSetupConstraints checks if the values respects the defined constraints
func AssertSiteSetupConstraints(obj SiteSetup) error {
	return nil
}
