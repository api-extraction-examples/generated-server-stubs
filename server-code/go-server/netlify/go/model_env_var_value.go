...
// AssertEnvVarValueRequired checks if the required fields are not zero-ed
func AssertEnvVarValueRequired(obj EnvVarValue) error {
	return nil
}

// AssertEnvVarValueConstraints checks if the values respects the defined constraints
func AssertEnvVarValueConstraints(obj EnvVarValue) error {
	return nil
}
