...
// AssertBillSummaryRequired checks if the required fields are not zero-ed
func AssertBillSummaryRequired(obj BillSummary) error {
...
// AssertBillSummaryConstraints checks if the values respects the defined constraints
func AssertBillSummaryConstraints(obj BillSummary) error {
	return nil
}
