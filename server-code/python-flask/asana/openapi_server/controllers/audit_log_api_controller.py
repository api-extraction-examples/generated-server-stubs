...
def get_audit_log_events(workspace_gid, start_at=None, end_at=None, event_type=None, actor_type=None, actor_gid=None, resource_gid=None, limit=None, offset=None):  # noqa: E501
    ...
    :rtype: Union[GetAuditLogEvents200Response, Tuple[GetAuditLogEvents200Response, int], Tuple[GetAuditLogEvents200Response, int, Dict[str, str]]
    """
