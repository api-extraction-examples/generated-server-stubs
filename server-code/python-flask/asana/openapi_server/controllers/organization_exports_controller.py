...
def create_organization_export(create_organization_export_request, opt_pretty=None, opt_fields=None, limit=None, offset=None):  # noqa: E501
    ...
    :param create_organization_export_request: The organization to export.
    :type create_organization_export_request: dict | bytes
    ...
    :rtype: Union[CreateOrganizationExport201Response, Tuple[CreateOrganizationExport201Response, int], Tuple[CreateOrganizationExport201Response, int, Dict[str, str]]
    """
    if connexion.request.is_json:
        create_organization_export_request = CreateOrganizationExportRequest.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def get_organization_export(organization_export_gid, opt_pretty=None, opt_fields=None):  # noqa: E501
