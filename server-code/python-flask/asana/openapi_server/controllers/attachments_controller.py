...
def create_attachment_for_object(opt_pretty=None, opt_fields=None, connect_to_app=None, file=None, name=None, parent=None, resource_subtype=None, url=None):  # noqa: E501
    ...
    :rtype: Union[CreateAttachmentForObject200Response, Tuple[CreateAttachmentForObject200Response, int], Tuple[CreateAttachmentForObject200Response, int, Dict[str, str]]
    """
    return 'do some magic!'


def delete_attachment(attachment_gid, opt_pretty=None, opt_fields=None):  # noqa: E501
...
def get_attachment(attachment_gid, opt_pretty=None, opt_fields=None):  # noqa: E501
    """Get an attachment
...
def get_attachments_for_object(parent, opt_pretty=None, opt_fields=None, limit=None, offset=None):  # noqa: E501
    """Get attachments from an object

    Returns the compact records for all attachments on the object.  There are three possible &#x60;parent&#x60; values for this request: &#x60;project&#x60;, &#x60;project_brief&#x60;, and &#x60;task&#x60;. For a project, an attachment refers to a file uploaded to the \&quot;Key resources\&quot; section in the project Overview. For a project brief, an attachment refers to inline files in the project brief itself. For a task, an attachment refers to a file directly associated to that task. # noqa: E501
    ...
    :rtype: Union[GetAttachmentsForObject200Response, Tuple[GetAttachmentsForObject200Response, int], Tuple[GetAttachmentsForObject200Response, int, Dict[str, str]]
    """
    return 'do some magic!'
