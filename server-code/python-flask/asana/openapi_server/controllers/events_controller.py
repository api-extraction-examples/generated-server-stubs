...
def get_events(resource, sync=None, opt_pretty=None, opt_fields=None):  # noqa: E501
    ...
    :rtype: Union[GetEvents200Response, Tuple[GetEvents200Response, int], Tuple[GetEvents200Response, int, Dict[str, str]]
    """
