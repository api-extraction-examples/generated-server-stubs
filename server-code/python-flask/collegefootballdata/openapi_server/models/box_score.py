...
from openapi_server.models.box_score_players import BoxScorePlayers  # noqa: E501
from openapi_server.models.box_score_teams import BoxScoreTeams  # noqa: E501
...
class BoxScore(Model):
    ...
    def __init__(self, players=None, teams=None):  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'BoxScore':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The BoxScore of this BoxScore.  # noqa: E501
        :rtype: BoxScore
        """
        return util.deserialize_model(dikt, cls)

    @property
    def players(self) -> BoxScorePlayers:
    ...
    @players.setter
    def players(self, players: BoxScorePlayers):
    ...
    @teams.setter
    def teams(self, teams: BoxScoreTeams):
