...
class AdvancedSeasonStatDefenseHavoc(Model):
    ...
    def __init__(self, db=None, front_seven=None, total=None):  # noqa: E501
        """AdvancedSeasonStatDefenseHavoc - a model defined in OpenAPI

        :param db: The db of this AdvancedSeasonStatDefenseHavoc.  # noqa: E501
        :type db: float
        :param front_seven: The front_seven of this AdvancedSeasonStatDefenseHavoc.  # noqa: E501
        :type front_seven: float
        :param total: The total of this AdvancedSeasonStatDefenseHavoc.  # noqa: E501
        :type total: float
        """
        self.openapi_types = {
            'db': float,
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'AdvancedSeasonStatDefenseHavoc':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The AdvancedSeasonStat_defense_havoc of this AdvancedSeasonStatDefenseHavoc.  # noqa: E501
