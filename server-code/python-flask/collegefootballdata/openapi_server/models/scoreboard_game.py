...
from openapi_server.models.scoreboard_game_away_team import ScoreboardGameAwayTeam  # noqa: E501
from openapi_server.models.scoreboard_game_betting import ScoreboardGameBetting  # noqa: E501
from openapi_server.models.scoreboard_game_venue import ScoreboardGameVenue  # noqa: E501
from openapi_server.models.scoreboard_game_weather import ScoreboardGameWeather  # noqa: E501
...
class ScoreboardGame(Model):
    ...
    def __init__(self, away_team=None, betting=None, clock=None, conference_game=None, home_team=None, id=None, neutral_site=None, period=None, possession=None, situation=None, start_date=None, start_time_tbd=None, status=None, tv=None, venue=None, weather=None):  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'ScoreboardGame':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The ScoreboardGame of this ScoreboardGame.  # noqa: E501
        :rtype: ScoreboardGame
        """
        return util.deserialize_model(dikt, cls)

    @property
    def away_team(self) -> ScoreboardGameAwayTeam:
    ...
    @away_team.setter
    def away_team(self, away_team: ScoreboardGameAwayTeam):
    ...
    @property
    def betting(self) -> ScoreboardGameBetting:
    ...
    @betting.setter
    def betting(self, betting: ScoreboardGameBetting):
    ...
    @property
    def home_team(self) -> ScoreboardGameAwayTeam:
    ...
    @home_team.setter
    def home_team(self, home_team: ScoreboardGameAwayTeam):
    ...
    @situation.setter
    def situation(self, situation: str):
    ...
    @property
    def venue(self) -> ScoreboardGameVenue:
    ...
    @venue.setter
    def venue(self, venue: ScoreboardGameVenue):
    ...
    @property
    def weather(self) -> ScoreboardGameWeather:
    ...
    @weather.setter
    def weather(self, weather: ScoreboardGameWeather):
