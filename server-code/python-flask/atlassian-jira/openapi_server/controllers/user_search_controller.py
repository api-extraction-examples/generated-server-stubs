...
def find_assignable_users(query=None, session_id=None, username=None, account_id=None, project=None, issue_key=None, start_at=None, max_results=None, action_descriptor_id=None, recommend=None):  # noqa: E501
...
def find_bulk_assignable_users(project_keys, query=None, username=None, account_id=None, start_at=None, max_results=None):  # noqa: E501
...
def find_user_keys_by_query(query, start_at=None, max_results=None):  # noqa: E501
    ...
    :rtype: Union[PageBeanUserKey, Tuple[PageBeanUserKey, int], Tuple[PageBeanUserKey, int, Dict[str, str]]
    """
    return 'do some magic!'


def find_users(query=None, username=None, account_id=None, start_at=None, max_results=None, _property=None):  # noqa: E501
    """Find users
...
def find_users_by_query(query, start_at=None, max_results=None):  # noqa: E501
    """Find users by query
...
def find_users_for_picker(query, max_results=None, show_avatar=None, exclude=None, exclude_account_ids=None, avatar_size=None, exclude_connect_users=None):  # noqa: E501
    ...
    :rtype: Union[FoundUsers, Tuple[FoundUsers, int], Tuple[FoundUsers, int, Dict[str, str]]
    """
    return 'do some magic!'


def find_users_with_all_permissions(permissions, query=None, username=None, account_id=None, issue_key=None, project_key=None, start_at=None, max_results=None):  # noqa: E501
...
def find_users_with_browse_permission(query=None, username=None, account_id=None, issue_key=None, project_key=None, start_at=None, max_results=None):  # noqa: E501
