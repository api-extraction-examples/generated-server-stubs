...
def archive_project(project_id_or_key):  # noqa: E501
    """Archive project
...
def create_project(create_project_details):  # noqa: E501
    """Create project
    ...
    :param create_project_details: The JSON representation of the project being created.
    :type create_project_details: dict | bytes

    :rtype: Union[ProjectIdentifiers, Tuple[ProjectIdentifiers, int], Tuple[ProjectIdentifiers, int, Dict[str, str]]
    """
    if connexion.request.is_json:
        create_project_details = CreateProjectDetails.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def delete_project(project_id_or_key, enable_undo=None):  # noqa: E501
    """Delete project
...
def delete_project_asynchronously(project_id_or_key):  # noqa: E501
...
def get_all_projects(expand=None, recent=None, properties=None):  # noqa: E501
    """Get all projects
...
def get_all_statuses(project_id_or_key):  # noqa: E501
    ...
    :rtype: Union[List[IssueTypeWithStatus], Tuple[List[IssueTypeWithStatus], int], Tuple[List[IssueTypeWithStatus], int, Dict[str, str]]
    """
    return 'do some magic!'


def get_hierarchy(project_id):  # noqa: E501
    ...
    :rtype: Union[ProjectIssueTypeHierarchy, Tuple[ProjectIssueTypeHierarchy, int], Tuple[ProjectIssueTypeHierarchy, int, Dict[str, str]]
    """
    return 'do some magic!'


def get_notification_scheme_for_project(project_key_or_id, expand=None):  # noqa: E501
    """Get project notification scheme

    Gets a [notification scheme](https://confluence.atlassian.com/x/8YdKLg) associated with the project. Deprecated, use [Get notification schemes paginated](#api-rest-api-3-notificationscheme-get) supporting search and pagination.  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) or *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg). # noqa: E501
...
def get_project(project_id_or_key, expand=None, properties=None):  # noqa: E501
    """Get project
...
def get_recent(expand=None, properties=None):  # noqa: E501
    """Get recent projects
...
def restore(project_id_or_key):  # noqa: E501
    """Restore deleted or archived project

    Restores a project that has been archived or placed in the Jira recycle bin.  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). # noqa: E501
...
def search_projects(start_at=None, max_results=None, order_by=None, id=None, keys=None, query=None, type_key=None, category_id=None, action=None, expand=None, status=None, properties=None, property_query=None):  # noqa: E501
    ...
    :rtype: Union[PageBeanProject, Tuple[PageBeanProject, int], Tuple[PageBeanProject, int, Dict[str, str]]
    """
    return 'do some magic!'


def update_project(project_id_or_key, update_project_details, expand=None):  # noqa: E501
    """Update project

    Updates the [project details](https://confluence.atlassian.com/x/ahLpNw) of a project.  All parameters are optional in the body of the request.  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). # noqa: E501

    :param project_id_or_key: The project ID or project key (case sensitive).
    :type project_id_or_key: str
    :param update_project_details: The project details to be updated.
    :type update_project_details: dict | bytes
    ...
    """
    if connexion.request.is_json:
        update_project_details = UpdateProjectDetails.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def update_project_type(project_id_or_key, new_project_type_key):  # noqa: E501
    """Update project type
