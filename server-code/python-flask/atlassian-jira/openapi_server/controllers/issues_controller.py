...
def assign_issue(issue_id_or_key, user):  # noqa: E501
    """Assign issue
...
def create_issue(issue_update_details, update_history=None):  # noqa: E501
    """Create issue
    ...
    :param issue_update_details: 
    :type issue_update_details: dict | bytes
    ...
    :rtype: Union[CreatedIssue, Tuple[CreatedIssue, int], Tuple[CreatedIssue, int, Dict[str, str]]
    """
    if connexion.request.is_json:
        issue_update_details = IssueUpdateDetails.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def create_issues(issues_update_bean):  # noqa: E501
    """Bulk create issue
    ...
    :param issues_update_bean: 
    :type issues_update_bean: dict | bytes

    :rtype: Union[CreatedIssues, Tuple[CreatedIssues, int], Tuple[CreatedIssues, int, Dict[str, str]]
    """
    if connexion.request.is_json:
        issues_update_bean = IssuesUpdateBean.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def delete_issue(issue_id_or_key, delete_subtasks=None):  # noqa: E501
    """Delete issue
...
def do_transition(issue_id_or_key, issue_update_details):  # noqa: E501
    """Transition issue
...
def edit_issue(issue_id_or_key, issue_update_details, notify_users=None, override_screen_security=None, override_editable_flag=None):  # noqa: E501
    """Edit issue
...
def get_change_logs(issue_id_or_key, start_at=None, max_results=None):  # noqa: E501
    """Get changelogs
    ...
    :rtype: Union[PageBeanChangelog, Tuple[PageBeanChangelog, int], Tuple[PageBeanChangelog, int, Dict[str, str]]
    """
    return 'do some magic!'


def get_change_logs_by_ids(issue_id_or_key, issue_changelog_ids):  # noqa: E501
    ...
    :param issue_id_or_key: The ID or key of the issue.
    :type issue_id_or_key: str
    :param issue_changelog_ids: 
    :type issue_changelog_ids: dict | bytes

    :rtype: Union[PageOfChangelogs, Tuple[PageOfChangelogs, int], Tuple[PageOfChangelogs, int, Dict[str, str]]
    """
    if connexion.request.is_json:
        issue_changelog_ids = IssueChangelogIds.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def get_create_issue_meta(project_ids=None, project_keys=None, issuetype_ids=None, issuetype_names=None, expand=None):  # noqa: E501
    ...
    :rtype: Union[IssueCreateMetadata, Tuple[IssueCreateMetadata, int], Tuple[IssueCreateMetadata, int, Dict[str, str]]
    """
    return 'do some magic!'


def get_edit_issue_meta(issue_id_or_key, override_screen_security=None, override_editable_flag=None):  # noqa: E501
    ...
    :rtype: Union[IssueUpdateMetadata, Tuple[IssueUpdateMetadata, int], Tuple[IssueUpdateMetadata, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def get_events():  # noqa: E501
    ...
    :rtype: Union[List[IssueEvent], Tuple[List[IssueEvent], int], Tuple[List[IssueEvent], int, Dict[str, str]]
    """
    return 'do some magic!'


def get_issue(issue_id_or_key, fields=None, fields_by_keys=None, expand=None, properties=None, update_history=None):  # noqa: E501
    """Get issue
    ...
    :rtype: Union[IssueBean, Tuple[IssueBean, int], Tuple[IssueBean, int, Dict[str, str]]
    """
    return 'do some magic!'


def get_transitions(issue_id_or_key, expand=None, transition_id=None, skip_remote_only_condition=None, include_unavailable_transitions=None, sort_by_ops_bar_and_status=None):  # noqa: E501
    """Get transitions
    ...
    :rtype: Union[Transitions, Tuple[Transitions, int], Tuple[Transitions, int, Dict[str, str]]
    """
    return 'do some magic!'


def notify(issue_id_or_key, notification):  # noqa: E501
