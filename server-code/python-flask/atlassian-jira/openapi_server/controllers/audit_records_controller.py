...
def get_audit_records(offset=None, limit=None, filter=None, _from=None, to=None):  # noqa: E501
    """Get audit records
    ...
    :rtype: Union[AuditRecords, Tuple[AuditRecords, int], Tuple[AuditRecords, int, Dict[str, str]]
    """
