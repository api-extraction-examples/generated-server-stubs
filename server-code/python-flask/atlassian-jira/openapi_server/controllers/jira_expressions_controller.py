...
def analyse_expression(jira_expression_for_analysis, check=None):  # noqa: E501
    ...
    :param jira_expression_for_analysis: The Jira expressions to analyse.
    :type jira_expression_for_analysis: dict | bytes
    ...
    :rtype: Union[JiraExpressionsAnalysis, Tuple[JiraExpressionsAnalysis, int], Tuple[JiraExpressionsAnalysis, int, Dict[str, str]]
    """
    if connexion.request.is_json:
        jira_expression_for_analysis = JiraExpressionForAnalysis.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def evaluate_jira_expression(jira_expression_eval_request_bean, expand=None):  # noqa: E501
    ...
    :param jira_expression_eval_request_bean: The Jira expression and the evaluation context.
    :type jira_expression_eval_request_bean: dict | bytes
    :param expand: Use [expand](#expansion) to include additional information in the response. This parameter accepts &#x60;meta.complexity&#x60; that returns information about the expression complexity. For example, the number of expensive operations used by the expression and how close the expression is to reaching the [complexity limit](https://developer.atlassian.com/cloud/jira/platform/jira-expressions/#restrictions). Useful when designing and debugging your expressions.
    :type expand: str

    :rtype: Union[JiraExpressionResult, Tuple[JiraExpressionResult, int], Tuple[JiraExpressionResult, int, Dict[str, str]]
    """
    if connexion.request.is_json:
        jira_expression_eval_request_bean = JiraExpressionEvalRequestBean.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'
