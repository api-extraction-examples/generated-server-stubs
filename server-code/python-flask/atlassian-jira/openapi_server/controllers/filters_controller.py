...
def change_filter_owner(id, change_filter_owner):  # noqa: E501
    """Change filter owner
    ...
    :type id: int
    :param change_filter_owner: The account ID of the new owner of the filter.
    :type change_filter_owner: dict | bytes

    :rtype: Union[object, Tuple[object, int], Tuple[object, int, Dict[str, str]]
    """
    if connexion.request.is_json:
        change_filter_owner = ChangeFilterOwner.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def create_filter(filter, expand=None, override_share_permissions=None):  # noqa: E501
    """Create filter
...
def delete_favourite_for_filter(id, expand=None):  # noqa: E501
...
def delete_filter(id):  # noqa: E501
    """Delete filter
...
def get_favourite_filters(expand=None):  # noqa: E501
...
def get_filter(id, expand=None, override_share_permissions=None):  # noqa: E501
    """Get filter
...
def get_filters_paginated(filter_name=None, account_id=None, owner=None, groupname=None, group_id=None, project_id=None, id=None, order_by=None, start_at=None, max_results=None, expand=None, override_share_permissions=None):  # noqa: E501
    """Search for filters
    ...
    :rtype: Union[PageBeanFilterDetails, Tuple[PageBeanFilterDetails, int], Tuple[PageBeanFilterDetails, int, Dict[str, str]]
    """
    return 'do some magic!'


def get_my_filters(expand=None, include_favourites=None):  # noqa: E501
    """Get my filters
...
def reset_columns(id):  # noqa: E501
    """Reset columns
...
def set_columns(id, request_body=None):  # noqa: E501
    """Set columns
...
def set_favourite_for_filter(id, expand=None):  # noqa: E501
...
def update_filter(id, filter, expand=None, override_share_permissions=None):  # noqa: E501
    """Update filter
