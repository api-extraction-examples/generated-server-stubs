...
def find_users_and_groups(query, max_results=None, show_avatar=None, field_id=None, project_id=None, issue_type_id=None, avatar_size=None, case_insensitive=None, exclude_connect_addons=None):  # noqa: E501
    ...
    :rtype: Union[FoundUsersAndGroups, Tuple[FoundUsersAndGroups, int], Tuple[FoundUsersAndGroups, int, Dict[str, str]]
    """
