...
class PageBeanWebhook(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PageBeanWebhook':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The PageBeanWebhook of this PageBeanWebhook.  # noqa: E501
        :rtype: PageBeanWebhook
        """
    ...
    @values.setter
    def values(self, values: List[Webhook]):
