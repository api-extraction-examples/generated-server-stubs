...
class OrderOfCustomFieldOptions(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'OrderOfCustomFieldOptions':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The OrderOfCustomFieldOptions of this OrderOfCustomFieldOptions.  # noqa: E501
        :rtype: OrderOfCustomFieldOptions
        """
    ...
    @property
    def custom_field_option_ids(self) -> List[str]:
    ...
    def custom_field_option_ids(self, custom_field_option_ids: List[str]):
