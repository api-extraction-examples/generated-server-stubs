...
class ProjectRoleActorsUpdateBean(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'ProjectRoleActorsUpdateBean':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The ProjectRoleActorsUpdateBean of this ProjectRoleActorsUpdateBean.  # noqa: E501
        :rtype: ProjectRoleActorsUpdateBean
        """
        return util.deserialize_model(dikt, cls)

    @property
    def categorised_actors(self) -> Dict[str, List[str]]:
    ...
    def categorised_actors(self, categorised_actors: Dict[str, List[str]]):
