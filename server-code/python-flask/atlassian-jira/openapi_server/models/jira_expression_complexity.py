...
class JiraExpressionComplexity(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'JiraExpressionComplexity':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The JiraExpressionComplexity of this JiraExpressionComplexity.  # noqa: E501
        :rtype: JiraExpressionComplexity
        """
        return util.deserialize_model(dikt, cls)

    @property
    def expensive_operations(self) -> str:
    ...
    def expensive_operations(self, expensive_operations: str):
