...
from openapi_server.models.field_reference_data import FieldReferenceData  # noqa: E501
from openapi_server.models.function_reference_data import FunctionReferenceData  # noqa: E501
...
class JQLReferenceData(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'JQLReferenceData':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The JQLReferenceData of this JQLReferenceData.  # noqa: E501
        :rtype: JQLReferenceData
        """
        return util.deserialize_model(dikt, cls)

    @property
    def jql_reserved_words(self) -> List[str]:
    ...
    def jql_reserved_words(self, jql_reserved_words: List[str]):
    ...
    @property
    def visible_field_names(self) -> List[FieldReferenceData]:
    ...
    def visible_field_names(self, visible_field_names: List[FieldReferenceData]):
    ...
    @property
    def visible_function_names(self) -> List[FunctionReferenceData]:
    ...
    def visible_function_names(self, visible_function_names: List[FunctionReferenceData]):
