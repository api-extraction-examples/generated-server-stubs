...
class CreateProjectDetails(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CreateProjectDetails':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CreateProjectDetails of this CreateProjectDetails.  # noqa: E501
        :rtype: CreateProjectDetails
        """
    ...
    @property
    def field_configuration_scheme(self) -> int:
    ...
    def field_configuration_scheme(self, field_configuration_scheme: int):
    ...
    @property
    def issue_type_scheme(self) -> int:
    ...
    def issue_type_scheme(self, issue_type_scheme: int):
    ...
    @property
    def issue_type_screen_scheme(self) -> int:
    ...
    def issue_type_screen_scheme(self, issue_type_screen_scheme: int):
    ...
    @property
    def project_template_key(self) -> str:
    ...
    def project_template_key(self, project_template_key: str):
    ...
    def workflow_scheme(self, workflow_scheme: int):
