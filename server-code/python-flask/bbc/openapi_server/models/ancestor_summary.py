...
from openapi_server.models.ancestor_titles import AncestorTitles  # noqa: E501
...
class AncestorSummary(Model):
    ...
    def __init__(self, ancestor_type=None, id=None, images=None, titles=None, type=None):  # noqa: E501
        """AncestorSummary - a model defined in OpenAPI

        :param ancestor_type: The ancestor_type of this AncestorSummary.  # noqa: E501
        :type ancestor_type: str
        :param id: The id of this AncestorSummary.  # noqa: E501
        :type id: str
        :param images: The images of this AncestorSummary.  # noqa: E501
        :type images: List[Image]
        :param titles: The titles of this AncestorSummary.  # noqa: E501
        :type titles: AncestorTitles
        :param type: The type of this AncestorSummary.  # noqa: E501
        :type type: str
        """
        self.openapi_types = {
            'ancestor_type': str,
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'AncestorSummary':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The AncestorSummary of this AncestorSummary.  # noqa: E501
        :rtype: AncestorSummary
        """
        return util.deserialize_model(dikt, cls)

    @property
    def ancestor_type(self) -> str:
    ...
    def ancestor_type(self, ancestor_type: str):
        ...
        if ancestor_type is None:
            raise ValueError("Invalid value for `ancestor_type`, must not be `None`")  # noqa: E501
    ...
    @property
    def titles(self) -> AncestorTitles:
    ...
    @titles.setter
    def titles(self, titles: AncestorTitles):
