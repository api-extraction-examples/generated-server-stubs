...
class ListDagRunsForm(Model):
    ...
    def __init__(self, dag_ids=None, end_date_gte=None, end_date_lte=None, execution_date_gte=None, execution_date_lte=None, order_by=None, page_limit=100, page_offset=None, start_date_gte=None, start_date_lte=None, states=None):  # noqa: E501
        ...
        :param order_by: The order_by of this ListDagRunsForm.  # noqa: E501
        :type order_by: str
        ...
        :param states: The states of this ListDagRunsForm.  # noqa: E501
    ...
    def order_by(self) -> str:
        ...
        The name of the field to order the results by. Prefix a field name with `-` to reverse the sort order.  *New in version 2.1.0*   # noqa: E501
    ...
    def states(self) -> List[str]:
        ...
        Return objects with specific states. The value can be repeated to retrieve multiple matching values (OR condition).  # noqa: E501
