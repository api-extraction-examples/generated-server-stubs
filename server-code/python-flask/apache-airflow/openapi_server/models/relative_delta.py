...
class RelativeDelta(Model):
    ...
    def __init__(self, type=None, day=None, days=None, hour=None, hours=None, leapdays=None, microsecond=None, microseconds=None, minute=None, minutes=None, month=None, months=None, second=None, seconds=None, year=None, years=None):  # noqa: E501
