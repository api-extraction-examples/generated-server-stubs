...
class CertificateCreateRequestDataAttributes(Model):
    ...
    def __init__(self, certificate_type=None, csr_content=None):  # noqa: E501
        """CertificateCreateRequestDataAttributes - a model defined in OpenAPI

        :param certificate_type: The certificate_type of this CertificateCreateRequestDataAttributes.  # noqa: E501
        :type certificate_type: CertificateType
        :param csr_content: The csr_content of this CertificateCreateRequestDataAttributes.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CertificateCreateRequestDataAttributes':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CertificateCreateRequest_data_attributes of this CertificateCreateRequestDataAttributes.  # noqa: E501
    ...
    @csr_content.setter
    def csr_content(self, csr_content: str):
        ...
        if csr_content is None:
            raise ValueError("Invalid value for `csr_content`, must not be `None`")  # noqa: E501
