...
def get_code_name(locale_geo_id):  # noqa: E501
    """5. Get list of codename details for Intel products.

    Use this to get codename details for Intel products. No pagination supported. # noqa: E501

    :param locale_geo_id: Locale and Geo code used to get localised data.&lt;br/&gt;&lt;br/&gt;
    :type locale_geo_id: str

    :rtype: Union[CompleteCodenameLsit, Tuple[CompleteCodenameLsit, int], Tuple[CompleteCodenameLsit, int, Dict[str, str]]
    """
    return 'do some magic!'


def get_product_info(locale_geo_id, product_id, include_reference=None):  # noqa: E501
    """2. Get complete product info with product id.

    Use this to get complete product info. No pagination supported. # noqa: E501
    ...
    :rtype: Union[DetailedProductInformation, Tuple[DetailedProductInformation, int], Tuple[DetailedProductInformation, int, Dict[str, str]]
    """
    return 'do some magic!'


def get_product_list(locale_geo_id, category_id=None, product_id=None, highlights=None, sort=None, filters=None, per_page=None, page_no=None):  # noqa: E501
    """1. Find products by product id or category id

    Use this to get basic details of products with pagination. Can be used to generate listing page for products. # noqa: E501
    ...
    :rtype: Union[ProductListingLevelInfo, Tuple[ProductListingLevelInfo, int], Tuple[ProductListingLevelInfo, int, Dict[str, str]]
    """
    return 'do some magic!'


def getorderinginfo(product_id, locale_geo_id):  # noqa: E501
    """3. Get ordering info for product id&#39;s requested.

    Use this to fetch ordering info details for Intel products. No pagination supported. # noqa: E501
    ...
    :rtype: Union[DetailedOrderingLevelInfo, Tuple[DetailedOrderingLevelInfo, int], Tuple[DetailedOrderingLevelInfo, int, Dict[str, str]]
    """
    return 'do some magic!'
