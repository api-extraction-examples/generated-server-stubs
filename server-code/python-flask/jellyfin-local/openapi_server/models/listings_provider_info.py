...
class ListingsProviderInfo(Model):
    ...
    def __init__(self, channel_mappings=None, country=None, enable_all_tuners=None, enabled_tuners=None, id=None, kids_categories=None, listings_id=None, movie_categories=None, movie_prefix=None, news_categories=None, password=None, path=None, preferred_language=None, sports_categories=None, type=None, user_agent=None, username=None, zip_code=None):  # noqa: E501
        """ListingsProviderInfo - a model defined in OpenAPI

        :param channel_mappings: The channel_mappings of this ListingsProviderInfo.  # noqa: E501
        :type channel_mappings: List[NameValuePair]
        :param country: The country of this ListingsProviderInfo.  # noqa: E501
        :type country: str
        :param enable_all_tuners: The enable_all_tuners of this ListingsProviderInfo.  # noqa: E501
        :type enable_all_tuners: bool
        :param enabled_tuners: The enabled_tuners of this ListingsProviderInfo.  # noqa: E501
        :type enabled_tuners: List[str]
        :param id: The id of this ListingsProviderInfo.  # noqa: E501
        :type id: str
        :param kids_categories: The kids_categories of this ListingsProviderInfo.  # noqa: E501
        :type kids_categories: List[str]
        :param listings_id: The listings_id of this ListingsProviderInfo.  # noqa: E501
        :type listings_id: str
        :param movie_categories: The movie_categories of this ListingsProviderInfo.  # noqa: E501
        :type movie_categories: List[str]
        :param movie_prefix: The movie_prefix of this ListingsProviderInfo.  # noqa: E501
        :type movie_prefix: str
        :param news_categories: The news_categories of this ListingsProviderInfo.  # noqa: E501
        :type news_categories: List[str]
        :param password: The password of this ListingsProviderInfo.  # noqa: E501
        :type password: str
        :param path: The path of this ListingsProviderInfo.  # noqa: E501
        :type path: str
        :param preferred_language: The preferred_language of this ListingsProviderInfo.  # noqa: E501
        :type preferred_language: str
        :param sports_categories: The sports_categories of this ListingsProviderInfo.  # noqa: E501
        :type sports_categories: List[str]
        :param type: The type of this ListingsProviderInfo.  # noqa: E501
        :type type: str
        :param user_agent: The user_agent of this ListingsProviderInfo.  # noqa: E501
        :type user_agent: str
        :param username: The username of this ListingsProviderInfo.  # noqa: E501
        :type username: str
        :param zip_code: The zip_code of this ListingsProviderInfo.  # noqa: E501
        :type zip_code: str
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'ListingsProviderInfo':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The ListingsProviderInfo of this ListingsProviderInfo.  # noqa: E501
        :rtype: ListingsProviderInfo
        """
        return util.deserialize_model(dikt, cls)

    @property
    def channel_mappings(self) -> List[NameValuePair]:
    ...
    def channel_mappings(self, channel_mappings: List[NameValuePair]):
    ...
    @property
    def enable_all_tuners(self) -> bool:
    ...
    def enable_all_tuners(self, enable_all_tuners: bool):
    ...
    @property
    def enabled_tuners(self) -> List[str]:
    ...
    def enabled_tuners(self, enabled_tuners: List[str]):
    ...
    @property
    def kids_categories(self) -> List[str]:
    ...
    def kids_categories(self, kids_categories: List[str]):
    ...
    @listings_id.setter
    def listings_id(self, listings_id: str):
    ...
    @property
    def movie_categories(self) -> List[str]:
    ...
    def movie_categories(self, movie_categories: List[str]):
    ...
    @movie_prefix.setter
    def movie_prefix(self, movie_prefix: str):
    ...
    def news_categories(self, news_categories: List[str]):
    ...
    @property
    def sports_categories(self) -> List[str]:
    ...
    def sports_categories(self, sports_categories: List[str]):
