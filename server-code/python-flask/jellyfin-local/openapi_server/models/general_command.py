...
class GeneralCommand(Model):
    ...
    def __init__(self, arguments=None, controlling_user_id=None, name=None):  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'GeneralCommand':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The GeneralCommand of this GeneralCommand.  # noqa: E501
        :rtype: GeneralCommand
        """
    ...
    @property
    def name(self) -> GeneralCommandType:
    ...
    @name.setter
    def name(self, name: GeneralCommandType):
