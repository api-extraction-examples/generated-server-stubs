...
from openapi_server.models.media_attachment import MediaAttachment  # noqa: E501
from openapi_server.models.media_protocol import MediaProtocol  # noqa: E501
from openapi_server.models.media_source_type import MediaSourceType  # noqa: E501
from openapi_server.models.media_stream import MediaStream  # noqa: E501
from openapi_server.models.transport_stream_timestamp import TransportStreamTimestamp  # noqa: E501
...
class MediaSourceInfo(Model):
    ...
    def __init__(self, analyze_duration_ms=None, bitrate=None, buffer_ms=None, container=None, default_audio_stream_index=None, default_subtitle_stream_index=None, e_tag=None, encoder_path=None, encoder_protocol=None, formats=None, gen_pts_input=None, id=None, ignore_dts=None, ignore_index=None, is_infinite_stream=None, is_remote=None, iso_type=None, live_stream_id=None, media_attachments=None, media_streams=None, name=None, open_token=None, path=None, protocol=None, read_at_native_framerate=None, required_http_headers=None, requires_closing=None, requires_looping=None, requires_opening=None, run_time_ticks=None, size=None, supports_direct_play=None, supports_direct_stream=None, supports_probing=None, supports_transcoding=None, timestamp=None, transcoding_container=None, transcoding_sub_protocol=None, transcoding_url=None, type=None, video3_d_format=None, video_type=None):  # noqa: E501
        ...
        :param e_tag: The e_tag of this MediaSourceInfo.  # noqa: E501
        :type e_tag: str
        ...
        :param gen_pts_input: The gen_pts_input of this MediaSourceInfo.  # noqa: E501
        :type gen_pts_input: bool
        :param id: The id of this MediaSourceInfo.  # noqa: E501
        :type id: str
        :param ignore_dts: The ignore_dts of this MediaSourceInfo.  # noqa: E501
        :type ignore_dts: bool
        :param ignore_index: The ignore_index of this MediaSourceInfo.  # noqa: E501
        ...
        :type is_remote: bool
        :param iso_type: The iso_type of this MediaSourceInfo.  # noqa: E501
        :type iso_type: IsoType
        :param live_stream_id: The live_stream_id of this MediaSourceInfo.  # noqa: E501
        :type live_stream_id: str
        :param media_attachments: The media_attachments of this MediaSourceInfo.  # noqa: E501
        ...
        :param video_type: The video_type of this MediaSourceInfo.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'MediaSourceInfo':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The MediaSourceInfo of this MediaSourceInfo.  # noqa: E501
        :rtype: MediaSourceInfo
        """
        return util.deserialize_model(dikt, cls)

    @property
    def analyze_duration_ms(self) -> int:
    ...
    def analyze_duration_ms(self, analyze_duration_ms: int):
    ...
    @buffer_ms.setter
    def buffer_ms(self, buffer_ms: int):
    ...
    @property
    def default_audio_stream_index(self) -> int:
    ...
    def default_audio_stream_index(self, default_audio_stream_index: int):
    ...
    @property
    def default_subtitle_stream_index(self) -> int:
    ...
    def default_subtitle_stream_index(self, default_subtitle_stream_index: int):
    ...
    @encoder_path.setter
    def encoder_path(self, encoder_path: str):
    ...
    @property
    def encoder_protocol(self) -> MediaProtocol:
    ...
    def encoder_protocol(self, encoder_protocol: MediaProtocol):
    ...
    def gen_pts_input(self, gen_pts_input: bool):
    ...
    @ignore_dts.setter
    def ignore_dts(self, ignore_dts: bool):
    ...
    @ignore_index.setter
    def ignore_index(self, ignore_index: bool):
    ...
    @property
    def is_infinite_stream(self) -> bool:
    ...
    def is_infinite_stream(self, is_infinite_stream: bool):
    ...
    @is_remote.setter
    def is_remote(self, is_remote: bool):
    ...
    def media_attachments(self, media_attachments: List[MediaAttachment]):
    ...
    @property
    def protocol(self) -> MediaProtocol:
    ...
    @protocol.setter
    def protocol(self, protocol: MediaProtocol):
    ...
    @property
    def read_at_native_framerate(self) -> bool:
    ...
    def read_at_native_framerate(self, read_at_native_framerate: bool):
    ...
    @property
    def required_http_headers(self) -> Dict[str, str]:
    ...
    def required_http_headers(self, required_http_headers: Dict[str, str]):
    ...
    def requires_closing(self, requires_closing: bool):
    ...
    @property
    def requires_looping(self) -> bool:
    ...
    def requires_looping(self, requires_looping: bool):
    ...
    def requires_opening(self, requires_opening: bool):
    ...
    def supports_direct_play(self, supports_direct_play: bool):
    ...
    def supports_direct_stream(self, supports_direct_stream: bool):
    ...
    def supports_probing(self, supports_probing: bool):
    ...
    @property
    def supports_transcoding(self) -> bool:
    ...
    def supports_transcoding(self, supports_transcoding: bool):
    ...
    @property
    def timestamp(self) -> TransportStreamTimestamp:
    ...
    @timestamp.setter
    def timestamp(self, timestamp: TransportStreamTimestamp):
    ...
    @property
    def transcoding_container(self) -> str:
    ...
    def transcoding_container(self, transcoding_container: str):
    ...
    @property
    def transcoding_sub_protocol(self) -> str:
    ...
    def transcoding_sub_protocol(self, transcoding_sub_protocol: str):
    ...
    def transcoding_url(self, transcoding_url: str):
    ...
    @type.setter
    def type(self, type: MediaSourceType):
