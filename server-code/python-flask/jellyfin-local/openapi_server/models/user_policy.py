...
from openapi_server.models.access_schedule import AccessSchedule  # noqa: E501
from openapi_server.models.sync_play_user_access_type import SyncPlayUserAccessType  # noqa: E501
from openapi_server.models.unrated_item import UnratedItem  # noqa: E501
...
class UserPolicy(Model):
    ...
    def __init__(self, access_schedules=None, authentication_provider_id=None, block_unrated_items=None, blocked_channels=None, blocked_media_folders=None, blocked_tags=None, enable_all_channels=None, enable_all_devices=None, enable_all_folders=None, enable_audio_playback_transcoding=None, enable_content_deletion=None, enable_content_deletion_from_folders=None, enable_content_downloading=None, enable_live_tv_access=None, enable_live_tv_management=None, enable_media_conversion=None, enable_media_playback=None, enable_playback_remuxing=None, enable_public_sharing=None, enable_remote_access=None, enable_remote_control_of_other_users=None, enable_shared_device_control=None, enable_sync_transcoding=None, enable_user_preference_access=None, enable_video_playback_transcoding=None, enabled_channels=None, enabled_devices=None, enabled_folders=None, force_remote_source_transcoding=None, invalid_login_attempt_count=None, is_administrator=None, is_disabled=None, is_hidden=None, login_attempts_before_lockout=None, max_active_sessions=None, max_parental_rating=None, password_reset_provider_id=None, remote_client_bitrate_limit=None, sync_play_access=None):  # noqa: E501
        ...
        :param blocked_channels: The blocked_channels of this UserPolicy.  # noqa: E501
        ...
        :param force_remote_source_transcoding: The force_remote_source_transcoding of this UserPolicy.  # noqa: E501
        ...
        :type is_hidden: bool
        :param login_attempts_before_lockout: The login_attempts_before_lockout of this UserPolicy.  # noqa: E501
        :type login_attempts_before_lockout: int
        :param max_active_sessions: The max_active_sessions of this UserPolicy.  # noqa: E501
        ...
        :param password_reset_provider_id: The password_reset_provider_id of this UserPolicy.  # noqa: E501
        ...
        :param sync_play_access: The sync_play_access of this UserPolicy.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'UserPolicy':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The UserPolicy of this UserPolicy.  # noqa: E501
        :rtype: UserPolicy
        """
        return util.deserialize_model(dikt, cls)

    @property
    def access_schedules(self) -> List[AccessSchedule]:
    ...
    def access_schedules(self, access_schedules: List[AccessSchedule]):
    ...
    @property
    def authentication_provider_id(self) -> str:
    ...
    def authentication_provider_id(self, authentication_provider_id: str):
    ...
    @property
    def block_unrated_items(self) -> List[UnratedItem]:
    ...
    def block_unrated_items(self, block_unrated_items: List[UnratedItem]):
    ...
    def blocked_channels(self, blocked_channels: List[str]):
    ...
    @property
    def blocked_media_folders(self) -> List[str]:
    ...
    def blocked_media_folders(self, blocked_media_folders: List[str]):
    ...
    @blocked_tags.setter
    def blocked_tags(self, blocked_tags: List[str]):
    ...
    @property
    def enable_all_channels(self) -> bool:
    ...
    def enable_all_channels(self, enable_all_channels: bool):
    ...
    def enable_all_devices(self, enable_all_devices: bool):
    ...
    @property
    def enable_all_folders(self) -> bool:
    ...
    def enable_all_folders(self, enable_all_folders: bool):
    ...
    @property
    def enable_audio_playback_transcoding(self) -> bool:
    ...
    def enable_audio_playback_transcoding(self, enable_audio_playback_transcoding: bool):
    ...
    @property
    def enable_content_deletion(self) -> bool:
    ...
    def enable_content_deletion(self, enable_content_deletion: bool):
    ...
    @property
    def enable_content_deletion_from_folders(self) -> List[str]:
    ...
    def enable_content_deletion_from_folders(self, enable_content_deletion_from_folders: List[str]):
    ...
    @property
    def enable_content_downloading(self) -> bool:
    ...
    def enable_content_downloading(self, enable_content_downloading: bool):
    ...
    @property
    def enable_live_tv_access(self) -> bool:
    ...
    def enable_live_tv_access(self, enable_live_tv_access: bool):
    ...
    @property
    def enable_live_tv_management(self) -> bool:
    ...
    def enable_live_tv_management(self, enable_live_tv_management: bool):
    ...
    @property
    def enable_media_conversion(self) -> bool:
    ...
    def enable_media_conversion(self, enable_media_conversion: bool):
    ...
    @property
    def enable_media_playback(self) -> bool:
    ...
    def enable_media_playback(self, enable_media_playback: bool):
    ...
    @property
    def enable_playback_remuxing(self) -> bool:
    ...
    def enable_playback_remuxing(self, enable_playback_remuxing: bool):
    ...
    @property
    def enable_public_sharing(self) -> bool:
    ...
    def enable_public_sharing(self, enable_public_sharing: bool):
    ...
    @property
    def enable_remote_control_of_other_users(self) -> bool:
    ...
    def enable_remote_control_of_other_users(self, enable_remote_control_of_other_users: bool):
    ...
    @property
    def enable_shared_device_control(self) -> bool:
    ...
    def enable_shared_device_control(self, enable_shared_device_control: bool):
    ...
    @property
    def enable_sync_transcoding(self) -> bool:
        """Gets the enable_sync_transcoding of this UserPolicy.

        Gets or sets a value indicating whether [enable synchronize].  # noqa: E501
    ...
    def enable_sync_transcoding(self, enable_sync_transcoding: bool):
    ...
    @property
    def enable_user_preference_access(self) -> bool:
    ...
    def enable_user_preference_access(self, enable_user_preference_access: bool):
    ...
    @property
    def enable_video_playback_transcoding(self) -> bool:
    ...
    def enable_video_playback_transcoding(self, enable_video_playback_transcoding: bool):
    ...
    def enabled_channels(self, enabled_channels: List[str]):
    ...
    def enabled_devices(self, enabled_devices: List[str]):
    ...
    def enabled_folders(self, enabled_folders: List[str]):
    ...
    @property
    def force_remote_source_transcoding(self) -> bool:
    ...
    def force_remote_source_transcoding(self, force_remote_source_transcoding: bool):
    ...
    @property
    def invalid_login_attempt_count(self) -> int:
    ...
    def invalid_login_attempt_count(self, invalid_login_attempt_count: int):
    ...
    def is_administrator(self) -> bool:
        ...
        Gets or sets a value indicating whether this instance is administrator.  # noqa: E501
    ...
    def is_disabled(self) -> bool:
        ...
        Gets or sets a value indicating whether this instance is disabled.  # noqa: E501
    ...
    @property
    def login_attempts_before_lockout(self) -> int:
    ...
    def login_attempts_before_lockout(self, login_attempts_before_lockout: int):
    ...
    def max_active_sessions(self, max_active_sessions: int):
    ...
    @property
    def max_parental_rating(self) -> int:
        """Gets the max_parental_rating of this UserPolicy.

        Gets or sets the max parental rating.  # noqa: E501
    ...
    def max_parental_rating(self, max_parental_rating: int):
    ...
    @property
    def password_reset_provider_id(self) -> str:
    ...
    def password_reset_provider_id(self, password_reset_provider_id: str):
    ...
    @property
    def sync_play_access(self) -> SyncPlayUserAccessType:
    ...
    def sync_play_access(self, sync_play_access: SyncPlayUserAccessType):
