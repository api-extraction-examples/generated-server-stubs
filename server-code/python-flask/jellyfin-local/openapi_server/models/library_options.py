...
from openapi_server.models.type_options import TypeOptions  # noqa: E501
...
class LibraryOptions(Model):
    ...
    def __init__(self, automatic_refresh_interval_days=None, disabled_local_metadata_readers=None, disabled_subtitle_fetchers=None, enable_automatic_series_grouping=None, enable_chapter_image_extraction=None, enable_embedded_episode_infos=None, enable_embedded_titles=None, enable_internet_providers=None, enable_photos=None, enable_realtime_monitor=None, extract_chapter_images_during_library_scan=None, local_metadata_reader_order=None, metadata_country_code=None, metadata_savers=None, path_infos=None, preferred_metadata_language=None, require_perfect_subtitle_match=None, save_local_metadata=None, save_subtitles_with_media=None, season_zero_display_name=None, skip_subtitles_if_audio_track_matches=None, skip_subtitles_if_embedded_subtitles_present=None, subtitle_download_languages=None, subtitle_fetcher_order=None, type_options=None):  # noqa: E501
        ...
        :param enable_embedded_episode_infos: The enable_embedded_episode_infos of this LibraryOptions.  # noqa: E501
        ...
        :param enable_internet_providers: The enable_internet_providers of this LibraryOptions.  # noqa: E501
        ...
        :param season_zero_display_name: The season_zero_display_name of this LibraryOptions.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'LibraryOptions':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The LibraryOptions of this LibraryOptions.  # noqa: E501
        :rtype: LibraryOptions
        """
        return util.deserialize_model(dikt, cls)

    @property
    def automatic_refresh_interval_days(self) -> int:
    ...
    def automatic_refresh_interval_days(self, automatic_refresh_interval_days: int):
    ...
    @property
    def disabled_local_metadata_readers(self) -> List[str]:
    ...
    def disabled_local_metadata_readers(self, disabled_local_metadata_readers: List[str]):
    ...
    @property
    def disabled_subtitle_fetchers(self) -> List[str]:
    ...
    def disabled_subtitle_fetchers(self, disabled_subtitle_fetchers: List[str]):
    ...
    @property
    def enable_automatic_series_grouping(self) -> bool:
    ...
    def enable_automatic_series_grouping(self, enable_automatic_series_grouping: bool):
    ...
    @property
    def enable_chapter_image_extraction(self) -> bool:
    ...
    def enable_chapter_image_extraction(self, enable_chapter_image_extraction: bool):
    ...
    @property
    def enable_embedded_episode_infos(self) -> bool:
    ...
    def enable_embedded_episode_infos(self, enable_embedded_episode_infos: bool):
    ...
    @property
    def enable_embedded_titles(self) -> bool:
    ...
    def enable_embedded_titles(self, enable_embedded_titles: bool):
    ...
    @property
    def enable_internet_providers(self) -> bool:
    ...
    def enable_internet_providers(self, enable_internet_providers: bool):
    ...
    def enable_photos(self, enable_photos: bool):
    ...
    @property
    def enable_realtime_monitor(self) -> bool:
    ...
    def enable_realtime_monitor(self, enable_realtime_monitor: bool):
    ...
    @property
    def extract_chapter_images_during_library_scan(self) -> bool:
    ...
    def extract_chapter_images_during_library_scan(self, extract_chapter_images_during_library_scan: bool):
    ...
    @property
    def metadata_savers(self) -> List[str]:
    ...
    def metadata_savers(self, metadata_savers: List[str]):
    ...
    @property
    def path_infos(self) -> List[MediaPathInfo]:
    ...
    @path_infos.setter
    def path_infos(self, path_infos: List[MediaPathInfo]):
    ...
    @property
    def require_perfect_subtitle_match(self) -> bool:
    ...
    def require_perfect_subtitle_match(self, require_perfect_subtitle_match: bool):
    ...
    @property
    def save_local_metadata(self) -> bool:
    ...
    def save_local_metadata(self, save_local_metadata: bool):
    ...
    @property
    def save_subtitles_with_media(self) -> bool:
    ...
    def save_subtitles_with_media(self, save_subtitles_with_media: bool):
    ...
    @property
    def season_zero_display_name(self) -> str:
    ...
    def season_zero_display_name(self, season_zero_display_name: str):
    ...
    @property
    def skip_subtitles_if_audio_track_matches(self) -> bool:
    ...
    def skip_subtitles_if_audio_track_matches(self, skip_subtitles_if_audio_track_matches: bool):
    ...
    @property
    def skip_subtitles_if_embedded_subtitles_present(self) -> bool:
    ...
    def skip_subtitles_if_embedded_subtitles_present(self, skip_subtitles_if_embedded_subtitles_present: bool):
    ...
    @property
    def subtitle_download_languages(self) -> List[str]:
    ...
    def subtitle_download_languages(self, subtitle_download_languages: List[str]):
    ...
    @property
    def subtitle_fetcher_order(self) -> List[str]:
    ...
    def subtitle_fetcher_order(self, subtitle_fetcher_order: List[str]):
    ...
    @property
    def type_options(self) -> List[TypeOptions]:
    ...
    @type_options.setter
    def type_options(self, type_options: List[TypeOptions]):
