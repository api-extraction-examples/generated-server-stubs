...
def get(search_term, start_index=None, limit=None, user_id=None, include_item_types=None, exclude_item_types=None, media_types=None, parent_id=None, is_movie=None, is_series=None, is_news=None, is_kids=None, is_sports=None, include_people=None, include_media=None, include_genres=None, include_studios=None, include_artists=None):  # noqa: E501
    ...
    :rtype: Union[SearchHintResult, Tuple[SearchHintResult, int], Tuple[SearchHintResult, int, Dict[str, str]]
    """
