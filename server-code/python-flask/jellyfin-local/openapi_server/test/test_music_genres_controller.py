...
class TestMusicGenresController(BaseTestCase):
    """MusicGenresController integration test stubs"""
    ...
    def test_get_music_genre(self):
        ...
        response = self.client.open(
            '/MusicGenres/{genre_name}'.format(genre_name='genre_name_example'),
            method='GET',
            headers=headers,
    ...
    def test_get_music_genres(self):
