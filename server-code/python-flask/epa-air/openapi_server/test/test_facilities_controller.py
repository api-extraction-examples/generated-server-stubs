...
class TestFacilitiesController(BaseTestCase):
    ...
    def test_air_rest_services_get_download_get(self):
    ...
    def test_air_rest_services_get_download_post(self):
    ...
    def test_air_rest_services_get_facilities_get(self):
    ...
    @unittest.skip("application/x-www-form-urlencoded not supported by Connexion")
    def test_air_rest_services_get_facilities_post(self):
    ...
    def test_air_rest_services_get_facility_info_get(self):
    ...
    @unittest.skip("application/x-www-form-urlencoded not supported by Connexion")
    def test_air_rest_services_get_facility_info_post(self):
    ...
    def test_air_rest_services_get_geojson_get(self):
    ...
    @unittest.skip("application/x-www-form-urlencoded not supported by Connexion")
    def test_air_rest_services_get_geojson_post(self):
    ...
    def test_air_rest_services_get_info_clusters_get(self):
    ...
    @unittest.skip("application/x-www-form-urlencoded not supported by Connexion")
    def test_air_rest_services_get_info_clusters_post(self):
    ...
    def test_air_rest_services_get_map_get(self):
    ...
    @unittest.skip("application/x-www-form-urlencoded not supported by Connexion")
    def test_air_rest_services_get_map_post(self):
    ...
    def test_air_rest_services_get_qid_get(self):
    ...
    @unittest.skip("application/x-www-form-urlencoded not supported by Connexion")
    def test_air_rest_services_get_qid_post(self):
