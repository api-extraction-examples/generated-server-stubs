...
class Air11(Model):
    ...
    def __init__(self, icon_base_url=None, map_data=None, pop_up_base_url=None, query_id=None):  # noqa: E501
        """Air11 - a model defined in OpenAPI

        :param icon_base_url: The icon_base_url of this Air11.  # noqa: E501
        :type icon_base_url: str
        :param map_data: The map_data of this Air11.  # noqa: E501
        :type map_data: List[Air02]
        :param pop_up_base_url: The pop_up_base_url of this Air11.  # noqa: E501
        :type pop_up_base_url: str
        :param query_id: The query_id of this Air11.  # noqa: E501
        :type query_id: str
        """
        self.openapi_types = {
            'icon_base_url': str,
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'Air11':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The air11 of this Air11.  # noqa: E501
        :rtype: Air11
        """
    ...
    def icon_base_url(self) -> str:
        """Gets the icon_base_url of this Air11.

        URL where all the icons are located  # noqa: E501

        :return: The icon_base_url of this Air11.
        :rtype: str
        """
    ...
    def icon_base_url(self, icon_base_url: str):
        """Sets the icon_base_url of this Air11.

        URL where all the icons are located  # noqa: E501

        :param icon_base_url: The icon_base_url of this Air11.
        :type icon_base_url: str
        """
    ...
    def map_data(self) -> List[Air02]:
        """Gets the map_data of this Air11.

        An array of facility geospatial information.  # noqa: E501

        :return: The map_data of this Air11.
        :rtype: List[Air02]
        """
    ...
    def map_data(self, map_data: List[Air02]):
        """Sets the map_data of this Air11.

        An array of facility geospatial information.  # noqa: E501

        :param map_data: The map_data of this Air11.
        :type map_data: List[Air02]
        """
        if map_data is None:
    ...
    def pop_up_base_url(self) -> str:
        """Gets the pop_up_base_url of this Air11.

        Combine this URL with the PUC to get popup info  # noqa: E501

        :return: The pop_up_base_url of this Air11.
        :rtype: str
        """
    ...
    def pop_up_base_url(self, pop_up_base_url: str):
        """Sets the pop_up_base_url of this Air11.

        Combine this URL with the PUC to get popup info  # noqa: E501

        :param pop_up_base_url: The pop_up_base_url of this Air11.
        :type pop_up_base_url: str
        """
    ...
    def query_id(self) -> str:
        """Gets the query_id of this Air11.

        Sequential number assigned to entire search result  # noqa: E501

        :return: The query_id of this Air11.
        :rtype: str
        """
    ...
    def query_id(self, query_id: str):
        """Sets the query_id of this Air11.

        Sequential number assigned to entire search result  # noqa: E501

        :param query_id: The query_id of this Air11.
        :type query_id: str
        """
        if query_id is None:
