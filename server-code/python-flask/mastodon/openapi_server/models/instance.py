...
class Instance(Model):
    ...
    def __init__(self, approval_required=None, contact_account=None, description=None, email=None, invites_enabled=None, languages=None, registrations=None, short_description=None, stats=None, thumbnail=None, title=None, uri=None, urls=None, version=None):  # noqa: E501
        ...
        :type email: str
        :param invites_enabled: The invites_enabled of this Instance.  # noqa: E501
    ...
    def approval_required(self, approval_required: bool):
    ...
    @property
    def contact_account(self) -> Account:
    ...
    def contact_account(self, contact_account: Account):
    ...
    def invites_enabled(self) -> bool:
        ...
        Whether invites are enabled.  # noqa: E501
    ...
    def invites_enabled(self, invites_enabled: bool):
        ...
        if invites_enabled is None:
            raise ValueError("Invalid value for `invites_enabled`, must not be `None`")  # noqa: E501
    ...
    def languages(self) -> List[str]:
        ...
        Primary languages of the website and its staff. ISO 639 Part 1-5 language codes.  # noqa: E501
    ...
    def registrations(self, registrations: bool):
    ...
    def stats(self) -> object:
        ...
        Statistics about how much information the instance contains.  # noqa: E501
    ...
    @property
    def urls(self) -> object:
        """Gets the urls of this Instance.

        URLs of interest for clients apps.  # noqa: E501
