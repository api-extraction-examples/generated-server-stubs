...
class PricingDetails(Model):
    ...
    def __init__(self, base_charge=None, cancel_penalty_amount=None, cost_minimum=None, cost_per_mile=None, cost_per_minute=None, currency=None, trust_and_service=None):  # noqa: E501
        """PricingDetails - a model defined in OpenAPI

        :param base_charge: The base_charge of this PricingDetails.  # noqa: E501
        :type base_charge: int
        :param cancel_penalty_amount: The cancel_penalty_amount of this PricingDetails.  # noqa: E501
        :type cancel_penalty_amount: int
        :param cost_minimum: The cost_minimum of this PricingDetails.  # noqa: E501
        :type cost_minimum: int
        :param cost_per_mile: The cost_per_mile of this PricingDetails.  # noqa: E501
        :type cost_per_mile: int
        :param cost_per_minute: The cost_per_minute of this PricingDetails.  # noqa: E501
        :type cost_per_minute: int
        :param currency: The currency of this PricingDetails.  # noqa: E501
        :type currency: str
        :param trust_and_service: The trust_and_service of this PricingDetails.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PricingDetails':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The PricingDetails of this PricingDetails.  # noqa: E501
        :rtype: PricingDetails
        """
        return util.deserialize_model(dikt, cls)

    @property
    def base_charge(self) -> int:
        """Gets the base_charge of this PricingDetails.

        The base charge of the trip  # noqa: E501
    ...
    @base_charge.setter
    def base_charge(self, base_charge: int):
    ...
    @property
    def cancel_penalty_amount(self) -> int:
        """Gets the cancel_penalty_amount of this PricingDetails.

        The charge amount if cancel penalty is involved  # noqa: E501
    ...
    def cancel_penalty_amount(self, cancel_penalty_amount: int):
    ...
    @property
    def cost_minimum(self) -> int:
        """Gets the cost_minimum of this PricingDetails.

        The minimum charge for the trip  # noqa: E501
    ...
    @cost_minimum.setter
    def cost_minimum(self, cost_minimum: int):
    ...
    @property
    def cost_per_mile(self) -> int:
        """Gets the cost_per_mile of this PricingDetails.

        The cost per mile  # noqa: E501
    ...
    def cost_per_mile(self, cost_per_mile: int):
    ...
    def cost_per_minute(self, cost_per_minute: int):
    ...
    @property
    def trust_and_service(self) -> int:
        """Gets the trust_and_service of this PricingDetails.

        Service fee  # noqa: E501
    ...
    def trust_and_service(self, trust_and_service: int):
