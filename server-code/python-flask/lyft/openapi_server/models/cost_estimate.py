...
class CostEstimate(Model):
    ...
    def __init__(self, cost_token=None, currency=None, display_name=None, estimated_cost_cents_max=None, estimated_cost_cents_min=None, estimated_distance_miles=None, estimated_duration_seconds=None, is_valid_estimate=None, primetime_confirmation_token=None, primetime_percentage=None, ride_type=None):  # noqa: E501
        """CostEstimate - a model defined in OpenAPI

        :param cost_token: The cost_token of this CostEstimate.  # noqa: E501
        :type cost_token: str
        :param currency: The currency of this CostEstimate.  # noqa: E501
        :type currency: str
        :param display_name: The display_name of this CostEstimate.  # noqa: E501
        :type display_name: str
        :param estimated_cost_cents_max: The estimated_cost_cents_max of this CostEstimate.  # noqa: E501
        :type estimated_cost_cents_max: int
        :param estimated_cost_cents_min: The estimated_cost_cents_min of this CostEstimate.  # noqa: E501
        :type estimated_cost_cents_min: int
        :param estimated_distance_miles: The estimated_distance_miles of this CostEstimate.  # noqa: E501
        :type estimated_distance_miles: float
        :param estimated_duration_seconds: The estimated_duration_seconds of this CostEstimate.  # noqa: E501
        :type estimated_duration_seconds: int
        :param is_valid_estimate: The is_valid_estimate of this CostEstimate.  # noqa: E501
        :type is_valid_estimate: bool
        :param primetime_confirmation_token: The primetime_confirmation_token of this CostEstimate.  # noqa: E501
        :type primetime_confirmation_token: str
        :param primetime_percentage: The primetime_percentage of this CostEstimate.  # noqa: E501
        :type primetime_percentage: str
        :param ride_type: The ride_type of this CostEstimate.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CostEstimate':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CostEstimate of this CostEstimate.  # noqa: E501
        :rtype: CostEstimate
        """
    ...
    def cost_token(self) -> str:
        ...
        A token that confirms the user has accepted current Prime Time and/or fixed price charges. See 'Request a Lyft' for more details  # noqa: E501
    ...
    @property
    def estimated_cost_cents_max(self) -> int:
        """Gets the estimated_cost_cents_max of this CostEstimate.

        Estimated upper bound for trip cost, in minor units (cents). Estimates are not guaranteed, and only provide a reasonable range based on current conditions.   # noqa: E501
    ...
    def estimated_cost_cents_max(self, estimated_cost_cents_max: int):
    ...
    @property
    def estimated_cost_cents_min(self) -> int:
        """Gets the estimated_cost_cents_min of this CostEstimate.

        Estimated lower bound for trip cost, in minor units (cents). Estimates are not guaranteed, and only provide a reasonable range based on current conditions.   # noqa: E501
    ...
    def estimated_cost_cents_min(self, estimated_cost_cents_min: int):
    ...
    def estimated_distance_miles(self) -> float:
        ...
        Estimated distance for this trip   # noqa: E501
    ...
    def estimated_distance_miles(self, estimated_distance_miles: float):
    ...
    def estimated_duration_seconds(self) -> int:
        ...
        Estimated time to get from the start location to the end.   # noqa: E501
    ...
    def estimated_duration_seconds(self, estimated_duration_seconds: int):
    ...
    def is_valid_estimate(self) -> bool:
        ...
        The validity of the cost estimate returned  # noqa: E501
    ...
    def primetime_confirmation_token(self) -> str:
        ...
        This token is needed when requesting rides. (Deprecated)  # noqa: E501
