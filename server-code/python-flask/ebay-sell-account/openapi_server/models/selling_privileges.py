...
from openapi_server.models.selling_limit import SellingLimit  # noqa: E501
...
class SellingPrivileges(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'SellingPrivileges':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The SellingPrivileges of this SellingPrivileges.  # noqa: E501
        :rtype: SellingPrivileges
        """
        return util.deserialize_model(dikt, cls)

    @property
    def seller_registration_completed(self) -> bool:
    ...
    def seller_registration_completed(self, seller_registration_completed: bool):
    ...
    @property
    def selling_limit(self) -> SellingLimit:
    ...
    def selling_limit(self, selling_limit: SellingLimit):
