...
class RegionSet(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'RegionSet':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The RegionSet of this RegionSet.  # noqa: E501
        :rtype: RegionSet
        """
        return util.deserialize_model(dikt, cls)

    @property
    def region_excluded(self) -> List[Region]:
    ...
    def region_excluded(self, region_excluded: List[Region]):
    ...
    @property
    def region_included(self) -> List[Region]:
    ...
    def region_included(self, region_included: List[Region]):
