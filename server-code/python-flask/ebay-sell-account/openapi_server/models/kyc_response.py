...
from openapi_server.models.kyc_check import KycCheck  # noqa: E501
...
class KycResponse(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'KycResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The KycResponse of this KycResponse.  # noqa: E501
        :rtype: KycResponse
        """
        return util.deserialize_model(dikt, cls)

    @property
    def kyc_checks(self) -> List[KycCheck]:
    ...
    @kyc_checks.setter
    def kyc_checks(self, kyc_checks: List[KycCheck]):
