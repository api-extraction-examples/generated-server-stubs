...
class PaymentsProgramResponse(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PaymentsProgramResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The PaymentsProgramResponse of this PaymentsProgramResponse.  # noqa: E501
        :rtype: PaymentsProgramResponse
        """
    ...
    @property
    def payments_program_type(self) -> str:
    ...
    def payments_program_type(self, payments_program_type: str):
    ...
    @property
    def was_previously_opted_in(self) -> bool:
    ...
    def was_previously_opted_in(self, was_previously_opted_in: bool):
