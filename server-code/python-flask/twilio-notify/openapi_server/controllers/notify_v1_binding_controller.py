...
def create_binding(service_sid, address, binding_type, identity, credential_sid=None, endpoint=None, notification_protocol_version=None, tag=None):  # noqa: E501
    """create_binding
    ...
    :rtype: Union[NotifyV1ServiceBinding, Tuple[NotifyV1ServiceBinding, int], Tuple[NotifyV1ServiceBinding, int, Dict[str, str]]
    """
    return 'do some magic!'


def delete_binding(service_sid, sid):  # noqa: E501
    """delete_binding
...
def fetch_binding(service_sid, sid):  # noqa: E501
    """fetch_binding
...
def list_binding(service_sid, start_date=None, end_date=None, identity=None, tag=None, page_size=None, page=None, page_token=None):  # noqa: E501
    """list_binding
    ...
    :rtype: Union[ListBindingResponse, Tuple[ListBindingResponse, int], Tuple[ListBindingResponse, int, Dict[str, str]]
    """
