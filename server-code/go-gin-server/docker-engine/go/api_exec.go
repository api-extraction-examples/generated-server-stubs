...
// Post /v1.33/containers/:id/exec
// Create an exec instance 
func (api *ExecAPI) ContainerExec(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Get /v1.33/exec/:id/json
// Inspect an exec instance 
func (api *ExecAPI) ExecInspect(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Post /v1.33/exec/:id/resize
// Resize an exec instance 
func (api *ExecAPI) ExecResize(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Post /v1.33/exec/:id/start
// Start an exec instance 
func (api *ExecAPI) ExecStart(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
