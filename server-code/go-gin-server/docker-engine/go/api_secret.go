...
// Post /v1.33/secrets/create
// Create a secret 
func (api *SecretAPI) SecretCreate(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Delete /v1.33/secrets/:id
// Delete a secret 
func (api *SecretAPI) SecretDelete(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Get /v1.33/secrets/:id
// Inspect a secret 
func (api *SecretAPI) SecretInspect(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
...
// Get /v1.33/secrets
// List secrets 
func (api *SecretAPI) SecretList(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Post /v1.33/secrets/:id/update
// Update a Secret 
func (api *SecretAPI) SecretUpdate(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
