...
func (api *SystemAPI) SystemAuth(c *gin.Context) {
...
func (api *SystemAPI) SystemDataUsage(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
...
// Get /v1.33/events
// Monitor events 
func (api *SystemAPI) SystemEvents(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
...
func (api *SystemAPI) SystemInfo(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
...
// Get /v1.33/_ping
// Ping 
func (api *SystemAPI) SystemPing(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
...
// Get /v1.33/version
// Get version 
func (api *SystemAPI) SystemVersion(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
