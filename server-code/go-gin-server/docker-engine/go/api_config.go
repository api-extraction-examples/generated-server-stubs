...
// Post /v1.33/configs/create
// Create a config 
func (api *ConfigAPI) ConfigCreate(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Delete /v1.33/configs/:id
// Delete a config 
func (api *ConfigAPI) ConfigDelete(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Get /v1.33/configs/:id
// Inspect a config 
func (api *ConfigAPI) ConfigInspect(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
...
// Get /v1.33/configs
// List configs 
func (api *ConfigAPI) ConfigList(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Post /v1.33/configs/:id/update
// Update a Config 
func (api *ConfigAPI) ConfigUpdate(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
