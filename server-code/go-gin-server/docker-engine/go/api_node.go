...
// Delete /v1.33/nodes/:id
// Delete a node 
func (api *NodeAPI) NodeDelete(c *gin.Context) {
...
// Get /v1.33/nodes/:id
// Inspect a node 
func (api *NodeAPI) NodeInspect(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
...
// Get /v1.33/nodes
// List nodes 
func (api *NodeAPI) NodeList(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Post /v1.33/nodes/:id/update
// Update a node 
func (api *NodeAPI) NodeUpdate(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
