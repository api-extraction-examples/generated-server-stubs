...
// Post /v1.33/volumes/create
// Create a volume 
func (api *VolumeAPI) VolumeCreate(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Delete /v1.33/volumes/:name
// Remove a volume 
func (api *VolumeAPI) VolumeDelete(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Get /v1.33/volumes/:name
// Inspect a volume 
func (api *VolumeAPI) VolumeInspect(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
...
// Get /v1.33/volumes
// List volumes 
func (api *VolumeAPI) VolumeList(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Post /v1.33/volumes/prune
// Delete unused volumes 
func (api *VolumeAPI) VolumePrune(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
