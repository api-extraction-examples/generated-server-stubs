...
// Get /echo/air_rest_services.metadata
// Clean Air Act Metadata Service 
func (api *MetadataAPI) AirRestServicesMetadataGet(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}

// Post /echo/air_rest_services.metadata
// Clean Air Act Metadata Service 
func (api *MetadataAPI) AirRestServicesMetadataPost(c *gin.Context) {
	// Your handler implementation
	c.JSON(200, gin.H{"status": "OK"})
}
