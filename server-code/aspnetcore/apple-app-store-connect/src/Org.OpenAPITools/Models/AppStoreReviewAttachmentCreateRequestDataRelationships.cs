...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AppStoreReviewAttachmentCreateRequestDataRelationships : IEquatable<AppStoreReviewAttachmentCreateRequestDataRelationships>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AppStoreReviewAttachmentCreateRequestDataRelationships)obj);
        }

        /// <summary>
        /// Returns true if AppStoreReviewAttachmentCreateRequestDataRelationships instances are equal
        /// </summary>
        /// <param name="other">Instance of AppStoreReviewAttachmentCreateRequestDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppStoreReviewAttachmentCreateRequestDataRelationships other)
        {
        ...
        public static bool operator ==(AppStoreReviewAttachmentCreateRequestDataRelationships left, AppStoreReviewAttachmentCreateRequestDataRelationships right)
        {
