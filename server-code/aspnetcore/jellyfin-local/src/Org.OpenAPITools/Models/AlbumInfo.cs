...
{ 
    ...
    public partial class AlbumInfo : IEquatable<AlbumInfo>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AlbumInfo)obj);
        }

        /// <summary>
        /// Returns true if AlbumInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of AlbumInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlbumInfo other)
        {
            ...
            return 
                ...
                (
                    ...
                    ArtistProviderIds != null &&
                    other.ArtistProviderIds != null &&
                    ArtistProviderIds.SequenceEqual(other.ArtistProviderIds)
                ) && 
                (
                ...
                (
                    ...
                    SongInfos != null &&
                    other.SongInfos != null &&
                    SongInfos.SequenceEqual(other.SongInfos)
                ) && 
                (
                    Year == other.Year ||
                    Year != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (ArtistProviderIds != null)
                    hashCode = hashCode * 59 + ArtistProviderIds.GetHashCode();
                    if (IndexNumber != null)
                    ...
                    if (SongInfos != null)
                    hashCode = hashCode * 59 + SongInfos.GetHashCode();
                    if (Year != null)
