...
{ 
    ...
    public partial class NotificationTypeInfo : IEquatable<NotificationTypeInfo>
    {
        ...
        /// </summary>
        [DataMember(Name="IsBasedOnUserEvent", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((NotificationTypeInfo)obj);
        }

        /// <summary>
        /// Returns true if NotificationTypeInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of NotificationTypeInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationTypeInfo other)
        {
            ...
            return 
                ...
                (
                    ...
                    IsBasedOnUserEvent.Equals(other.IsBasedOnUserEvent)
                ) && 
                (
                    Name == other.Name ||
                    Name != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + IsBasedOnUserEvent.GetHashCode();
                    if (Name != null)
