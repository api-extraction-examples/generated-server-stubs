...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceOptions : IEquatable<DeviceOptions>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DeviceOptions)obj);
        }

        /// <summary>
        /// Returns true if DeviceOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of DeviceOptions to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (CustomName != null)
                    hashCode = hashCode * 59 + CustomName.GetHashCode();
                return hashCode;
            }
        }
