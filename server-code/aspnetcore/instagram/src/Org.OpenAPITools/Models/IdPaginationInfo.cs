...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class IdPaginationInfo : IEquatable<IdPaginationInfo>
    {
        /// <summary>
        /// The max ID of the next page
        /// </summary>
        /// <value>The max ID of the next page</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((IdPaginationInfo)obj);
        }

        /// <summary>
        /// Returns true if IdPaginationInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of IdPaginationInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdPaginationInfo other)
        {
        ...
        public static bool operator ==(IdPaginationInfo left, IdPaginationInfo right)
        {
