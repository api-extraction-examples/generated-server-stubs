...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CustomPolicyCreateRequest : IEquatable<CustomPolicyCreateRequest>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Specifies the type of custom policy being created. &lt;br/&gt;&lt;br/&gt;Two Custom Policy types are supported: &lt;ul&gt;&lt;li&gt;Product Compliance (PRODUCT_COMPLIANCE)&lt;/li&gt; &lt;li&gt;Takeback (TAKE_BACK)&lt;/li&gt;&lt;/ul&gt; For implementation help, refer to &lt;a href&#x3D;&#39;https://developer.ebay.com/api-docs/sell/account/types/api:CustomPolicyTypeEnum&#39;&gt;eBay API documentation&lt;/a&gt;</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CustomPolicyCreateRequest)obj);
        }

        /// <summary>
        /// Returns true if CustomPolicyCreateRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CustomPolicyCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomPolicyCreateRequest other)
        {
        ...
        public static bool operator ==(CustomPolicyCreateRequest left, CustomPolicyCreateRequest right)
        {
