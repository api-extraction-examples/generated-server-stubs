...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ReturnPolicyResponse : IEquatable<ReturnPolicyResponse>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>A list of all of the seller&#39;s return business policies defined for the specified marketplace. This array will be returned as empty if no return business policies are defined for the specified marketplace.</value>
        ...
        /// </summary>
        /// <value>The total number of return business policies retrieved in the result set.  &lt;br/&gt;&lt;br/&gt;If no return business policies are defined for the specified marketplace, this field is returned with a value of &lt;code&gt;0&lt;/code&gt;.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ReturnPolicyResponse)obj);
        }

        /// <summary>
        /// Returns true if ReturnPolicyResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ReturnPolicyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReturnPolicyResponse other)
        {
            ...
            return 
                ...
                (
                    ReturnPolicies == other.ReturnPolicies ||
                    ReturnPolicies != null &&
                    other.ReturnPolicies != null &&
                    ReturnPolicies.SequenceEqual(other.ReturnPolicies)
                ) && 
                (
                    Total == other.Total ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ReturnPolicies.GetHashCode();
        ...
        public static bool operator ==(ReturnPolicyResponse left, ReturnPolicyResponse right)
        {
