...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FulfillmentPolicy : IEquatable<FulfillmentPolicy>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>A unique eBay-assigned ID for the fulfillment policy. This ID is generated when the policy is created.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FulfillmentPolicy)obj);
        }

        /// <summary>
        /// Returns true if FulfillmentPolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of FulfillmentPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FulfillmentPolicy other)
        {
        ...
        public static bool operator ==(FulfillmentPolicy left, FulfillmentPolicy right)
        {
