...
{ 
    ...
    public partial class CancellationRequest : IEquatable<CancellationRequest>
    {
        ...
        /// </summary>
        /// <value>Token affirming the user accepts the cancellation fee. Required if a cancellation fee is in effect.</value>
        [DataMember(Name="cancel_confirmation_token", EmitDefaultValue=false)]
