...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TaskSpecPluginSpec : IEquatable<TaskSpecPluginSpec>
    {
        /// <summary>
        ...
        public List<PluginPullRequestInner> PluginPrivilege { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TaskSpecPluginSpec)obj);
        }

        /// <summary>
        /// Returns true if TaskSpecPluginSpec instances are equal
        /// </summary>
        /// <param name="other">Instance of TaskSpecPluginSpec to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskSpecPluginSpec other)
        {
            ...
            return 
                ...
                (
                    ...
                    other.PluginPrivilege != null &&
                    PluginPrivilege.SequenceEqual(other.PluginPrivilege)
                ) && 
                (
                    Remote == other.Remote ||
                    Remote != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + PluginPrivilege.GetHashCode();
                    if (Remote != null)
                    hashCode = hashCode * 59 + Remote.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(TaskSpecPluginSpec left, TaskSpecPluginSpec right)
        {
