...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceObject : IEquatable<ResourceObject>
    {
        /// <summary>
        ...
        [DataMember(Name="MemoryBytes", EmitDefaultValue=true)]
        ...
        /// <summary>
        /// Returns true if ResourceObject instances are equal
        /// </summary>
        /// <param name="other">Instance of ResourceObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceObject other)
        {
            ...
            return 
                ...
                (
                    ...
                    MemoryBytes.Equals(other.MemoryBytes)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + MemoryBytes.GetHashCode();
