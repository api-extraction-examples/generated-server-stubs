...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceSpecMode : IEquatable<ServiceSpecMode>
    {
        /// <summary>
        /// Gets or Sets Global
        /// </summary>
        ...
        public ServiceSpecModeReplicated Replicated { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ServiceSpecMode)obj);
        }

        /// <summary>
        /// Returns true if ServiceSpecMode instances are equal
        /// </summary>
        /// <param name="other">Instance of ServiceSpecMode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceSpecMode other)
        {
            ...
            return 
                ...
                (
                    ...
                    Replicated != null &&
                    Replicated.Equals(other.Replicated)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Replicated != null)
                    hashCode = hashCode * 59 + Replicated.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(ServiceSpecMode left, ServiceSpecMode right)
        {
