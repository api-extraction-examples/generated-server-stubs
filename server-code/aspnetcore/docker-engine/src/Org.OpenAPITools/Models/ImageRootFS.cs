...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ImageRootFS : IEquatable<ImageRootFS>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ImageRootFS)obj);
        }

        /// <summary>
        /// Returns true if ImageRootFS instances are equal
        /// </summary>
        /// <param name="other">Instance of ImageRootFS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageRootFS other)
        {
            ...
            return 
                (
                    ...
                    BaseLayer != null &&
                    BaseLayer.Equals(other.BaseLayer)
                ) && 
                (
                    Layers == other.Layers ||
                    Layers != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (BaseLayer != null)
                    hashCode = hashCode * 59 + BaseLayer.GetHashCode();
                    if (Layers != null)
        ...
        public static bool operator ==(ImageRootFS left, ImageRootFS right)
        {
