...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RegistryServiceConfig : IEquatable<RegistryServiceConfig>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>List of IP ranges to which nondistributable artifacts can be pushed, using the CIDR syntax [RFC 4632](https://tools.ietf.org/html/4632).  Some images (for example, Windows base images) contain artifacts whose distribution is restricted by license. When these images are pushed to a registry, restricted artifacts are not included.  This configuration override this behavior, and enables the daemon to push nondistributable artifacts to all registries whose resolved IP address is within the subnet described by the CIDR syntax.  This option is useful when pushing images containing nondistributable artifacts to a registry on an air-gapped network so hosts on that network can pull the images without connecting to another server.  &gt; **Warning**: Nondistributable artifacts typically have restrictions &gt; on how and where they can be distributed and shared. Only use this &gt; feature to push artifacts to private registries and ensure that you &gt; are in compliance with any terms that cover redistributing &gt; nondistributable artifacts. </value>
        ...
        /// </summary>
        /// <value>List of registry hostnames to which nondistributable artifacts can be pushed, using the format &#x60;&lt;hostname&gt;[:&lt;port&gt;]&#x60; or &#x60;&lt;IP address&gt;[:&lt;port&gt;]&#x60;.  Some images (for example, Windows base images) contain artifacts whose distribution is restricted by license. When these images are pushed to a registry, restricted artifacts are not included.  This configuration override this behavior for the specified registries.  This option is useful when pushing images containing nondistributable artifacts to a registry on an air-gapped network so hosts on that network can pull the images without connecting to another server.  &gt; **Warning**: Nondistributable artifacts typically have restrictions &gt; on how and where they can be distributed and shared. Only use this &gt; feature to push artifacts to private registries and ensure that you &gt; are in compliance with any terms that cover redistributing &gt; nondistributable artifacts. </value>
        /// <example>[&quot;registry.internal.corp.example.com:3000&quot;,&quot;[2001:db8:a0b:12f0::1]:443&quot;]</example>
        ...
        /// </summary>
        /// <example>{&quot;127.0.0.1:5000&quot;:{&quot;Mirrors&quot;:[],&quot;Name&quot;:&quot;127.0.0.1:5000&quot;,&quot;Official&quot;:false,&quot;Secure&quot;:false},&quot;[2001:db8:a0b:12f0::1]:80&quot;:{&quot;Mirrors&quot;:[],&quot;Name&quot;:&quot;[2001:db8:a0b:12f0::1]:80&quot;,&quot;Official&quot;:false,&quot;Secure&quot;:false},&quot;docker.io&quot;:{&quot;Mirrors&quot;:[&quot;https://hub-mirror.corp.example.com:5000/&quot;],&quot;Name&quot;:&quot;docker.io&quot;,&quot;Official&quot;:true,&quot;Secure&quot;:true},&quot;registry.internal.corp.example.com:3000&quot;:{&quot;Mirrors&quot;:[],&quot;Name&quot;:&quot;registry.internal.corp.example.com:3000&quot;,&quot;Official&quot;:false,&quot;Secure&quot;:false}}</example>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RegistryServiceConfig)obj);
        }

        /// <summary>
        /// Returns true if RegistryServiceConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of RegistryServiceConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegistryServiceConfig other)
        {
            ...
            return 
                (
                    AllowNondistributableArtifactsCIDRs == other.AllowNondistributableArtifactsCIDRs ||
                    AllowNondistributableArtifactsCIDRs != null &&
                    other.AllowNondistributableArtifactsCIDRs != null &&
                    AllowNondistributableArtifactsCIDRs.SequenceEqual(other.AllowNondistributableArtifactsCIDRs)
                ) && 
                (
                    AllowNondistributableArtifactsHostnames == other.AllowNondistributableArtifactsHostnames ||
                    AllowNondistributableArtifactsHostnames != null &&
                    other.AllowNondistributableArtifactsHostnames != null &&
                    AllowNondistributableArtifactsHostnames.SequenceEqual(other.AllowNondistributableArtifactsHostnames)
                ) && 
                (
                    IndexConfigs == other.IndexConfigs ||
                    IndexConfigs != null &&
                    other.IndexConfigs != null &&
                    IndexConfigs.SequenceEqual(other.IndexConfigs)
                ) && 
                (
                    InsecureRegistryCIDRs == other.InsecureRegistryCIDRs ||
                    InsecureRegistryCIDRs != null &&
                    other.InsecureRegistryCIDRs != null &&
                    InsecureRegistryCIDRs.SequenceEqual(other.InsecureRegistryCIDRs)
                ) && 
                (
        ...
        public static bool operator ==(RegistryServiceConfig left, RegistryServiceConfig right)
        {
