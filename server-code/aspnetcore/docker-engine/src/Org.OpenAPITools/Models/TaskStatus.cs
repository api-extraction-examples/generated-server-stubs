...
{ 
    ...
    public partial class TaskStatus : IEquatable<TaskStatus>
    {
        ...
        public TaskStatusContainerStatus ContainerStatus { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TaskStatus)obj);
        }
        ...
        public bool Equals(TaskStatus other)
        {
            ...
            return 
                (
                    ...
                    ContainerStatus.Equals(other.ContainerStatus)
                ) && 
                (
                    Err == other.Err ||
                    Err != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ContainerStatus.GetHashCode();
                    if (Err != null)
