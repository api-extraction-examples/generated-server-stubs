...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SecretCreateRequest : IEquatable<SecretCreateRequest>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Base64-url-safe-encoded ([RFC 4648](https://tools.ietf.org/html/rfc4648#section-3.2)) data to store as secret.  This field is only used to _create_ a secret, and is not returned by other endpoints. </value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SecretCreateRequest)obj);
        }

        /// <summary>
        /// Returns true if SecretCreateRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of SecretCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecretCreateRequest other)
        {
        ...
        public static bool operator ==(SecretCreateRequest left, SecretCreateRequest right)
        {
