...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class VolumeUsageData : IEquatable<VolumeUsageData>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((VolumeUsageData)obj);
        }

        /// <summary>
        /// Returns true if VolumeUsageData instances are equal
        /// </summary>
        /// <param name="other">Instance of VolumeUsageData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VolumeUsageData other)
        {
            ...
            return 
                (
                    ...
                    RefCount.Equals(other.RefCount)
                ) && 
                (
                    Size == other.Size ||
        ...
        public static bool operator ==(VolumeUsageData left, VolumeUsageData right)
        {
