...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Swarm : IEquatable<Swarm>
    {
        /// <summary>
        ...
        [DataMember(Name="RootRotationInProgress", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Swarm)obj);
        }

        /// <summary>
        /// Returns true if Swarm instances are equal
        /// </summary>
        /// <param name="other">Instance of Swarm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Swarm other)
        {
            ...
            return 
                ...
                (
                    ...
                    RootRotationInProgress.Equals(other.RootRotationInProgress)
                ) && 
                (
                    Spec == other.Spec ||
                    Spec != null &&
                ...
                (
                    ...
                    JoinTokens != null &&
                    JoinTokens.Equals(other.JoinTokens)
                );
        }
        ...
        public static bool operator ==(Swarm left, Swarm right)
        {
