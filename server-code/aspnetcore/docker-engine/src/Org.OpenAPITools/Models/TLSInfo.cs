...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TLSInfo : IEquatable<TLSInfo>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TLSInfo)obj);
        }

        /// <summary>
        /// Returns true if TLSInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of TLSInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TLSInfo other)
        {
            ...
            return 
                (
                    ...
                    CertIssuerPublicKey.Equals(other.CertIssuerPublicKey)
                ) && 
                (
                    CertIssuerSubject == other.CertIssuerSubject ||
                    CertIssuerSubject != null &&
                    CertIssuerSubject.Equals(other.CertIssuerSubject)
                ) && 
                (
                    TrustRoot == other.TrustRoot ||
                    TrustRoot != null &&
                    TrustRoot.Equals(other.TrustRoot)
                );
        }
        ...
        public static bool operator ==(TLSInfo left, TLSInfo right)
        {
