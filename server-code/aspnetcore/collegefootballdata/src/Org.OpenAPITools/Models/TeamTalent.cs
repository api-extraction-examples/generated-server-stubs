...
{ 
    ...
    public partial class TeamTalent : IEquatable<TeamTalent>
    {
        ...
        /// Gets or Sets Talent
        /// </summary>
        [DataMember(Name="talent", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TeamTalent)obj);
        }

        /// <summary>
        /// Returns true if TeamTalent instances are equal
        /// </summary>
        /// <param name="other">Instance of TeamTalent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamTalent other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + Talent.GetHashCode();
        ...
        public static bool operator ==(TeamTalent left, TeamTalent right)
        {
