...
{ 
    ...
    public partial class ConferenceSPRating : IEquatable<ConferenceSPRating>
    {
        ...
        /// </summary>
        [DataMember(Name="secondOrderWins", EmitDefaultValue=true)]
        public decimal SecondOrderWins { get; set; }

        /// <summary>
        /// Gets or Sets Sos
        /// </summary>
        [DataMember(Name="sos", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ConferenceSPRating)obj);
        }

        /// <summary>
        /// Returns true if ConferenceSPRating instances are equal
        /// </summary>
        /// <param name="other">Instance of ConferenceSPRating to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConferenceSPRating other)
        {
            ...
            return 
                ...
                (
                    SecondOrderWins == other.SecondOrderWins ||
                    
                    SecondOrderWins.Equals(other.SecondOrderWins)
                ) && 
                (
                    Sos == other.Sos ||
                    
                    Sos.Equals(other.Sos)
                ) && 
                (
                    SpecialTeams == other.SpecialTeams ||
                    SpecialTeams != null &&
                    SpecialTeams.Equals(other.SpecialTeams)
                ) && 
                (
                    Year == other.Year ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + SecondOrderWins.GetHashCode();
                    
                    hashCode = hashCode * 59 + Sos.GetHashCode();
                    if (SpecialTeams != null)
                    hashCode = hashCode * 59 + SpecialTeams.GetHashCode();
        ...
        public static bool operator ==(ConferenceSPRating left, ConferenceSPRating right)
        {
