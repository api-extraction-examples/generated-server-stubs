        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    {
                        Title = "NBA Stats API",
                        Description = "NBA Stats API (ASP.NET Core 3.1)",
                    ...
                    c.DocumentFilter<BasePathFilter>("/stats");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/version/openapi.json", "NBA Stats API");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "NBA Stats API Original");
                });
            app.UseRouting();
