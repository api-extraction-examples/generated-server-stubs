...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SimulatePolicyResponse : IEquatable<SimulatePolicyResponse>
    {
        /// <summary>
        /// Gets or Sets EvaluationResults
        /// </summary>
        [DataMember(Name="EvaluationResults", EmitDefaultValue=false)]
        public List EvaluationResults { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SimulatePolicyResponse)obj);
        }

        /// <summary>
        /// Returns true if SimulatePolicyResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SimulatePolicyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimulatePolicyResponse other)
        {
            ...
            return 
                (
                    ...
                    EvaluationResults.Equals(other.EvaluationResults)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + EvaluationResults.GetHashCode();
        ...
        public static bool operator ==(SimulatePolicyResponse left, SimulatePolicyResponse right)
        {
