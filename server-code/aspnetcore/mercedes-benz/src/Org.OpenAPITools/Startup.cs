        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    {
                        Title = "Dealer",
                        Description = "Dealer (ASP.NET Core 3.1)",
                    ...
                    c.DocumentFilter<BasePathFilter>("/dealer_tryout/v1");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/1.0/openapi.json", "Dealer");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "Dealer Original");
                });
            app.UseRouting();
