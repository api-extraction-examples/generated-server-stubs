...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentConsent : IEquatable<PaymentConsent>
    {
        /// <summary>
        /// Consent Id
        /// </summary>
        ...
        public SignatureValidationStatus SignatureStatus { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PaymentConsent)obj);
        }

        /// <summary>
        /// Returns true if PaymentConsent instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentConsent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentConsent other)
        {
            ...
            return 
                ...
                (
                    ...
                    SignatureStatus.Equals(other.SignatureStatus)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + SignatureStatus.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(PaymentConsent left, PaymentConsent right)
        {
