...
{ 
    ...
    public partial class Emoji : IEquatable<Emoji>
    {
        ...
        /// </summary>
        /// <value>A link to a static copy of the custom emoji. The format is URL.</value>
        [Required]
        ...
        /// </summary>
        /// <value>A link to the custom emoji. The format is URL.</value>
        [Required]
        ...
        /// </summary>
        /// <value>Whether this Emoji should be visible in the picker or unlisted.</value>
        [Required]
        [DataMember(Name="visible_in_picker", EmitDefaultValue=true)]
