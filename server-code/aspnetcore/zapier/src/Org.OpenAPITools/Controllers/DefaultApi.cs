...
{ 
    ...
    { 
        ...
        /// Check
        /// </summary>
        /// <remarks>Test that the API and auth are working.</remarks>
        /// <response code="200">OK</response>
        [HttpGet]
        [Route("/api/v1/check/")]
        [Authorize(Policy = "AccessPointApiKeyQuery")]
        [Authorize(Policy = "SessionAuth")]
        [Authorize(Policy = "AccessPointApiKeyHeader")]
        [ValidateModelState]
        ...
        /// </summary>
        /// <remarks>Give us a plain english description of exact action you want to do. There should be dynamically generated documentation for this endpoint for each action that is exposed.</remarks>
        /// <param name="exposedAppActionId"></param>
        ...
        [ValidateModelState]
        [SwaggerOperation("ExecuteAppActionEndpoint")]
        [SwaggerResponse(statusCode: 200, type: typeof(ExecuteResponse), description: "OK")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        public virtual IActionResult ExecuteAppActionEndpoint([FromRoute (Name = "exposed_app_action_id")][Required][RegularExpression("^[A-Z0-9]{26}$")]string exposedAppActionId, [FromBody]ExecuteRequest executeRequest)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(ExecuteResponse));
            ...
            ? JsonConvert.DeserializeObject<ExecuteResponse>(exampleJson)
            : default(ExecuteResponse);
        ...
        /// </summary>
        /// <remarks>Provides a link to configure more actions. Alternatively, searching through apps and actions will provide more specific configuration links.</remarks>
        /// <response code="200">OK</response>
        [HttpGet]
        ...
        [Authorize(Policy = "AccessPointApiKeyHeader")]
        [ValidateModelState]
        [SwaggerOperation("GetConfigurationLink")]
        public virtual IActionResult GetConfigurationLink()
        {
        ...
        /// </summary>
        /// <remarks>Get the execution log for a given execution log id.</remarks>
        /// <param name="executionLogId"></param>
        /// <response code="200">OK</response>
        /// <response code="400">Bad Request</response>
        [HttpGet]
        [Route("/api/v1/execution-log/{execution_log_id}/")]
        [Authorize(Policy = "AccessPointApiKeyQuery")]
        [Authorize(Policy = "SessionAuth")]
        [Authorize(Policy = "AccessPointApiKeyHeader")]
        [ValidateModelState]
        [SwaggerOperation("GetExecutionLogEndpoint")]
        [SwaggerResponse(statusCode: 200, type: typeof(ExecuteResponse), description: "OK")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        public virtual IActionResult GetExecutionLogEndpoint([FromRoute (Name = "execution_log_id")][Required][RegularExpression("^[A-Z0-9]{26}$")]string executionLogId)
        {
        ...
        /// </summary>
        /// <remarks>List all the currently exposed actions for the given account.</remarks>
        /// <response code="200">OK</response>
        [HttpGet]
        ...
        [Authorize(Policy = "AccessPointApiKeyHeader")]
        [ValidateModelState]
        [SwaggerOperation("ListExposedActions")]
        [SwaggerResponse(statusCode: 200, type: typeof(ExposedActionResponseSchema), description: "OK")]
        public virtual IActionResult ListExposedActions()
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(ExposedActionResponseSchema));
            string exampleJson = null;
            exampleJson = "{\n  \"configuration_link\" : \"configuration_link\",\n  \"results\" : [ {\n    \"description\" : \"description\",\n    \"operation_id\" : \"operation_id\",\n    \"id\" : \"id\",\n    \"params\" : \"{}\"\n  }, {\n    \"description\" : \"description\",\n    \"operation_id\" : \"operation_id\",\n    \"id\" : \"id\",\n    \"params\" : \"{}\"\n  } ]\n}";
            
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<ExposedActionResponseSchema>(exampleJson)
            : default(ExposedActionResponseSchema);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
    }
