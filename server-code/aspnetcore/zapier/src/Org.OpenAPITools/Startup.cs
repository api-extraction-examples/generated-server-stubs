...
namespace Org.OpenAPITools
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                authConfig.AddPolicy("AccessPointApiKeyHeader", policyBuilder =>
                {
                    policyBuilder
                        .AddRequirements(new ApiKeyRequirement(new[] { "my-secret-key" },"AccessPointApiKeyHeader"));
                });
            });
            services.AddTransient<IAuthorizationHandler, ApiKeyRequirementHandler>();
            services.AddAuthorization(authConfig =>
            {
                authConfig.AddPolicy("AccessPointApiKeyQuery", policyBuilder =>
                {
                    policyBuilder
                        .AddRequirements(new ApiKeyRequirement(new[] { "my-secret-key" },"AccessPointApiKeyQuery"));
                });
            });
            services.AddTransient<IAuthorizationHandler, ApiKeyRequirementHandler>();
            services.AddAuthorization(authConfig =>
            {
                authConfig.AddPolicy("SessionAuth", policyBuilder =>
                {
                    policyBuilder
                        .AddRequirements(new ApiKeyRequirement(new[] { "my-secret-key" },"SessionAuth"));
                });
            });
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    {
                        Title = "Zapier Natural Language Actions (NLA) API - Beta",
                        Description = "Zapier Natural Language Actions (NLA) API - Beta (ASP.NET Core 3.1)",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/1.0.0/openapi.json", "Zapier Natural Language Actions (NLA) API - Beta");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "Zapier Natural Language Actions (NLA) API - Beta Original");
                });
            app.UseRouting();
