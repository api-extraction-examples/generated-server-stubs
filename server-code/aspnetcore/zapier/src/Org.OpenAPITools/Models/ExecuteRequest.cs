...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ExecuteRequest : IEquatable<ExecuteRequest>
    {
        /// <summary>
        /// Plain english instructions. Provide as much detail as possible, even if other fields are present.
        /// </summary>
        /// <value>Plain english instructions. Provide as much detail as possible, even if other fields are present.</value>
        [Required]
        ...
        /// </summary>
        /// <value>If true, we will not execute the action, but will return the params of the preview.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ExecuteRequest)obj);
        }

        /// <summary>
        /// Returns true if ExecuteRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of ExecuteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExecuteRequest other)
        {
            ...
            return 
                ...
                (
                    ...
                    PreviewOnly.Equals(other.PreviewOnly)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + PreviewOnly.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(ExecuteRequest left, ExecuteRequest right)
        {
