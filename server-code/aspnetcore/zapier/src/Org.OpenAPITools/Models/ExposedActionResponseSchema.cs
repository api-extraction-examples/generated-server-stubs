...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ExposedActionResponseSchema : IEquatable<ExposedActionResponseSchema>
    {
        /// <summary>
        /// URL to configure and expose more actions.
        /// </summary>
        /// <value>URL to configure and expose more actions.</value>
        [Required]
        [DataMember(Name="configuration_link", EmitDefaultValue=false)]
        ...
        public List<ExposedActionSchema> Results { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ExposedActionResponseSchema)obj);
        }

        /// <summary>
        /// Returns true if ExposedActionResponseSchema instances are equal
        /// </summary>
        /// <param name="other">Instance of ExposedActionResponseSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExposedActionResponseSchema other)
        {
            ...
            return 
                (
                    ConfigurationLink == other.ConfigurationLink ||
                    ConfigurationLink != null &&
                    ConfigurationLink.Equals(other.ConfigurationLink)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ConfigurationLink.GetHashCode();
                    if (Results != null)
        ...
        public static bool operator ==(ExposedActionResponseSchema left, ExposedActionResponseSchema right)
        {
