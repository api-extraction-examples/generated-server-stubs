...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ExecuteResponse : IEquatable<ExecuteResponse>
    {
        /// <summary>
        /// The name of the action that was executed.
        /// </summary>
        /// <value>The name of the action that was executed.</value>
        [Required]
        [DataMember(Name="action_used", EmitDefaultValue=false)]
        public string ActionUsed { get; set; }

        /// <summary>
        /// The rest of the full results. Always returns an array of objects
        /// </summary>
        /// <value>The rest of the full results. Always returns an array of objects</value>
        [Required]
        [DataMember(Name="additional_results", EmitDefaultValue=false)]
        public List<Object> AdditionalResults { get; set; }

        /// <summary>
        /// A hint for the assistant on what to do next.
        /// </summary>
        /// <value>A hint for the assistant on what to do next.</value>
        [DataMember(Name="assistant_hint", EmitDefaultValue=false)]
        public string AssistantHint { get; set; }

        /// <summary>
        /// The error message if the execution failed.
        /// </summary>
        /// <value>The error message if the execution failed.</value>
        ...
        /// </summary>
        /// <value>The id of the execution log.</value>
        [Required]
        ...
        /// </summary>
        /// <value>The params we used / will use to execute the action.</value>
        [Required]
        ...
        /// </summary>
        /// <value>A trimmed down result of the first item of the full results. Ideal for humans and language models!</value>
        ...
        /// </summary>
        /// <value>Human readable labels for some of the keys in the result.</value>
        [DataMember(Name="result_field_labels", EmitDefaultValue=false)]
        public Object ResultFieldLabels { get; set; }

        /// <summary>
        /// The URL to run the action or review the AI choices the AI made for input_params given instructions.
        /// </summary>
        /// <value>The URL to run the action or review the AI choices the AI made for input_params given instructions.</value>
        [Required]
        ...
        /// </summary>
        /// <value>The status of the execution.</value>
        ...
        public StatusEnum Status { get; set; } = StatusEnum.SuccessEnum;
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ActionUsed: ").Append(ActionUsed).Append("\n");
            sb.Append("  AdditionalResults: ").Append(AdditionalResults).Append("\n");
            sb.Append("  AssistantHint: ").Append(AssistantHint).Append("\n");
            sb.Append("  Error: ").Append(Error).Append("\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  InputParams: ").Append(InputParams).Append("\n");
            sb.Append("  Result: ").Append(Result).Append("\n");
            sb.Append("  ResultFieldLabels: ").Append(ResultFieldLabels).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ExecuteResponse)obj);
        }

        /// <summary>
        /// Returns true if ExecuteResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ExecuteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExecuteResponse other)
        {
            ...
            return 
                (
                    ActionUsed == other.ActionUsed ||
                    ActionUsed != null &&
                    ActionUsed.Equals(other.ActionUsed)
                ) && 
                (
                    AdditionalResults == other.AdditionalResults ||
                    AdditionalResults != null &&
                    other.AdditionalResults != null &&
                    AdditionalResults.SequenceEqual(other.AdditionalResults)
                ) && 
                (
                    AssistantHint == other.AssistantHint ||
                    AssistantHint != null &&
                    AssistantHint.Equals(other.AssistantHint)
                ) && 
                (
                    Error == other.Error ||
                    Error != null &&
                ...
                (
                    ResultFieldLabels == other.ResultFieldLabels ||
                    ResultFieldLabels != null &&
                    ResultFieldLabels.Equals(other.ResultFieldLabels)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (ActionUsed != null)
                    hashCode = hashCode * 59 + ActionUsed.GetHashCode();
                    if (AdditionalResults != null)
                    hashCode = hashCode * 59 + AdditionalResults.GetHashCode();
                    if (AssistantHint != null)
                    hashCode = hashCode * 59 + AssistantHint.GetHashCode();
                    if (Error != null)
                    hashCode = hashCode * 59 + Error.GetHashCode();
                    if (Id != null)
                    hashCode = hashCode * 59 + Id.GetHashCode();
                    if (InputParams != null)
                    hashCode = hashCode * 59 + InputParams.GetHashCode();
                    if (Result != null)
                    hashCode = hashCode * 59 + Result.GetHashCode();
                    if (ResultFieldLabels != null)
                    hashCode = hashCode * 59 + ResultFieldLabels.GetHashCode();
                    if (ReviewUrl != null)
        ...
        public static bool operator ==(ExecuteResponse left, ExecuteResponse right)
        {
