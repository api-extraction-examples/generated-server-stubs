...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <param name="checkPostRequest"></param>
        ...
        public virtual IActionResult CheckPost([FromBody]CheckPostRequest checkPostRequest)
        {
        ...
        /// </summary>
        /// <param name="resetPostRequest"></param>
        /// <response code="200">Success</response>
        /// <response code="400">Bad Request</response>
        [HttpPost]
        [Route("/reset/")]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("ResetPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(CheckPost200Response), description: "Success")]
        [SwaggerResponse(statusCode: 400, type: typeof(CheckPost400Response), description: "Bad Request")]
        public virtual IActionResult ResetPost([FromBody]ResetPostRequest resetPostRequest)
        {
        ...
        /// </summary>
        /// <param name="setpasswordPostRequest"></param>
        /// <response code="200">Success</response>
        /// <response code="400">Bad Request</response>
        [HttpPost]
        [Route("/setpassword/")]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("SetpasswordPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(CheckPost200Response), description: "Success")]
        [SwaggerResponse(statusCode: 400, type: typeof(CheckPost400Response), description: "Bad Request")]
        public virtual IActionResult SetpasswordPost([FromBody]SetpasswordPostRequest setpasswordPostRequest)
        {
