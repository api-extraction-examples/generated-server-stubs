...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <remarks>Our password policy requires a minimum password length of 10 chars with at least one symbol or number. </remarks>
        /// <param name="profileChangePasswordPostRequest"></param>
        ...
        [ValidateModelState]
        [SwaggerOperation("ProfileChangePasswordPost")]
        ...
        public virtual IActionResult ProfileChangePasswordPost([FromBody]ProfileChangePasswordPostRequest profileChangePasswordPostRequest)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(User), description: "User object")]
        public virtual IActionResult ProfileGet([FromQuery (Name = "page")]int? page, [FromQuery (Name = "length")]int? length, [FromQuery (Name = "ordering")]string ordering, [FromQuery (Name = "search")]string search)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(UsersGet200Response), description: "User list")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        public virtual IActionResult UsersGet([FromQuery (Name = "page")]int? page, [FromQuery (Name = "length")]int? length, [FromQuery (Name = "ordering")]string ordering, [FromQuery (Name = "search")]string search)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(UsersGet200Response));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(AccountGet401Response));
            string exampleJson = null;
            exampleJson = "{\n  \"page_total\" : 1,\n  \"count\" : 6,\n  \"length\" : 10,\n  \"page\" : 1,\n  \"results\" : [ {\n    \"is_admin\" : true,\n    \"is_billing_admin\" : true,\n    \"is_active\" : true,\n    \"changed_by\" : {\n      \"name\" : \"Henrique Cimento\",\n      \"id\" : \"jMXUw-BE_2vd\",\n      \"email\" : \"example@probely.com\"\n    },\n    \"name\" : \"Henrique Cimento\",\n    \"id\" : \"jMXUw-BE_2vd\",\n    \"email\" : \"example@probely.com\",\n    \"changed\" : \"2018-01-31T16:32:17.238553Z\"\n  }, {\n    \"is_admin\" : true,\n    \"is_billing_admin\" : true,\n    \"is_active\" : true,\n    \"changed_by\" : {\n      \"name\" : \"Henrique Cimento\",\n      \"id\" : \"jMXUw-BE_2vd\",\n      \"email\" : \"example@probely.com\"\n    },\n    \"name\" : \"Henrique Cimento\",\n    \"id\" : \"jMXUw-BE_2vd\",\n    \"email\" : \"example@probely.com\",\n    \"changed\" : \"2018-01-31T16:32:17.238553Z\"\n  } ]\n}";
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<UsersGet200Response>(exampleJson)
            : default(UsersGet200Response);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("UsersIdPatch")]
        [SwaggerResponse(statusCode: 200, type: typeof(User), description: "User object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult UsersIdPatch([FromRoute (Name = "id")][Required]string id, [FromBody]UsersPostRequest usersPostRequest)
        {
        ...
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult UsersIdPut([FromRoute (Name = "id")][Required]string id, [FromBody]UsersPostRequest usersPostRequest)
        {
        ...
        /// </summary>
        /// <param name="usersPostRequest"></param>
        /// <response code="201">User object</response>
        [HttpPost]
        [Route("/users/")]
        [Authorize]
        [Consumes("application/json")]
        ...
        [SwaggerResponse(statusCode: 201, type: typeof(User), description: "User object")]
        public virtual IActionResult UsersPost([FromBody]UsersPostRequest usersPostRequest)
        {
