...
{ 
    ...
    /// </summary>
    [ApiController]
    public class SlackIntegrationApiController : ControllerBase
    { 
        /// <summary>
        /// Retrieve slack integration data
        /// </summary>
        /// <param name="targetId">Target id</param>
        /// <response code="200">Slack integration</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="403">Not allowed to perform operation</response>
        [HttpGet]
        [Route("/targets/{target_id}/integrations/slack/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdIntegrationsSlackGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Slack), description: "Slack integration")]
        ...
        public virtual IActionResult TargetsTargetIdIntegrationsSlackGet([FromRoute (Name = "target_id")][Required]string targetId)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Slack));
            ...
            ? JsonConvert.DeserializeObject<Slack>(exampleJson)
            : default(Slack);
        ...
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdIntegrationsSlackPatch")]
        [SwaggerResponse(statusCode: 200, type: typeof(Slack), description: "Slack integration")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdIntegrationsSlackPatch([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]Slack slack)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdIntegrationsSlackPut")]
        [SwaggerResponse(statusCode: 200, type: typeof(Slack), description: "Slack integration")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdIntegrationsSlackPut([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]Slack slack)
        {
