...
{ 
    ...
    /// </summary>
    [ApiController]
    public class APIKeysApiController : ControllerBase
    { 
        /// <summary>
        ...
        /// <response code="200">API Key list</response>
        ...
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("KeysGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(KeysGet200Response), description: "API Key list")]
        ...
        public virtual IActionResult KeysGet([FromQuery (Name = "page")]int? page, [FromQuery (Name = "length")]int? length, [FromQuery (Name = "ordering")]string ordering, [FromQuery (Name = "search")]string search)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(KeysGet200Response));
            ...
            ? JsonConvert.DeserializeObject<KeysGet200Response>(exampleJson)
            : default(KeysGet200Response);
        ...
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("KeysIdDelete")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        public virtual IActionResult KeysIdDelete([FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// </summary>
        /// <param name="id">Object Id</param>
        /// <response code="200">API Key object</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="403">Not allowed to perform operation</response>
        [HttpGet]
        [Route("/keys/{id}/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("KeysIdGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(APIKey), description: "API Key object")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        public virtual IActionResult KeysIdGet([FromRoute (Name = "id")][Required]string id)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(APIKey));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(AccountGet401Response));
            //TODO: Uncomment the next line to return response 403 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(403, default(BillingPut403Response));
        ...
        /// <response code="201">API Key object</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="403">Not allowed to perform operation</response>
        [HttpPost]
        [Route("/keys/")]
        ...
        [ValidateModelState]
        [SwaggerOperation("KeysPost")]
        [SwaggerResponse(statusCode: 201, type: typeof(APIKey), description: "API Key object")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        public virtual IActionResult KeysPost([FromBody]APIKey aPIKey)
        {

            //TODO: Uncomment the next line to return response 201 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(201, default(APIKey));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(AccountGet401Response));
            //TODO: Uncomment the next line to return response 403 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(403, default(BillingPut403Response));
        ...
        [HttpGet]
        [Route("/targets/{target_id}/keys/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdKeysGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(KeysGet200Response), description: "API Key list")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdKeysGet([FromRoute (Name = "target_id")][Required]string targetId, [FromQuery (Name = "page")]int? page, [FromQuery (Name = "length")]int? length, [FromQuery (Name = "ordering")]string ordering, [FromQuery (Name = "search")]string search)
        {
        ...
        /// <response code="404">Not found</response>
        [HttpDelete]
        [Route("/targets/{target_id}/keys/{id}/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdKeysIdDelete")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdKeysIdDelete([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdKeysIdGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(APIKey), description: "API Key object")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdKeysIdGet([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdKeysPost")]
        [SwaggerResponse(statusCode: 201, type: typeof(APIKey), description: "API Key object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdKeysPost([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]APIKey aPIKey)
        {
