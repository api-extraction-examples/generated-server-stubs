...
{ 
    ...
    /// </summary>
    [ApiController]
    public class JiraCloudIntegrationApiController : ControllerBase
    { 
        /// <summary>
        /// List Jira Projects
        /// </summary>
        ...
        [HttpGet]
        [Route("/integrations/jira-cloud/projects/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("IntegrationsJiraCloudProjectsGet")]
        ...
        public virtual IActionResult IntegrationsJiraCloudProjectsGet()
        {
        ...
        [HttpGet]
        [Route("/integrations/jira-cloud/projects/{project_id}/issue_types/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("IntegrationsJiraCloudProjectsProjectIdIssueTypesGet")]
        ...
        public virtual IActionResult IntegrationsJiraCloudProjectsProjectIdIssueTypesGet([FromRoute (Name = "project_id")][Required]string projectId)
        {
        ...
        /// <response code="403">Not allowed to perform operation</response>
        [HttpGet]
        [Route("/integrations/jira-cloud/projects/{project_id}/issue_types/{issue_type_id}/priorities/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<JiraIssuePriority>), description: "Jira issue priorities")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        public virtual IActionResult IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdPrioritiesGet([FromRoute (Name = "project_id")][Required]string projectId, [FromRoute (Name = "issue_type_id")][Required]string issueTypeId)
        {
        ...
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/integrations/jira-cloud/projects/{project_id}/issue_types/{issue_type_id}/status/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdStatusGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<JiraIssueStatus>), description: "Jira issue statuses")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult IntegrationsJiraCloudProjectsProjectIdIssueTypesIssueTypeIdStatusGet([FromRoute (Name = "project_id")][Required]string projectId, [FromRoute (Name = "issue_type_id")][Required]string issueTypeId)
        {
        ...
        /// <response code="200">Jira Cloud Finding configuration</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="403">Not allowed to perform operation</response>
        [HttpGet]
        [Route("/targets/{target_id}/findings/{id}/integrations/jira-cloud/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdFindingsIdIntegrationsJiraCloudGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(JiraFinding), description: "Jira Cloud Finding configuration")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        public virtual IActionResult TargetsTargetIdFindingsIdIntegrationsJiraCloudGet([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdFindingsIdIntegrationsJiraCloudPatch")]
        [SwaggerResponse(statusCode: 200, type: typeof(JiraFinding), description: "Jira Cloud Finding configuration")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdFindingsIdIntegrationsJiraCloudPatch([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id, [FromBody]JiraFinding jiraFinding)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdFindingsIdIntegrationsJiraCloudPut")]
        [SwaggerResponse(statusCode: 200, type: typeof(JiraFinding), description: "Jira Cloud Finding configuration")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdFindingsIdIntegrationsJiraCloudPut([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id, [FromBody]JiraFinding jiraFinding)
        {
        ...
        /// </summary>
        /// <param name="targetId">Target id</param>
        /// <response code="200">Jira Cloud Target configuration</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="403">Not allowed to perform operation</response>
        [HttpGet]
        [Route("/targets/{target_id}/integrations/jira-cloud/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdIntegrationsJiraCloudGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(JiraScope), description: "Jira Cloud Target configuration")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        public virtual IActionResult TargetsTargetIdIntegrationsJiraCloudGet([FromRoute (Name = "target_id")][Required]string targetId)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdIntegrationsJiraCloudPatch")]
        [SwaggerResponse(statusCode: 200, type: typeof(JiraScope), description: "Jira Cloud Target configuration")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdIntegrationsJiraCloudPatch([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]JiraScope jiraScope)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdIntegrationsJiraCloudPut")]
        [SwaggerResponse(statusCode: 200, type: typeof(JiraScope), description: "Jira Cloud Target configuration")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdIntegrationsJiraCloudPut([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]JiraScope jiraScope)
        {
