...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <response code="200">Average fix time plot data</response>
        [HttpGet]
        [Route("/targets/all/average_fix_time/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsAllAverageFixTimeGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsAllAverageFixTimeGet200Response), description: "Average fix time plot data")]
        public virtual IActionResult TargetsAllAverageFixTimeGet()
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(TargetsAllAverageFixTimeGet200Response));
            string exampleJson = null;
            exampleJson = "{\n  \"results\" : {\n    \"high\" : 2,\n    \"low\" : 3,\n    \"medium\" : 5\n  }\n}";
            
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<TargetsAllAverageFixTimeGet200Response>(exampleJson)
            : default(TargetsAllAverageFixTimeGet200Response);
        ...
        [HttpGet]
        [Route("/targets/all/needs_attention_pie/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsAllNeedsAttentionPieGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsAllNeedsAttentionPieGet200Response), description: "Success")]
        public virtual IActionResult TargetsAllNeedsAttentionPieGet()
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(TargetsAllNeedsAttentionPieGet200Response));
            string exampleJson = null;
            exampleJson = "{\n  \"0\" : {\n    \"0\" : \"needing attention\",\n    \"1\" : 0,\n    \"2\" : \"needs_atention\"\n  },\n  \"1\" : {\n    \"0\" : \"no issues found\",\n    \"1\" : 6,\n    \"2\" : \"no_issues_found\"\n  }\n}";
            
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<TargetsAllNeedsAttentionPieGet200Response>(exampleJson)
            : default(TargetsAllNeedsAttentionPieGet200Response);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// <response code="200">Success</response>
        [HttpGet]
        [Route("/targets/all/needs_attention_top/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsAllNeedsAttentionTopGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<TargetsAllNeedsAttentionTopGet200ResponseInner>), description: "Success")]
        public virtual IActionResult TargetsAllNeedsAttentionTopGet()
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(List<TargetsAllNeedsAttentionTopGet200ResponseInner>));
            string exampleJson = null;
            exampleJson = "[ {\n  \"name\" : \"Probely\",\n  \"highs\" : 3,\n  \"id\" : \"QJxMvgPebu0e\",\n  \"lows\" : 4,\n  \"mediums\" : 8,\n  \"url\" : \"https://probely.com\"\n}, {\n  \"name\" : \"Probely\",\n  \"highs\" : 3,\n  \"id\" : \"QJxMvgPebu0e\",\n  \"lows\" : 4,\n  \"mediums\" : 8,\n  \"url\" : \"https://probely.com\"\n} ]";
            
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<List<TargetsAllNeedsAttentionTopGet200ResponseInner>>(exampleJson)
            : default(List<TargetsAllNeedsAttentionTopGet200ResponseInner>);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// </summary>
        /// <response code="200">Risk trend plot data</response>
        [HttpGet]
        [Route("/targets/all/risk_trend/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsAllRiskTrendGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<TargetsAllRiskTrendGet200ResponseInner>), description: "Risk trend plot data")]
        public virtual IActionResult TargetsAllRiskTrendGet()
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(List<TargetsAllRiskTrendGet200ResponseInner>));
            string exampleJson = null;
            exampleJson = "[ {\n  \"0\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"1\" : 0\n}, {\n  \"0\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"1\" : 0\n} ]";
            
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<List<TargetsAllRiskTrendGet200ResponseInner>>(exampleJson)
            : default(List<TargetsAllRiskTrendGet200ResponseInner>);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// </summary>
        /// <response code="200">Severity trend plot data</response>
        [HttpGet]
        [Route("/targets/all/severity_trend/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsAllSeverityTrendGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsAllSeverityTrendGet200Response), description: "Severity trend plot data")]
        public virtual IActionResult TargetsAllSeverityTrendGet()
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(TargetsAllSeverityTrendGet200Response));
            string exampleJson = null;
            exampleJson = "{\n  \"step\" : 86400,\n  \"results\" : {\n    \"high\" : [ {\n      \"0\" : \"2000-01-23T04:56:07.000+00:00\",\n      \"1\" : 0\n    }, {\n      \"0\" : \"2000-01-23T04:56:07.000+00:00\",\n      \"1\" : 0\n    } ],\n    \"low\" : [ {\n      \"0\" : \"2000-01-23T04:56:07.000+00:00\",\n      \"1\" : 0\n    }, {\n      \"0\" : \"2000-01-23T04:56:07.000+00:00\",\n      \"1\" : 0\n    } ],\n    \"medium\" : [ {\n      \"0\" : \"2000-01-23T04:56:07.000+00:00\",\n      \"1\" : 0\n    }, {\n      \"0\" : \"2000-01-23T04:56:07.000+00:00\",\n      \"1\" : 0\n    } ]\n  }\n}";
            
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<TargetsAllSeverityTrendGet200Response>(exampleJson)
            : default(TargetsAllSeverityTrendGet200Response);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// </summary>
        /// <response code="200">Top vulnerabilities plot data</response>
        [HttpGet]
        [Route("/targets/all/top_vulns/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsAllTopVulnsGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<TargetsAllTopVulnsGet200ResponseInner>), description: "Top vulnerabilities plot data")]
        public virtual IActionResult TargetsAllTopVulnsGet()
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(List<TargetsAllTopVulnsGet200ResponseInner>));
            string exampleJson = null;
            exampleJson = "[ {\n  \"0\" : \"0\",\n  \"1\" : \"1\"\n}, {\n  \"0\" : \"0\",\n  \"1\" : \"1\"\n} ]";
            
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<List<TargetsAllTopVulnsGet200ResponseInner>>(exampleJson)
            : default(List<TargetsAllTopVulnsGet200ResponseInner>);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// <response code="200">Average fix time plot data</response>
        [HttpGet]
        [Route("/targets/{target_id}/average_fix_time/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdAverageFixTimeGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsAllAverageFixTimeGet200Response), description: "Average fix time plot data")]
        public virtual IActionResult TargetsTargetIdAverageFixTimeGet([FromRoute (Name = "target_id")][Required]string targetId)
        {
        ...
        /// <response code="200">Risk trend plot data</response>
        [HttpGet]
        [Route("/targets/{target_id}/risk_trend/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdRiskTrendGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<TargetsAllRiskTrendGet200ResponseInner>), description: "Risk trend plot data")]
        public virtual IActionResult TargetsTargetIdRiskTrendGet([FromRoute (Name = "target_id")][Required]string targetId)
        {
        ...
        /// <response code="200">Severity trend plot data</response>
        [HttpGet]
        [Route("/targets/{target_id}/severity_trend/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdSeverityTrendGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsAllSeverityTrendGet200Response), description: "Severity trend plot data")]
        public virtual IActionResult TargetsTargetIdSeverityTrendGet([FromRoute (Name = "target_id")][Required]string targetId)
        {
        ...
        /// <response code="200">Top vulnerabilities plot data</response>
        [HttpGet]
        [Route("/targets/{target_id}/top_vulns/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdTopVulnsGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<TargetsAllTopVulnsGet200ResponseInner>), description: "Top vulnerabilities plot data")]
        public virtual IActionResult TargetsTargetIdTopVulnsGet([FromRoute (Name = "target_id")][Required]string targetId)
        {
