...
{ 
    ...
    /// </summary>
    [ApiController]
    public class ScheduledApiController : ControllerBase
    { 
        /// <summary>
        /// List scheduled scans for all targets expanding recurrence
        /// </summary>
        /// <param name="length">Number of results to return per page</param>
        /// <response code="200">Next scheduled scans</response>
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/all/scheduledscans/expanded/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsAllScheduledscansExpandedGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsAllScheduledscansExpandedGet200Response), description: "Next scheduled scans")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsAllScheduledscansExpandedGet([FromQuery (Name = "length")]int? length)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(TargetsAllScheduledscansExpandedGet200Response));
            ...
            ? JsonConvert.DeserializeObject<TargetsAllScheduledscansExpandedGet200Response>(exampleJson)
            : default(TargetsAllScheduledscansExpandedGet200Response);
        ...
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scheduledscans/expanded/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScheduledscansExpandedGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsAllScheduledscansExpandedGet200Response), description: "Next scheduled scans")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScheduledscansExpandedGet([FromRoute (Name = "target_id")][Required]string targetId, [FromQuery (Name = "length")]int? length)
        {
        ...
        /// <response code="200">Scheduled scan list</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scheduledscans/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScheduledscansGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsTargetIdScheduledscansGet200Response), description: "Scheduled scan list")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScheduledscansGet([FromRoute (Name = "target_id")][Required]string targetId, [FromQuery (Name = "page")]int? page, [FromQuery (Name = "length")]int? length, [FromQuery (Name = "ordering")]string ordering, [FromQuery (Name = "search")]string search)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(TargetsTargetIdScheduledscansGet200Response));
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<TargetsTargetIdScheduledscansGet200Response>(exampleJson)
            : default(TargetsTargetIdScheduledscansGet200Response);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        [HttpDelete]
        [Route("/targets/{target_id}/scheduledscans/{id}/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScheduledscansIdDelete")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        public virtual IActionResult TargetsTargetIdScheduledscansIdDelete([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// <param name="targetId">Target id</param>
        /// <param name="id">Object Id</param>
        /// <response code="200">Scheduled scan object</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scheduledscans/{id}/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScheduledscansIdGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Scheduled), description: "Scheduled scan object")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScheduledscansIdGet([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Scheduled));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(AccountGet401Response));
            //TODO: Uncomment the next line to return response 404 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(404, default(EventsIdGet404Response));
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<Scheduled>(exampleJson)
            : default(Scheduled);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// <param name="targetId">Target id</param>
        /// <param name="id">Object Id</param>
        /// <param name="targetsTargetIdScheduledscansPostRequest"></param>
        /// <response code="200">Scheduled scan object</response>
        ...
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScheduledscansIdPatch")]
        [SwaggerResponse(statusCode: 200, type: typeof(Scheduled), description: "Scheduled scan object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScheduledscansIdPatch([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id, [FromBody]TargetsTargetIdScheduledscansPostRequest targetsTargetIdScheduledscansPostRequest)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScheduledscansIdPut")]
        [SwaggerResponse(statusCode: 200, type: typeof(Scheduled), description: "Scheduled scan object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScheduledscansIdPut([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id, [FromBody]TargetsTargetIdScheduledscansPostRequest targetsTargetIdScheduledscansPostRequest)
        {
        ...
        /// <param name="targetId">Target id</param>
        /// <param name="targetsTargetIdScheduledscansPostRequest"></param>
        /// <response code="201">Scheduled scan object</response>
        /// <response code="400">Bad Request</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="403">Not allowed to perform operation</response>
        /// <response code="404">Not found</response>
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScheduledscansPost")]
        [SwaggerResponse(statusCode: 201, type: typeof(Scheduled), description: "Scheduled scan object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScheduledscansPost([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]TargetsTargetIdScheduledscansPostRequest targetsTargetIdScheduledscansPostRequest)
        {

            //TODO: Uncomment the next line to return response 201 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(201, default(Scheduled));
            //TODO: Uncomment the next line to return response 400 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(400, default(AuthObtainPost400Response));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(AccountGet401Response));
