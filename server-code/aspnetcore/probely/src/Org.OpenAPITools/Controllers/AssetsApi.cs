...
{ 
    ...
    { 
        ...
        /// <response code="200">Asset list</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/assets/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdAssetsGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsTargetIdAssetsGet200Response), description: "Asset list")]
        ...
        public virtual IActionResult TargetsTargetIdAssetsGet([FromRoute (Name = "target_id")][Required]string targetId, [FromQuery (Name = "page")]int? page, [FromQuery (Name = "length")]int? length, [FromQuery (Name = "ordering")]string ordering, [FromQuery (Name = "search")]string search)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(TargetsTargetIdAssetsGet200Response));
            ...
            ? JsonConvert.DeserializeObject<TargetsTargetIdAssetsGet200Response>(exampleJson)
            : default(TargetsTargetIdAssetsGet200Response);
        ...
        /// <response code="404">Not found</response>
        [HttpDelete]
        [Route("/targets/{target_id}/assets/{id}/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdAssetsIdDelete")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdAssetsIdDelete([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// <param name="targetId">Target id</param>
        /// <param name="id">Object Id</param>
        /// <response code="200">Asset object</response>
        ...
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdAssetsIdGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Asset), description: "Asset object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdAssetsIdGet([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdAssetsIdPatch")]
        [SwaggerResponse(statusCode: 200, type: typeof(Asset), description: "Asset object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdAssetsIdPatch([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id, [FromBody]Asset asset)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdAssetsIdPut")]
        [SwaggerResponse(statusCode: 200, type: typeof(Asset), description: "Asset object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdAssetsIdPut([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id, [FromBody]Asset asset)
        {
        ...
        /// <param name="targetId">Target id</param>
        /// <param name="id">Object Id</param>
        /// <param name="targetsTargetIdAssetsIdVerifyPostRequest"></param>
        ...
        /// <response code="404">Not found</response>
        [HttpPost]
        [Route("/targets/{target_id}/assets/{id}/verify/")]
        [Authorize]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdAssetsIdVerifyPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(CheckPost200Response), description: "Success")]
        [SwaggerResponse(statusCode: 400, type: typeof(CheckPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdAssetsIdVerifyPost([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id, [FromBody]TargetsTargetIdAssetsIdVerifyPostRequest targetsTargetIdAssetsIdVerifyPostRequest)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(CheckPost200Response));
            //TODO: Uncomment the next line to return response 400 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<CheckPost200Response>(exampleJson)
            : default(CheckPost200Response);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// <param name="targetId">Target id</param>
        /// <param name="asset"></param>
        /// <response code="201">Asset object</response>
        /// <response code="400">Bad Request</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="403">Not allowed to perform operation</response>
        /// <response code="404">Not found</response>
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdAssetsPost")]
        [SwaggerResponse(statusCode: 201, type: typeof(Asset), description: "Asset object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdAssetsPost([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]Asset asset)
        {
