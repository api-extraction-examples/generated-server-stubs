...
{ 
    ...
    { 
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(Account), description: "Account data")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        public virtual IActionResult AccountGet()
        {
        ...
        /// <response code="200">Required action to enable targets</response>
        [HttpPost]
        [Route("/billing/actions/")]
        [Authorize]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("BillingActionsPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(Action), description: "Required action to enable targets")]
        public virtual IActionResult BillingActionsPost([FromBody]List<string> requestBody)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Action));
            string exampleJson = null;
            exampleJson = "{ }";
            
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<Action>(exampleJson)
            : default(Action);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("BillingEstimatePost")]
        [SwaggerResponse(statusCode: 200, type: typeof(Invoice), description: "Charges")]
        ...
        public virtual IActionResult BillingEstimatePost([FromBody]Subscription subscription)
        {
        ...
        /// </summary>
        /// <response code="200">Billing information</response>
        [HttpGet]
        [Route("/billing/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("BillingGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Billing), description: "Billing information")]
        public virtual IActionResult BillingGet()
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Billing));
            string exampleJson = null;
            exampleJson = "{\n  \"zip\" : \"zip\",\n  \"country\" : \"DE\",\n  \"other\" : \"other\",\n  \"reg_number\" : \"reg_number\",\n  \"address\" : \"address\",\n  \"city\" : \"Munich\",\n  \"vat_number\" : \"vat_number\",\n  \"last_name\" : \"last_name\",\n  \"first_name\" : \"first_name\",\n  \"email\" : \"email\"\n}";
            
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<Billing>(exampleJson)
            : default(Billing);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("BillingPatch")]
        [SwaggerResponse(statusCode: 200, type: typeof(Billing), description: "Billing information")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        public virtual IActionResult BillingPatch([FromBody]Billing billing)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("BillingPut")]
        [SwaggerResponse(statusCode: 200, type: typeof(Billing), description: "Billing information")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        public virtual IActionResult BillingPut([FromBody]Billing billing)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("BillingSubscribePost")]
        [SwaggerResponse(statusCode: 200, type: typeof(Invoice), description: "Charges")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        public virtual IActionResult BillingSubscribePost([FromBody]Subscription subscription)
        {
        ...
        /// </summary>
        /// <param name="requestBody"></param>
        /// <response code="200">Available actions for targets</response>
        [HttpPost]
        [Route("/target-actions/")]
        [Authorize]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetActionsPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<ActionsInner>), description: "Available actions for targets")]
        public virtual IActionResult TargetActionsPost([FromBody]List<string> requestBody)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(List<ActionsInner>));
            string exampleJson = null;
            exampleJson = "[ {\n  \"action\" : \"edit\",\n  \"label\" : \"label\"\n}, {\n  \"action\" : \"edit\",\n  \"label\" : \"label\"\n} ]";
            
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<List<ActionsInner>>(exampleJson)
            : default(List<ActionsInner>);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
    }
