...
{ 
    ...
    { 
        ...
        /// <response code="200">Site object</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/site/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdSiteGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Site), description: "Site object")]
        ...
        [Obsolete]
        public virtual IActionResult TargetsTargetIdSiteGet([FromRoute (Name = "target_id")][Required]string targetId)
        {
        ...
        /// </summary>
        /// <remarks>Note that the URL can only be set once.</remarks>
        /// <param name="targetId">Target id</param>
        ...
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdSitePatch")]
        [SwaggerResponse(statusCode: 200, type: typeof(Site), description: "Site object")]
        ...
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        [Obsolete]
        public virtual IActionResult TargetsTargetIdSitePatch([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]Site site)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdSitePut")]
        [SwaggerResponse(statusCode: 200, type: typeof(Site), description: "Site object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        [Obsolete]
        public virtual IActionResult TargetsTargetIdSitePut([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]Site site)
        {
        ...
        /// <response code="404">Not found</response>
        [HttpPost]
        [Route("/targets/{target_id}/site/verify/")]
        [Authorize]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdSiteVerifyPost")]
        ...
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        [Obsolete]
        public virtual IActionResult TargetsTargetIdSiteVerifyPost([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]TargetsTargetIdAssetsIdVerifyPostRequest targetsTargetIdAssetsIdVerifyPostRequest)
        {
