...
{ 
    ...
    { 
        ...
        /// Authenticate user
        /// </summary>
        /// <remarks>The received token should be used for authenticated requests by including in the Authorization header as &#x60;Authorization: JWT &lt;token&gt;&#x60;. </remarks>
        /// <param name="login"></param>
        /// <response code="200">Token and respective time to live</response>
        ...
        [ValidateModelState]
        [SwaggerOperation("AuthObtainPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(AuthObtainPost200Response), description: "Token and respective time to live")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 500, type: typeof(AuthObtainPost500Response), description: "Internal server error")]
        public virtual IActionResult AuthObtainPost([FromBody]Login login)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(AuthObtainPost200Response));
            //TODO: Uncomment the next line to return response 400 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(400, default(AuthObtainPost400Response));
            //TODO: Uncomment the next line to return response 500 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(500, default(AuthObtainPost500Response));
            ...
            ? JsonConvert.DeserializeObject<AuthObtainPost200Response>(exampleJson)
            : default(AuthObtainPost200Response);
        ...
        /// </summary>
        /// <param name="authRefreshPostRequest"></param>
        /// <response code="200">Token and respective time to live</response>
        /// <response code="400">Bad Request</response>
        /// <response code="500">Internal server error</response>
        [HttpPost]
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("AuthRefreshPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(AuthObtainPost200Response), description: "Token and respective time to live")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 500, type: typeof(AuthObtainPost500Response), description: "Internal server error")]
        public virtual IActionResult AuthRefreshPost([FromBody]AuthRefreshPostRequest authRefreshPostRequest)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("AuthRevokePost")]
        [SwaggerResponse(statusCode: 200, type: typeof(AuthObtainPost200Response), description: "Token and respective time to live")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 500, type: typeof(AuthObtainPost500Response), description: "Internal server error")]
        public virtual IActionResult AuthRevokePost([FromBody]AuthRefreshPostRequest authRefreshPostRequest)
        {
        ...
        /// Verify a token
        /// </summary>
        /// <remarks>Check for the validity of a user token. </remarks>
        /// <param name="authRefreshPostRequest"></param>
        /// <response code="200">Token and respective time to live</response>
        /// <response code="400">Bad Request</response>
        /// <response code="500">Internal server error</response>
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("AuthVerifyPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(AuthObtainPost200Response), description: "Token and respective time to live")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 500, type: typeof(AuthObtainPost500Response), description: "Internal server error")]
        public virtual IActionResult AuthVerifyPost([FromBody]AuthRefreshPostRequest authRefreshPostRequest)
        {
        ...
        /// <response code="500">Internal server error</response>
        [HttpPost]
        [Route("/enterprise/auth/obtain/")]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("EnterpriseAuthObtainPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(AuthObtainPost200Response), description: "Token and respective time to live")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 500, type: typeof(AuthObtainPost500Response), description: "Internal server error")]
        public virtual IActionResult EnterpriseAuthObtainPost([FromBody]Login login)
        {
        ...
        /// <response code="500">Internal server error</response>
        [HttpPost]
        [Route("/enterprise/auth/refresh/")]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("EnterpriseAuthRefreshPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(AuthObtainPost200Response), description: "Token and respective time to live")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 500, type: typeof(AuthObtainPost500Response), description: "Internal server error")]
        public virtual IActionResult EnterpriseAuthRefreshPost([FromBody]AuthRefreshPostRequest authRefreshPostRequest)
        {
        ...
        /// <response code="500">Internal server error</response>
        [HttpPost]
        [Route("/enterprise/auth/revoke/")]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("EnterpriseAuthRevokePost")]
        [SwaggerResponse(statusCode: 200, type: typeof(AuthObtainPost200Response), description: "Token and respective time to live")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 500, type: typeof(AuthObtainPost500Response), description: "Internal server error")]
        public virtual IActionResult EnterpriseAuthRevokePost([FromBody]AuthRefreshPostRequest authRefreshPostRequest)
        {
        ...
        /// <response code="500">Internal server error</response>
        [HttpPost]
        [Route("/enterprise/auth/verify/")]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("EnterpriseAuthVerifyPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(AuthObtainPost200Response), description: "Token and respective time to live")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 500, type: typeof(AuthObtainPost500Response), description: "Internal server error")]
        public virtual IActionResult EnterpriseAuthVerifyPost([FromBody]AuthRefreshPostRequest authRefreshPostRequest)
        {
