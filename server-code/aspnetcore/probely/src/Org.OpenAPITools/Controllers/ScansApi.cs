...
{ 
    ...
    { 
        ...
        /// <response code="200">Scan list</response>
        /// <response code="401">Access token is missing or invalid</response>
        [HttpGet]
        [Route("/targets/all/scans/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsAllScansGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsAllScansGet200Response), description: "Scan list")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        public virtual IActionResult TargetsAllScansGet([FromQuery (Name = "page")]int? page, [FromQuery (Name = "length")]int? length, [FromQuery (Name = "ordering")]string ordering, [FromQuery (Name = "search")]string search, [FromQuery (Name = "started")]List<DateTime> started, [FromQuery (Name = "status")]ScanStatus status)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(TargetsAllScansGet200Response));
            ...
            ? JsonConvert.DeserializeObject<TargetsAllScansGet200Response>(exampleJson)
            : default(TargetsAllScansGet200Response);
        ...
        /// <param name="targetsTargetIdScanNowPostRequest"></param>
        /// <response code="200">Scan object</response>
        /// <response code="400">Bad Request</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="403">Not allowed to perform operation</response>
        /// <response code="404">Not found</response>
        [HttpPost]
        [Route("/targets/{target_id}/scan_now/")]
        [Authorize]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScanNowPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(Scan), description: "Scan object")]
        ...
        public virtual IActionResult TargetsTargetIdScanNowPost([FromRoute (Name = "target_id")][Required]string targetId, [FromBody]TargetsTargetIdScanNowPostRequest targetsTargetIdScanNowPostRequest)
        {
        ...
        /// </summary>
        /// <param name="targetId">Target id</param>
        /// <response code="200">Dates for which there are scans</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scans/dates/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScansDatesGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<DateTime>), description: "Dates for which there are scans")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScansDatesGet([FromRoute (Name = "target_id")][Required]string targetId)
        {
            ...
            // return StatusCode(404, default(EventsIdGet404Response));
            string exampleJson = null;
            exampleJson = "[ \"2017-06-12\", \"2017-06-22\" ]";
        ...
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scans/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScansGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsAllScansGet200Response), description: "Scan list")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScansGet([FromRoute (Name = "target_id")][Required]string targetId, [FromQuery (Name = "page")]int? page, [FromQuery (Name = "length")]int? length, [FromQuery (Name = "ordering")]string ordering, [FromQuery (Name = "search")]string search, [FromQuery (Name = "started")]List<DateTime> started, [FromQuery (Name = "status")]ScanStatus status)
        {
        ...
        /// <response code="404">Not found</response>
        [HttpPost]
        [Route("/targets/{target_id}/scans/{id}/cancel/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScansIdCancelPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(Scan), description: "Scan object")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 403, type: typeof(BillingPut403Response), description: "Not allowed to perform operation")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScansIdCancelPost([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// <param name="targetId">Target id</param>
        /// <param name="id">Object Id</param>
        /// <response code="200">Endpoint list CSV file</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scans/{id}/endpoints/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScansIdEndpointsGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(System.IO.Stream), description: "Endpoint list CSV file")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScansIdEndpointsGet([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scans/{id}/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScansIdGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Scan), description: "Scan object")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScansIdGet([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scans/{id}/report/default/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScansIdReportDefaultGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(System.IO.Stream), description: "Scan report PDF")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScansIdReportDefaultGet([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scans/{id}/report/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScansIdReportGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(System.IO.Stream), description: "Scan report PDF")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScansIdReportGet([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scans/{id}/report/owasp/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScansIdReportOwaspGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(System.IO.Stream), description: "Scan report PDF")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScansIdReportOwaspGet([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scans/{id}/report/pci/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScansIdReportPciGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(System.IO.Stream), description: "Scan report PDF")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScansIdReportPciGet([FromRoute (Name = "target_id")][Required]string targetId, [FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// Scan page
        /// </summary>
        /// <remarks>Given a date return the page number</remarks>
        /// <param name="targetId">Target id</param>
        /// <param name="date">Date</param>
        /// <param name="length">Number of results to return per page</param>
        /// <response code="200">Page number for supplied date</response>
        /// <response code="400">Bad Request</response>
        /// <response code="401">Access token is missing or invalid</response>
        /// <response code="404">Not found</response>
        [HttpGet]
        [Route("/targets/{target_id}/scans/retrieve_page/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("TargetsTargetIdScansRetrievePageGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(TargetsTargetIdScansRetrievePageGet200Response), description: "Page number for supplied date")]
        [SwaggerResponse(statusCode: 400, type: typeof(CheckPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult TargetsTargetIdScansRetrievePageGet([FromRoute (Name = "target_id")][Required]string targetId, [FromQuery (Name = "date")][Required()]DateTime date, [FromQuery (Name = "length")]int? length)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(TargetsTargetIdScansRetrievePageGet200Response));
            //TODO: Uncomment the next line to return response 400 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(400, default(CheckPost400Response));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(AccountGet401Response));
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<TargetsTargetIdScansRetrievePageGet200Response>(exampleJson)
            : default(TargetsTargetIdScansRetrievePageGet200Response);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
    }
