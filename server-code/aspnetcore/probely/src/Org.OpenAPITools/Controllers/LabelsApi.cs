...
{ 
    ...
    { 
        ...
        /// <response code="200">Label list</response>
        /// <response code="401">Access token is missing or invalid</response>
        [HttpGet]
        [Route("/labels/")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("LabelsGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(LabelsGet200Response), description: "Label list")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        public virtual IActionResult LabelsGet([FromQuery (Name = "page")]int? page, [FromQuery (Name = "length")]int? length, [FromQuery (Name = "ordering")]string ordering, [FromQuery (Name = "search")]string search)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(LabelsGet200Response));
            ...
            ? JsonConvert.DeserializeObject<LabelsGet200Response>(exampleJson)
            : default(LabelsGet200Response);
        ...
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("LabelsIdDelete")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        public virtual IActionResult LabelsIdDelete([FromRoute (Name = "id")][Required]string id)
        {
        ...
        /// </summary>
        /// <param name="id">Object Id</param>
        /// <response code="200">Label object</response>
        /// <response code="401">Access token is missing or invalid</response>
        ...
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("LabelsIdGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Label), description: "Label object")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult LabelsIdGet([FromRoute (Name = "id")][Required]string id)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Label));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(AccountGet401Response));
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<Label>(exampleJson)
            : default(Label);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        [ValidateModelState]
        [SwaggerOperation("LabelsIdPatch")]
        [SwaggerResponse(statusCode: 200, type: typeof(Label), description: "Label object")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult LabelsIdPatch([FromRoute (Name = "id")][Required]string id, [FromBody]Label label)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("LabelsIdPut")]
        [SwaggerResponse(statusCode: 200, type: typeof(Label), description: "Label object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        [SwaggerResponse(statusCode: 404, type: typeof(EventsIdGet404Response), description: "Not found")]
        public virtual IActionResult LabelsIdPut([FromRoute (Name = "id")][Required]string id, [FromBody]Label label)
        {
        ...
        /// </summary>
        /// <param name="label"></param>
        /// <response code="201">Label object</response>
        /// <response code="400">Bad Request</response>
        /// <response code="401">Access token is missing or invalid</response>
        [HttpPost]
        [Route("/labels/")]
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("LabelsPost")]
        [SwaggerResponse(statusCode: 201, type: typeof(Label), description: "Label object")]
        [SwaggerResponse(statusCode: 400, type: typeof(AuthObtainPost400Response), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(AccountGet401Response), description: "Access token is missing or invalid")]
        public virtual IActionResult LabelsPost([FromBody]Label label)
        {

            //TODO: Uncomment the next line to return response 201 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(201, default(Label));
            //TODO: Uncomment the next line to return response 400 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(400, default(AuthObtainPost400Response));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(AccountGet401Response));
