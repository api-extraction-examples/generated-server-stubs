...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TargetAllowedScanProfilesInner : IEquatable<TargetAllowedScanProfilesInner>
    {
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        [DataMember(Name="id", EmitDefaultValue=true)]
        public ScanProfile Id { get; set; }

        /// <summary>
        /// Name of the scan profile.
        /// </summary>
        /// <value>Name of the scan profile.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetAllowedScanProfilesInner {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TargetAllowedScanProfilesInner)obj);
        }

        /// <summary>
        /// Returns true if TargetAllowedScanProfilesInner instances are equal
        /// </summary>
        /// <param name="other">Instance of TargetAllowedScanProfilesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetAllowedScanProfilesInner other)
        {
        ...
        public static bool operator ==(TargetAllowedScanProfilesInner left, TargetAllowedScanProfilesInner right)
        {
