...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class JiraFinding : IEquatable<JiraFinding>
    {
        /// <summary>
        /// Jira issue id connected to this finding
        /// </summary>
        /// <value>Jira issue id connected to this finding</value>
        ...
        /// </summary>
        /// <value>Selective sync active for this finding.</value>
        [DataMember(Name="selective_sync", EmitDefaultValue=true)]
        public bool SelectiveSync { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JiraFinding {\n");
            sb.Append("  IssueId: ").Append(IssueId).Append("\n");
            sb.Append("  SelectiveSync: ").Append(SelectiveSync).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((JiraFinding)obj);
        }

        /// <summary>
        /// Returns true if JiraFinding instances are equal
        /// </summary>
        /// <param name="other">Instance of JiraFinding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JiraFinding other)
        {
            ...
            return 
                ...
                (
                    SelectiveSync == other.SelectiveSync ||
                    
                    SelectiveSync.Equals(other.SelectiveSync)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + SelectiveSync.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(JiraFinding left, JiraFinding right)
        {
