...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TargetSimple : IEquatable<TargetSimple>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TargetSimple)obj);
        }

        /// <summary>
        /// Returns true if TargetSimple instances are equal
        /// </summary>
        /// <param name="other">Instance of TargetSimple to be compared</param>
        /// <returns>Boolean</returns>
