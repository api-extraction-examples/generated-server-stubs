...
{ 
    ...
    public partial class Activity : IEquatable<Activity>
    {
        ...
        /// <summary>
        /// Type of change:   * created - First time the issue is found   * comment - User left a comment in the timeline   * found - Found again in a later scan   * changed - One of the parameters of the finding was changed    (e.g. severity) 
        /// </summary>
        /// <value>Type of change:   * created - First time the issue is found   * comment - User left a comment in the timeline   * found - Found again in a later scan   * changed - One of the parameters of the finding was changed    (e.g. severity) </value>
        ...
        public enum ChangeEnum
        {
            ...
            /// <summary>
            /// Enum NullEnum2 for null
            /// </summary>
            
            NullEnum2 = null,
            
            /// <summary>
            /// Enum NullEnum3 for null
            /// </summary>
            
            NullEnum3 = null,
            
            /// <summary>
            /// Enum NullEnum4 for null
            /// </summary>
        ...
        /// </summary>
        /// <value>Field that was changed</value>
