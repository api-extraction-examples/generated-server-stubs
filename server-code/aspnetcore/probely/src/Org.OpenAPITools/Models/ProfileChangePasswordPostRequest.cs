...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ProfileChangePasswordPostRequest : IEquatable<ProfileChangePasswordPostRequest>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProfileChangePasswordPostRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ProfileChangePasswordPostRequest)obj);
        }

        /// <summary>
        /// Returns true if ProfileChangePasswordPostRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of ProfileChangePasswordPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProfileChangePasswordPostRequest other)
        {
        ...
        public static bool operator ==(ProfileChangePasswordPostRequest left, ProfileChangePasswordPostRequest right)
        {
