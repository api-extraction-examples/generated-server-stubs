...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CreatedBy : IEquatable<CreatedBy>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CreatedBy)obj);
        }

        /// <summary>
        /// Returns true if CreatedBy instances are equal
        /// </summary>
        /// <param name="other">Instance of CreatedBy to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(CreatedBy left, CreatedBy right)
        {
