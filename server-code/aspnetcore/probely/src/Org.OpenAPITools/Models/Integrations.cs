...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Integrations : IEquatable<Integrations>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Integrations)obj);
        }

        /// <summary>
        /// Returns true if Integrations instances are equal
        /// </summary>
        /// <param name="other">Instance of Integrations to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Installed != null)
                    hashCode = hashCode * 59 + Installed.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(Integrations left, Integrations right)
        {
