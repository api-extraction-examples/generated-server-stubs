...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ScanScannerStatus : IEquatable<ScanScannerStatus>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Total number of tasks in the queue</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScanScannerStatus {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ScanScannerStatus)obj);
        }

        /// <summary>
        /// Returns true if ScanScannerStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of ScanScannerStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScanScannerStatus other)
        {
        ...
        public static bool operator ==(ScanScannerStatus left, ScanScannerStatus right)
        {
