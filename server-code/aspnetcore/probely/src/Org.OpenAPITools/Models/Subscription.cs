...
{ 
    ...
    public partial class Subscription : IEquatable<Subscription>
    {
        ...
        /// Coupon ids
        /// </summary>
        /// <value>Coupon ids</value>
        [DataMember(Name="coupon_ids", EmitDefaultValue=false)]
        ...
        /// </summary>
        [DataMember(Name="target_ids", EmitDefaultValue=false)]
        ...
        public bool Equals(Subscription other)
        {
            ...
            return 
                (
                    ...
                    CouponIds != null &&
                    other.CouponIds != null &&
                    CouponIds.SequenceEqual(other.CouponIds)
                ) && 
                (
                    PlanId == other.PlanId ||
                    PlanId != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (CouponIds != null)
                    hashCode = hashCode * 59 + CouponIds.GetHashCode();
                    if (PlanId != null)
