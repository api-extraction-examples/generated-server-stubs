...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Scheduled : IEquatable<Scheduled>
    {
        /// <summary>
        ...
        /// Scheduled object id
        /// </summary>
        /// <value>Scheduled object id</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Scheduled)obj);
        }

        /// <summary>
        /// Returns true if Scheduled instances are equal
        /// </summary>
        /// <param name="other">Instance of Scheduled to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(Scheduled left, Scheduled right)
        {
