...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AuthRefreshPostRequest : IEquatable<AuthRefreshPostRequest>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AuthRefreshPostRequest)obj);
        }

        /// <summary>
        /// Returns true if AuthRefreshPostRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of AuthRefreshPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthRefreshPostRequest other)
        {
        ...
        public static bool operator ==(AuthRefreshPostRequest left, AuthRefreshPostRequest right)
        {
