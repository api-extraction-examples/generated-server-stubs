...
{ 
    ...
    public partial class Site : IEquatable<Site>
    {
        ...
        /// </summary>
        /// <value>Custom cookies name/value pairs</value>
        [DataMember(Name="cookies", EmitDefaultValue=false)]
        public List<CookiesInner> Cookies { get; set; }

        /// <summary>
        /// Custom description for the resource
        /// </summary>
        /// <value>Custom description for the resource</value>
        ...
        /// </summary>
        /// <value>Form login field name, field input pairs</value>
        [DataMember(Name="form_login", EmitDefaultValue=false)]
        public List<FormLoginInner> FormLogin { get; set; }

        /// <summary>
        /// Pattern to check successful authentication (not used)
        /// </summary>
        /// <value>Pattern to check successful authentication (not used)</value>
        [DataMember(Name="form_login_check_pattern", EmitDefaultValue=false)]
        public string FormLoginCheckPattern { get; set; } = "";

        /// <summary>
        /// URL for the form login
        /// </summary>
        /// <value>URL for the form login</value>
        /// <example>https://app.probely.com/</example>
        [DataMember(Name="form_login_url", EmitDefaultValue=false)]
        public string FormLoginUrl { get; set; } = "";

        /// <summary>
        /// Use basic authentication in scan
        /// </summary>
        /// <value>Use basic authentication in scan</value>
        /// <example>true</example>
        [DataMember(Name="has_basic_auth", EmitDefaultValue=true)]
        public bool HasBasicAuth { get; set; } = false;

        /// <summary>
        /// Does the resource use form login
        /// </summary>
        /// <value>Does the resource use form login</value>
        /// <example>true</example>
        [DataMember(Name="has_form_login", EmitDefaultValue=true)]
        public bool HasFormLogin { get; set; } = false;

        /// <summary>
        /// Custom headers name value pairs
        /// </summary>
        /// <value>Custom headers name value pairs</value>
        [DataMember(Name="headers", EmitDefaultValue=false)]
        public List<HeadersInner> Headers { get; set; }

        /// <summary>
        /// Site host
        /// </summary>
        /// <value>Site host</value>
        /// <example>app.probely.com</example>
        ...
        /// </summary>
        /// <value>List of frameworks detected on this resource</value>
        ...
        /// </summary>
        /// <value>Site URL, it should include the path if the site is not located at the root. This URL can only be set once. </value>
        /// <example>https://app.probely.com</example>
        ...
        /// </summary>
        /// <value>Verification date time</value>
        /// <example>2018-01-31T16:32:52.226652Z</example>
        [DataMember(Name="verification_date", EmitDefaultValue=false)]
        public DateTime VerificationDate { get; set; }

        /// <summary>
        /// Reason for last verification failure.
        /// </summary>
        /// <value>Reason for last verification failure.</value>
        [DataMember(Name="verification_last_error", EmitDefaultValue=false)]
        public string VerificationLastError { get; set; }
        ...
        /// </summary>
        /// <value>Token used to verify</value>
        /// <example>a38351cb-ede8-4dc8-9366-80d3a7042d9a</example>
        ...
        /// </summary>
        /// <value>Has resource ownership been verified</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FormLogin: ").Append(FormLogin).Append("\n");
            sb.Append("  FormLoginCheckPattern: ").Append(FormLoginCheckPattern).Append("\n");
            sb.Append("  FormLoginUrl: ").Append(FormLoginUrl).Append("\n");
            sb.Append("  HasBasicAuth: ").Append(HasBasicAuth).Append("\n");
            sb.Append("  HasFormLogin: ").Append(HasFormLogin).Append("\n");
            ...
            sb.Append("  VerificationLastError: ").Append(VerificationLastError).Append("\n");
        ...
        public bool Equals(Site other)
        {
            ...
            return 
                (
                    ...
                    BasicAuth != null &&
                    BasicAuth.Equals(other.BasicAuth)
                ) && 
                (
                ...
                (
                    FormLogin == other.FormLogin ||
                    FormLogin != null &&
                    other.FormLogin != null &&
                    FormLogin.SequenceEqual(other.FormLogin)
                ) && 
                (
                    FormLoginCheckPattern == other.FormLoginCheckPattern ||
                    FormLoginCheckPattern != null &&
                    FormLoginCheckPattern.Equals(other.FormLoginCheckPattern)
                ) && 
                (
                    FormLoginUrl == other.FormLoginUrl ||
                    FormLoginUrl != null &&
                    FormLoginUrl.Equals(other.FormLoginUrl)
                ) && 
                (
                    HasBasicAuth == other.HasBasicAuth ||
                    
                    HasBasicAuth.Equals(other.HasBasicAuth)
                ) && 
                (
                    HasFormLogin == other.HasFormLogin ||
                    
                    HasFormLogin.Equals(other.HasFormLogin)
                ) && 
                (
                ...
                (
                    ...
                    VerificationDate.Equals(other.VerificationDate)
                ) && 
                (
                    VerificationLastError == other.VerificationLastError ||
                    VerificationLastError != null &&
                    VerificationLastError.Equals(other.VerificationLastError)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (BasicAuth != null)
                    hashCode = hashCode * 59 + BasicAuth.GetHashCode();
                    if (Changed != null)
                    ...
                    if (FormLogin != null)
                    hashCode = hashCode * 59 + FormLogin.GetHashCode();
                    if (FormLoginCheckPattern != null)
                    hashCode = hashCode * 59 + FormLoginCheckPattern.GetHashCode();
                    if (FormLoginUrl != null)
                    hashCode = hashCode * 59 + FormLoginUrl.GetHashCode();
                    
                    hashCode = hashCode * 59 + HasBasicAuth.GetHashCode();
                    
                    hashCode = hashCode * 59 + HasFormLogin.GetHashCode();
                    if (Headers != null)
                    ...
                    if (Stack != null)
                    hashCode = hashCode * 59 + Stack.GetHashCode();
                    if (Url != null)
                    hashCode = hashCode * 59 + Url.GetHashCode();
                    if (VerificationDate != null)
                    hashCode = hashCode * 59 + VerificationDate.GetHashCode();
                    if (VerificationLastError != null)
                    hashCode = hashCode * 59 + VerificationLastError.GetHashCode();
                    
                    hashCode = hashCode * 59 + VerificationMethod.GetHashCode();
                    if (VerificationToken != null)
                    hashCode = hashCode * 59 + VerificationToken.GetHashCode();
