...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AuthObtainPost400Response : IEquatable<AuthObtainPost400Response>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets NonFieldErrors
        /// </summary>
        [DataMember(Name="non_field_errors", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthObtainPost400Response {\n");
            sb.Append("  FieldName: ").Append(FieldName).Append("\n");
            sb.Append("  NonFieldErrors: ").Append(NonFieldErrors).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AuthObtainPost400Response)obj);
        }

        /// <summary>
        /// Returns true if AuthObtainPost400Response instances are equal
        /// </summary>
        /// <param name="other">Instance of AuthObtainPost400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthObtainPost400Response other)
        {
            ...
            return 
                (
                    ...
                    FieldName.SequenceEqual(other.FieldName)
                ) && 
                (
                    NonFieldErrors == other.NonFieldErrors ||
                    NonFieldErrors != null &&
                    other.NonFieldErrors != null &&
                    NonFieldErrors.SequenceEqual(other.NonFieldErrors)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + NonFieldErrors.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(AuthObtainPost400Response left, AuthObtainPost400Response right)
        {
