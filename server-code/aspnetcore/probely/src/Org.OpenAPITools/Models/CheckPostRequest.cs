...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CheckPostRequest : IEquatable<CheckPostRequest>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckPostRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CheckPostRequest)obj);
        }

        /// <summary>
        /// Returns true if CheckPostRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CheckPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckPostRequest other)
        {
        ...
        public static bool operator ==(CheckPostRequest left, CheckPostRequest right)
        {
