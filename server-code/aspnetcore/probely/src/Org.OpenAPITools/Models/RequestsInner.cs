...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RequestsInner : IEquatable<RequestsInner>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RequestsInner)obj);
        }

        /// <summary>
        /// Returns true if RequestsInner instances are equal
        /// </summary>
        /// <param name="other">Instance of RequestsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestsInner other)
        {
        ...
        public static bool operator ==(RequestsInner left, RequestsInner right)
        {
