...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ActionsInner : IEquatable<ActionsInner>
    {

        /// <summary>
        /// Actions are: * edit - edit target * delete - delete target * trial - start a trial with this target * plan - select a subscipition plan with this target * subscribe - add target to subscribed plan * unsubscribe - remove target from subscription * archive - archive target * activate - unarchive target 
        /// </summary>
        /// <value>Actions are: * edit - edit target * delete - delete target * trial - start a trial with this target * plan - select a subscipition plan with this target * subscribe - add target to subscribed plan * unsubscribe - remove target from subscription * archive - archive target * activate - unarchive target </value>
        ...
        /// Label or the action
        /// </summary>
        /// <value>Label or the action</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ActionsInner)obj);
        }

        /// <summary>
        /// Returns true if ActionsInner instances are equal
        /// </summary>
        /// <param name="other">Instance of ActionsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionsInner other)
        {
        ...
        public static bool operator ==(ActionsInner left, ActionsInner right)
        {
