...
{ 
    ...
    public partial class Action : IEquatable<Action>
    {
        ...
        /// <summary>
        /// Action to enable targets: * null - no action required * trial - start a trial * plan - select a plan to subscribe * subscribe - add target to subscribed plan 
        /// </summary>
        /// <value>Action to enable targets: * null - no action required * trial - start a trial * plan - select a plan to subscribe * subscribe - add target to subscribed plan </value>
        ...
        public bool Equals(Action other)
        {
            ...
            return 
                (
                    VarAction == other.VarAction ||
                    
                    VarAction.Equals(other.VarAction)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + VarAction.GetHashCode();
                return hashCode;
            }
        }
