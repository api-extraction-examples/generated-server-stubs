...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Finding : IEquatable<Finding>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Finding)obj);
        }

        /// <summary>
        /// Returns true if Finding instances are equal
        /// </summary>
        /// <param name="other">Instance of Finding to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(Finding left, Finding right)
        {
