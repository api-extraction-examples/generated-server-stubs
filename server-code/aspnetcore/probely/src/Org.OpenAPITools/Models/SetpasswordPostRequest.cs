...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SetpasswordPostRequest : IEquatable<SetpasswordPostRequest>
    {
        /// <summary>
        /// Gets or Sets Confpassword
        /// </summary>
        [Required]
        [DataMember(Name="confpassword", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Reset token received in the user email</value>
        /// <example>KJUUCY2VIVEHO5KJGVHQ&#x3D;&#x3D;&#x3D;&#x3D;-PJZXGNKSGNQVSODFPJGQ&#x3D;&#x3D;&#x3D;&#x3D;-GYZDKOI&#x3D;-8065bfbf8a0192774f3f/</example>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetpasswordPostRequest {\n");
            sb.Append("  Confpassword: ").Append(Confpassword).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SetpasswordPostRequest)obj);
        }

        /// <summary>
        /// Returns true if SetpasswordPostRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of SetpasswordPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetpasswordPostRequest other)
        {
            ...
            return 
                (
                    Confpassword == other.Confpassword ||
                    Confpassword != null &&
                    Confpassword.Equals(other.Confpassword)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + Confpassword.GetHashCode();
                    if (Password != null)
        ...
        public static bool operator ==(SetpasswordPostRequest left, SetpasswordPostRequest right)
        {
