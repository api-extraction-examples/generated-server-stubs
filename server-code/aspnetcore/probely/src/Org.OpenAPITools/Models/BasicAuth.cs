...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BasicAuth : IEquatable<BasicAuth>
    {
        /// <summary>
        /// Gets or Sets Password
        /// </summary>
        /// <example>dolphins</example>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasicAuth)obj);
        }

        /// <summary>
        /// Returns true if BasicAuth instances are equal
        /// </summary>
        /// <param name="other">Instance of BasicAuth to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(BasicAuth left, BasicAuth right)
        {
