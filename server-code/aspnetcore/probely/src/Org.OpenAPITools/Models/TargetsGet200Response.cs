...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TargetsGet200Response : IEquatable<TargetsGet200Response>
    {
        /// <summary>
        /// Number of objects per page.
        /// </summary>
        /// <value>Number of objects per page.</value>
        /// <example>10</example>
        ...
        /// <example>1</example>
        [DataMember(Name="page_total", EmitDefaultValue=true)]
        public int PageTotal { get; set; }

        /// <summary>
        /// Number of objects in the response.
        /// </summary>
        /// <value>Number of objects in the response.</value>
        /// <example>6</example>
        [DataMember(Name="pagination_count", EmitDefaultValue=true)]
        public int PaginationCount { get; set; }

        /// <summary>
        /// Target objects
        /// </summary>
        /// <value>Target objects</value>
        [DataMember(Name="results", EmitDefaultValue=false)]
        public List<Target> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetsGet200Response {\n");
            sb.Append("  Length: ").Append(Length).Append("\n");
            sb.Append("  Page: ").Append(Page).Append("\n");
            sb.Append("  PageTotal: ").Append(PageTotal).Append("\n");
            sb.Append("  PaginationCount: ").Append(PaginationCount).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TargetsGet200Response)obj);
        }

        /// <summary>
        /// Returns true if TargetsGet200Response instances are equal
        /// </summary>
        /// <param name="other">Instance of TargetsGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetsGet200Response other)
        {
            ...
            return 
                ...
                (
                    ...
                    PageTotal.Equals(other.PageTotal)
                ) && 
                (
                    PaginationCount == other.PaginationCount ||
                    
                    PaginationCount.Equals(other.PaginationCount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + PageTotal.GetHashCode();
                    
                    hashCode = hashCode * 59 + PaginationCount.GetHashCode();
                    if (Results != null)
        ...
        public static bool operator ==(TargetsGet200Response left, TargetsGet200Response right)
        {
