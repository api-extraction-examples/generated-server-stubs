...
{ 
    ...
    public partial class Webhook : IEquatable<Webhook>
    {
        ...
        public WebhookApiVersion ApiVersion { get; set; }
        ...
        /// </summary>
        /// <value>Verify webhook URL HTTPS certificate</value>
        [DataMember(Name="check_cert", EmitDefaultValue=true)]
        ...
        public ChangedBy CreatedBy { get; set; }
        ...
        /// </summary>
        /// <value>URL to post events to (must be https)</value>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CheckCert: ").Append(CheckCert).Append("\n");
        ...
        public bool Equals(Webhook other)
        {
            ...
            return 
                ...
                (
                    CheckCert == other.CheckCert ||
                    
                    CheckCert.Equals(other.CheckCert)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CheckCert.GetHashCode();
                    if (Created != null)
