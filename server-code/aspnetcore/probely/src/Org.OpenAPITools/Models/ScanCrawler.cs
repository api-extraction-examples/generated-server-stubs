...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ScanCrawler : IEquatable<ScanCrawler>
    {
        /// <summary>
        /// List of possible errors from the crawler
        /// </summary>
        /// <value>List of possible errors from the crawler</value>
        ...
        /// </summary>
        /// <value>The current state of the crawler</value>
        ...
        /// </summary>
        /// <value>List of possible warnings from the crawler</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ScanCrawler)obj);
        }

        /// <summary>
        /// Returns true if ScanCrawler instances are equal
        /// </summary>
        /// <param name="other">Instance of ScanCrawler to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScanCrawler other)
        {
        ...
        public static bool operator ==(ScanCrawler left, ScanCrawler right)
        {
