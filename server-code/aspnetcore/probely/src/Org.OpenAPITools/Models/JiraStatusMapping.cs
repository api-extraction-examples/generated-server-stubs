...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class JiraStatusMapping : IEquatable<JiraStatusMapping>
    {
        /// <summary>
        /// Id of the Jira status that &#x60;accepted&#x60; findings should be mapped to.
        /// </summary>
        /// <value>Id of the Jira status that &#x60;accepted&#x60; findings should be mapped to.</value>
        ...
        /// </summary>
        /// <value>Id of the Jira status that &#x60;fixed&#x60; findings should be mapped to.</value>
        [DataMember(Name="fixed", EmitDefaultValue=false)]
        public string VarFixed { get; set; }

        /// <summary>
        /// Id of the Jira status that &#x60;invalid&#x60; findings should be mapped to.
        /// </summary>
        /// <value>Id of the Jira status that &#x60;invalid&#x60; findings should be mapped to.</value>
        ...
        /// </summary>
        /// <value>Id of the Jira status that &#x60;notfixed&#x60; findings should be mapped to.</value>
        [DataMember(Name="notfixed", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JiraStatusMapping {\n");
            sb.Append("  Accepted: ").Append(Accepted).Append("\n");
            sb.Append("  VarFixed: ").Append(VarFixed).Append("\n");
            sb.Append("  Invalid: ").Append(Invalid).Append("\n");
            sb.Append("  Notfixed: ").Append(Notfixed).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((JiraStatusMapping)obj);
        }

        /// <summary>
        /// Returns true if JiraStatusMapping instances are equal
        /// </summary>
        /// <param name="other">Instance of JiraStatusMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JiraStatusMapping other)
        {
            ...
            return 
                ...
                (
                    VarFixed == other.VarFixed ||
                    VarFixed != null &&
                    VarFixed.Equals(other.VarFixed)
                ) && 
                (
                ...
                (
                    Notfixed == other.Notfixed ||
                    Notfixed != null &&
                    Notfixed.Equals(other.Notfixed)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (VarFixed != null)
                    hashCode = hashCode * 59 + VarFixed.GetHashCode();
                    if (Invalid != null)
                    hashCode = hashCode * 59 + Invalid.GetHashCode();
                    if (Notfixed != null)
                    hashCode = hashCode * 59 + Notfixed.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(JiraStatusMapping left, JiraStatusMapping right)
        {
