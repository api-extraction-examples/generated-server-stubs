...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CookiesInner : IEquatable<CookiesInner>
    {
        /// <summary>
        /// Cookie name.
        /// </summary>
        /// <value>Cookie name.</value>
        /// <example>cookie_1</example>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CookiesInner)obj);
        }

        /// <summary>
        /// Returns true if CookiesInner instances are equal
        /// </summary>
        /// <param name="other">Instance of CookiesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CookiesInner other)
        {
        ...
        public static bool operator ==(CookiesInner left, CookiesInner right)
        {
