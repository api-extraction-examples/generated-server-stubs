...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Reporter : IEquatable<Reporter>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Reporter)obj);
        }

        /// <summary>
        /// Returns true if Reporter instances are equal
        /// </summary>
        /// <param name="other">Instance of Reporter to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(Reporter left, Reporter right)
        {
