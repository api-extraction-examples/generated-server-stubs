...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class InvoiceTaxesInner : IEquatable<InvoiceTaxesInner>
    {
        /// <summary>
        /// Amount of tax in cents
        /// </summary>
        /// <value>Amount of tax in cents</value>
        ...
        /// Name of applied tax
        /// </summary>
        /// <value>Name of applied tax</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvoiceTaxesInner {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InvoiceTaxesInner)obj);
        }

        /// <summary>
        /// Returns true if InvoiceTaxesInner instances are equal
        /// </summary>
        /// <param name="other">Instance of InvoiceTaxesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceTaxesInner other)
        {
        ...
        public static bool operator ==(InvoiceTaxesInner left, InvoiceTaxesInner right)
        {
