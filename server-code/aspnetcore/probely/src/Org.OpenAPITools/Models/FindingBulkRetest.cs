...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FindingBulkRetest : IEquatable<FindingBulkRetest>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FindingBulkRetest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FindingBulkRetest)obj);
        }

        /// <summary>
        /// Returns true if FindingBulkRetest instances are equal
        /// </summary>
        /// <param name="other">Instance of FindingBulkRetest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FindingBulkRetest other)
        {
        ...
        public static bool operator ==(FindingBulkRetest left, FindingBulkRetest right)
        {
