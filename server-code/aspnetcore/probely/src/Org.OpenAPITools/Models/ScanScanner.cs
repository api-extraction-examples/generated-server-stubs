...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ScanScanner : IEquatable<ScanScanner>
    {
        /// <summary>
        /// List of possible errors from the scanner
        /// </summary>
        /// <value>List of possible errors from the scanner</value>
        ...
        /// </summary>
        /// <value>The current state of the scanner</value>
        ...
        /// </summary>
        /// <value>List of possible warnings from the scanner</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ScanScanner)obj);
        }

        /// <summary>
        /// Returns true if ScanScanner instances are equal
        /// </summary>
        /// <param name="other">Instance of ScanScanner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScanScanner other)
        {
        ...
        public static bool operator ==(ScanScanner left, ScanScanner right)
        {
