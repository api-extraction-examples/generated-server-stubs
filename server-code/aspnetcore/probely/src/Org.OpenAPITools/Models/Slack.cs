...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Slack : IEquatable<Slack>
    {
        /// <summary>
        /// Notify of fixed findings.
        /// </summary>
        /// <value>Notify of fixed findings.</value>
        [DataMember(Name="notify_finding_fixed", EmitDefaultValue=true)]
        public bool NotifyFindingFixed { get; set; } = false;

        /// <summary>
        /// Notify of new high severity findings.
        /// </summary>
        /// <value>Notify of new high severity findings.</value>
        [DataMember(Name="notify_high_findings", EmitDefaultValue=true)]
        public bool NotifyHighFindings { get; set; } = false;

        /// <summary>
        /// Notify of new low severity findings.
        /// </summary>
        /// <value>Notify of new low severity findings.</value>
        [DataMember(Name="notify_low_findings", EmitDefaultValue=true)]
        public bool NotifyLowFindings { get; set; } = false;

        /// <summary>
        /// Notify of new medium severity findings.
        /// </summary>
        /// <value>Notify of new medium severity findings.</value>
        [DataMember(Name="notify_medium_findings", EmitDefaultValue=true)]
        public bool NotifyMediumFindings { get; set; } = false;

        /// <summary>
        /// Notify of completed scans.
        /// </summary>
        /// <value>Notify of completed scans.</value>
        [DataMember(Name="notify_scan_completed", EmitDefaultValue=true)]
        public bool NotifyScanCompleted { get; set; } = false;

        /// <summary>
        /// Notify of started scans.
        /// </summary>
        /// <value>Notify of started scans.</value>
        [DataMember(Name="notify_scan_started", EmitDefaultValue=true)]
        public bool NotifyScanStarted { get; set; } = false;

        /// <summary>
        /// Slack notification webhook url.
        /// </summary>
        /// <value>Slack notification webhook url.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NotifyFindingFixed: ").Append(NotifyFindingFixed).Append("\n");
            sb.Append("  NotifyHighFindings: ").Append(NotifyHighFindings).Append("\n");
            sb.Append("  NotifyLowFindings: ").Append(NotifyLowFindings).Append("\n");
            sb.Append("  NotifyMediumFindings: ").Append(NotifyMediumFindings).Append("\n");
            sb.Append("  NotifyScanCompleted: ").Append(NotifyScanCompleted).Append("\n");
            sb.Append("  NotifyScanStarted: ").Append(NotifyScanStarted).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Slack)obj);
        }

        /// <summary>
        /// Returns true if Slack instances are equal
        /// </summary>
        /// <param name="other">Instance of Slack to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Slack other)
        {
            ...
            return 
                (
                    NotifyFindingFixed == other.NotifyFindingFixed ||
                    
                    NotifyFindingFixed.Equals(other.NotifyFindingFixed)
                ) && 
                (
                    NotifyHighFindings == other.NotifyHighFindings ||
                    
                    NotifyHighFindings.Equals(other.NotifyHighFindings)
                ) && 
                (
                    NotifyLowFindings == other.NotifyLowFindings ||
                    
                    NotifyLowFindings.Equals(other.NotifyLowFindings)
                ) && 
                (
                    NotifyMediumFindings == other.NotifyMediumFindings ||
                    
                    NotifyMediumFindings.Equals(other.NotifyMediumFindings)
                ) && 
                (
                    NotifyScanCompleted == other.NotifyScanCompleted ||
                    
                    NotifyScanCompleted.Equals(other.NotifyScanCompleted)
                ) && 
                (
                    NotifyScanStarted == other.NotifyScanStarted ||
                    
                    NotifyScanStarted.Equals(other.NotifyScanStarted)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + NotifyFindingFixed.GetHashCode();
                    
                    hashCode = hashCode * 59 + NotifyHighFindings.GetHashCode();
                    
                    hashCode = hashCode * 59 + NotifyLowFindings.GetHashCode();
                    
                    hashCode = hashCode * 59 + NotifyMediumFindings.GetHashCode();
                    
                    hashCode = hashCode * 59 + NotifyScanCompleted.GetHashCode();
                    
                    hashCode = hashCode * 59 + NotifyScanStarted.GetHashCode();
                    if (WebhookUrl != null)
        ...
        public static bool operator ==(Slack left, Slack right)
        {
