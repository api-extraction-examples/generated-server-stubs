...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class JiraScope : IEquatable<JiraScope>
    {
        /// <summary>
        /// Is this target allowed Jira integration.
        /// </summary>
        /// <value>Is this target allowed Jira integration.</value>
        [DataMember(Name="allow_jira", EmitDefaultValue=true)]
        public bool AllowJira { get; set; }

        /// <summary>
        /// Automatically synchronise all findings to Jira issues.
        /// </summary>
        /// <value>Automatically synchronise all findings to Jira issues.</value>
        [DataMember(Name="auto_sync", EmitDefaultValue=true)]
        public bool AutoSync { get; set; }

        /// <summary>
        /// Id of the issue type to be created in Jira.
        /// </summary>
        /// <value>Id of the issue type to be created in Jira.</value>
        [DataMember(Name="issue_type_id", EmitDefaultValue=false)]
        public string IssueTypeId { get; set; }

        /// <summary>
        /// Gets or Sets PriorityMapping
        /// </summary>
        [DataMember(Name="priority_mapping", EmitDefaultValue=false)]
        public JiraPriorityMapping PriorityMapping { get; set; }

        /// <summary>
        /// Id of the Jira project where issues for this target will be created.
        /// </summary>
        /// <value>Id of the Jira project where issues for this target will be created.</value>
        [DataMember(Name="project_id", EmitDefaultValue=false)]
        public string ProjectId { get; set; }

        /// <summary>
        /// Gets or Sets StatusMapping
        /// </summary>
        [DataMember(Name="status_mapping", EmitDefaultValue=false)]
        public JiraStatusMapping StatusMapping { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JiraScope {\n");
            sb.Append("  AllowJira: ").Append(AllowJira).Append("\n");
            sb.Append("  AutoSync: ").Append(AutoSync).Append("\n");
            sb.Append("  IssueTypeId: ").Append(IssueTypeId).Append("\n");
            sb.Append("  PriorityMapping: ").Append(PriorityMapping).Append("\n");
            sb.Append("  ProjectId: ").Append(ProjectId).Append("\n");
            sb.Append("  StatusMapping: ").Append(StatusMapping).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((JiraScope)obj);
        }

        /// <summary>
        /// Returns true if JiraScope instances are equal
        /// </summary>
        /// <param name="other">Instance of JiraScope to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JiraScope other)
        {
            ...
            return 
                (
                    AllowJira == other.AllowJira ||
                    
                    AllowJira.Equals(other.AllowJira)
                ) && 
                (
                    AutoSync == other.AutoSync ||
                    
                    AutoSync.Equals(other.AutoSync)
                ) && 
                (
                ...
                (
                    ...
                    PriorityMapping.Equals(other.PriorityMapping)
                ) && 
                (
                ...
                (
                    StatusMapping == other.StatusMapping ||
                    StatusMapping != null &&
                    StatusMapping.Equals(other.StatusMapping)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AllowJira.GetHashCode();
                    
                    hashCode = hashCode * 59 + AutoSync.GetHashCode();
                    if (IssueTypeId != null)
                    hashCode = hashCode * 59 + IssueTypeId.GetHashCode();
                    if (PriorityMapping != null)
                    hashCode = hashCode * 59 + PriorityMapping.GetHashCode();
                    if (ProjectId != null)
                    hashCode = hashCode * 59 + ProjectId.GetHashCode();
                    if (StatusMapping != null)
                    hashCode = hashCode * 59 + StatusMapping.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(JiraScope left, JiraScope right)
        {
