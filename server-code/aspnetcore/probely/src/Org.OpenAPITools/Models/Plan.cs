...
{ 
    ...
    public partial class Plan : IEquatable<Plan>
    {
        ...
        /// </summary>
        /// <value>List of scan profiles allowed by the plan</value>
        [DataMember(Name="allowed_scan_profiles", EmitDefaultValue=false)]
        public List<string> AllowedScanProfiles { get; set; }

        /// <summary>
        /// Gets or Sets ChargeModel
        /// </summary>
        [DataMember(Name="charge_model", EmitDefaultValue=true)]
        public PlanChargeModel ChargeModel { get; set; }
        ...
        /// </summary>
        /// <value>Is this a trial plan</value>
        /// <example>false</example>
        [DataMember(Name="is_trial", EmitDefaultValue=true)]
        ...
        /// </summary>
        /// <value>Number of of period unit between charges</value>
        /// <example>1</example>
        ...
        /// </summary>
        [DataMember(Name="period_unit", EmitDefaultValue=true)]
        public BillingPeriodUnit PeriodUnit { get; set; }

        /// <summary>
        /// Price in cents
        /// </summary>
        /// <value>Price in cents</value>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + IsTrial.GetHashCode();
                    if (Name != null)
                    hashCode = hashCode * 59 + Name.GetHashCode();
                    if (Period != null)
                    hashCode = hashCode * 59 + Period.GetHashCode();
                    
                    hashCode = hashCode * 59 + PeriodUnit.GetHashCode();
