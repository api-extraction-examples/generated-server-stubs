...
{ 
    ...
    public partial class JiraProject : IEquatable<JiraProject>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((JiraProject)obj);
        }

        /// <summary>
        /// Returns true if JiraProject instances are equal
        /// </summary>
        /// <param name="other">Instance of JiraProject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JiraProject other)
        {
        ...
        public static bool operator ==(JiraProject left, JiraProject right)
        {
