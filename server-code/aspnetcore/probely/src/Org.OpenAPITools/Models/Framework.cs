...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Framework : IEquatable<Framework>
    {
        /// <summary>
        /// Framework description
        /// </summary>
        /// <value>Framework description</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Framework)obj);
        }

        /// <summary>
        /// Returns true if Framework instances are equal
        /// </summary>
        /// <param name="other">Instance of Framework to be compared</param>
        /// <returns>Boolean</returns>
