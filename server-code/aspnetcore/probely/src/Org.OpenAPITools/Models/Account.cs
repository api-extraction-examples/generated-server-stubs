...
{ 
    ...
    {
        /// <summary>
        /// Gets or Sets AutoCollection
        /// </summary>
        [DataMember(Name="auto_collection", EmitDefaultValue=true)]
        public AccountAutoCollection AutoCollection { get; set; }

        /// <summary>
        /// Account balance in cents
        /// </summary>
        /// <value>Account balance in cents</value>
        /// <example>0</example>
        ...
        /// </summary>
        /// <value>3 letter currency code</value>
        /// <example>EUR</example>
        [DataMember(Name="balance_currency_code", EmitDefaultValue=false)]
        public string BalanceCurrencyCode { get; set; }

        /// <summary>
        /// Number of free targets
        /// </summary>
        /// <value>Number of free targets</value>
        /// <example>3</example>
        [DataMember(Name="free_target_quantity", EmitDefaultValue=true)]
        public int FreeTargetQuantity { get; set; }

        /// <summary>
        /// Has account used up it&#39;s trial
        /// </summary>
        /// <value>Has account used up it&#39;s trial</value>
        /// <example>true</example>
        [DataMember(Name="has_used_trial", EmitDefaultValue=true)]
        public bool HasUsedTrial { get; set; }

        /// <summary>
        /// Heroku accounts (for future use)
        /// </summary>
        /// <value>Heroku accounts (for future use)</value>
        [DataMember(Name="heroku", EmitDefaultValue=true)]
        public bool Heroku { get; set; }

        /// <summary>
        /// Date of next billing
        /// </summary>
        /// <value>Date of next billing</value>
        [DataMember(Name="next_billing_at", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Number of subscribed targets</value>
        /// <example>3</example>
        [DataMember(Name="plan_target_quantity", EmitDefaultValue=true)]
        public int PlanTargetQuantity { get; set; }

        /// <summary>
        /// Maximum number of subscribed target for pool plans
        /// </summary>
        /// <value>Maximum number of subscribed target for pool plans</value>
        /// <example>5</example>
        [DataMember(Name="pool_size", EmitDefaultValue=true)]
        ...
        /// </summary>
        /// <value>Trial termination date</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AutoCollection: ").Append(AutoCollection).Append("\n");
            sb.Append("  Balance: ").Append(Balance).Append("\n");
            sb.Append("  BalanceCurrencyCode: ").Append(BalanceCurrencyCode).Append("\n");
            sb.Append("  FreeTargetQuantity: ").Append(FreeTargetQuantity).Append("\n");
            sb.Append("  HasUsedTrial: ").Append(HasUsedTrial).Append("\n");
            sb.Append("  Heroku: ").Append(Heroku).Append("\n");
            sb.Append("  NextBillingAt: ").Append(NextBillingAt).Append("\n");
            sb.Append("  Plan: ").Append(Plan).Append("\n");
            sb.Append("  PlanTargetQuantity: ").Append(PlanTargetQuantity).Append("\n");
        ...
        public bool Equals(Account other)
        {
            ...
            return 
                (
                    ...
                    AutoCollection.Equals(other.AutoCollection)
                ) && 
                (
                ...
                (
                    ...
                    BalanceCurrencyCode.Equals(other.BalanceCurrencyCode)
                ) && 
                (
                    FreeTargetQuantity == other.FreeTargetQuantity ||
                    
                    FreeTargetQuantity.Equals(other.FreeTargetQuantity)
                ) && 
                (
                    HasUsedTrial == other.HasUsedTrial ||
                    
                    HasUsedTrial.Equals(other.HasUsedTrial)
                ) && 
                (
                    Heroku == other.Heroku ||
                    
                    Heroku.Equals(other.Heroku)
                ) && 
                (
                    NextBillingAt == other.NextBillingAt ||
                    NextBillingAt != null &&
                    NextBillingAt.Equals(other.NextBillingAt)
                ) && 
                (
                    Plan == other.Plan ||
                    Plan != null &&
                ...
                (
                    PlanTargetQuantity == other.PlanTargetQuantity ||
                    
                    PlanTargetQuantity.Equals(other.PlanTargetQuantity)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AutoCollection.GetHashCode();
                    
                    hashCode = hashCode * 59 + Balance.GetHashCode();
                    if (BalanceCurrencyCode != null)
                    hashCode = hashCode * 59 + BalanceCurrencyCode.GetHashCode();
                    
                    hashCode = hashCode * 59 + FreeTargetQuantity.GetHashCode();
                    
                    hashCode = hashCode * 59 + HasUsedTrial.GetHashCode();
                    
                    hashCode = hashCode * 59 + Heroku.GetHashCode();
                    if (NextBillingAt != null)
                    hashCode = hashCode * 59 + NextBillingAt.GetHashCode();
                    if (Plan != null)
                    hashCode = hashCode * 59 + Plan.GetHashCode();
                    
                    hashCode = hashCode * 59 + PlanTargetQuantity.GetHashCode();
