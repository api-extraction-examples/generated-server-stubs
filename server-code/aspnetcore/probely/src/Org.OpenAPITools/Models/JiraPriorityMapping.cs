...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class JiraPriorityMapping : IEquatable<JiraPriorityMapping>
    {
        /// <summary>
        /// Id of the Jira priority that low severity findings should be mapped to.
        /// </summary>
        /// <value>Id of the Jira priority that low severity findings should be mapped to.</value>
        ...
        /// </summary>
        /// <value>Id of the Jira priority that medium severity findings should be mapped to.</value>
        ...
        /// </summary>
        /// <value>Id of the Jira status that high severity findings should be mapped to.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JiraPriorityMapping {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((JiraPriorityMapping)obj);
        }

        /// <summary>
        /// Returns true if JiraPriorityMapping instances are equal
        /// </summary>
        /// <param name="other">Instance of JiraPriorityMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JiraPriorityMapping other)
        {
            ...
            return 
                (
                    Var10 == other.Var10 ||
                    Var10 != null &&
                    Var10.Equals(other.Var10)
                ) && 
                (
                    Var20 == other.Var20 ||
                    Var20 != null &&
                    Var20.Equals(other.Var20)
                ) && 
                (
                    Var30 == other.Var30 ||
                    Var30 != null &&
                    Var30.Equals(other.Var30)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Var10 != null)
                    hashCode = hashCode * 59 + Var10.GetHashCode();
                    if (Var20 != null)
                    hashCode = hashCode * 59 + Var20.GetHashCode();
                    if (Var30 != null)
                    hashCode = hashCode * 59 + Var30.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(JiraPriorityMapping left, JiraPriorityMapping right)
        {
