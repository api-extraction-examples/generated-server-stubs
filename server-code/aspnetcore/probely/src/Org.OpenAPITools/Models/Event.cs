...
{ 
    ...
    public partial class Event : IEquatable<Event>
    {
        ...
        /// </summary>
        /// <value>Date time of when the event occurred</value>
        /// <example>2018-01-31T16:32:17.238553Z</example>
        [DataMember(Name="ocurred_at", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OcurredAt: ").Append(OcurredAt).Append("\n");
        ...
        public bool Equals(Event other)
        {
            ...
            return 
                ...
                (
                    OcurredAt == other.OcurredAt ||
                    OcurredAt != null &&
                    OcurredAt.Equals(other.OcurredAt)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (OcurredAt != null)
                    hashCode = hashCode * 59 + OcurredAt.GetHashCode();
                    if (Webhooks != null)
