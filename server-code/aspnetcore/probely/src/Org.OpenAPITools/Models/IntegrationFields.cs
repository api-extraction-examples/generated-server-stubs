...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class IntegrationFields : IEquatable<IntegrationFields>
    {
        /// <summary>
        /// Gets or Sets Heroku
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets JiraCloud
        /// </summary>
        [DataMember(Name="jira_cloud", EmitDefaultValue=true)]
        public bool JiraCloud { get; set; }

        /// <summary>
        /// Gets or Sets JiraServer
        /// </summary>
        [DataMember(Name="jira_server", EmitDefaultValue=true)]
        public bool JiraServer { get; set; }

        /// <summary>
        /// Gets or Sets Slack
        /// </summary>
        [DataMember(Name="slack", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IntegrationFields {\n");
            sb.Append("  Heroku: ").Append(Heroku).Append("\n");
            sb.Append("  JiraCloud: ").Append(JiraCloud).Append("\n");
            sb.Append("  JiraServer: ").Append(JiraServer).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((IntegrationFields)obj);
        }

        /// <summary>
        /// Returns true if IntegrationFields instances are equal
        /// </summary>
        /// <param name="other">Instance of IntegrationFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegrationFields other)
        {
            ...
            return 
                ...
                (
                    JiraCloud == other.JiraCloud ||
                    
                    JiraCloud.Equals(other.JiraCloud)
                ) && 
                (
                    JiraServer == other.JiraServer ||
                    
                    JiraServer.Equals(other.JiraServer)
                ) && 
                (
                    Slack == other.Slack ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + JiraCloud.GetHashCode();
                    
                    hashCode = hashCode * 59 + JiraServer.GetHashCode();
                    
                    hashCode = hashCode * 59 + Slack.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(IntegrationFields left, IntegrationFields right)
        {
