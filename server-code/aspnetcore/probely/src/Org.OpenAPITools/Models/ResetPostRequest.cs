...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ResetPostRequest : IEquatable<ResetPostRequest>
    {
        /// <summary>
        /// Gets or Sets Email
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResetPostRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ResetPostRequest)obj);
        }

        /// <summary>
        /// Returns true if ResetPostRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of ResetPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResetPostRequest other)
        {
        ...
        public static bool operator ==(ResetPostRequest left, ResetPostRequest right)
        {
