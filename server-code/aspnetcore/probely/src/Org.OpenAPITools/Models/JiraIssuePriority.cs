...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class JiraIssuePriority : IEquatable<JiraIssuePriority>
    {
        /// <summary>
        /// Jira issue priority id
        /// </summary>
        /// <value>Jira issue priority id</value>
        /// <example>3</example>
        ...
        /// </summary>
        /// <value>Jira issue priority name</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JiraIssuePriority {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((JiraIssuePriority)obj);
        }

        /// <summary>
        /// Returns true if JiraIssuePriority instances are equal
        /// </summary>
        /// <param name="other">Instance of JiraIssuePriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JiraIssuePriority other)
        {
        ...
        public static bool operator ==(JiraIssuePriority left, JiraIssuePriority right)
        {
