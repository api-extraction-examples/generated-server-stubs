...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class InvoiceDiscountsInner : IEquatable<InvoiceDiscountsInner>
    {
        /// <summary>
        /// Discounted amount in cents
        /// </summary>
        /// <value>Discounted amount in cents</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvoiceDiscountsInner {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InvoiceDiscountsInner)obj);
        }

        /// <summary>
        /// Returns true if InvoiceDiscountsInner instances are equal
        /// </summary>
        /// <param name="other">Instance of InvoiceDiscountsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceDiscountsInner other)
        {
        ...
        public static bool operator ==(InvoiceDiscountsInner left, InvoiceDiscountsInner right)
        {
