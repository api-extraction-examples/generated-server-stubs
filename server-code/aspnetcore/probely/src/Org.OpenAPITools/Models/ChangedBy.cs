...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ChangedBy : IEquatable<ChangedBy>
    {
        /// <summary>
        ...
        /// <example>Henrique Cimento</example>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ChangedBy)obj);
        }

        /// <summary>
        /// Returns true if ChangedBy instances are equal
        /// </summary>
        /// <param name="other">Instance of ChangedBy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangedBy other)
        {
        ...
        public static bool operator ==(ChangedBy left, ChangedBy right)
        {
