...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FindingBulkIds : IEquatable<FindingBulkIds>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FindingBulkIds {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FindingBulkIds)obj);
        }

        /// <summary>
        /// Returns true if FindingBulkIds instances are equal
        /// </summary>
        /// <param name="other">Instance of FindingBulkIds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FindingBulkIds other)
        {
        ...
        public static bool operator ==(FindingBulkIds left, FindingBulkIds right)
        {
