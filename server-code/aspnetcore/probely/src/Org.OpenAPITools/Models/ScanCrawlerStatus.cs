...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ScanCrawlerStatus : IEquatable<ScanCrawlerStatus>
    {
        /// <summary>
        /// Number of crawled URLs
        /// </summary>
        /// <value>Number of crawled URLs</value>
        ...
        /// </summary>
        /// <value>Total number of URLs in the queue</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScanCrawlerStatus {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ScanCrawlerStatus)obj);
        }

        /// <summary>
        /// Returns true if ScanCrawlerStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of ScanCrawlerStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScanCrawlerStatus other)
        {
        ...
        public static bool operator ==(ScanCrawlerStatus left, ScanCrawlerStatus right)
        {
