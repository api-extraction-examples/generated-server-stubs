...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class JiraIssueStatus : IEquatable<JiraIssueStatus>
    {
        /// <summary>
        /// Jira issue status id
        /// </summary>
        /// <value>Jira issue status id</value>
        ...
        /// </summary>
        /// <value>Jira issue status name</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JiraIssueStatus {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((JiraIssueStatus)obj);
        }

        /// <summary>
        /// Returns true if JiraIssueStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of JiraIssueStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JiraIssueStatus other)
        {
        ...
        public static bool operator ==(JiraIssueStatus left, JiraIssueStatus right)
        {
