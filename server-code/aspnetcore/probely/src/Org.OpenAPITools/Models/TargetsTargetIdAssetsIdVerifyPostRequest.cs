...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TargetsTargetIdAssetsIdVerifyPostRequest : IEquatable<TargetsTargetIdAssetsIdVerifyPostRequest>
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetsTargetIdAssetsIdVerifyPostRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TargetsTargetIdAssetsIdVerifyPostRequest)obj);
        }

        /// <summary>
        /// Returns true if TargetsTargetIdAssetsIdVerifyPostRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of TargetsTargetIdAssetsIdVerifyPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetsTargetIdAssetsIdVerifyPostRequest other)
        {
        ...
        public static bool operator ==(TargetsTargetIdAssetsIdVerifyPostRequest left, TargetsTargetIdAssetsIdVerifyPostRequest right)
        {
