            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("1.2.0", new OpenApiInfo
                    {
                        ...
                        Description = "Probely Developers (ASP.NET Core 3.1)",
                        TermsOfService = new Uri("https://github.com/openapitools/openapi-generator"),
                        Contact = new OpenApiContact
                        {
                            Name = "Probely Support",
                            Url = new Uri("https://probely.com"),
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/1.2.0/openapi.json", "Probely Developers");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "Probely Developers Original");
                });
            app.UseRouting();
