        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    {
                        Title = "Top Stories",
                        Description = "Top Stories (ASP.NET Core 3.1)",
                        TermsOfService = new Uri("http://developer.nytimes.com/tou"),
                    ...
                    c.DocumentFilter<BasePathFilter>("/svc/topstories/v2");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/2.0.0/openapi.json", "Top Stories");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "Top Stories Original");
                });
            app.UseRouting();
