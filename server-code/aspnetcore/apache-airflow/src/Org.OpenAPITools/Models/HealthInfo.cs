...
{ 
    ...
    {
        /// <summary>
        /// Gets or Sets Metadatabase
        /// </summary>
        [DataMember(Name="metadatabase", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Metadatabase: ").Append(Metadatabase).Append("\n");
        ...
        public bool Equals(HealthInfo other)
        {
            ...
            return 
                (
                    ...
                    Metadatabase != null &&
                    Metadatabase.Equals(other.Metadatabase)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + Metadatabase.GetHashCode();
                    if (Scheduler != null)
                    hashCode = hashCode * 59 + Scheduler.GetHashCode();
                return hashCode;
            }
        }
