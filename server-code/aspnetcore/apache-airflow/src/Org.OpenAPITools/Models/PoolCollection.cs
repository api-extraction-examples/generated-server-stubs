...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PoolCollection : IEquatable<PoolCollection>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PoolCollection)obj);
        }

        /// <summary>
        /// Returns true if PoolCollection instances are equal
        /// </summary>
        /// <param name="other">Instance of PoolCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolCollection other)
        {
            ...
            return 
                ...
                (
                    ...
                    Pools != null &&
                    other.Pools != null &&
                    Pools.SequenceEqual(other.Pools)
                );
        }
        ...
        public static bool operator ==(PoolCollection left, PoolCollection right)
        {
