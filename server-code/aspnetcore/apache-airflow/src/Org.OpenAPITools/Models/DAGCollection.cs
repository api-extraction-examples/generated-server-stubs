...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DAGCollection : IEquatable<DAGCollection>
    {
        /// <summary>
        ...
        /// Gets or Sets Dags
        /// </summary>
        [DataMember(Name="dags", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Dags: ").Append(Dags).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DAGCollection)obj);
        }

        /// <summary>
        /// Returns true if DAGCollection instances are equal
        /// </summary>
        /// <param name="other">Instance of DAGCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGCollection other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Dags != null)
                    hashCode = hashCode * 59 + Dags.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(DAGCollection left, DAGCollection right)
        {
