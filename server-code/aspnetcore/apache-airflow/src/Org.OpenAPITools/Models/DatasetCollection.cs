...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DatasetCollection : IEquatable<DatasetCollection>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DatasetCollection)obj);
        }

        /// <summary>
        /// Returns true if DatasetCollection instances are equal
        /// </summary>
        /// <param name="other">Instance of DatasetCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DatasetCollection other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Datasets != null)
                    hashCode = hashCode * 59 + Datasets.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(DatasetCollection left, DatasetCollection right)
        {
