...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ClearTaskInstances : IEquatable<ClearTaskInstances>
    {
        /// <summary>
        /// The DagRun ID for this task instance
        /// </summary>
        /// <value>The DagRun ID for this task instance</value>
        ...
        /// </summary>
        /// <value>If set, don&#39;t actually run this operation. The response will contain a list of task instances planned to be cleaned, but not modified in any way. </value>
        ...
        /// </summary>
        /// <value>The maximum execution date to clear.</value>
        ...
        public bool IncludeDownstream { get; set; } = false;
        ...
        /// </summary>
        /// <value>Clear tasks in the parent dag of the subdag.</value>
        [DataMember(Name="include_parentdag", EmitDefaultValue=true)]
        public bool IncludeParentdag { get; set; }
        ...
        /// </summary>
        /// <value>Clear tasks in subdags and clear external tasks indicated by ExternalTaskMarker.</value>
        [DataMember(Name="include_subdags", EmitDefaultValue=true)]
        public bool IncludeSubdags { get; set; }
        ...
        public bool IncludeUpstream { get; set; } = false;

        /// <summary>
        /// Only clear failed tasks.
        /// </summary>
        /// <value>Only clear failed tasks.</value>
        [DataMember(Name="only_failed", EmitDefaultValue=true)]
        public bool OnlyFailed { get; set; } = true;

        /// <summary>
        /// Only clear running tasks.
        /// </summary>
        /// <value>Only clear running tasks.</value>
        [DataMember(Name="only_running", EmitDefaultValue=true)]
        public bool OnlyRunning { get; set; } = false;

        /// <summary>
        /// Set state of DAG runs to RUNNING.
        /// </summary>
        /// <value>Set state of DAG runs to RUNNING.</value>
        [DataMember(Name="reset_dag_runs", EmitDefaultValue=true)]
        public bool ResetDagRuns { get; set; }

        /// <summary>
        /// The minimum execution date to clear.
        /// </summary>
        /// <value>The minimum execution date to clear.</value>
        ...
        /// </summary>
        /// <value>A list of task ids to clear.  *New in version 2.1.0* </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IncludeParentdag: ").Append(IncludeParentdag).Append("\n");
            sb.Append("  IncludePast: ").Append(IncludePast).Append("\n");
            sb.Append("  IncludeSubdags: ").Append(IncludeSubdags).Append("\n");
            sb.Append("  IncludeUpstream: ").Append(IncludeUpstream).Append("\n");
            sb.Append("  OnlyFailed: ").Append(OnlyFailed).Append("\n");
            sb.Append("  OnlyRunning: ").Append(OnlyRunning).Append("\n");
            sb.Append("  ResetDagRuns: ").Append(ResetDagRuns).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ClearTaskInstances)obj);
        }

        /// <summary>
        /// Returns true if ClearTaskInstances instances are equal
        /// </summary>
        /// <param name="other">Instance of ClearTaskInstances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClearTaskInstances other)
        {
            ...
            return 
                ...
                (
                    IncludeParentdag == other.IncludeParentdag ||
                    
                    IncludeParentdag.Equals(other.IncludeParentdag)
                ) && 
                (
                ...
                (
                    IncludeSubdags == other.IncludeSubdags ||
                    
                    IncludeSubdags.Equals(other.IncludeSubdags)
                ) && 
                (
                ...
                (
                    OnlyFailed == other.OnlyFailed ||
                    
                    OnlyFailed.Equals(other.OnlyFailed)
                ) && 
                (
                    OnlyRunning == other.OnlyRunning ||
                    
                    OnlyRunning.Equals(other.OnlyRunning)
                ) && 
                (
                    ResetDagRuns == other.ResetDagRuns ||
                    
                    ResetDagRuns.Equals(other.ResetDagRuns)
                ) && 
                (
                ...
                (
                    ...
                    TaskIds != null &&
                    other.TaskIds != null &&
                    TaskIds.SequenceEqual(other.TaskIds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + IncludeParentdag.GetHashCode();
                    
                    hashCode = hashCode * 59 + IncludePast.GetHashCode();
                    
                    hashCode = hashCode * 59 + IncludeSubdags.GetHashCode();
                    
                    hashCode = hashCode * 59 + IncludeUpstream.GetHashCode();
                    
                    hashCode = hashCode * 59 + OnlyFailed.GetHashCode();
                    
                    hashCode = hashCode * 59 + OnlyRunning.GetHashCode();
                    
                    hashCode = hashCode * 59 + ResetDagRuns.GetHashCode();
                    if (StartDate != null)
        ...
        public static bool operator ==(ClearTaskInstances left, ClearTaskInstances right)
        {
