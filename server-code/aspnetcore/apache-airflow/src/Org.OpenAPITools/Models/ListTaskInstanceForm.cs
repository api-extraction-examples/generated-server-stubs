...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ListTaskInstanceForm : IEquatable<ListTaskInstanceForm>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Returns objects greater than or equal to the specified values.  This can be combined with duration_lte parameter to receive only the selected period. </value>
        [DataMember(Name="duration_gte", EmitDefaultValue=true)]
        ...
        /// </summary>
        /// <value>Returns objects less than or equal to the specified values.  This can be combined with duration_gte parameter to receive only the selected range. </value>
        [DataMember(Name="duration_lte", EmitDefaultValue=true)]
        ...
        /// </summary>
        /// <value>Returns objects greater or equal the specified date.  This can be combined with start_date_lte parameter to receive only the selected period. </value>
        ...
        /// </summary>
        /// <value>Returns objects less than or equal to the specified date.  This can be combined with start_date_gte parameter to receive only the selected period. </value>
        ...
        /// </summary>
        /// <value>Returns objects greater or equal to the specified date.  This can be combined with execution_date_lte parameter to receive only the selected period. </value>
        ...
        /// </summary>
        /// <value>Returns objects less than or equal to the specified date.  This can be combined with execution_date_gte parameter to receive only the selected period. </value>
        ...
        /// </summary>
        /// <value>The value can be repeated to retrieve multiple matching values (OR condition).</value>
        ...
        public List<TaskState> State { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DurationGte: ").Append(DurationGte).Append("\n");
            sb.Append("  DurationLte: ").Append(DurationLte).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ListTaskInstanceForm)obj);
        }

        /// <summary>
        /// Returns true if ListTaskInstanceForm instances are equal
        /// </summary>
        /// <param name="other">Instance of ListTaskInstanceForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTaskInstanceForm other)
        {
            ...
            return 
                ...
                (
                    DurationGte == other.DurationGte ||
                    
                    DurationGte.Equals(other.DurationGte)
                ) && 
                (
                    DurationLte == other.DurationLte ||
                    
                    DurationLte.Equals(other.DurationLte)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + DurationGte.GetHashCode();
                    
                    hashCode = hashCode * 59 + DurationLte.GetHashCode();
                    if (EndDateGte != null)
        ...
        public static bool operator ==(ListTaskInstanceForm left, ListTaskInstanceForm right)
        {
