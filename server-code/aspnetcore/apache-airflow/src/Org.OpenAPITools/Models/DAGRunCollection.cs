...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DAGRunCollection : IEquatable<DAGRunCollection>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets DagRuns
        /// </summary>
        [DataMember(Name="dag_runs", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DagRuns: ").Append(DagRuns).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DAGRunCollection)obj);
        }

        /// <summary>
        /// Returns true if DAGRunCollection instances are equal
        /// </summary>
        /// <param name="other">Instance of DAGRunCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGRunCollection other)
        {
            ...
            return 
                ...
                (
                    DagRuns == other.DagRuns ||
                    DagRuns != null &&
                    other.DagRuns != null &&
                    DagRuns.SequenceEqual(other.DagRuns)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (DagRuns != null)
                    hashCode = hashCode * 59 + DagRuns.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(DAGRunCollection left, DAGRunCollection right)
        {
