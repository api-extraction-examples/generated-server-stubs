...
{ 
    ...
    public partial class CronExpression : IEquatable<CronExpression>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CronExpression)obj);
        }

        /// <summary>
        /// Returns true if CronExpression instances are equal
        /// </summary>
        /// <param name="other">Instance of CronExpression to be compared</param>
        /// <returns>Boolean</returns>
