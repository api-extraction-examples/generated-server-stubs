...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ClassReference : IEquatable<ClassReference>
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="module_path", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ClassReference)obj);
        }

        /// <summary>
        /// Returns true if ClassReference instances are equal
        /// </summary>
        /// <param name="other">Instance of ClassReference to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (ModulePath != null)
                    hashCode = hashCode * 59 + ModulePath.GetHashCode();
                return hashCode;
            }
        }
