...
{ 
    ...
    public partial class VersionInfo : IEquatable<VersionInfo>
    {
        ...
        /// </summary>
        /// <value>The git version (including git commit hash)</value>
        [DataMember(Name="git_version", EmitDefaultValue=true)]
        public string GitVersion { get; set; }

        /// <summary>
        /// The version of Airflow
        /// </summary>
        /// <value>The version of Airflow</value>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (GitVersion != null)
                    hashCode = hashCode * 59 + GitVersion.GetHashCode();
                    if (VarVersion != null)
