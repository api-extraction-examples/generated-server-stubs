...
{ 
    ...
    public partial class Job : IEquatable<Job>
    {
        ...
        /// Gets or Sets DagId
        /// </summary>
        [DataMember(Name="dag_id", EmitDefaultValue=true)]
        ...
        /// <summary>
        /// Gets or Sets ExecutorClass
        /// </summary>
        [DataMember(Name="executor_class", EmitDefaultValue=true)]
        public string ExecutorClass { get; set; }
        ...
        /// <summary>
        /// Gets or Sets LatestHeartbeat
        /// </summary>
        [DataMember(Name="latest_heartbeat", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="unixname", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LatestHeartbeat: ").Append(LatestHeartbeat).Append("\n");
        ...
        public bool Equals(Job other)
        {
            ...
            return 
                ...
                (
                    ExecutorClass == other.ExecutorClass ||
                    ExecutorClass != null &&
                    ExecutorClass.Equals(other.ExecutorClass)
                ) && 
                (
                ...
                (
                    LatestHeartbeat == other.LatestHeartbeat ||
                    LatestHeartbeat != null &&
                    LatestHeartbeat.Equals(other.LatestHeartbeat)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ExecutorClass.GetHashCode();
                    if (Hostname != null)
                    ...
                    hashCode = hashCode * 59 + LatestHeartbeat.GetHashCode();
                    if (StartDate != null)
