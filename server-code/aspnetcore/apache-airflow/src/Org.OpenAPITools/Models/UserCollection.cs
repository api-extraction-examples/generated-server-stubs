...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class UserCollection : IEquatable<UserCollection>
    {
        /// <summary>
        ...
        public List<UserCollectionItem> Users { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((UserCollection)obj);
        }

        /// <summary>
        /// Returns true if UserCollection instances are equal
        /// </summary>
        /// <param name="other">Instance of UserCollection to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(UserCollection left, UserCollection right)
        {
