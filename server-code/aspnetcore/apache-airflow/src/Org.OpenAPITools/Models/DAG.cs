...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DAG : IEquatable<DAG>
    {
        /// <summary>
        /// The ID of the DAG.
        /// </summary>
        ...
        /// </summary>
        /// <value>Default view of the DAG inside the webserver  *New in version 2.3.0* </value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DAG)obj);
        }

        /// <summary>
        /// Returns true if DAG instances are equal
        /// </summary>
        /// <param name="other">Instance of DAG to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(DAG left, DAG right)
        {
