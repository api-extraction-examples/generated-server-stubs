...
{ 
    ...
    public partial class Role : IEquatable<Role>
    {
        ...
        public List<ActionResource> Actions { get; set; }

        /// <summary>
        /// The name of the role  *Changed in version 2.3.0*&amp;#58; A minimum character length requirement (&#39;minLength&#39;) is added. 
        /// </summary>
        /// <value>The name of the role  *Changed in version 2.3.0*&amp;#58; A minimum character length requirement (&#39;minLength&#39;) is added. </value>
        [MinLength(1)]
