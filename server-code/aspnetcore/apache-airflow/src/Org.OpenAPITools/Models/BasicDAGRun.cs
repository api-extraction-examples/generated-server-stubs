...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BasicDAGRun : IEquatable<BasicDAGRun>
    {
        /// <summary>
        /// Gets or Sets DagId
        /// </summary>
        ...
        [DataMember(Name="logical_date", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BasicDAGRun)obj);
        }

        /// <summary>
        /// Returns true if BasicDAGRun instances are equal
        /// </summary>
        /// <param name="other">Instance of BasicDAGRun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicDAGRun other)
        {
        ...
        public static bool operator ==(BasicDAGRun left, BasicDAGRun right)
        {
