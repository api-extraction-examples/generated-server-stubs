...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SLAMiss : IEquatable<SLAMiss>
    {
        /// <summary>
        /// The DAG ID.
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name="email_sent", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="notification_sent", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SLAMiss)obj);
        }

        /// <summary>
        /// Returns true if SLAMiss instances are equal
        /// </summary>
        /// <param name="other">Instance of SLAMiss to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SLAMiss other)
        {
            ...
            return 
                ...
                (
                    ...
                    EmailSent.Equals(other.EmailSent)
                ) && 
                (
                ...
                (
                    NotificationSent == other.NotificationSent ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + EmailSent.GetHashCode();
                    if (ExecutionDate != null)
                    hashCode = hashCode * 59 + ExecutionDate.GetHashCode();
                    
                    hashCode = hashCode * 59 + NotificationSent.GetHashCode();
                    if (TaskId != null)
        ...
        public static bool operator ==(SLAMiss left, SLAMiss right)
        {
