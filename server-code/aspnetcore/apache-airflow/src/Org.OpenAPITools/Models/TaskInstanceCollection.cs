...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TaskInstanceCollection : IEquatable<TaskInstanceCollection>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TaskInstanceCollection)obj);
        }

        /// <summary>
        /// Returns true if TaskInstanceCollection instances are equal
        /// </summary>
        /// <param name="other">Instance of TaskInstanceCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskInstanceCollection other)
        {
        ...
        public static bool operator ==(TaskInstanceCollection left, TaskInstanceCollection right)
        {
