...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CollectionInfo : IEquatable<CollectionInfo>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CollectionInfo)obj);
        }

        /// <summary>
        /// Returns true if CollectionInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of CollectionInfo to be compared</param>
        /// <returns>Boolean</returns>
