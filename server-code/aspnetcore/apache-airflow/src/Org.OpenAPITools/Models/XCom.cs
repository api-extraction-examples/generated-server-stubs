...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class XCom : IEquatable<XCom>
    {
        /// <summary>
        /// Gets or Sets DagId
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((XCom)obj);
        }

        /// <summary>
        /// Returns true if XCom instances are equal
        /// </summary>
        /// <param name="other">Instance of XCom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XCom other)
        {
        ...
        public static bool operator ==(XCom left, XCom right)
        {
