...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DAGRun : IEquatable<DAGRun>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DAGRun)obj);
        }

        /// <summary>
        /// Returns true if DAGRun instances are equal
        /// </summary>
        /// <param name="other">Instance of DAGRun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGRun other)
        {
        ...
        public static bool operator ==(DAGRun left, DAGRun right)
        {
