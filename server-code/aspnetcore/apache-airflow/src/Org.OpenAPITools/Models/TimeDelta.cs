...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TimeDelta : IEquatable<TimeDelta>
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TimeDelta)obj);
        }

        /// <summary>
        /// Returns true if TimeDelta instances are equal
        /// </summary>
        /// <param name="other">Instance of TimeDelta to be compared</param>
        /// <returns>Boolean</returns>
