...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <remarks>Get a list of loaded plugins.  *New in version 2.1.0* </remarks>
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(PluginCollection), description: "Success")]
        ...
        public virtual IActionResult GetPlugins([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(PluginCollection));
            ...
            ? JsonConvert.DeserializeObject<PluginCollection>(exampleJson)
            : default(PluginCollection);
