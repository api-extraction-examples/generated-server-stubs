...
{ 
    ...
    { 
        ...
        /// Delete a role
        /// </summary>
        /// <remarks>Delete a role.  *New in version 2.1.0* </remarks>
        ...
        public virtual IActionResult DeleteRole([FromRoute (Name = "role_name")][Required]string roleName)
        {
        ...
        /// Get a role
        /// </summary>
        /// <remarks>Get a role.  *New in version 2.1.0* </remarks>
        /// <param name="roleName">The role name</param>
        ...
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        [SwaggerResponse(statusCode: 404, type: typeof(Error), description: "A specified resource is not found.")]
        public virtual IActionResult GetRole([FromRoute (Name = "role_name")][Required]string roleName)
        {
        ...
        /// List roles
        /// </summary>
        /// <remarks>Get a list of roles.  *New in version 2.1.0* </remarks>
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(RoleCollection), description: "Success.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        public virtual IActionResult GetRoles([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset, [FromQuery (Name = "order_by")]string orderBy)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(RoleCollection));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(Error));
            //TODO: Uncomment the next line to return response 403 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(403, default(Error));
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<RoleCollection>(exampleJson)
            : default(RoleCollection);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// Update a role
        /// </summary>
        /// <remarks>Update a role.  *New in version 2.1.0* </remarks>
        /// <param name="roleName">The role name</param>
        ...
        [ValidateModelState]
        [SwaggerOperation("PatchRole")]
        [SwaggerResponse(statusCode: 200, type: typeof(Role), description: "Success.")]
        [SwaggerResponse(statusCode: 400, type: typeof(Error), description: "Client specified an invalid argument.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        [SwaggerResponse(statusCode: 404, type: typeof(Error), description: "A specified resource is not found.")]
        public virtual IActionResult PatchRole([FromRoute (Name = "role_name")][Required]string roleName, [FromBody]Role role, [FromQuery (Name = "update_mask")]List<string> updateMask)
        {
        ...
        /// Create a role
        /// </summary>
        /// <remarks>Create a new role.  *New in version 2.1.0* </remarks>
        /// <param name="role"></param>
        /// <response code="200">Success.</response>
        /// <response code="400">Client specified an invalid argument.</response>
        /// <response code="401">Request not authenticated due to missing, invalid, authentication info.</response>
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("PostRole")]
        [SwaggerResponse(statusCode: 200, type: typeof(Role), description: "Success.")]
        [SwaggerResponse(statusCode: 400, type: typeof(Error), description: "Client specified an invalid argument.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        public virtual IActionResult PostRole([FromBody]Role role)
        {
