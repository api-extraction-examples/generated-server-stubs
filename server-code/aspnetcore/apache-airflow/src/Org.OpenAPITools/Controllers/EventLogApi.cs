...
{ 
    ...
    /// </summary>
    [ApiController]
    public class EventLogApiController : ControllerBase
    { 
        /// <summary>
        /// Get a log entry
        /// </summary>
        ...
        [HttpGet]
        [Route("/api/v1/eventLogs/{event_log_id}")]
        [ValidateModelState]
        [SwaggerOperation("GetEventLog")]
        [SwaggerResponse(statusCode: 200, type: typeof(EventLog), description: "Success.")]
        ...
        public virtual IActionResult GetEventLog([FromRoute (Name = "event_log_id")][Required]int eventLogId)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(EventLog));
            ...
            ? JsonConvert.DeserializeObject<EventLog>(exampleJson)
            : default(EventLog);
        ...
        /// List log entries
        /// </summary>
        /// <remarks>List log entries from event log.</remarks>
        ...
        /// <response code="403">Client does not have sufficient permission.</response>
        [HttpGet]
        [Route("/api/v1/eventLogs")]
        [ValidateModelState]
        [SwaggerOperation("GetEventLogs")]
        [SwaggerResponse(statusCode: 200, type: typeof(EventLogCollection), description: "Success.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        public virtual IActionResult GetEventLogs([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset, [FromQuery (Name = "order_by")]string orderBy)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(EventLogCollection));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(Error));
            //TODO: Uncomment the next line to return response 403 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(403, default(Error));
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<EventLogCollection>(exampleJson)
            : default(EventLogCollection);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
    }
