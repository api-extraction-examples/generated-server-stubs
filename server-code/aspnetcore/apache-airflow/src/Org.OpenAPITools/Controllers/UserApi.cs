...
{ 
    ...
    { 
        ...
        /// Delete a user
        /// </summary>
        /// <remarks>Delete a user with a specific username.  *New in version 2.2.0* </remarks>
        /// <param name="username">The username of the user.  *New in version 2.1.0* </param>
        ...
        /// Get a user
        /// </summary>
        /// <remarks>Get a user with a specific username.  *New in version 2.1.0* </remarks>
        /// <param name="username">The username of the user.  *New in version 2.1.0* </param>
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(UserCollectionItem), description: "Success.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        [SwaggerResponse(statusCode: 404, type: typeof(Error), description: "A specified resource is not found.")]
        public virtual IActionResult GetUser([FromRoute (Name = "username")][Required]string username)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(UserCollectionItem));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(Error));
            //TODO: Uncomment the next line to return response 403 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(403, default(Error));
            ...
            ? JsonConvert.DeserializeObject<UserCollectionItem>(exampleJson)
            : default(UserCollectionItem);
        ...
        /// List users
        /// </summary>
        /// <remarks>Get a list of users.  *New in version 2.1.0* </remarks>
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(UserCollection), description: "Success.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        public virtual IActionResult GetUsers([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset, [FromQuery (Name = "order_by")]string orderBy)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(UserCollection));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(Error));
            //TODO: Uncomment the next line to return response 403 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(403, default(Error));
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<UserCollection>(exampleJson)
        ...
        /// Update a user
        /// </summary>
        /// <remarks>Update fields for a user.  *New in version 2.2.0* </remarks>
        /// <param name="username">The username of the user.  *New in version 2.1.0* </param>
        ...
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        [SwaggerResponse(statusCode: 404, type: typeof(Error), description: "A specified resource is not found.")]
        public virtual IActionResult PatchUser([FromRoute (Name = "username")][Required]string username, [FromBody]User user, [FromQuery (Name = "update_mask")]List<string> updateMask)
        {
        ...
        /// Create a user
        /// </summary>
        /// <remarks>Create a new user with unique username and email.  *New in version 2.2.0* </remarks>
        /// <param name="user"></param>
        /// <response code="200">Success.</response>
        /// <response code="400">Client specified an invalid argument.</response>
        /// <response code="401">Request not authenticated due to missing, invalid, authentication info.</response>
