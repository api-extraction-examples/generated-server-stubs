...
{ 
    ...
    /// </summary>
    [ApiController]
    public class DatasetApiController : ControllerBase
    { 
        /// <summary>
        /// Get a dataset
        /// </summary>
        /// <remarks>Get a dataset by uri.</remarks>
        /// <param name="uri">The encoded Dataset URI</param>
        ...
        public virtual IActionResult GetDataset([FromRoute (Name = "uri")][Required]string uri)
        {
            ...
            ? JsonConvert.DeserializeObject<Dataset>(exampleJson)
            : default(Dataset);
        ...
        /// Get dataset events
        /// </summary>
        /// <remarks>Get dataset events</remarks>
        ...
        /// <param name="datasetId">The Dataset ID that updated the dataset.</param>
        /// <param name="sourceDagId">The DAG ID that updated the dataset.</param>
        /// <param name="sourceTaskId">The task ID that updated the dataset.</param>
        /// <param name="sourceRunId">The DAG run ID that updated the dataset.</param>
        /// <param name="sourceMapIndex">The map index that updated the dataset.</param>
        /// <response code="200">Success.</response>
        /// <response code="401">Request not authenticated due to missing, invalid, authentication info.</response>
        /// <response code="403">Client does not have sufficient permission.</response>
        /// <response code="404">A specified resource is not found.</response>
        [HttpGet]
        [Route("/api/v1/datasets/events")]
        [ValidateModelState]
        [SwaggerOperation("GetDatasetEvents")]
        [SwaggerResponse(statusCode: 200, type: typeof(DatasetEventCollection), description: "Success.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        [SwaggerResponse(statusCode: 404, type: typeof(Error), description: "A specified resource is not found.")]
        public virtual IActionResult GetDatasetEvents([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset, [FromQuery (Name = "order_by")]string orderBy, [FromQuery (Name = "dataset_id")]int? datasetId, [FromQuery (Name = "source_dag_id")]string sourceDagId, [FromQuery (Name = "source_task_id")]string sourceTaskId, [FromQuery (Name = "source_run_id")]string sourceRunId, [FromQuery (Name = "source_map_index")]int? sourceMapIndex)
        {
        ...
        /// <param name="offset">The number of items to skip before starting to collect the result set.</param>
        /// <param name="orderBy">The name of the field to order the results by. Prefix a field name with &#x60;-&#x60; to reverse the sort order.  *New in version 2.1.0* </param>
        /// <param name="uriPattern">If set, only return datasets with uris matching this pattern. </param>
        /// <response code="200">Success.</response>
        /// <response code="401">Request not authenticated due to missing, invalid, authentication info.</response>
        /// <response code="403">Client does not have sufficient permission.</response>
        [HttpGet]
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(DatasetCollection), description: "Success.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        public virtual IActionResult GetDatasets([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset, [FromQuery (Name = "order_by")]string orderBy, [FromQuery (Name = "uri_pattern")]string uriPattern)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(DatasetCollection));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(Error));
            //TODO: Uncomment the next line to return response 403 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(403, default(Error));
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<DatasetCollection>(exampleJson)
