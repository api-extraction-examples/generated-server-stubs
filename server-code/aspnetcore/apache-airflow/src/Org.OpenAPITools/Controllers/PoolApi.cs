...
{ 
    ...
    { 
        ...
        public virtual IActionResult DeletePool([FromRoute (Name = "pool_name")][Required]string poolName)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(Pool), description: "Success.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        [SwaggerResponse(statusCode: 404, type: typeof(Error), description: "A specified resource is not found.")]
        public virtual IActionResult GetPool([FromRoute (Name = "pool_name")][Required]string poolName)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Pool));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(Error));
            //TODO: Uncomment the next line to return response 403 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(403, default(Error));
            ...
            ? JsonConvert.DeserializeObject<Pool>(exampleJson)
            : default(Pool);
        ...
        /// <response code="200">List of pools.</response>
        /// <response code="401">Request not authenticated due to missing, invalid, authentication info.</response>
        /// <response code="403">Client does not have sufficient permission.</response>
        [HttpGet]
        [Route("/api/v1/pools")]
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(PoolCollection), description: "List of pools.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        public virtual IActionResult GetPools([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset, [FromQuery (Name = "order_by")]string orderBy)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(PoolCollection));
            //TODO: Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(Error));
            //TODO: Uncomment the next line to return response 403 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(403, default(Error));
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<PoolCollection>(exampleJson)
            : default(PoolCollection);
            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        public virtual IActionResult PatchPool([FromRoute (Name = "pool_name")][Required]string poolName, [FromBody]Pool pool, [FromQuery (Name = "update_mask")]List<string> updateMask)
        {
        ...
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("PostPool")]
        [SwaggerResponse(statusCode: 200, type: typeof(Pool), description: "Success.")]
        [SwaggerResponse(statusCode: 400, type: typeof(Error), description: "Client specified an invalid argument.")]
        [SwaggerResponse(statusCode: 401, type: typeof(Error), description: "Request not authenticated due to missing, invalid, authentication info.")]
        [SwaggerResponse(statusCode: 403, type: typeof(Error), description: "Client does not have sufficient permission.")]
        public virtual IActionResult PostPool([FromBody]Pool pool)
        {
