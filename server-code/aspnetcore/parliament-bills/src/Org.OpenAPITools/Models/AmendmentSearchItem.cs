...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AmendmentSearchItem : IEquatable<AmendmentSearchItem>
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="summaryText", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AmendmentSearchItem)obj);
        }

        /// <summary>
        /// Returns true if AmendmentSearchItem instances are equal
        /// </summary>
        /// <param name="other">Instance of AmendmentSearchItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AmendmentSearchItem other)
        {
            ...
            return 
                ...
                (
                    ...
                    SummaryText != null &&
                    other.SummaryText != null &&
                    SummaryText.SequenceEqual(other.SummaryText)
                );
        }
        ...
        public static bool operator ==(AmendmentSearchItem left, AmendmentSearchItem right)
        {
