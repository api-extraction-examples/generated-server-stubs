...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <remarks>&lt;p&gt;This endpoint returns metadata for the most recent data loads of SAM and FPDS data. It takes no parameters.&lt;/p&gt;</remarks>
        /// <response code="200">No response was specified</response>
        [HttpGet]
        [Route("/api/metadata/")]
        [ValidateModelState]
        [SwaggerOperation("MetadataGET")]
        [SwaggerResponse(statusCode: 200, type: typeof(Object), description: "No response was specified")]
        public virtual IActionResult MetadataGET()
        {
