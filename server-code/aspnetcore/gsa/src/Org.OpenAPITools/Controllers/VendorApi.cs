...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <remarks>&lt;p&gt;This endpoint returns a single vendor by their 9 digit DUNS number. DUNS numbers can be looked up in the &lt;a href&#x3D;\&quot;https://www.sam.gov\&quot;&gt;System for Award Management&lt;/a&gt; by vendor name.&lt;/p&gt;</remarks>
        ...
        [HttpGet]
        [Route("/api/vendor/{duns}")]
        [ValidateModelState]
        [SwaggerOperation("GetVendorGET")]
        [SwaggerResponse(statusCode: 200, type: typeof(Object), description: "No response was specified")]
        public virtual IActionResult GetVendorGET([FromRoute (Name = "duns")][Required]string duns)
        {
