...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectMembershipResponse : IEquatable<ProjectMembershipResponse>
    {
        /// <summary>
        ...
        [TypeConverter(typeof(CustomEnumConverter<WriteAccessEnum>))]
        [JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public enum WriteAccessEnum
        {
            
            /// <summary>
            /// Enum FullWriteEnum for full_write
            /// </summary>
            [EnumMember(Value = "full_write")]
            FullWriteEnum = 1,
            
            /// <summary>
            /// Enum CommentOnlyEnum for comment_only
            /// </summary>
        ...
        [DataMember(Name="write_access", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ProjectMembershipResponse)obj);
        }

        /// <summary>
        /// Returns true if ProjectMembershipResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ProjectMembershipResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectMembershipResponse other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + WriteAccess.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(ProjectMembershipResponse left, ProjectMembershipResponse right)
        {
