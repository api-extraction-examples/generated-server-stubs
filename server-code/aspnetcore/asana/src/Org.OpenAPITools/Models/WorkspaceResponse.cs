...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class WorkspaceResponse : IEquatable<WorkspaceResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((WorkspaceResponse)obj);
        }

        /// <summary>
        /// Returns true if WorkspaceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of WorkspaceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkspaceResponse other)
        {
            ...
            return 
                ...
                (
                    ...
                    EmailDomains != null &&
                    other.EmailDomains != null &&
                    EmailDomains.SequenceEqual(other.EmailDomains)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + EmailDomains.GetHashCode();
                    
                    hashCode = hashCode * 59 + IsOrganization.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(WorkspaceResponse left, WorkspaceResponse right)
        {
