...
{ 
    ...
    { 
        ...
        /// Get a job by id
        /// </summary>
        /// <remarks>Returns the full record for a job.</remarks>
        ...
        /// <response code="200">Successfully retrieved Job.</response>
        ...
        [HttpGet]
        [Route("/api/1.0/jobs/{job_gid}")]
        [Authorize]
        [ValidateModelState]
        [SwaggerOperation("GetJob")]
        [SwaggerResponse(statusCode: 200, type: typeof(GetJob200Response), description: "Successfully retrieved Job.")]
        ...
        public virtual IActionResult GetJob([FromRoute (Name = "job_gid")][Required]string jobGid, [FromQuery (Name = "opt_pretty")]bool? optPretty, [FromQuery (Name = "opt_fields")]List<string> optFields)
        {

            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(GetJob200Response));
