            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("v1", new OpenApiInfo
                    {
                        ...
                        Description = "CircleCI REST API (ASP.NET Core 3.1)",
                        ...
                        {
                            Name = "NoLicense",
                            Url = new Uri("http://creativecommons.org/licenses/by-nc-sa/4.0/")
                        },
                        Version = "v1",
                    });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/v1/openapi.json", "CircleCI REST API");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "CircleCI REST API Original");
                });
            app.UseRouting();
