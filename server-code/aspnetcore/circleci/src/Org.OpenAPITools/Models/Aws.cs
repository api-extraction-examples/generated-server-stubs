...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Aws : IEquatable<Aws>
    {
        /// <summary>
        /// Gets or Sets Keypair
        /// </summary>
        [DataMember(Name="keypair", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Aws)obj);
        }

        /// <summary>
        /// Returns true if Aws instances are equal
        /// </summary>
        /// <param name="other">Instance of Aws to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Keypair != null)
                    hashCode = hashCode * 59 + Keypair.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(Aws left, Aws right)
        {
