            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("1.0.2", new OpenApiInfo
                    {
                        ...
                        Description = "AltoroJ REST API (ASP.NET Core 3.1)",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/1.0.2/openapi.json", "AltoroJ REST API");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "AltoroJ REST API Original");
                });
            app.UseRouting();
