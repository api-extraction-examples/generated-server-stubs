...
{ 
        ...
        /// </summary>
        /// <value>Indicates whether to AND or OR the Owner/Operator parameter (p_owop) and the federal agency code (p_fa) parameters.</value>
        [TypeConverter(typeof(CustomEnumConverter<FormDataFPAgoo>))]
