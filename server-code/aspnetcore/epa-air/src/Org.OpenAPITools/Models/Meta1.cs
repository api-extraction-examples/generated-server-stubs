...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Meta1 : IEquatable<Meta1>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets ResultColumns
        /// </summary>
        [DataMember(Name="ResultColumns", EmitDefaultValue=false)]
        public List<Meta3> ResultColumns { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResultColumns: ").Append(ResultColumns).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Meta1)obj);
        }

        /// <summary>
        /// Returns true if Meta1 instances are equal
        /// </summary>
        /// <param name="other">Instance of Meta1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Meta1 other)
        {
            ...
            return 
                ...
                (
                    ...
                    ResultColumns != null &&
                    other.ResultColumns != null &&
                    ResultColumns.SequenceEqual(other.ResultColumns)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ResultColumns.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(Meta1 left, Meta1 right)
        {
