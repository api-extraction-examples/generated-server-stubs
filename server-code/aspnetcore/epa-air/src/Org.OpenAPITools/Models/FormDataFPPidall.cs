...
{ 
        ...
        /// </summary>
        /// <value>Controls whether search is restricted to existing system. Y means the search will match the p_pid parameter against all associated permits (AIR, RCRA, SDWIS, etc).</value>
        [TypeConverter(typeof(CustomEnumConverter<FormDataFPPidall>))]
