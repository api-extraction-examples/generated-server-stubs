...
{ 
        ...
        /// </summary>
        /// <value>Years (1 to 5) Range.  This value is used to create a date range for Formal Enforcement Actions (FEA). Used along with p_fea (which indicates whether to look within or outside of the date range) to find FEAs within (or not within) the number of years specified.</value>
        [TypeConverter(typeof(CustomEnumConverter<FormDataFPFeay>))]
