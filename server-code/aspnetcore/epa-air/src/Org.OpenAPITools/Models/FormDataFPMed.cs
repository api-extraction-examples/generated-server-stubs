...
{ 
        ...
        /// </summary>
        /// <value>Filter Results by Media. - M = RMP (Risk Management Plan) - R = RCRA (Hazardous Waste) - S = SDWA (Public Drinking Water Systems) - W = Water - ALL = Water and RCRA and SDWA</value>
        [TypeConverter(typeof(CustomEnumConverter<FormDataFPMed>))]
