...
{ 
        ...
        /// </summary>
        /// <value>Output Sort Column Descending Flag.  Enter Y to column identified in the newsort parameter descending.  Enter N to use ascending sort order. Used only when newsort parameter is populated.</value>
        [TypeConverter(typeof(CustomEnumConverter<FormDataFDescending>))]
