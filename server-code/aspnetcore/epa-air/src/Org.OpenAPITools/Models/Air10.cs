...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Air10 : IEquatable<Air10>
    {
        /// <summary>
        ...
        /// <example>2806.0</example>
        [Required]
        [DataMember(Name="AIRDaysLastEval", EmitDefaultValue=true)]
        public decimal AIRDaysLastEval { get; set; }
        ...
        /// <example>0.0</example>
        [Required]
        [DataMember(Name="AIREvalCnt", EmitDefaultValue=true)]
        public decimal AIREvalCnt { get; set; }
        ...
        /// <example>3.0</example>
        [Required]
        [DataMember(Name="AIRMnthsWithHpv", EmitDefaultValue=true)]
        public decimal AIRMnthsWithHpv { get; set; }
        ...
        /// <example>4.0</example>
        [Required]
        [DataMember(Name="AIRQtrsWithHpv", EmitDefaultValue=true)]
        public decimal AIRQtrsWithHpv { get; set; }
        ...
        /// <example>2.0</example>
        [Required]
        [DataMember(Name="AIRQtrsWithViol", EmitDefaultValue=true)]
        public decimal AIRQtrsWithViol { get; set; }
        ...
        /// <example>2.0</example>
        [Required]
        [DataMember(Name="AIRRecentViolCnt", EmitDefaultValue=true)]
        public decimal AIRRecentViolCnt { get; set; }
        ...
        /// </summary>
        /// <value>Indicates the calculated accuracy in meters for the facilities geospatial coordinate.  Generally, the accuracy is directly linked to the collection method where GPS methods are more accurate that manual methods like map or photo interpolations.</value>
        /// <example>50.0</example>
        [Required]
        [DataMember(Name="CalculatedAccuracyMeters", EmitDefaultValue=true)]
        public decimal CalculatedAccuracyMeters { get; set; }
        ...
        /// <example>1.0</example>
        [Required]
        [DataMember(Name="CurrSvFlag", EmitDefaultValue=true)]
        public decimal CurrSvFlag { get; set; }
        ...
        /// <example>1.0</example>
        [Required]
        [DataMember(Name="CurrVioFlag", EmitDefaultValue=true)]
        public decimal CurrVioFlag { get; set; }
        ...
        /// <example>0.0</example>
        [Required]
        [DataMember(Name="Ea5yrFlag", EmitDefaultValue=true)]
        public decimal Ea5yrFlag { get; set; }
        ...
        [Required]
        [DataMember(Name="FacPercentMinority", EmitDefaultValue=true)]
        public decimal FacPercentMinority { get; set; }
        ...
        [Required]
        [DataMember(Name="FacPopulationDensity", EmitDefaultValue=true)]
        public decimal FacPopulationDensity { get; set; }
        ...
        /// <example>1.0</example>
        [Required]
        [DataMember(Name="Infea5yrFlag", EmitDefaultValue=true)]
        public decimal Infea5yrFlag { get; set; }
        ...
        /// <example>1.0</example>
        [Required]
        [DataMember(Name="Insp5yrFlag", EmitDefaultValue=true)]
        public decimal Insp5yrFlag { get; set; }
        ...
        /// <example>54.7</example>
        [Required]
        [DataMember(Name="MaxPctileUs", EmitDefaultValue=true)]
        public decimal MaxPctileUs { get; set; }
        ...
        /// <example>1.0</example>
        [Required]
        [DataMember(Name="MaxScore", EmitDefaultValue=true)]
        ...
        /// <example>3.0</example>
        [Required]
        [DataMember(Name="Over80CountUs", EmitDefaultValue=true)]
        public decimal Over80CountUs { get; set; }
        ...
        [Required]
        [DataMember(Name="PctileCancerUs", EmitDefaultValue=true)]
        public decimal PctileCancerUs { get; set; }
        ...
        /// <example>99.0</example>
        [Required]
        [DataMember(Name="PctileDpmUs", EmitDefaultValue=true)]
        public decimal PctileDpmUs { get; set; }
        ...
        /// <example>52.4</example>
        [Required]
        [DataMember(Name="PctileO3Us", EmitDefaultValue=true)]
        public decimal PctileO3Us { get; set; }
        ...
        [Required]
        [DataMember(Name="PctilePctpre1960Us", EmitDefaultValue=true)]
        public decimal PctilePctpre1960Us { get; set; }
        ...
        /// <example>52.4</example>
        [Required]
        [DataMember(Name="PctilePmUs", EmitDefaultValue=true)]
        public decimal PctilePmUs { get; set; }
        ...
        /// <example>45.3</example>
        [Required]
        [DataMember(Name="PctileProximityNPDESUs", EmitDefaultValue=true)]
        public decimal PctileProximityNPDESUs { get; set; }
        ...
        /// <example>38.9</example>
        [Required]
        [DataMember(Name="PctileProximityNplUs", EmitDefaultValue=true)]
        public decimal PctileProximityNplUs { get; set; }
        ...
        /// <example>54.7</example>
        [Required]
        [DataMember(Name="PctileProximityRmpUs", EmitDefaultValue=true)]
        public decimal PctileProximityRmpUs { get; set; }
        ...
        /// <example>42.4</example>
        [Required]
        [DataMember(Name="PctileProximityTsdfUs", EmitDefaultValue=true)]
        public decimal PctileProximityTsdfUs { get; set; }
        ...
        [Required]
        [DataMember(Name="PctileRespUs", EmitDefaultValue=true)]
        public decimal PctileRespUs { get; set; }
        ...
        /// <example>7.0</example>
        [Required]
        [DataMember(Name="PctileTrafficScoreUs", EmitDefaultValue=true)]
        public decimal PctileTrafficScoreUs { get; set; }
        ...
        /// </summary>
        /// <value>A value of \&quot;1\&quot; indicates that the facility is within an Indian Tribal or Alaskan Native Village area.</value>
        /// <example>1.0</example>
        [Required]
        [DataMember(Name="TRIbalFlag", EmitDefaultValue=true)]
        public decimal TRIbalFlag { get; set; }
        ...
        /// <example>1.0</example>
        [Required]
        [DataMember(Name="ViolFlag", EmitDefaultValue=true)]
        public decimal ViolFlag { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Air10)obj);
        }

        /// <summary>
        /// Returns true if Air10 instances are equal
        /// </summary>
        /// <param name="other">Instance of Air10 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Air10 other)
        {
        ...
        public static bool operator ==(Air10 left, Air10 right)
        {
