...
*
* returns BuildPrune_200_response
* */
const buildPrune = () => new Promise(
...
* body File A tar archive compressed with one of the following algorithms: identity (no compression), gzip, bzip2, xz. (optional)
* no response value expected for this operation
* */
const imageBuild = ({ dockerfile, t, extrahosts, remote, q, nocache, cachefrom, pull, rm, forcerm, memory, memswap, cpushares, cpusetcpus, cpuperiod, cpuquota, buildargs, shmsize, squash, labels, networkmode, contentType, xRegistryConfig, body }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        dockerfile,
...
* body String Image content if the value `-` has been specified in fromSrc query parameter (optional)
* no response value expected for this operation
* */
const imageCreate = ({ fromImage, fromSrc, repo, tag, xRegistryAuth, body }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        fromImage,
...
* returns List
* */
const imageList = ({ all, filters, digests }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        all,
...
* body File Tar archive containing images (optional)
* no response value expected for this operation
* */
const imageLoad = ({ quiet, body }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        quiet,
...
* returns ImagePrune_200_response
* */
