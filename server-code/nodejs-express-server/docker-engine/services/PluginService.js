...
* body File Path to tar containing plugin rootfs and manifest (optional)
* no response value expected for this operation
* */
const pluginCreate = ({ name, body }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* no response value expected for this operation
* */
const pluginDisable = ({ name }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* pluginPullUnderscorerequestUnderscoreinner List  (optional)
* no response value expected for this operation
* */
const pluginPull = ({ remote, name, xRegistryAuth, pluginPullUnderscorerequestUnderscoreinner }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        remote,
        name,
        xRegistryAuth,
        pluginPullUnderscorerequestUnderscoreinner,
      }));
    } catch (e) {
      reject(Service.rejectResponse(
        e.message || 'Invalid input',
...
* no response value expected for this operation
* */
const pluginSet = ({ name, string }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* no response value expected for this operation
* */
const pluginUpgrade = ({ name, remote, xRegistryAuth, pluginPullUnderscorerequestUnderscoreinner }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
