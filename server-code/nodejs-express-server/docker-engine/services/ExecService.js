...
* containerExecRequest ContainerExecRequest Exec configuration
* returns IdResponse
* */
const containerExec = ({ id, containerExecRequest }) => new Promise(
...
* returns ExecInspect_200_response
* */
...
*
* id String Exec instance ID
* execStartRequest ExecStartRequest  (optional)
* no response value expected for this operation
* */
const execStart = ({ id, execStartRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        id,
