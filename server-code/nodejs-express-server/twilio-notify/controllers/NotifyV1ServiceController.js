/**
 * The NotifyV1ServiceController file is a very simple one, which does not need to be changed manually,
...
const service = require('../services/NotifyV1ServiceService');
...
const fetchService = async (request, response) => {
  await Controller.handleRequest(request, response, service.fetchService);
};
