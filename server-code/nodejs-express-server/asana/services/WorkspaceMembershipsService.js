...
*
* workspaceUnderscoremembershipUnderscoregid String 
...
* returns getWorkspaceMembership_200_response
* */
const getWorkspaceMembership = ({ workspaceUnderscoremembershipUnderscoregid, optUnderscorepretty, optUnderscorefields }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        workspaceUnderscoremembershipUnderscoregid,
        optUnderscorepretty,
        optUnderscorefields,
      }));
    } catch (e) {
...
* returns getWorkspaceMembershipsForUser_200_response
* */
const getWorkspaceMembershipsForUser = ({ userUnderscoregid, optUnderscorepretty, optUnderscorefields, limit, offset }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        userUnderscoregid,
...
* returns getWorkspaceMembershipsForUser_200_response
* */
const getWorkspaceMembershipsForWorkspace = ({ workspaceUnderscoregid, user, optUnderscorepretty, optUnderscorefields, limit, offset }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
