...
*
* portfolioUnderscoremembershipUnderscoregid String 
...
* returns getPortfolioMembership_200_response
* */
const getPortfolioMembership = ({ portfolioUnderscoremembershipUnderscoregid, optUnderscorepretty, optUnderscorefields }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        portfolioUnderscoremembershipUnderscoregid,
        optUnderscorepretty,
        optUnderscorefields,
      }));
    } catch (e) {
...
* returns getPortfolioMemberships_200_response
* */
const getPortfolioMemberships = ({ portfolio, workspace, user, optUnderscorepretty, optUnderscorefields, limit, offset }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        portfolio,
...
* returns getPortfolioMemberships_200_response
* */
const getPortfolioMembershipsForPortfolio = ({ portfolioUnderscoregid, user, optUnderscorepretty, optUnderscorefields, limit, offset }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
