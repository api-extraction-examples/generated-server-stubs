/**
 * The PersonsController file is a very simple one, which does not need to be changed manually,
...
const getPersons = async (request, response) => {
  await Controller.handleRequest(request, response, service.getPersons);
};
