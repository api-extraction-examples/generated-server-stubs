/**
 * The CollectionController file is a very simple one, which does not need to be changed manually,
...
const service = require('../services/CollectionService');
...
const createCollection = async (request, response) => {
  await Controller.handleRequest(request, response, service.createCollection);
};
