...
* includeItemTypes List Optional. If specified, results will be filtered based on the item type. This allows multiple, comma delimited. (optional)
...
* */
const getItems = ({ userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber, hasParentalRating, isHd, is4K, locationTypes, excludeLocationTypes, isMissing, isUnaired, minCommunityRating, minCriticRating, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, filters, isFavorite, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, years, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, artists, excludeArtistIds, artistIds, albumArtistIds, contributingArtistIds, albums, albumIds, ids, videoTypes, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, collapseBoxSetItems, minWidth, minHeight, maxWidth, maxHeight, is3D, seriesStatus, nameStartsWithOrGreater, nameStartsWith, nameLessThan, studioIds, genreIds, enableTotalRecordCount, enableImages }) => new Promise(
...
* isHd Boolean Optional filter by items that are HD or not. (optional)
* is4K Boolean Optional filter by items that are 4K or not. (optional)
* locationTypes List Optional. If specified, results will be filtered based on LocationType. This allows multiple, comma delimeted. (optional)
* excludeLocationTypes List Optional. If specified, results will be filtered based on the LocationType. This allows multiple, comma delimeted. (optional)
* isMissing Boolean Optional filter by items that are missing episodes or not. (optional)
* isUnaired Boolean Optional filter by items that are unaired episodes or not. (optional)
* minCommunityRating Double Optional filter by minimum community rating. (optional)
* minCriticRating Double Optional filter by minimum critic rating. (optional)
...
* hasTmdbId Boolean Optional filter by items that have a tmdb id or not. (optional)
* hasTvdbId Boolean Optional filter by items that have a tvdb id or not. (optional)
* excludeItemIds List Optional. If specified, results will be filtered by exxcluding item ids. This allows multiple, comma delimeted. (optional)
* startIndex Integer Optional. The record index to start at. All items with a lower index will be dropped from the results. (optional)
* limit Integer Optional. The maximum number of records to return. (optional)
* recursive Boolean When searching within folders, this determines whether or not the search will be recursive. true/false. (optional)
* searchTerm String Optional. Filter based on a search term. (optional)
...
* excludeItemTypes List Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted. (optional)
* includeItemTypes List Optional. If specified, results will be filtered based on the item type. This allows multiple, comma delimeted. (optional)
* filters List Optional. Specify additional filters to apply. This allows multiple, comma delimeted. Options: IsFolder, IsNotFolder, IsUnplayed, IsPlayed, IsFavorite, IsResumable, Likes, Dislikes. (optional)
* isFavorite Boolean Optional filter by items that are marked as favorite, or not. (optional)
* mediaTypes List Optional filter by MediaType. Allows multiple, comma delimited. (optional)
* imageTypes List Optional. If specified, results will be filtered based on those containing image types. This allows multiple, comma delimited. (optional)
...
* isPlayed Boolean Optional filter by items that are played, or not. (optional)
* genres List Optional. If specified, results will be filtered based on genre. This allows multiple, pipe delimeted. (optional)
* officialRatings List Optional. If specified, results will be filtered based on OfficialRating. This allows multiple, pipe delimeted. (optional)
* tags List Optional. If specified, results will be filtered based on tag. This allows multiple, pipe delimeted. (optional)
* years List Optional. If specified, results will be filtered based on production year. This allows multiple, comma delimeted. (optional)
* enableUserData Boolean Optional, include user data. (optional)
* imageTypeLimit Integer Optional, the max number of images to return, per image type. (optional)
* enableImageTypes List Optional. The image types to include in the output. (optional)
* person String Optional. If specified, results will be filtered to include only those containing the specified person. (optional)
* personIds List Optional. If specified, results will be filtered to include only those containing the specified person id. (optional)
* personTypes List Optional. If specified, along with Person, results will be filtered to include only those containing the specified person and PersonType. Allows multiple, comma-delimited. (optional)
* studios List Optional. If specified, results will be filtered based on studio. This allows multiple, pipe delimeted. (optional)
* artists List Optional. If specified, results will be filtered based on artists. This allows multiple, pipe delimeted. (optional)
* excludeArtistIds List Optional. If specified, results will be filtered based on artist id. This allows multiple, pipe delimeted. (optional)
* artistIds List Optional. If specified, results will be filtered to include only those containing the specified artist id. (optional)
* albumArtistIds List Optional. If specified, results will be filtered to include only those containing the specified album artist id. (optional)
* contributingArtistIds List Optional. If specified, results will be filtered to include only those containing the specified contributing artist id. (optional)
* albums List Optional. If specified, results will be filtered based on album. This allows multiple, pipe delimeted. (optional)
* albumIds List Optional. If specified, results will be filtered based on album id. This allows multiple, pipe delimeted. (optional)
* ids List Optional. If specific items are needed, specify a list of item id's to retrieve. This allows multiple, comma delimited. (optional)
* videoTypes List Optional filter by VideoType (videofile, dvd, bluray, iso). Allows multiple, comma delimeted. (optional)
* minOfficialRating String Optional filter by minimum official rating (PG, PG-13, TV-MA, etc). (optional)
* isLocked Boolean Optional filter by items that are locked. (optional)
* isPlaceHolder Boolean Optional filter by items that are placeholders. (optional)
* hasOfficialRating Boolean Optional filter by items that have official ratings. (optional)
...
* maxHeight Integer Optional. Filter by the maximum height of the item. (optional)
* is3D Boolean Optional filter by items that are 3D, or not. (optional)
* seriesStatus List Optional filter by Series Status. Allows multiple, comma delimeted. (optional)
* nameStartsWithOrGreater String Optional filter by items whose name is sorted equally or greater than a given input string. (optional)
* nameStartsWith String Optional filter by items whose name is sorted equally than a given input string. (optional)
* nameLessThan String Optional filter by items whose name is equally or lesser than a given input string. (optional)
* studioIds List Optional. If specified, results will be filtered based on studio id. This allows multiple, pipe delimeted. (optional)
* genreIds List Optional. If specified, results will be filtered based on genre id. This allows multiple, pipe delimeted. (optional)
* enableTotalRecordCount Boolean Optional. Enable the total record count. (optional)
* enableImages Boolean Optional, include image information in output. (optional)
* returns BaseItemDtoQueryResult
* */
const getItemsByUserId = ({ userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber, hasParentalRating, isHd, is4K, locationTypes, excludeLocationTypes, isMissing, isUnaired, minCommunityRating, minCriticRating, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, filters, isFavorite, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, years, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, artists, excludeArtistIds, artistIds, albumArtistIds, contributingArtistIds, albums, albumIds, ids, videoTypes, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, collapseBoxSetItems, minWidth, minHeight, maxWidth, maxHeight, is3D, seriesStatus, nameStartsWithOrGreater, nameStartsWith, nameLessThan, studioIds, genreIds, enableTotalRecordCount, enableImages }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        userId,
...
* returns BaseItemDtoQueryResult
* */
const getResumeItems = ({ userId, startIndex, limit, searchTerm, parentId, fields, mediaTypes, enableUserData, imageTypeLimit, enableImageTypes, excludeItemTypes, includeItemTypes, enableTotalRecordCount, enableImages }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        userId,
