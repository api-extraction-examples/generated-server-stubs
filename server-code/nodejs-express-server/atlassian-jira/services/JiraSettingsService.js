...
* returns List
* */
const getAdvancedSettings = () => new Promise(
...
* returns List
* */
const getApplicationProperty = ({ key, permissionLevel, keyFilter }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        key,
...
* returns ApplicationProperty
* */
const setApplicationProperty = ({ id, simpleApplicationPropertyBean }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        id,
