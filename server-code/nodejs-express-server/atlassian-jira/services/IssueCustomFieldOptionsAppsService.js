...
* */
const createIssueFieldOption = ({ fieldKey, issueFieldOptionCreateBean }) => new Promise(
...
* */
const deleteIssueFieldOption = ({ fieldKey, optionId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        fieldKey,
...
* returns PageBeanIssueFieldOption
* */
const getAllIssueFieldOptions = ({ fieldKey, startAt, maxResults }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        fieldKey,
...
* returns IssueFieldOption
* */
const getIssueFieldOption = ({ fieldKey, optionId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        fieldKey,
...
* returns PageBeanIssueFieldOption
* */
const getSelectableIssueFieldOptions = ({ fieldKey, startAt, maxResults, projectId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        fieldKey,
...
* returns PageBeanIssueFieldOption
* */
const getVisibleIssueFieldOptions = ({ fieldKey, startAt, maxResults, projectId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        fieldKey,
...
* overrideScreenSecurity Boolean Whether screen security is overridden to enable hidden fields to be edited. Available to Connect and Forge app users with admin permission. (optional)
* overrideEditableFlag Boolean Whether screen security is overridden to enable uneditable fields to be edited. Available to Connect and Forge app users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). (optional)
* no response value expected for this operation
* */
const replaceIssueFieldOption = ({ fieldKey, optionId, replaceWith, jql, overrideScreenSecurity, overrideEditableFlag }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        fieldKey,
...
* returns IssueFieldOption
* */
const updateIssueFieldOption = ({ fieldKey, optionId, issueFieldOption }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        fieldKey,
