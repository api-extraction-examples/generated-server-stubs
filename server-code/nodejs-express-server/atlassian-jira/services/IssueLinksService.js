...
* */
const deleteIssueLink = ({ linkId }) => new Promise(
...
* returns IssueLink
* */
const getIssueLink = ({ linkId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        linkId,
...
*
* linkIssueRequestJsonBean LinkIssueRequestJsonBean The issue link request.
* returns oas_any_type_not_mapped
* */
const linkIssues = ({ linkIssueRequestJsonBean }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
