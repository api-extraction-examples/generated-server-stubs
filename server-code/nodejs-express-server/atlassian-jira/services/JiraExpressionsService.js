...
*
* jiraExpressionForAnalysis JiraExpressionForAnalysis The Jira expressions to analyse.
...
* returns JiraExpressionsAnalysis
* */
const analyseExpression = ({ jiraExpressionForAnalysis, check }) => new Promise(
...
*
* jiraExpressionEvalRequestBean JiraExpressionEvalRequestBean The Jira expression and the evaluation context.
* expand String Use [expand](#expansion) to include additional information in the response. This parameter accepts `meta.complexity` that returns information about the expression complexity. For example, the number of expensive operations used by the expression and how close the expression is to reaching the [complexity limit](https://developer.atlassian.com/cloud/jira/platform/jira-expressions/#restrictions). Useful when designing and debugging your expressions. (optional)
* returns JiraExpressionResult
* */
const evaluateJiraExpression = ({ jiraExpressionEvalRequestBean, expand }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
