...
public class ErrorResponse {
   ...
   */
  public ErrorResponse(String $schema, List<@Valid Error> errors) {
    this.$schema = $schema;
    this.errors = errors;
  }

  public ErrorResponse $schema(String $schema) {
    this.$schema = $schema;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.$schema, errorResponse.$schema) &&
