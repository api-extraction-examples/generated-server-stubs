...
public class ClipSummary {
   ...
   */
  public ClipSummary(List<@Valid AncestorSummary> ancestors, List<@Valid AvailableVersions> availableVersions, List<@Valid Image> images, String mediaType, NetworkSummary networkSummary, String pid, String releaseDate, String shortSynopsis, ProgrammeTitles titles, TypeEnum type) {
  ...
  public ClipSummary ancestors(List<@Valid AncestorSummary> ancestors) {
    this.ancestors = ancestors;
    return this;
  }

  public ClipSummary addAncestorsItem(AncestorSummary ancestorsItem) {
  ...
  */
  ...
  public ClipSummary availableVersions(List<@Valid AvailableVersions> availableVersions) {
    this.availableVersions = availableVersions;
    return this;
  }

  public ClipSummary addAvailableVersionsItem(AvailableVersions availableVersionsItem) {
  ...
  */
  ...
  public ClipSummary images(List<@Valid Image> images) {
    this.images = images;
    return this;
  }

  public ClipSummary addImagesItem(Image imagesItem) {
    if (this.images == null) {
  ...
  */
  ...
  public ClipSummary mediaType(String mediaType) {
    this.mediaType = mediaType;
    return this;
  }
  ...
  */
  ...
  public ClipSummary networkSummary(NetworkSummary networkSummary) {
    this.networkSummary = networkSummary;
    return this;
  }
  ...
  */
  ...
  public ClipSummary pid(String pid) {
    this.pid = pid;
    return this;
  }
  ...
  */
  ...
  public ClipSummary releaseDate(String releaseDate) {
    this.releaseDate = releaseDate;
    return this;
  }
  ...
  */
  ...
  public ClipSummary shortSynopsis(String shortSynopsis) {
    this.shortSynopsis = shortSynopsis;
    return this;
  }
  ...
  */
  ...
  public ClipSummary titles(ProgrammeTitles titles) {
    this.titles = titles;
    return this;
  }
  ...
  */
  ...
  public ClipSummary type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ClipSummary clipSummary = (ClipSummary) o;
    return Objects.equals(this.ancestors, clipSummary.ancestors) &&
        Objects.equals(this.availableVersions, clipSummary.availableVersions) &&
        Objects.equals(this.images, clipSummary.images) &&
        Objects.equals(this.mediaType, clipSummary.mediaType) &&
        Objects.equals(this.networkSummary, clipSummary.networkSummary) &&
        Objects.equals(this.pid, clipSummary.pid) &&
        Objects.equals(this.releaseDate, clipSummary.releaseDate) &&
        Objects.equals(this.shortSynopsis, clipSummary.shortSynopsis) &&
        Objects.equals(this.titles, clipSummary.titles) &&
        Objects.equals(this.type, clipSummary.type);
  }
