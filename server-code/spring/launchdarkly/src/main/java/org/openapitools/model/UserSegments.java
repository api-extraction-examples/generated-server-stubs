...
public class UserSegments {
  ...
  @Valid
  private List<@Valid UserSegment> items;
  ...
  */
  ...
  public UserSegments items(List<@Valid UserSegment> items) {
    this.items = items;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("items")
  public List<@Valid UserSegment> getItems() {
    return items;
  }

  public void setItems(List<@Valid UserSegment> items) {
    this.items = items;
  }
