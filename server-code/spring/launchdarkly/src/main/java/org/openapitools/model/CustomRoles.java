...
public class CustomRoles {
  ...
  @Valid
  private List<@Valid CustomRole> items;
  ...
  */
  ...
  public CustomRoles items(List<@Valid CustomRole> items) {
    this.items = items;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("items")
  public List<@Valid CustomRole> getItems() {
    return items;
  }

  public void setItems(List<@Valid CustomRole> items) {
    this.items = items;
  }
