...
public interface SubmissionsApi {
    ...
    @RequestMapping(
        ...
        value = "/submissions/{submission_id}",
        produces = { "application/json" }
    )
    
    default ResponseEntity<Void> deleteSubmission(
        @Parameter(name = "submission_id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("submission_id") String submissionId
    ) {
    ...
    default ResponseEntity<List<Submission>> listFormSubmission(
        @Parameter(name = "submission_id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("submission_id") String submissionId,
