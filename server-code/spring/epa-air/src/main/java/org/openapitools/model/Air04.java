...
@Schema(name = "air04", description = "Map Output Object")
@JsonTypeName("air04")
...
public class Air04 {
   ...
   */
  public Air04(String iconBaseURL, List<@Valid Air02> mapData, String popUpBaseURL, String queryID) {
  ...
  */
  ...
  public Air04 mapData(List<@Valid Air02> mapData) {
    this.mapData = mapData;
    return this;
  }
