...
import org.openapitools.model.EndUserLicenseAgreement;
...
public class EndUserLicenseAgreementResponse {
   ...
   */
  public EndUserLicenseAgreementResponse(EndUserLicenseAgreement data, DocumentLinks links) {
    this.data = data;
    this.links = links;
  }
  ...
  */
  ...
  public EndUserLicenseAgreementResponse included(List<@Valid Territory> included) {
