...
import org.openapitools.model.AppStoreReviewDetailRelationships;
...
public class AppStoreReviewDetail implements AppStoreVersionResponseIncludedInner {
   ...
   */
  public AppStoreReviewDetail(String id, ResourceLinks links, TypeEnum type) {
    this.id = id;
    this.links = links;
    this.type = type;
  }
