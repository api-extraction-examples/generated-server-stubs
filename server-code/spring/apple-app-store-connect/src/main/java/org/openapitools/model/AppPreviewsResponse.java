...
public class AppPreviewsResponse {
  ...
  @Valid
  private List<@Valid AppPreview> data = new ArrayList<>();
   ...
   */
  public AppPreviewsResponse(List<@Valid AppPreview> data, PagedDocumentLinks links) {
    this.data = data;
    this.links = links;
  }

  public AppPreviewsResponse data(List<@Valid AppPreview> data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid AppPreview> getData() {
    return data;
  }

  public void setData(List<@Valid AppPreview> data) {
    this.data = data;
  }
