...
import org.openapitools.model.AppAttributes;
import org.openapitools.model.AppRelationships;
...
public class App implements BetaGroupResponseIncludedInner, BetaTesterResponseIncludedInner, BuildResponseIncludedInner, BundleIdResponseIncludedInner, PreReleaseVersionsResponseIncludedInner {
   ...
   */
  public App(String id, ResourceLinks links, TypeEnum type) {
    this.id = id;
    this.links = links;
    this.type = type;
  }
