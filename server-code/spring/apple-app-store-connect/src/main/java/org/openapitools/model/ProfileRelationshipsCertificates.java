...
public class ProfileRelationshipsCertificates {
  ...
  @Valid
  private List<@Valid ProfileRelationshipsCertificatesDataInner> data;

  private AppRelationshipsAppInfosLinks links;

  private PagingInformation meta;

  public ProfileRelationshipsCertificates data(List<@Valid ProfileRelationshipsCertificatesDataInner> data) {
    this.data = data;
    return this;
  }
