...
public class AppScreenshotSetAppScreenshotsLinkagesResponse {
  ...
  @Valid
  private List<@Valid AppScreenshotSetRelationshipsAppScreenshotsDataInner> data = new ArrayList<>();
   ...
   */
  public AppScreenshotSetAppScreenshotsLinkagesResponse(List<@Valid AppScreenshotSetRelationshipsAppScreenshotsDataInner> data, PagedDocumentLinks links) {
    this.data = data;
    this.links = links;
  }

  public AppScreenshotSetAppScreenshotsLinkagesResponse data(List<@Valid AppScreenshotSetRelationshipsAppScreenshotsDataInner> data) {
    this.data = data;
    return this;
  }
