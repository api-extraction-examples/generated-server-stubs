...
public class BuildBetaDetailsResponse {
  ...
  @Valid
  private List<@Valid BuildBetaDetail> data = new ArrayList<>();
   ...
   */
  public BuildBetaDetailsResponse(List<@Valid BuildBetaDetail> data, PagedDocumentLinks links) {
    this.data = data;
    this.links = links;
  }

  public BuildBetaDetailsResponse data(List<@Valid BuildBetaDetail> data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid BuildBetaDetail> getData() {
    return data;
  }

  public void setData(List<@Valid BuildBetaDetail> data) {
    this.data = data;
  }

  public BuildBetaDetailsResponse included(List<@Valid Build> included) {
