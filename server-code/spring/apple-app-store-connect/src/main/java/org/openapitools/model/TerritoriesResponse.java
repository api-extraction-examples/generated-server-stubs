...
public class TerritoriesResponse {
  ...
  @Valid
  private List<@Valid Territory> data = new ArrayList<>();
   ...
   */
  public TerritoriesResponse(List<@Valid Territory> data, PagedDocumentLinks links) {
    this.data = data;
    this.links = links;
  }

  public TerritoriesResponse data(List<@Valid Territory> data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid Territory> getData() {
    return data;
  }

  public void setData(List<@Valid Territory> data) {
    this.data = data;
  }
