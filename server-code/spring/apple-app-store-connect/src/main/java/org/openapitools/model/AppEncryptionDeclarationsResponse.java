...
public class AppEncryptionDeclarationsResponse {
  ...
  @Valid
  private List<@Valid AppEncryptionDeclaration> data = new ArrayList<>();
   ...
   */
  public AppEncryptionDeclarationsResponse(List<@Valid AppEncryptionDeclaration> data, PagedDocumentLinks links) {
    this.data = data;
    this.links = links;
  }

  public AppEncryptionDeclarationsResponse data(List<@Valid AppEncryptionDeclaration> data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid AppEncryptionDeclaration> getData() {
    return data;
  }

  public void setData(List<@Valid AppEncryptionDeclaration> data) {
    this.data = data;
  }

  public AppEncryptionDeclarationsResponse included(List<@Valid App> included) {
