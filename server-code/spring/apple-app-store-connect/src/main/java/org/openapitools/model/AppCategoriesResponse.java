...
public class AppCategoriesResponse {
  ...
  @Valid
  private List<@Valid AppCategory> data = new ArrayList<>();
   ...
   */
  public AppCategoriesResponse(List<@Valid AppCategory> data, PagedDocumentLinks links) {
    this.data = data;
    this.links = links;
  }

  public AppCategoriesResponse data(List<@Valid AppCategory> data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid AppCategory> getData() {
    return data;
  }

  public void setData(List<@Valid AppCategory> data) {
    this.data = data;
  }

  public AppCategoriesResponse included(List<@Valid AppCategoriesResponseIncludedInner> included) {
