...
import org.openapitools.model.BundleIdAttributes;
import org.openapitools.model.BundleIdRelationships;
...
public class BundleId implements ProfileResponseIncludedInner {
   ...
   */
  public BundleId(String id, ResourceLinks links, TypeEnum type) {
    this.id = id;
    this.links = links;
    this.type = type;
  }
