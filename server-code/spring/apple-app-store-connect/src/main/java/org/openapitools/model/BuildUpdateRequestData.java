...
import org.openapitools.model.BuildUpdateRequestDataAttributes;
import org.openapitools.model.BuildUpdateRequestDataRelationships;
...
public class BuildUpdateRequestData {
   ...
   */
  public BuildUpdateRequestData(String id, TypeEnum type) {
    this.id = id;
    this.type = type;
  }
