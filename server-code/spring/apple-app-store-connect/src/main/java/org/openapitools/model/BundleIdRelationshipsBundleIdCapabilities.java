...
import org.openapitools.model.BundleIdRelationshipsBundleIdCapabilitiesDataInner;
...
public class BundleIdRelationshipsBundleIdCapabilities {
  ...
  @Valid
  private List<@Valid BundleIdRelationshipsBundleIdCapabilitiesDataInner> data;

  private AppRelationshipsAppInfosLinks links;

  private PagingInformation meta;

  public BundleIdRelationshipsBundleIdCapabilities data(List<@Valid BundleIdRelationshipsBundleIdCapabilitiesDataInner> data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid BundleIdRelationshipsBundleIdCapabilitiesDataInner> getData() {
    return data;
  }

  public void setData(List<@Valid BundleIdRelationshipsBundleIdCapabilitiesDataInner> data) {
    this.data = data;
  }

  public BundleIdRelationshipsBundleIdCapabilities links(AppRelationshipsAppInfosLinks links) {
    this.links = links;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, bundleIdRelationshipsBundleIdCapabilities.data) &&
        Objects.equals(this.links, bundleIdRelationshipsBundleIdCapabilities.links) &&
