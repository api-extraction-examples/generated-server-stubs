...
import org.openapitools.model.AppPricePointAttributes;
import org.openapitools.model.AppPricePointRelationships;
...
public class AppPricePoint {
   ...
   */
  public AppPricePoint(String id, ResourceLinks links, TypeEnum type) {
    this.id = id;
    this.links = links;
    this.type = type;
  }
