...
import org.openapitools.model.UserInvitation;
...
public class UserInvitationsResponse {
  ...
  @Valid
  private List<@Valid UserInvitation> data = new ArrayList<>();
   ...
   */
  public UserInvitationsResponse(List<@Valid UserInvitation> data, PagedDocumentLinks links) {
    this.data = data;
    this.links = links;
  }

  public UserInvitationsResponse data(List<@Valid UserInvitation> data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid UserInvitation> getData() {
    return data;
  }

  public void setData(List<@Valid UserInvitation> data) {
    this.data = data;
  }

  public UserInvitationsResponse included(List<@Valid App> included) {
