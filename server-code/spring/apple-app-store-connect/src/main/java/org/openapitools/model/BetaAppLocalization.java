...
import org.openapitools.model.BetaAppLocalizationAttributes;
...
public class BetaAppLocalization implements AppResponseIncludedInner {
   ...
   */
  public BetaAppLocalization(String id, ResourceLinks links, TypeEnum type) {
    this.id = id;
    this.links = links;
    this.type = type;
  }
