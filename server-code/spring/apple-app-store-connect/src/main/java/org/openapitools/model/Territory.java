...
import org.openapitools.model.TerritoryAttributes;
...
public class Territory implements AppResponseIncludedInner {
   ...
   */
  public Territory(String id, ResourceLinks links, TypeEnum type) {
    this.id = id;
    this.links = links;
    this.type = type;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, territory.attributes) &&
        Objects.equals(this.id, territory.id) &&
        Objects.equals(this.links, territory.links) &&
        Objects.equals(this.type, territory.type);
  }
