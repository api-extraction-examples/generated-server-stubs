...
import org.openapitools.model.DeviceAttributes;
...
public class Device implements ProfileResponseIncludedInner {
   ...
   */
  public Device(String id, ResourceLinks links, TypeEnum type) {
    this.id = id;
    this.links = links;
    this.type = type;
  }
