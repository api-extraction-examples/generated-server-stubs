...
import org.openapitools.model.EndUserLicenseAgreementUpdateRequestDataRelationships;
...
public class EndUserLicenseAgreementUpdateRequestData {
   ...
   */
  public EndUserLicenseAgreementUpdateRequestData(String id, TypeEnum type) {
    this.id = id;
    this.type = type;
  }
