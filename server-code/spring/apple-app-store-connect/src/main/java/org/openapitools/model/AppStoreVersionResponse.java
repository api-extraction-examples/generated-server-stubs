...
public class AppStoreVersionResponse {
   ...
   */
  public AppStoreVersionResponse(AppStoreVersion data, DocumentLinks links) {
    this.data = data;
    this.links = links;
  }
  ...
  */
  ...
  public AppStoreVersionResponse included(List<@Valid AppStoreVersionResponseIncludedInner> included) {
