...
import org.openapitools.model.AppPreviewSetAttributes;
import org.openapitools.model.AppPreviewSetRelationships;
...
public class AppPreviewSet implements AppStoreVersionLocalizationResponseIncludedInner {
   ...
   */
  public AppPreviewSet(String id, ResourceLinks links, TypeEnum type) {
    this.id = id;
    this.links = links;
    this.type = type;
  }
