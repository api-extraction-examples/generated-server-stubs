...
public class BetaBuildLocalizationsResponse {
  ...
  @Valid
  private List<@Valid BetaBuildLocalization> data = new ArrayList<>();
   ...
   */
  public BetaBuildLocalizationsResponse(List<@Valid BetaBuildLocalization> data, PagedDocumentLinks links) {
    this.data = data;
    this.links = links;
  }

  public BetaBuildLocalizationsResponse data(List<@Valid BetaBuildLocalization> data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid BetaBuildLocalization> getData() {
    return data;
  }

  public void setData(List<@Valid BetaBuildLocalization> data) {
    this.data = data;
  }

  public BetaBuildLocalizationsResponse included(List<@Valid Build> included) {
