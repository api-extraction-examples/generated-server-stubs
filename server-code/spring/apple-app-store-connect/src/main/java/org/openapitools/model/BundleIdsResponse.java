...
public class BundleIdsResponse {
  ...
  @Valid
  private List<@Valid BundleId> data = new ArrayList<>();
   ...
   */
  public BundleIdsResponse(List<@Valid BundleId> data, PagedDocumentLinks links) {
    this.data = data;
    this.links = links;
  }

  public BundleIdsResponse data(List<@Valid BundleId> data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid BundleId> getData() {
    return data;
  }

  public void setData(List<@Valid BundleId> data) {
    this.data = data;
  }

  public BundleIdsResponse included(List<@Valid BundleIdResponseIncludedInner> included) {
    this.included = included;
    return this;
  }

  public BundleIdsResponse addIncludedItem(BundleIdResponseIncludedInner includedItem) {
