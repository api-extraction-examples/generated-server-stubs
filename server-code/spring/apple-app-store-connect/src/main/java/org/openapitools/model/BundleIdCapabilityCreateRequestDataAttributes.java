...
public class BundleIdCapabilityCreateRequestDataAttributes {
   ...
   */
  public BundleIdCapabilityCreateRequestDataAttributes(CapabilityType capabilityType) {
  ...
  */
  @NotNull @Valid 
  @Schema(name = "capabilityType", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public BundleIdCapabilityCreateRequestDataAttributes settings(List<@Valid CapabilitySetting> settings) {
