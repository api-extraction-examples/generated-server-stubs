...
public class PreReleaseVersionsResponse {
  ...
  @Valid
  private List<@Valid PrereleaseVersion> data = new ArrayList<>();
   ...
   */
  public PreReleaseVersionsResponse(List<@Valid PrereleaseVersion> data, PagedDocumentLinks links) {
    this.data = data;
    this.links = links;
  }

  public PreReleaseVersionsResponse data(List<@Valid PrereleaseVersion> data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid PrereleaseVersion> getData() {
    return data;
  }

  public void setData(List<@Valid PrereleaseVersion> data) {
    this.data = data;
  }

  public PreReleaseVersionsResponse included(List<@Valid PreReleaseVersionsResponseIncludedInner> included) {
