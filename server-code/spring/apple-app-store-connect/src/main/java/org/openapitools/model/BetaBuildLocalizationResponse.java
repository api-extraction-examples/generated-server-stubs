...
public class BetaBuildLocalizationResponse {
   ...
   */
  public BetaBuildLocalizationResponse(BetaBuildLocalization data, DocumentLinks links) {
    this.data = data;
    this.links = links;
  }
  ...
  */
  ...
  public BetaBuildLocalizationResponse included(List<@Valid Build> included) {
