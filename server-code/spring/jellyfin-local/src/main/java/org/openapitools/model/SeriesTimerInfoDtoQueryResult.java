...
public class SeriesTimerInfoDtoQueryResult {
  ...
  @Valid
  private JsonNullable<List<@Valid SeriesTimerInfoDto>> items = JsonNullable.<List<@Valid SeriesTimerInfoDto>>undefined();

  private Integer startIndex;

  private Integer totalRecordCount;

  public SeriesTimerInfoDtoQueryResult items(List<@Valid SeriesTimerInfoDto> items) {
  ...
  */
  ...
  @JsonProperty("Items")
  public JsonNullable<List<@Valid SeriesTimerInfoDto>> getItems() {
    return items;
  }

  public void setItems(JsonNullable<List<@Valid SeriesTimerInfoDto>> items) {
    this.items = items;
  }
