...
@Schema(name = "FileSystemEntryInfo", description = "Class FileSystemEntryInfo.")
...
public class FileSystemEntryInfo {
  ...
  public FileSystemEntryInfo name(String name) {
  ...
  */
  ...
  public FileSystemEntryInfo path(String path) {
  ...
  */
  ...
  @Schema(name = "Path", accessMode = Schema.AccessMode.READ_ONLY, description = "Gets the path.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("Path")
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, fileSystemEntryInfo.name) &&
        equalsNullable(this.path, fileSystemEntryInfo.path) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(name), hashCodeNullable(path), type);
  }
