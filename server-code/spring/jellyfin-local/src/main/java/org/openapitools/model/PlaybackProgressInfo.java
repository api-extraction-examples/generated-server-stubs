...
@Schema(name = "PlaybackProgressInfo", description = "Class PlaybackProgressInfo.")
...
public class PlaybackProgressInfo {
  ...
  */
  ...
  public PlaybackProgressInfo nowPlayingQueue(List<@Valid QueueItem> nowPlayingQueue) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.aspectRatio, playbackProgressInfo.aspectRatio) &&
