...
public class MovieInfo {
  ...
  */
  ...
  public MovieInfo providerIds(Map<String, String> providerIds) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.indexNumber, movieInfo.indexNumber) &&
        ...
        equalsNullable(this.name, movieInfo.name) &&
