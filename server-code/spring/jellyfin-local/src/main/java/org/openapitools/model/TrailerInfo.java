...
public class TrailerInfo {
  ...
  */
  ...
  public TrailerInfo providerIds(Map<String, String> providerIds) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.indexNumber, trailerInfo.indexNumber) &&
        ...
        equalsNullable(this.name, trailerInfo.name) &&
