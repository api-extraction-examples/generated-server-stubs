...
public class TimerInfoDtoQueryResult {
  ...
  @Valid
  private JsonNullable<List<@Valid TimerInfoDto>> items = JsonNullable.<List<@Valid TimerInfoDto>>undefined();

  private Integer startIndex;

  private Integer totalRecordCount;

  public TimerInfoDtoQueryResult items(List<@Valid TimerInfoDto> items) {
  ...
  */
  ...
  @JsonProperty("Items")
  public JsonNullable<List<@Valid TimerInfoDto>> getItems() {
    return items;
  }

  public void setItems(JsonNullable<List<@Valid TimerInfoDto>> items) {
    this.items = items;
  }

  public TimerInfoDtoQueryResult startIndex(Integer startIndex) {
  ...
  */
  ...
  public TimerInfoDtoQueryResult totalRecordCount(Integer totalRecordCount) {
