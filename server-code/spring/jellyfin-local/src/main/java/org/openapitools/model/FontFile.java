...
@Schema(name = "FontFile", description = "Class FontFile.")
...
public class FontFile {
  ...
  public FontFile dateCreated(OffsetDateTime dateCreated) {
  ...
  */
  ...
  public FontFile dateModified(OffsetDateTime dateModified) {
  ...
  */
  ...
  public FontFile name(String name) {
  ...
  */
  ...
  public FontFile size(Long size) {
    this.size = size;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dateCreated, fontFile.dateCreated) &&
        Objects.equals(this.dateModified, fontFile.dateModified) &&
        equalsNullable(this.name, fontFile.name) &&
