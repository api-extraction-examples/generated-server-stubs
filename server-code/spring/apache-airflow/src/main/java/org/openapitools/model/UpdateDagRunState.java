...
@Schema(name = "UpdateDagRunState", description = "Modify the state of a DAG run.  *New in version 2.2.0* ")
...
public class UpdateDagRunState {
  ...
  */
  ...
  @Schema(name = "state", description = "The state to set this DagRun", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("state")
