...
@Schema(name = "ConfigOption", description = "The option of configuration.")
...
public class ConfigOption {
  ...
  */
  ...
  @Schema(name = "key", accessMode = Schema.AccessMode.READ_ONLY, requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("key")
