...
@Schema(name = "ImportErrorCollection", description = "Collection of import errors.  *Changed in version 2.1.0*&#58; 'total_entries' field is added. ")
...
public class ImportErrorCollection {
  ...
  @Valid
  private List<@Valid ImportError> importErrors;
  ...
  */
  ...
  public ImportErrorCollection importErrors(List<@Valid ImportError> importErrors) {
  ...
  */
  ...
  public List<@Valid ImportError> getImportErrors() {
    return importErrors;
  }

  public void setImportErrors(List<@Valid ImportError> importErrors) {
    this.importErrors = importErrors;
  }
