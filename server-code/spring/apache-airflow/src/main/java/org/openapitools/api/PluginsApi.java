...
public interface PluginsApi {
    ...
    /**
     * GET /plugins : Get a list of loaded plugins
    ...
    @Operation(
        ...
        description = "Get a list of loaded plugins.  *New in version 2.1.0* ",
        tags = { "Plugin" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = PluginCollection.class))
            }),
    ...
    default ResponseEntity<PluginCollection> getPlugins(
