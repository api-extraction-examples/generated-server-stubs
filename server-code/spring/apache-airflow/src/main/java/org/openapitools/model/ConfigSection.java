...
import org.openapitools.model.ConfigOption;
...
@Schema(name = "ConfigSection", description = "The section of configuration.")
...
public class ConfigSection {
  ...
  @Valid
  private List<@Valid ConfigOption> options;
  ...
  */
  ...
  public ConfigSection options(List<@Valid ConfigOption> options) {
  ...
  */
  ...
  public List<@Valid ConfigOption> getOptions() {
    return options;
  }

  public void setOptions(List<@Valid ConfigOption> options) {
    this.options = options;
  }
