...
@JsonTypeName("postPaymentsSepaCreditTransfersOKBodyTransfer")
...
public class PostPaymentsSepaCreditTransfersOKBodyTransfer {
   ...
   */
  public PostPaymentsSepaCreditTransfersOKBodyTransfer(String paymentId, TransactionStatusEnum transactionStatus) {
