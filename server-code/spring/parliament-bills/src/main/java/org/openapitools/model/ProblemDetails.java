...
public class ProblemDetails {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.detail, problemDetails.detail) &&
        ...
        equalsNullable(this.type, problemDetails.type) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(detail), hashCodeNullable(instance), hashCodeNullable(status), hashCodeNullable(title), hashCodeNullable(type), additionalProperties);
  }
