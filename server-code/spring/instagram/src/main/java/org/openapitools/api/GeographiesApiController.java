...
@Controller
@RequestMapping("${openapi.instagram.base-path:/v1}")
public class GeographiesApiController implements GeographiesApi {

    private final NativeWebRequest request;

    @Autowired
    public GeographiesApiController(NativeWebRequest request) {
