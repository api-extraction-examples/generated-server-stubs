...
public class TagInfoResponse {
  ...
  public TagInfoResponse data(TagInfo data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  public TagInfoResponse meta(MetaData meta) {
    this.meta = meta;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    TagInfoResponse tagInfoResponse = (TagInfoResponse) o;
    return Objects.equals(this.data, tagInfoResponse.data) &&
        Objects.equals(this.meta, tagInfoResponse.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class TagInfoResponse {\n");
