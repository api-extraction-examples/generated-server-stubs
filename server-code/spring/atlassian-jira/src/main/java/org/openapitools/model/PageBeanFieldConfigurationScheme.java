...
@Schema(name = "PageBeanFieldConfigurationScheme", description = "A page of items.")
...
public class PageBeanFieldConfigurationScheme {
  ...
  @Valid
  private List<@Valid FieldConfigurationScheme> values;

  public PageBeanFieldConfigurationScheme isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanFieldConfigurationScheme maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanFieldConfigurationScheme nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanFieldConfigurationScheme self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanFieldConfigurationScheme startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanFieldConfigurationScheme total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanFieldConfigurationScheme values(List<@Valid FieldConfigurationScheme> values) {
    this.values = values;
    return this;
  }

  public PageBeanFieldConfigurationScheme addValuesItem(FieldConfigurationScheme valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid FieldConfigurationScheme> getValues() {
    return values;
  }

  public void setValues(List<@Valid FieldConfigurationScheme> values) {
    this.values = values;
  }
