...
@Schema(name = "PageBeanCustomFieldContextOption", description = "A page of items.")
...
public class PageBeanCustomFieldContextOption {
  ...
  @Valid
  private List<@Valid CustomFieldContextOption> values;

  public PageBeanCustomFieldContextOption isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanCustomFieldContextOption maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanCustomFieldContextOption nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanCustomFieldContextOption self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanCustomFieldContextOption startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanCustomFieldContextOption total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanCustomFieldContextOption values(List<@Valid CustomFieldContextOption> values) {
    this.values = values;
    return this;
  }

  public PageBeanCustomFieldContextOption addValuesItem(CustomFieldContextOption valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid CustomFieldContextOption> getValues() {
    return values;
  }

  public void setValues(List<@Valid CustomFieldContextOption> values) {
    this.values = values;
  }
