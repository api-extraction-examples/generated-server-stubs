...
@Schema(name = "IssueTypeScreenSchemeUpdateDetails", description = "Details of an issue type screen scheme.")
...
public class IssueTypeScreenSchemeUpdateDetails {
  ...
  */
  ...
  @Schema(name = "name", description = "The name of the issue type screen scheme. The name must be unique. The maximum length is 255 characters.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
