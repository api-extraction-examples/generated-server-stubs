...
@Schema(name = "Worklog_updateAuthor", description = "Details of the user who last updated the worklog.")
@JsonTypeName("Worklog_updateAuthor")
...
public class WorklogUpdateAuthor {
  ...
  */
  ...
  public WorklogUpdateAuthor accountType(String accountType) {
  ...
  */
  ...
  public WorklogUpdateAuthor active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  */
  ...
  public WorklogUpdateAuthor avatarUrls(UserAvatarUrls avatarUrls) {
  ...
  */
  ...
  public WorklogUpdateAuthor displayName(String displayName) {
  ...
  */
  ...
  public WorklogUpdateAuthor emailAddress(String emailAddress) {
  ...
  */
  ...
  public WorklogUpdateAuthor key(String key) {
    this.key = key;
    return this;
  }
  ...
  */
  ...
  public WorklogUpdateAuthor name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public WorklogUpdateAuthor self(String self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public WorklogUpdateAuthor timeZone(String timeZone) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, worklogUpdateAuthor.accountId) &&
        ...
        Objects.equals(this.self, worklogUpdateAuthor.self) &&
