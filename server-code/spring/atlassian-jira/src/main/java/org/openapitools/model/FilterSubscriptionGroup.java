...
@Schema(name = "FilterSubscription_group", description = "The group subscribing to filter.")
...
public class FilterSubscriptionGroup {
  ...
  */
  ...
  public FilterSubscriptionGroup self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.groupId, filterSubscriptionGroup.groupId) &&
        Objects.equals(this.name, filterSubscriptionGroup.name) &&
