...
@Schema(name = "FilterDetails_owner", description = "The user who owns the filter. Defaults to the creator of the filter, however, Jira administrators can change the owner of a shared filter in the admin settings.")
@JsonTypeName("FilterDetails_owner")
...
public class FilterDetailsOwner {
  ...
  */
  ...
  public FilterDetailsOwner accountType(AccountTypeEnum accountType) {
  ...
  */
  ...
  public FilterDetailsOwner active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  */
  ...
  public FilterDetailsOwner avatarUrls(UserAvatarUrls avatarUrls) {
  ...
  */
  ...
  public FilterDetailsOwner displayName(String displayName) {
  ...
  */
  ...
  public FilterDetailsOwner emailAddress(String emailAddress) {
  ...
  */
  ...
  public FilterDetailsOwner expand(String expand) {
    this.expand = expand;
    return this;
  }
  ...
  */
  ...
  public FilterDetailsOwner locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  */
  ...
  public FilterDetailsOwner self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public FilterDetailsOwner timeZone(String timeZone) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, filterDetailsOwner.accountId) &&
        ...
        Objects.equals(this.self, filterDetailsOwner.self) &&
