...
@Schema(name = "PageBeanUserDetails", description = "A page of items.")
...
public class PageBeanUserDetails {
  ...
  @Valid
  private List<@Valid UserDetails> values;

  public PageBeanUserDetails isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanUserDetails maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanUserDetails nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanUserDetails self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanUserDetails startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanUserDetails total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanUserDetails values(List<@Valid UserDetails> values) {
    this.values = values;
    return this;
  }

  public PageBeanUserDetails addValuesItem(UserDetails valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid UserDetails> getValues() {
    return values;
  }

  public void setValues(List<@Valid UserDetails> values) {
    this.values = values;
  }
