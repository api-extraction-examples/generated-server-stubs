...
@Schema(name = "PageBeanWebhook", description = "A page of items.")
...
public class PageBeanWebhook {
  ...
  @Valid
  private List<@Valid Webhook> values;

  public PageBeanWebhook isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanWebhook maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanWebhook nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanWebhook self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanWebhook startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanWebhook total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanWebhook values(List<@Valid Webhook> values) {
    this.values = values;
    return this;
  }

  public PageBeanWebhook addValuesItem(Webhook valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid Webhook> getValues() {
    return values;
  }

  public void setValues(List<@Valid Webhook> values) {
    this.values = values;
  }
