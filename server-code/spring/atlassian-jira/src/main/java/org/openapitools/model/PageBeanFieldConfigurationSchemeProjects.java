...
import org.openapitools.model.FieldConfigurationSchemeProjects;
...
@Schema(name = "PageBeanFieldConfigurationSchemeProjects", description = "A page of items.")
...
public class PageBeanFieldConfigurationSchemeProjects {
  ...
  @Valid
  private List<@Valid FieldConfigurationSchemeProjects> values;

  public PageBeanFieldConfigurationSchemeProjects isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanFieldConfigurationSchemeProjects maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanFieldConfigurationSchemeProjects nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanFieldConfigurationSchemeProjects self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanFieldConfigurationSchemeProjects startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanFieldConfigurationSchemeProjects total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanFieldConfigurationSchemeProjects values(List<@Valid FieldConfigurationSchemeProjects> values) {
    this.values = values;
    return this;
  }

  public PageBeanFieldConfigurationSchemeProjects addValuesItem(FieldConfigurationSchemeProjects valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid FieldConfigurationSchemeProjects> getValues() {
    return values;
  }

  public void setValues(List<@Valid FieldConfigurationSchemeProjects> values) {
    this.values = values;
  }
