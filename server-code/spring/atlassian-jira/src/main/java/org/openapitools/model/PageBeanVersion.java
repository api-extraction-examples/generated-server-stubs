...
@Schema(name = "PageBeanVersion", description = "A page of items.")
...
public class PageBeanVersion {
  ...
  @Valid
  private List<@Valid Version> values;

  public PageBeanVersion isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanVersion maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanVersion nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanVersion self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanVersion startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanVersion total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanVersion values(List<@Valid Version> values) {
    this.values = values;
    return this;
  }

  public PageBeanVersion addValuesItem(Version valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid Version> getValues() {
    return values;
  }

  public void setValues(List<@Valid Version> values) {
    this.values = values;
  }
