...
@Schema(name = "ProjectFeatureState", description = "Details of the feature state.")
...
public class ProjectFeatureState {
  ...
  */
  ...
  @Schema(name = "state", description = "The feature state.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("state")
