...
import org.openapitools.model.ComponentWithIssueCount;
...
@Schema(name = "PageBeanComponentWithIssueCount", description = "A page of items.")
...
public class PageBeanComponentWithIssueCount {
  ...
  @Valid
  private List<@Valid ComponentWithIssueCount> values;

  public PageBeanComponentWithIssueCount isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanComponentWithIssueCount maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanComponentWithIssueCount nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanComponentWithIssueCount self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanComponentWithIssueCount startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanComponentWithIssueCount total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanComponentWithIssueCount values(List<@Valid ComponentWithIssueCount> values) {
    this.values = values;
    return this;
  }

  public PageBeanComponentWithIssueCount addValuesItem(ComponentWithIssueCount valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid ComponentWithIssueCount> getValues() {
    return values;
  }

  public void setValues(List<@Valid ComponentWithIssueCount> values) {
    this.values = values;
  }
