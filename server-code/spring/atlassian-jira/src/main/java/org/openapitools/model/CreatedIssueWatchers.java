...
@Schema(name = "CreatedIssue_watchers", description = "The response code and messages related to any requested watchers.")
...
public class CreatedIssueWatchers {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    CreatedIssueWatchers createdIssueWatchers = (CreatedIssueWatchers) o;
    return Objects.equals(this.errorCollection, createdIssueWatchers.errorCollection) &&
        Objects.equals(this.status, createdIssueWatchers.status) &&
        Objects.equals(this.warningCollection, createdIssueWatchers.warningCollection);
  }
