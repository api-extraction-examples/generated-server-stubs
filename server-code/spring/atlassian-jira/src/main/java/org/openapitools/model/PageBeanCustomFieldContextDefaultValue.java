...
@Schema(name = "PageBeanCustomFieldContextDefaultValue", description = "A page of items.")
...
public class PageBeanCustomFieldContextDefaultValue {
  ...
  @Valid
  private List<@Valid CustomFieldContextDefaultValue> values;

  public PageBeanCustomFieldContextDefaultValue isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanCustomFieldContextDefaultValue maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanCustomFieldContextDefaultValue nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanCustomFieldContextDefaultValue self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanCustomFieldContextDefaultValue startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanCustomFieldContextDefaultValue total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanCustomFieldContextDefaultValue values(List<@Valid CustomFieldContextDefaultValue> values) {
    this.values = values;
    return this;
  }

  public PageBeanCustomFieldContextDefaultValue addValuesItem(CustomFieldContextDefaultValue valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid CustomFieldContextDefaultValue> getValues() {
    return values;
  }

  public void setValues(List<@Valid CustomFieldContextDefaultValue> values) {
    this.values = values;
  }
