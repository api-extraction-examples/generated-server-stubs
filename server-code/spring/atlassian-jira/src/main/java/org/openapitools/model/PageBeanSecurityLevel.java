...
@Schema(name = "PageBeanSecurityLevel", description = "A page of items.")
...
public class PageBeanSecurityLevel {
  ...
  @Valid
  private List<@Valid SecurityLevel> values;

  public PageBeanSecurityLevel isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanSecurityLevel maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanSecurityLevel nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanSecurityLevel self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanSecurityLevel startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanSecurityLevel total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanSecurityLevel values(List<@Valid SecurityLevel> values) {
    this.values = values;
    return this;
  }

  public PageBeanSecurityLevel addValuesItem(SecurityLevel valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid SecurityLevel> getValues() {
    return values;
  }

  public void setValues(List<@Valid SecurityLevel> values) {
    this.values = values;
  }
