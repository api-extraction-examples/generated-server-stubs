...
import org.openapitools.model.FilterDetails;
...
@Schema(name = "PageBeanFilterDetails", description = "A page of items.")
...
public class PageBeanFilterDetails {
  ...
  @Valid
  private List<@Valid FilterDetails> values;

  public PageBeanFilterDetails isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanFilterDetails maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanFilterDetails nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanFilterDetails self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanFilterDetails startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanFilterDetails total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanFilterDetails values(List<@Valid FilterDetails> values) {
    this.values = values;
    return this;
  }

  public PageBeanFilterDetails addValuesItem(FilterDetails valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid FilterDetails> getValues() {
    return values;
  }

  public void setValues(List<@Valid FilterDetails> values) {
    this.values = values;
  }
