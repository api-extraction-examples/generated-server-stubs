...
@Schema(name = "PageBeanUser", description = "A page of items.")
...
public class PageBeanUser {
  ...
  @Valid
  private List<@Valid User> values;

  public PageBeanUser isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanUser maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanUser nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanUser self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanUser startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanUser total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanUser values(List<@Valid User> values) {
    this.values = values;
    return this;
  }

  public PageBeanUser addValuesItem(User valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid User> getValues() {
    return values;
  }

  public void setValues(List<@Valid User> values) {
    this.values = values;
  }
