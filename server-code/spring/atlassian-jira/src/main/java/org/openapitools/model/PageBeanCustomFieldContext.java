...
import org.openapitools.model.CustomFieldContext;
...
@Schema(name = "PageBeanCustomFieldContext", description = "A page of items.")
...
public class PageBeanCustomFieldContext {
  ...
  @Valid
  private List<@Valid CustomFieldContext> values;

  public PageBeanCustomFieldContext isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanCustomFieldContext maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanCustomFieldContext nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanCustomFieldContext self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanCustomFieldContext startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanCustomFieldContext total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanCustomFieldContext values(List<@Valid CustomFieldContext> values) {
    this.values = values;
    return this;
  }

  public PageBeanCustomFieldContext addValuesItem(CustomFieldContext valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid CustomFieldContext> getValues() {
    return values;
  }

  public void setValues(List<@Valid CustomFieldContext> values) {
    this.values = values;
  }
