...
@Schema(name = "PageBeanDashboard", description = "A page of items.")
...
public class PageBeanDashboard {
  ...
  @Valid
  private List<@Valid Dashboard> values;
  ...
  */
  ...
  public PageBeanDashboard nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanDashboard self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanDashboard values(List<@Valid Dashboard> values) {
    this.values = values;
    return this;
  }

  public PageBeanDashboard addValuesItem(Dashboard valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid Dashboard> getValues() {
    return values;
  }

  public void setValues(List<@Valid Dashboard> values) {
    this.values = values;
  }
