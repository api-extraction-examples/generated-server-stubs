...
import org.openapitools.model.ContextForProjectAndIssueType;
...
@Schema(name = "PageBeanContextForProjectAndIssueType", description = "A page of items.")
...
public class PageBeanContextForProjectAndIssueType {
  ...
  @Valid
  private List<@Valid ContextForProjectAndIssueType> values;

  public PageBeanContextForProjectAndIssueType isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanContextForProjectAndIssueType maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanContextForProjectAndIssueType nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanContextForProjectAndIssueType self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanContextForProjectAndIssueType startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanContextForProjectAndIssueType total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanContextForProjectAndIssueType values(List<@Valid ContextForProjectAndIssueType> values) {
    this.values = values;
    return this;
  }

  public PageBeanContextForProjectAndIssueType addValuesItem(ContextForProjectAndIssueType valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid ContextForProjectAndIssueType> getValues() {
    return values;
  }

  public void setValues(List<@Valid ContextForProjectAndIssueType> values) {
    this.values = values;
  }
