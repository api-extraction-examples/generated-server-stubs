...
import org.openapitools.model.ScreenWithTab;
...
@Schema(name = "PageBeanScreenWithTab", description = "A page of items.")
...
public class PageBeanScreenWithTab {
  ...
  @Valid
  private List<@Valid ScreenWithTab> values;

  public PageBeanScreenWithTab isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanScreenWithTab maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanScreenWithTab nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanScreenWithTab self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanScreenWithTab startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanScreenWithTab total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanScreenWithTab values(List<@Valid ScreenWithTab> values) {
    this.values = values;
    return this;
  }

  public PageBeanScreenWithTab addValuesItem(ScreenWithTab valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid ScreenWithTab> getValues() {
    return values;
  }

  public void setValues(List<@Valid ScreenWithTab> values) {
    this.values = values;
  }
