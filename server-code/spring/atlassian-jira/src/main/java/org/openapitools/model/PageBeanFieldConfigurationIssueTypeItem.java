...
import org.openapitools.model.FieldConfigurationIssueTypeItem;
...
@Schema(name = "PageBeanFieldConfigurationIssueTypeItem", description = "A page of items.")
...
public class PageBeanFieldConfigurationIssueTypeItem {
  ...
  @Valid
  private List<@Valid FieldConfigurationIssueTypeItem> values;

  public PageBeanFieldConfigurationIssueTypeItem isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanFieldConfigurationIssueTypeItem maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanFieldConfigurationIssueTypeItem nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanFieldConfigurationIssueTypeItem self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanFieldConfigurationIssueTypeItem startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanFieldConfigurationIssueTypeItem total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanFieldConfigurationIssueTypeItem values(List<@Valid FieldConfigurationIssueTypeItem> values) {
    this.values = values;
    return this;
  }

  public PageBeanFieldConfigurationIssueTypeItem addValuesItem(FieldConfigurationIssueTypeItem valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid FieldConfigurationIssueTypeItem> getValues() {
    return values;
  }

  public void setValues(List<@Valid FieldConfigurationIssueTypeItem> values) {
    this.values = values;
  }
