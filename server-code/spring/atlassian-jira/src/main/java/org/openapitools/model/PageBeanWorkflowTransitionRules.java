...
@Schema(name = "PageBeanWorkflowTransitionRules", description = "A page of items.")
...
public class PageBeanWorkflowTransitionRules {
  ...
  @Valid
  private List<@Valid WorkflowTransitionRules> values;

  public PageBeanWorkflowTransitionRules isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanWorkflowTransitionRules maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanWorkflowTransitionRules nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanWorkflowTransitionRules self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanWorkflowTransitionRules startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanWorkflowTransitionRules total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanWorkflowTransitionRules values(List<@Valid WorkflowTransitionRules> values) {
    this.values = values;
    return this;
  }

  public PageBeanWorkflowTransitionRules addValuesItem(WorkflowTransitionRules valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid WorkflowTransitionRules> getValues() {
    return values;
  }

  public void setValues(List<@Valid WorkflowTransitionRules> values) {
    this.values = values;
  }
