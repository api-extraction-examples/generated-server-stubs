...
@Schema(name = "PageBeanIssueTypeScheme", description = "A page of items.")
...
public class PageBeanIssueTypeScheme {
  ...
  @Valid
  private List<@Valid IssueTypeScheme> values;

  public PageBeanIssueTypeScheme isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanIssueTypeScheme maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanIssueTypeScheme nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanIssueTypeScheme self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanIssueTypeScheme startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanIssueTypeScheme total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanIssueTypeScheme values(List<@Valid IssueTypeScheme> values) {
    this.values = values;
    return this;
  }

  public PageBeanIssueTypeScheme addValuesItem(IssueTypeScheme valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid IssueTypeScheme> getValues() {
    return values;
  }

  public void setValues(List<@Valid IssueTypeScheme> values) {
    this.values = values;
  }
