...
@Schema(name = "ProjectComponent_realAssignee", description = "The user assigned to issues created with this component, when `assigneeType` does not identify a valid assignee.")
@JsonTypeName("ProjectComponent_realAssignee")
...
public class ProjectComponentRealAssignee {
  ...
  */
  ...
  public ProjectComponentRealAssignee accountType(AccountTypeEnum accountType) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, projectComponentRealAssignee.accountId) &&
        ...
        Objects.equals(this.self, projectComponentRealAssignee.self) &&
