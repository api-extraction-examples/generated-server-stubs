...
@Schema(name = "ProjectComponent_lead", description = "The user details for the component's lead user.")
@JsonTypeName("ProjectComponent_lead")
...
public class ProjectComponentLead {
  ...
  */
  ...
  public ProjectComponentLead accountType(AccountTypeEnum accountType) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, projectComponentLead.accountId) &&
        ...
        Objects.equals(this.self, projectComponentLead.self) &&
