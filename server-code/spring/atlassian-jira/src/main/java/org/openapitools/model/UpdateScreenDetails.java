...
@Schema(name = "UpdateScreenDetails", description = "Details of a screen.")
...
public class UpdateScreenDetails {
  ...
  */
  ...
  @Schema(name = "name", description = "The name of the screen. The name must be unique. The maximum length is 255 characters.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
