...
@Schema(name = "PageBeanWorkflow", description = "A page of items.")
...
public class PageBeanWorkflow {
  ...
  @Valid
  private List<@Valid Workflow> values;
  ...
  */
  ...
  public PageBeanWorkflow values(List<@Valid Workflow> values) {
    this.values = values;
    return this;
  }

  public PageBeanWorkflow addValuesItem(Workflow valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid Workflow> getValues() {
    return values;
  }

  public void setValues(List<@Valid Workflow> values) {
    this.values = values;
  }
