...
@Schema(name = "Filter_owner", description = "The user who owns the filter. This is defaulted to the creator of the filter, however Jira administrators can change the owner of a shared filter in the admin settings.")
@JsonTypeName("Filter_owner")
...
public class FilterOwner {
  ...
  */
  ...
  public FilterOwner accountType(AccountTypeEnum accountType) {
  ...
  */
  ...
  public FilterOwner active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  */
  ...
  public FilterOwner avatarUrls(UserAvatarUrls avatarUrls) {
  ...
  */
  ...
  public FilterOwner displayName(String displayName) {
  ...
  */
  ...
  public FilterOwner emailAddress(String emailAddress) {
  ...
  */
  ...
  public FilterOwner expand(String expand) {
    this.expand = expand;
    return this;
  }
  ...
  */
  ...
  public FilterOwner locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  */
  ...
  public FilterOwner self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public FilterOwner timeZone(String timeZone) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, filterOwner.accountId) &&
        ...
        Objects.equals(this.self, filterOwner.self) &&
