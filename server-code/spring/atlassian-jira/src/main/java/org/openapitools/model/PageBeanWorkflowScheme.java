...
@Schema(name = "PageBeanWorkflowScheme", description = "A page of items.")
...
public class PageBeanWorkflowScheme {
  ...
  @Valid
  private List<@Valid WorkflowScheme> values;

  public PageBeanWorkflowScheme isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanWorkflowScheme maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanWorkflowScheme nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanWorkflowScheme self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanWorkflowScheme startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanWorkflowScheme total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanWorkflowScheme values(List<@Valid WorkflowScheme> values) {
    this.values = values;
    return this;
  }

  public PageBeanWorkflowScheme addValuesItem(WorkflowScheme valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid WorkflowScheme> getValues() {
    return values;
  }

  public void setValues(List<@Valid WorkflowScheme> values) {
    this.values = values;
  }
