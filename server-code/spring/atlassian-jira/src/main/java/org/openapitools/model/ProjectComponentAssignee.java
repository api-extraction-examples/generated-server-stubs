...
@Schema(name = "ProjectComponent_assignee", description = "The details of the user associated with `assigneeType`, if any. See `realAssignee` for details of the user assigned to issues created with this component.")
@JsonTypeName("ProjectComponent_assignee")
...
public class ProjectComponentAssignee {
  ...
  */
  ...
  public ProjectComponentAssignee accountType(AccountTypeEnum accountType) {
  ...
  */
  ...
  public ProjectComponentAssignee active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  */
  ...
  public ProjectComponentAssignee avatarUrls(UserAvatarUrls avatarUrls) {
  ...
  */
  ...
  public ProjectComponentAssignee displayName(String displayName) {
  ...
  */
  ...
  public ProjectComponentAssignee emailAddress(String emailAddress) {
  ...
  */
  ...
  public ProjectComponentAssignee expand(String expand) {
    this.expand = expand;
    return this;
  }
  ...
  */
  ...
  public ProjectComponentAssignee locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  */
  ...
  public ProjectComponentAssignee self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public ProjectComponentAssignee timeZone(String timeZone) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, projectComponentAssignee.accountId) &&
        ...
        Objects.equals(this.self, projectComponentAssignee.self) &&
