...
import org.openapitools.model.ScreenScheme;
...
@Schema(name = "PageBeanScreenScheme", description = "A page of items.")
...
public class PageBeanScreenScheme {
  ...
  @Valid
  private List<@Valid ScreenScheme> values;

  public PageBeanScreenScheme isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanScreenScheme maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanScreenScheme nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanScreenScheme self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanScreenScheme startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanScreenScheme total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanScreenScheme values(List<@Valid ScreenScheme> values) {
    this.values = values;
    return this;
  }

  public PageBeanScreenScheme addValuesItem(ScreenScheme valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid ScreenScheme> getValues() {
    return values;
  }

  public void setValues(List<@Valid ScreenScheme> values) {
    this.values = values;
  }
