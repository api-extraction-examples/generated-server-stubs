...
@Schema(name = "PageBeanIssueFieldOption", description = "A page of items.")
...
public class PageBeanIssueFieldOption {
  ...
  @Valid
  private List<@Valid IssueFieldOption> values;

  public PageBeanIssueFieldOption isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanIssueFieldOption maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanIssueFieldOption nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanIssueFieldOption self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanIssueFieldOption startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanIssueFieldOption total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanIssueFieldOption values(List<@Valid IssueFieldOption> values) {
    this.values = values;
    return this;
  }

  public PageBeanIssueFieldOption addValuesItem(IssueFieldOption valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid IssueFieldOption> getValues() {
    return values;
  }

  public void setValues(List<@Valid IssueFieldOption> values) {
    this.values = values;
  }
