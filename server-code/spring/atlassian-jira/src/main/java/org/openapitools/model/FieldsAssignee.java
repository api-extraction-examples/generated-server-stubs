...
@Schema(name = "Fields_assignee", description = "The assignee of the linked issue.")
@JsonTypeName("Fields_assignee")
...
public class FieldsAssignee {
  ...
  */
  ...
  public FieldsAssignee accountType(String accountType) {
  ...
  */
  ...
  public FieldsAssignee active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  */
  ...
  public FieldsAssignee avatarUrls(UserAvatarUrls avatarUrls) {
  ...
  */
  ...
  public FieldsAssignee displayName(String displayName) {
  ...
  */
  ...
  public FieldsAssignee emailAddress(String emailAddress) {
  ...
  */
  ...
  public FieldsAssignee key(String key) {
    this.key = key;
    return this;
  }
  ...
  */
  ...
  public FieldsAssignee name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public FieldsAssignee self(String self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public FieldsAssignee timeZone(String timeZone) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, fieldsAssignee.accountId) &&
        ...
        Objects.equals(this.self, fieldsAssignee.self) &&
