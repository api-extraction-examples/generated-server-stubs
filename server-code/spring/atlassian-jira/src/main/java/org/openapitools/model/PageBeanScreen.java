...
@Schema(name = "PageBeanScreen", description = "A page of items.")
...
public class PageBeanScreen {
  ...
  @Valid
  private List<@Valid Screen> values;

  public PageBeanScreen isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanScreen maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanScreen nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanScreen self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanScreen startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanScreen total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanScreen values(List<@Valid Screen> values) {
    this.values = values;
    return this;
  }

  public PageBeanScreen addValuesItem(Screen valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid Screen> getValues() {
    return values;
  }

  public void setValues(List<@Valid Screen> values) {
    this.values = values;
  }
