...
@Schema(name = "CustomFieldContextUpdateDetails", description = "Details of a custom field context.")
...
public class CustomFieldContextUpdateDetails {
  ...
  */
  ...
  @Schema(name = "description", description = "The description of the custom field context. The maximum length is 255 characters.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  */
  ...
  @Schema(name = "name", description = "The name of the custom field context. The name must be unique. The maximum length is 255 characters.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
