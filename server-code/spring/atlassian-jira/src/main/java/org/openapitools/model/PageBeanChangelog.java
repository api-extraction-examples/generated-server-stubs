...
@Schema(name = "PageBeanChangelog", description = "A page of items.")
...
public class PageBeanChangelog {
  ...
  @Valid
  private List<@Valid Changelog> values;
  ...
  */
  ...
  public PageBeanChangelog values(List<@Valid Changelog> values) {
    this.values = values;
    return this;
  }

  public PageBeanChangelog addValuesItem(Changelog valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid Changelog> getValues() {
    return values;
  }

  public void setValues(List<@Valid Changelog> values) {
    this.values = values;
  }
