...
@Schema(name = "Attachment_author", description = "Details of the user who added the attachment.")
@JsonTypeName("Attachment_author")
...
public class AttachmentAuthor {
  ...
  */
  ...
  public AttachmentAuthor accountType(String accountType) {
  ...
  */
  ...
  public AttachmentAuthor active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  */
  ...
  public AttachmentAuthor avatarUrls(UserAvatarUrls avatarUrls) {
  ...
  */
  ...
  public AttachmentAuthor displayName(String displayName) {
  ...
  */
  ...
  public AttachmentAuthor emailAddress(String emailAddress) {
  ...
  */
  ...
  public AttachmentAuthor key(String key) {
    this.key = key;
    return this;
  }
  ...
  */
  ...
  public AttachmentAuthor name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public AttachmentAuthor self(String self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public AttachmentAuthor timeZone(String timeZone) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, attachmentAuthor.accountId) &&
        ...
        Objects.equals(this.self, attachmentAuthor.self) &&
