...
@Schema(name = "ReorderIssuePriorities", description = "Change the order of issue priorities.")
...
public class ReorderIssuePriorities {
   ...
   */
  public ReorderIssuePriorities(List<String> ids) {
    this.ids = ids;
  }
  ...
  */
  ...
  @Schema(name = "after", description = "The ID of the priority. Required if `position` isn't provided.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("after")
  ...
  */
  @NotNull 
  @Schema(name = "ids", description = "The list of issue IDs to be reordered. Cannot contain duplicates nor after ID.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("ids")
  ...
  */
  ...
  @Schema(name = "position", description = "The position for issue priorities to be moved to. Required if `after` isn't provided.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
