...
@Schema(name = "PageBeanNotificationScheme", description = "A page of items.")
...
public class PageBeanNotificationScheme {
  ...
  @Valid
  private List<@Valid NotificationScheme> values;

  public PageBeanNotificationScheme isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanNotificationScheme maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanNotificationScheme nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanNotificationScheme self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanNotificationScheme startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanNotificationScheme total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanNotificationScheme values(List<@Valid NotificationScheme> values) {
    this.values = values;
    return this;
  }

  public PageBeanNotificationScheme addValuesItem(NotificationScheme valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid NotificationScheme> getValues() {
    return values;
  }

  public void setValues(List<@Valid NotificationScheme> values) {
    this.values = values;
  }
