...
@Schema(name = "PageBeanPriority", description = "A page of items.")
...
public class PageBeanPriority {
  ...
  @Valid
  private List<@Valid Priority> values;

  public PageBeanPriority isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanPriority maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanPriority nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanPriority self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanPriority startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanPriority total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanPriority values(List<@Valid Priority> values) {
    this.values = values;
    return this;
  }

  public PageBeanPriority addValuesItem(Priority valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid Priority> getValues() {
    return values;
  }

  public void setValues(List<@Valid Priority> values) {
    this.values = values;
  }
