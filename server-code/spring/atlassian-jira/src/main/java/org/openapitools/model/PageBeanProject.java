...
@Schema(name = "PageBeanProject", description = "A page of items.")
...
public class PageBeanProject {
  ...
  @Valid
  private List<@Valid Project> values;
  ...
  */
  ...
  public PageBeanProject values(List<@Valid Project> values) {
    this.values = values;
    return this;
  }

  public PageBeanProject addValuesItem(Project valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid Project> getValues() {
    return values;
  }

  public void setValues(List<@Valid Project> values) {
    this.values = values;
  }
