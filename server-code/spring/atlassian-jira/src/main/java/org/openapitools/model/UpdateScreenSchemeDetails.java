...
import org.openapitools.model.UpdateScreenTypes;
...
@Schema(name = "UpdateScreenSchemeDetails", description = "Details of a screen scheme.")
...
public class UpdateScreenSchemeDetails {
  ...
  */
  ...
  @Schema(name = "name", description = "The name of the screen scheme. The name must be unique. The maximum length is 255 characters.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
