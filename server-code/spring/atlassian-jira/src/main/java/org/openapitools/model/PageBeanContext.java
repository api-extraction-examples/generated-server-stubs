...
@Schema(name = "PageBeanContext", description = "A page of items.")
...
public class PageBeanContext {
  ...
  @Valid
  private List<@Valid Context> values;

  public PageBeanContext isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanContext maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanContext nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanContext self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanContext startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanContext total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanContext values(List<@Valid Context> values) {
    this.values = values;
    return this;
  }

  public PageBeanContext addValuesItem(Context valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid Context> getValues() {
    return values;
  }

  public void setValues(List<@Valid Context> values) {
    this.values = values;
  }
