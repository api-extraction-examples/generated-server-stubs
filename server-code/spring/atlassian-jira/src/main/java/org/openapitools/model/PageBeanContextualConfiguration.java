...
@Schema(name = "PageBeanContextualConfiguration", description = "A page of items.")
...
public class PageBeanContextualConfiguration {
  ...
  @Valid
  private List<@Valid ContextualConfiguration> values;

  public PageBeanContextualConfiguration isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanContextualConfiguration maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanContextualConfiguration nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanContextualConfiguration self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanContextualConfiguration startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanContextualConfiguration total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanContextualConfiguration values(List<@Valid ContextualConfiguration> values) {
    this.values = values;
    return this;
  }

  public PageBeanContextualConfiguration addValuesItem(ContextualConfiguration valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid ContextualConfiguration> getValues() {
    return values;
  }

  public void setValues(List<@Valid ContextualConfiguration> values) {
    this.values = values;
  }
