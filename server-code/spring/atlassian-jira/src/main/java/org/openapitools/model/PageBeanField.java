...
@Schema(name = "PageBeanField", description = "A page of items.")
...
public class PageBeanField {
  ...
  @Valid
  private List<@Valid Field> values;
  ...
  */
  ...
  public PageBeanField values(List<@Valid Field> values) {
    this.values = values;
    return this;
  }

  public PageBeanField addValuesItem(Field valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid Field> getValues() {
    return values;
  }

  public void setValues(List<@Valid Field> values) {
    this.values = values;
  }
