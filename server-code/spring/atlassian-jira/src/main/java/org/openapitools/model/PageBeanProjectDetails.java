...
@Schema(name = "PageBeanProjectDetails", description = "A page of items.")
...
public class PageBeanProjectDetails {
  ...
  @Valid
  private List<@Valid ProjectDetails> values;

  public PageBeanProjectDetails isLast(Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  */
  ...
  public PageBeanProjectDetails maxResults(Integer maxResults) {
  ...
  */
  ...
  public PageBeanProjectDetails nextPage(URI nextPage) {
  ...
  */
  ...
  public PageBeanProjectDetails self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public PageBeanProjectDetails startAt(Long startAt) {
  ...
  */
  ...
  public PageBeanProjectDetails total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public PageBeanProjectDetails values(List<@Valid ProjectDetails> values) {
    this.values = values;
    return this;
  }

  public PageBeanProjectDetails addValuesItem(ProjectDetails valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid ProjectDetails> getValues() {
    return values;
  }

  public void setValues(List<@Valid ProjectDetails> values) {
    this.values = values;
  }
