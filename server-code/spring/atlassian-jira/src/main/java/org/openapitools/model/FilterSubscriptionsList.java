...
@Schema(name = "FilterSubscriptionsList", description = "A paginated list of subscriptions to a filter.")
...
public class FilterSubscriptionsList {
  ...
  */
  ...
  public FilterSubscriptionsList items(List<@Valid FilterSubscription> items) {
    this.items = items;
    return this;
  }

  public FilterSubscriptionsList addItemsItem(FilterSubscription itemsItem) {
    if (this.items == null) {
