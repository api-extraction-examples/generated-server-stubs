...
import org.openapitools.model.UserKey;
...
@Schema(name = "PageBeanUserKey", description = "A page of items.")
...
public class PageBeanUserKey {
  ...
  @Valid
  private List<@Valid UserKey> values;
  ...
  */
  ...
  public PageBeanUserKey values(List<@Valid UserKey> values) {
    this.values = values;
    return this;
  }

  public PageBeanUserKey addValuesItem(UserKey valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  @JsonProperty("values")
  public List<@Valid UserKey> getValues() {
    return values;
  }

  public void setValues(List<@Valid UserKey> values) {
    this.values = values;
  }
