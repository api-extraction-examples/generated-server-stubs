...
@Controller
@RequestMapping("${openapi.dealer.base-path:/dealer_tryout/v1}")
public class DealersApiController implements DealersApi {

    private final NativeWebRequest request;

    @Autowired
    public DealersApiController(NativeWebRequest request) {
