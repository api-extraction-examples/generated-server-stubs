...
@Validated
@Tag(name = "playerdashboardbyteamperformance", description = "the playerdashboardbyteamperformance API")
public interface PlayerdashboardbyteamperformanceApi {
     ...
     */
    @Operation(
        operationId = "playerdashboardbyteamperformanceGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashboardbyteamperformance"
    )
    
    default ResponseEntity<Void> playerdashboardbyteamperformanceGet(
