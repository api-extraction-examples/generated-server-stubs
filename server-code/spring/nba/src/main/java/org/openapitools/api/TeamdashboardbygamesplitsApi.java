...
@Validated
@Tag(name = "teamdashboardbygamesplits", description = "the teamdashboardbygamesplits API")
public interface TeamdashboardbygamesplitsApi {
     ...
     */
    @Operation(
        operationId = "teamdashboardbygamesplitsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamdashboardbygamesplits"
    )
    
    default ResponseEntity<Void> teamdashboardbygamesplitsGet(
