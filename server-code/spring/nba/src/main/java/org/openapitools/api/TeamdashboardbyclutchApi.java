...
@Validated
@Tag(name = "teamdashboardbyclutch", description = "the teamdashboardbyclutch API")
public interface TeamdashboardbyclutchApi {
     ...
     */
    @Operation(
        operationId = "teamdashboardbyclutchGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamdashboardbyclutch"
    )
    
    default ResponseEntity<Void> teamdashboardbyclutchGet(
