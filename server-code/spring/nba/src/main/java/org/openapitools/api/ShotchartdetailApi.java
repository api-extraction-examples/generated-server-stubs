...
@Validated
@Tag(name = "shotchartdetail", description = "the shotchartdetail API")
public interface ShotchartdetailApi {
     ...
     */
    @Operation(
        operationId = "shotchartdetailGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/shotchartdetail"
    )
    
    default ResponseEntity<Void> shotchartdetailGet(
        ...
        @NotNull @Parameter(name = "Position", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Position", required = true) String position,
        @NotNull @Parameter(name = "RookieYear", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "RookieYear", required = true) String rookieYear,
