...
@Validated
@Tag(name = "teamdashptreb", description = "the teamdashptreb API")
public interface TeamdashptrebApi {
    ...
    default ResponseEntity<Void> teamdashptrebGet(
