...
@Validated
@Tag(name = "playerdashptshotdefend", description = "the playerdashptshotdefend API")
public interface PlayerdashptshotdefendApi {
     ...
     */
    @Operation(
        operationId = "playerdashptshotdefendGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashptshotdefend"
    )
    
    default ResponseEntity<Void> playerdashptshotdefendGet(
