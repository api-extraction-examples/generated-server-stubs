...
@Validated
@Tag(name = "leaguedashplayershotlocations", description = "the leaguedashplayershotlocations API")
public interface LeaguedashplayershotlocationsApi {
     ...
     */
    @Operation(
        operationId = "leaguedashplayershotlocationsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashplayershotlocations"
    )
    
    default ResponseEntity<Void> leaguedashplayershotlocationsGet(
        ...
        @NotNull @Parameter(name = "DistanceRange", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "DistanceRange", required = true) String distanceRange,
