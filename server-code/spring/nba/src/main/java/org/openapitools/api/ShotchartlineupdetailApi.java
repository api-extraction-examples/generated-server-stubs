...
@Validated
@Tag(name = "shotchartlineupdetail", description = "the shotchartlineupdetail API")
public interface ShotchartlineupdetailApi {
     ...
     */
    @Operation(
        operationId = "shotchartlineupdetailGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/shotchartlineupdetail"
    )
    
    default ResponseEntity<Void> shotchartlineupdetailGet(
        ...
        @NotNull @Parameter(name = "TeamID", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "TeamID", required = true) String teamID,
        ...
        @NotNull @Parameter(name = "GROUP_ID", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "GROUP_ID", required = true) String GROUP_ID,
        @NotNull @Parameter(name = "ContextMeasure", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "ContextMeasure", required = true) String contextMeasure,
        @NotNull @Parameter(name = "ContextFilter", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "ContextFilter", required = true) String contextFilter
    ) {
