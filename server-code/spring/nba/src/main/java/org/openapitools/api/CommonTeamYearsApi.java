...
@Validated
@Tag(name = "commonTeamYears", description = "the commonTeamYears API")
public interface CommonTeamYearsApi {
     ...
     */
    @Operation(
        operationId = "commonTeamYearsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/commonTeamYears"
    )
    
    default ResponseEntity<Void> commonTeamYearsGet(
