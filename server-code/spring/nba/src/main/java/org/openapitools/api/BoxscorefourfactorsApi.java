...
@Validated
@Tag(name = "boxscorefourfactors", description = "the boxscorefourfactors API")
public interface BoxscorefourfactorsApi {
    ...
    @Deprecated
    @Operation(
        operationId = "boxscorefourfactorsGet",
        deprecated = true,
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/boxscorefourfactors"
    )
    
    default ResponseEntity<Void> boxscorefourfactorsGet(
