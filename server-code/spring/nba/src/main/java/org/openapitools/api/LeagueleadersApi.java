...
@Validated
@Tag(name = "leagueleaders", description = "the leagueleaders API")
public interface LeagueleadersApi {
    ...
    default ResponseEntity<Void> leagueleadersGet(
        ...
        @NotNull @Parameter(name = "Scope", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Scope", required = true) String scope,
        @Parameter(name = "StatCategory", description = "", in = ParameterIn.QUERY) @Valid @RequestParam(value = "StatCategory", required = false) String statCategory
    ) {
