...
@Validated
@Tag(name = "teamdashptpass", description = "the teamdashptpass API")
public interface TeamdashptpassApi {
    ...
    @RequestMapping(
        ...
        value = "/teamdashptpass"
    )
    
    default ResponseEntity<Void> teamdashptpassGet(
