...
@Validated
@Tag(name = "drafthistory", description = "the drafthistory API")
public interface DrafthistoryApi {
    ...
    default ResponseEntity<Void> drafthistoryGet(
