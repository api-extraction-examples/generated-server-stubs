...
@Validated
@Tag(name = "teamdashboardbyyearoveryear", description = "the teamdashboardbyyearoveryear API")
public interface TeamdashboardbyyearoveryearApi {
     ...
     */
    @Operation(
        operationId = "teamdashboardbyyearoveryearGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamdashboardbyyearoveryear"
    )
    
    default ResponseEntity<Void> teamdashboardbyyearoveryearGet(
