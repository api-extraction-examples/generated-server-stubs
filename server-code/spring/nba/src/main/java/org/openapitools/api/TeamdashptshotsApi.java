...
@Validated
@Tag(name = "teamdashptshots", description = "the teamdashptshots API")
public interface TeamdashptshotsApi {
     ...
     */
    @Operation(
        operationId = "teamdashptshotsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamdashptshots"
    )
    
    default ResponseEntity<Void> teamdashptshotsGet(
