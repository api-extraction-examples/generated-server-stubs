...
@Validated
@Tag(name = "teamdashlineups", description = "the teamdashlineups API")
public interface TeamdashlineupsApi {
     ...
     */
    @Operation(
        operationId = "teamdashlineupsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamdashlineups"
    )
    
    default ResponseEntity<Void> teamdashlineupsGet(
        @NotNull @Parameter(name = "GroupQuantity", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "GroupQuantity", required = true) String groupQuantity,
