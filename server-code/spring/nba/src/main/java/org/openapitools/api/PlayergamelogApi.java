...
@Validated
@Tag(name = "playergamelog", description = "the playergamelog API")
public interface PlayergamelogApi {
    ...
    default ResponseEntity<Void> playergamelogGet(
