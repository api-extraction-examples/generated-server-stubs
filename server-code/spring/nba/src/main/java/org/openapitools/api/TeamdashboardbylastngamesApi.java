...
@Validated
@Tag(name = "teamdashboardbylastngames", description = "the teamdashboardbylastngames API")
public interface TeamdashboardbylastngamesApi {
     ...
     */
    @Operation(
        operationId = "teamdashboardbylastngamesGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamdashboardbylastngames"
    )
    
    default ResponseEntity<Void> teamdashboardbylastngamesGet(
