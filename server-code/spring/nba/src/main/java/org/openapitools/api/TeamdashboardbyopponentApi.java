...
@Validated
@Tag(name = "teamdashboardbyopponent", description = "the teamdashboardbyopponent API")
public interface TeamdashboardbyopponentApi {
     ...
     */
    @Operation(
        operationId = "teamdashboardbyopponentGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamdashboardbyopponent"
    )
    
    default ResponseEntity<Void> teamdashboardbyopponentGet(
