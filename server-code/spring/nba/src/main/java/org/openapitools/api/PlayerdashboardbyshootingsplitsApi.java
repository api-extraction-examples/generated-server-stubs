...
@Validated
@Tag(name = "playerdashboardbyshootingsplits", description = "the playerdashboardbyshootingsplits API")
public interface PlayerdashboardbyshootingsplitsApi {
     ...
     */
    @Operation(
        operationId = "playerdashboardbyshootingsplitsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashboardbyshootingsplits"
    )
    
    default ResponseEntity<Void> playerdashboardbyshootingsplitsGet(
