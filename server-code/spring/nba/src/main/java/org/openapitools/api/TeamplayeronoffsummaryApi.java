...
@Validated
@Tag(name = "teamplayeronoffsummary", description = "the teamplayeronoffsummary API")
public interface TeamplayeronoffsummaryApi {
     ...
     */
    @Operation(
        operationId = "teamplayeronoffsummaryGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamplayeronoffsummary"
    )
    
    default ResponseEntity<Void> teamplayeronoffsummaryGet(
