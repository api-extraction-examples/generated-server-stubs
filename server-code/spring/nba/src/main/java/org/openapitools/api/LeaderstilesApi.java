...
@Validated
@Tag(name = "leaderstiles", description = "the leaderstiles API")
public interface LeaderstilesApi {
    ...
    default ResponseEntity<Void> leaderstilesGet(
        @NotNull @Parameter(name = "Stat", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Stat", required = true) String stat,
