...
@Validated
@Tag(name = "draftcombinenonstationaryshooting", description = "the draftcombinenonstationaryshooting API")
public interface DraftcombinenonstationaryshootingApi {
     ...
     */
    @Operation(
        operationId = "draftcombinenonstationaryshootingGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/draftcombinenonstationaryshooting"
    )
    
    default ResponseEntity<Void> draftcombinenonstationaryshootingGet(
