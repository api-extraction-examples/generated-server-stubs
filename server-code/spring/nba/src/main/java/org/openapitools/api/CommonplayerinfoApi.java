...
@Validated
@Tag(name = "commonplayerinfo", description = "the commonplayerinfo API")
public interface CommonplayerinfoApi {
     ...
     */
    @Operation(
        operationId = "commonplayerinfoGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/commonplayerinfo"
    )
    
    default ResponseEntity<Void> commonplayerinfoGet(
