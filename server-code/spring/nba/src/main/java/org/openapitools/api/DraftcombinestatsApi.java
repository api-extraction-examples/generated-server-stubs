...
@Validated
@Tag(name = "draftcombinestats", description = "the draftcombinestats API")
public interface DraftcombinestatsApi {
     ...
     */
    @Operation(
        operationId = "draftcombinestatsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/draftcombinestats"
    )
    
    default ResponseEntity<Void> draftcombinestatsGet(
