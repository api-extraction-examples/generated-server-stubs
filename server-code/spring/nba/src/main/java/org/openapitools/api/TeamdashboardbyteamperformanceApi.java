...
@Validated
@Tag(name = "teamdashboardbyteamperformance", description = "the teamdashboardbyteamperformance API")
public interface TeamdashboardbyteamperformanceApi {
     ...
     */
    @Operation(
        operationId = "teamdashboardbyteamperformanceGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamdashboardbyteamperformance"
    )
    
    default ResponseEntity<Void> teamdashboardbyteamperformanceGet(
