...
@Validated
@Tag(name = "playbyplayv2", description = "the playbyplayv2 API")
public interface Playbyplayv2Api {
    ...
    default ResponseEntity<Void> playbyplayv2Get(
