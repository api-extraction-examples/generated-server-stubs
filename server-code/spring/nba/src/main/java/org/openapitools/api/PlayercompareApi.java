...
@Validated
@Tag(name = "playercompare", description = "the playercompare API")
public interface PlayercompareApi {
    ...
    default ResponseEntity<Void> playercompareGet(
        @NotNull @Parameter(name = "PlayerIDList", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "PlayerIDList", required = true) String playerIDList,
        @NotNull @Parameter(name = "VsPlayerIDList", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "VsPlayerIDList", required = true) String vsPlayerIDList,
