...
@Validated
@Tag(name = "playerdashboardbyclutch", description = "the playerdashboardbyclutch API")
public interface PlayerdashboardbyclutchApi {
     ...
     */
    @Operation(
        operationId = "playerdashboardbyclutchGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashboardbyclutch"
    )
    
    default ResponseEntity<Void> playerdashboardbyclutchGet(
