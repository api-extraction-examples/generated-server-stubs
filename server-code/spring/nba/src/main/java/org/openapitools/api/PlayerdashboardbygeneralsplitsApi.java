...
@Validated
@Tag(name = "playerdashboardbygeneralsplits", description = "the playerdashboardbygeneralsplits API")
public interface PlayerdashboardbygeneralsplitsApi {
     ...
     */
    @Operation(
        operationId = "playerdashboardbygeneralsplitsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashboardbygeneralsplits"
    )
    
    default ResponseEntity<Void> playerdashboardbygeneralsplitsGet(
