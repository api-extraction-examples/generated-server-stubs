...
@Validated
@Tag(name = "leaguedashplayerstats", description = "the leaguedashplayerstats API")
public interface LeaguedashplayerstatsApi {
     ...
     */
    @Operation(
        operationId = "leaguedashplayerstatsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashplayerstats"
    )
    
    default ResponseEntity<Void> leaguedashplayerstatsGet(
