...
@Validated
@Tag(name = "boxscorescoring", description = "the boxscorescoring API")
public interface BoxscorescoringApi {
    ...
    @Deprecated
    @Operation(
        operationId = "boxscorescoringGet",
        deprecated = true,
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/boxscorescoring"
    )
    
    default ResponseEntity<Void> boxscorescoringGet(
