...
@Validated
@Tag(name = "teaminfocommon", description = "the teaminfocommon API")
public interface TeaminfocommonApi {
    ...
    @RequestMapping(
        ...
        value = "/teaminfocommon"
    )
    
    default ResponseEntity<Void> teaminfocommonGet(
