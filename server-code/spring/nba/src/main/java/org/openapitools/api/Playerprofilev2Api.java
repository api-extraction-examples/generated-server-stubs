...
@Validated
@Tag(name = "playerprofilev2", description = "the playerprofilev2 API")
public interface Playerprofilev2Api {
     ...
     */
    @Operation(
        operationId = "playerprofilev2Get",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerprofilev2"
    )
    
    default ResponseEntity<Void> playerprofilev2Get(
