...
@Validated
@Tag(name = "teamyearbyyearstats", description = "the teamyearbyyearstats API")
public interface TeamyearbyyearstatsApi {
     ...
     */
    @Operation(
        operationId = "teamyearbyyearstatsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamyearbyyearstats"
    )
    
    default ResponseEntity<Void> teamyearbyyearstatsGet(
