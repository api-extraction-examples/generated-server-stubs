...
@Validated
@Tag(name = "playerdashboardbygamesplits", description = "the playerdashboardbygamesplits API")
public interface PlayerdashboardbygamesplitsApi {
     ...
     */
    @Operation(
        operationId = "playerdashboardbygamesplitsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashboardbygamesplits"
    )
    
    default ResponseEntity<Void> playerdashboardbygamesplitsGet(
