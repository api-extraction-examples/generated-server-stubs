...
@Validated
@Tag(name = "leaguedashplayerptshot", description = "the leaguedashplayerptshot API")
public interface LeaguedashplayerptshotApi {
     ...
     */
    @Operation(
        operationId = "leaguedashplayerptshotGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashplayerptshot"
    )
    
    default ResponseEntity<Void> leaguedashplayerptshotGet(
