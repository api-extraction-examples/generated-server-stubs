...
@Validated
@Tag(name = "boxscoreusage", description = "the boxscoreusage API")
public interface BoxscoreusageApi {
    ...
    default ResponseEntity<Void> boxscoreusageGet(
