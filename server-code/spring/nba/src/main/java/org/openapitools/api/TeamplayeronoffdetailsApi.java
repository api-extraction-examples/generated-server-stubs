...
@Validated
@Tag(name = "teamplayeronoffdetails", description = "the teamplayeronoffdetails API")
public interface TeamplayeronoffdetailsApi {
     ...
     */
    @Operation(
        operationId = "teamplayeronoffdetailsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamplayeronoffdetails"
    )
    
    default ResponseEntity<Void> teamplayeronoffdetailsGet(
