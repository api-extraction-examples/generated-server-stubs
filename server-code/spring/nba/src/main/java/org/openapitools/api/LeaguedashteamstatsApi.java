...
@Validated
@Tag(name = "leaguedashteamstats", description = "the leaguedashteamstats API")
public interface LeaguedashteamstatsApi {
     ...
     */
    @Operation(
        operationId = "leaguedashteamstatsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashteamstats"
    )
    
    default ResponseEntity<Void> leaguedashteamstatsGet(
