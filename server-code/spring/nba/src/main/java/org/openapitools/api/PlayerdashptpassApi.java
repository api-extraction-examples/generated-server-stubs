...
@Validated
@Tag(name = "playerdashptpass", description = "the playerdashptpass API")
public interface PlayerdashptpassApi {
     ...
     */
    @Operation(
        operationId = "playerdashptpassGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashptpass"
    )
    
    default ResponseEntity<Void> playerdashptpassGet(
