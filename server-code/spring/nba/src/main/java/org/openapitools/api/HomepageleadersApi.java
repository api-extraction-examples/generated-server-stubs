...
@Validated
@Tag(name = "homepageleaders", description = "the homepageleaders API")
public interface HomepageleadersApi {
     ...
     */
    @Operation(
        operationId = "homepageleadersGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/homepageleaders"
    )
    
    default ResponseEntity<Void> homepageleadersGet(
        @NotNull @Parameter(name = "StatCategory", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "StatCategory", required = true) String statCategory,
