...
@Validated
@Tag(name = "playerdashboardbyopponent", description = "the playerdashboardbyopponent API")
public interface PlayerdashboardbyopponentApi {
     ...
     */
    @Operation(
        operationId = "playerdashboardbyopponentGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashboardbyopponent"
    )
    
    default ResponseEntity<Void> playerdashboardbyopponentGet(
