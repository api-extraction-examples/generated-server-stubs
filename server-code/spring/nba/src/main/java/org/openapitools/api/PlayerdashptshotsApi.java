...
@Validated
@Tag(name = "playerdashptshots", description = "the playerdashptshots API")
public interface PlayerdashptshotsApi {
     ...
     */
    @Operation(
        operationId = "playerdashptshotsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashptshots"
    )
    
    default ResponseEntity<Void> playerdashptshotsGet(
