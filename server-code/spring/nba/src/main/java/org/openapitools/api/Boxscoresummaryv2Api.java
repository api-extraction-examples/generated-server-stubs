...
@Validated
@Tag(name = "boxscoresummaryv2", description = "the boxscoresummaryv2 API")
public interface Boxscoresummaryv2Api {
     ...
     */
    @Operation(
        operationId = "boxscoresummaryv2Get",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/boxscoresummaryv2"
    )
    
    default ResponseEntity<Void> boxscoresummaryv2Get(
