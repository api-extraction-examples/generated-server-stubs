...
@Validated
@Tag(name = "leaguedashplayerbiostats", description = "the leaguedashplayerbiostats API")
public interface LeaguedashplayerbiostatsApi {
     ...
     */
    @Operation(
        operationId = "leaguedashplayerbiostatsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashplayerbiostats"
    )
    
    default ResponseEntity<Void> leaguedashplayerbiostatsGet(
