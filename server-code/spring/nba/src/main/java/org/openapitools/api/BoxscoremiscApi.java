...
@Validated
@Tag(name = "boxscoremisc", description = "the boxscoremisc API")
public interface BoxscoremiscApi {
    ...
    default ResponseEntity<Void> boxscoremiscGet(
