...
@Validated
@Tag(name = "teamdashboardbyshootingsplits", description = "the teamdashboardbyshootingsplits API")
public interface TeamdashboardbyshootingsplitsApi {
     ...
     */
    @Operation(
        operationId = "teamdashboardbyshootingsplitsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamdashboardbyshootingsplits"
    )
    
    default ResponseEntity<Void> teamdashboardbyshootingsplitsGet(
