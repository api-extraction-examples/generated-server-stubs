...
@Validated
@Tag(name = "playervsplayer", description = "the playervsplayer API")
public interface PlayervsplayerApi {
    ...
    default ResponseEntity<Void> playervsplayerGet(
