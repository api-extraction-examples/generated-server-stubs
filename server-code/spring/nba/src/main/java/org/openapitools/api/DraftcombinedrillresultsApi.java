...
@Validated
@Tag(name = "draftcombinedrillresults", description = "the draftcombinedrillresults API")
public interface DraftcombinedrillresultsApi {
     ...
     */
    @Operation(
        operationId = "draftcombinedrillresultsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/draftcombinedrillresults"
    )
    
    default ResponseEntity<Void> draftcombinedrillresultsGet(
