...
@Validated
@Tag(name = "playerprofile", description = "the playerprofile API")
public interface PlayerprofileApi {
    ...
    default ResponseEntity<Void> playerprofileGet(
        ...
        @NotNull @Parameter(name = "GraphStartSeason", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "GraphStartSeason", required = true) String graphStartSeason,
        @NotNull @Parameter(name = "GraphEndSeason", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "GraphEndSeason", required = true) String graphEndSeason,
        @NotNull @Parameter(name = "GraphStat", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "GraphStat", required = true) String graphStat
    ) {
