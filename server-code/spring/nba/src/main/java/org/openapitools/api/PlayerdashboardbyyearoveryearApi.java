...
@Validated
@Tag(name = "playerdashboardbyyearoveryear", description = "the playerdashboardbyyearoveryear API")
public interface PlayerdashboardbyyearoveryearApi {
     ...
     */
    @Operation(
        operationId = "playerdashboardbyyearoveryearGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashboardbyyearoveryear"
    )
    
    default ResponseEntity<Void> playerdashboardbyyearoveryearGet(
