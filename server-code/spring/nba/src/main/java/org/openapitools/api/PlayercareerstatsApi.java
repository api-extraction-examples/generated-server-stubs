...
@Validated
@Tag(name = "playercareerstats", description = "the playercareerstats API")
public interface PlayercareerstatsApi {
     ...
     */
    @Operation(
        operationId = "playercareerstatsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playercareerstats"
    )
    
    default ResponseEntity<Void> playercareerstatsGet(
