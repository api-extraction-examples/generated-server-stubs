...
@Validated
@Tag(name = "leaguedashplayerclutch", description = "the leaguedashplayerclutch API")
public interface LeaguedashplayerclutchApi {
     ...
     */
    @Operation(
        operationId = "leaguedashplayerclutchGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashplayerclutch"
    )
    
    default ResponseEntity<Void> leaguedashplayerclutchGet(
        @NotNull @Parameter(name = "ClutchTime", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "ClutchTime", required = true) String clutchTime,
        @NotNull @Parameter(name = "AheadBehind", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "AheadBehind", required = true) String aheadBehind,
        @NotNull @Parameter(name = "PointDiff", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "PointDiff", required = true) String pointDiff,
        ...
        @NotNull @Parameter(name = "PlayerExperience", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "PlayerExperience", required = true) String playerExperience,
        @NotNull @Parameter(name = "PlayerPosition", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "PlayerPosition", required = true) String playerPosition,
        @NotNull @Parameter(name = "StarterBench", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "StarterBench", required = true) String starterBench,
