...
@Validated
@Tag(name = "leaguedashptdefend", description = "the leaguedashptdefend API")
public interface LeaguedashptdefendApi {
     ...
     */
    @Operation(
        operationId = "leaguedashptdefendGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashptdefend"
    )
    
    default ResponseEntity<Void> leaguedashptdefendGet(
