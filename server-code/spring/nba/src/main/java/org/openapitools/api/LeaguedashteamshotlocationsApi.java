...
@Validated
@Tag(name = "leaguedashteamshotlocations", description = "the leaguedashteamshotlocations API")
public interface LeaguedashteamshotlocationsApi {
     ...
     */
    @Operation(
        operationId = "leaguedashteamshotlocationsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashteamshotlocations"
    )
    
    default ResponseEntity<Void> leaguedashteamshotlocationsGet(
