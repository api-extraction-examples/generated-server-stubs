...
@Validated
@Tag(name = "boxscoreplayertrackv2", description = "the boxscoreplayertrackv2 API")
public interface Boxscoreplayertrackv2Api {
     ...
     */
    @Operation(
        operationId = "boxscoreplayertrackv2Get",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/boxscoreplayertrackv2"
    )
    
    default ResponseEntity<Void> boxscoreplayertrackv2Get(
