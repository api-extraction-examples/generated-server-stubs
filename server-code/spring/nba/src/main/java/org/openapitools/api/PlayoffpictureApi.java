...
@Validated
@Tag(name = "playoffpicture", description = "the playoffpicture API")
public interface PlayoffpictureApi {
    ...
    @RequestMapping(
        ...
        value = "/playoffpicture"
    )
    
    default ResponseEntity<Void> playoffpictureGet(
        ...
        @NotNull @Parameter(name = "SeasonID", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "SeasonID", required = true) String seasonID
    ) {
