...
@Validated
@Tag(name = "teamvsplayer", description = "the teamvsplayer API")
public interface TeamvsplayerApi {
    ...
    default ResponseEntity<Void> teamvsplayerGet(
        ...
        @NotNull @Parameter(name = "VsPlayerID", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "VsPlayerID", required = true) String vsPlayerID,
