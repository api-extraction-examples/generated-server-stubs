...
@Validated
@Tag(name = "teamplayerdashboard", description = "the teamplayerdashboard API")
public interface TeamplayerdashboardApi {
     ...
     */
    @Operation(
        operationId = "teamplayerdashboardGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamplayerdashboard"
    )
    
    default ResponseEntity<Void> teamplayerdashboardGet(
