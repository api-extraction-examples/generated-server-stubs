...
@Validated
@Tag(name = "franchisehistory", description = "the franchisehistory API")
public interface FranchisehistoryApi {
     ...
     */
    @Operation(
        operationId = "franchisehistoryGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/franchisehistory"
    )
    
    default ResponseEntity<Void> franchisehistoryGet(
