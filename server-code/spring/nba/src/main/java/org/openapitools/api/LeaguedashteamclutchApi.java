...
@Validated
@Tag(name = "leaguedashteamclutch", description = "the leaguedashteamclutch API")
public interface LeaguedashteamclutchApi {
     ...
     */
    @Operation(
        operationId = "leaguedashteamclutchGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashteamclutch"
    )
    
    default ResponseEntity<Void> leaguedashteamclutchGet(
