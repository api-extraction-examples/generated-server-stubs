...
@Validated
@Tag(name = "leaguedashlineups", description = "the leaguedashlineups API")
public interface LeaguedashlineupsApi {
     ...
     */
    @Operation(
        operationId = "leaguedashlineupsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashlineups"
    )
    
    default ResponseEntity<Void> leaguedashlineupsGet(
