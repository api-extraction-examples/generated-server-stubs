...
@Validated
@Tag(name = "playerdashptreb", description = "the playerdashptreb API")
public interface PlayerdashptrebApi {
     ...
     */
    @Operation(
        operationId = "playerdashptrebGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/playerdashptreb"
    )
    
    default ResponseEntity<Void> playerdashptrebGet(
