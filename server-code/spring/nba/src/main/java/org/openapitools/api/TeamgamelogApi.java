...
@Validated
@Tag(name = "teamgamelog", description = "the teamgamelog API")
public interface TeamgamelogApi {
    ...
    default ResponseEntity<Void> teamgamelogGet(
