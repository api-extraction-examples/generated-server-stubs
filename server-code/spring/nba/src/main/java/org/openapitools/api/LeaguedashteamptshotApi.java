...
@Validated
@Tag(name = "leaguedashteamptshot", description = "the leaguedashteamptshot API")
public interface LeaguedashteamptshotApi {
     ...
     */
    @Operation(
        operationId = "leaguedashteamptshotGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashteamptshot"
    )
    
    default ResponseEntity<Void> leaguedashteamptshotGet(
