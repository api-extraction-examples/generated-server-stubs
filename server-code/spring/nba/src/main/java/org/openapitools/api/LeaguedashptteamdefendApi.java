...
@Validated
@Tag(name = "leaguedashptteamdefend", description = "the leaguedashptteamdefend API")
public interface LeaguedashptteamdefendApi {
     ...
     */
    @Operation(
        operationId = "leaguedashptteamdefendGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/leaguedashptteamdefend"
    )
    
    default ResponseEntity<Void> leaguedashptteamdefendGet(
        ...
        @NotNull @Parameter(name = "DefenseCategory", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "DefenseCategory", required = true) String defenseCategory
    ) {
