...
@Validated
@Tag(name = "teamdashboardbygeneralsplits", description = "the teamdashboardbygeneralsplits API")
public interface TeamdashboardbygeneralsplitsApi {
     ...
     */
    @Operation(
        operationId = "teamdashboardbygeneralsplitsGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/teamdashboardbygeneralsplits"
    )
    
    default ResponseEntity<Void> teamdashboardbygeneralsplitsGet(
