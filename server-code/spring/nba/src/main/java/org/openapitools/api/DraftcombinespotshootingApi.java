...
@Validated
@Tag(name = "draftcombinespotshooting", description = "the draftcombinespotshooting API")
public interface DraftcombinespotshootingApi {
     ...
     */
    @Operation(
        operationId = "draftcombinespotshootingGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/draftcombinespotshooting"
    )
    
    default ResponseEntity<Void> draftcombinespotshootingGet(
