...
@Validated
@Tag(name = "commonteamroster", description = "the commonteamroster API")
public interface CommonteamrosterApi {
     ...
     */
    @Operation(
        operationId = "commonteamrosterGet",
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/commonteamroster"
    )
    
    default ResponseEntity<Void> commonteamrosterGet(
