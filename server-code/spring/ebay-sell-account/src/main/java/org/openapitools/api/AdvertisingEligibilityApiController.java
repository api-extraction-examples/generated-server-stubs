...
public class AdvertisingEligibilityApiController implements AdvertisingEligibilityApi {

    private final NativeWebRequest request;

    @Autowired
    public AdvertisingEligibilityApiController(NativeWebRequest request) {
