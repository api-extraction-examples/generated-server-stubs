...
public interface StoriesApi {
    ...
    @RequestMapping(
        ...
        value = "/stories/{story_gid}",
        produces = { "application/json" }
    )
    
    default ResponseEntity<DeleteAttachment200Response> deleteStory(
        @Parameter(name = "story_gid", description = "Globally unique identifier for the story.", required = true, in = ParameterIn.PATH) @PathVariable("story_gid") String storyGid,
