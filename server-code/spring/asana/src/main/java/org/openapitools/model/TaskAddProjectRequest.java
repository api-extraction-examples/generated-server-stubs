...
public class TaskAddProjectRequest {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.insertAfter, taskAddProjectRequest.insertAfter) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(insertAfter), hashCodeNullable(insertBefore), project, hashCodeNullable(section));
  }
