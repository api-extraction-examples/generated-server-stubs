...
public interface PortfolioMembershipsApi {
    ...
    @RequestMapping(
        ...
        value = "/portfolio_memberships/{portfolio_membership_gid}",
        produces = { "application/json" }
    )
    
    default ResponseEntity<GetPortfolioMembership200Response> getPortfolioMembership(
        @Parameter(name = "portfolio_membership_gid", description = "", required = true, in = ParameterIn.PATH) @PathVariable("portfolio_membership_gid") String portfolioMembershipGid,
    ...
    default ResponseEntity<GetPortfolioMemberships200Response> getPortfolioMemberships(
        @Parameter(name = "portfolio", description = "The portfolio to filter results on.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "portfolio", required = false) String portfolio,
