...
public class TaskResponseAllOfAssigneeSection {
  ...
  public TaskResponseAllOfAssigneeSection gid(String gid) {
    this.gid = gid;
    return this;
  }
  ...
  */
  ...
  public TaskResponseAllOfAssigneeSection resourceType(String resourceType) {
  ...
  */
  ...
  public TaskResponseAllOfAssigneeSection name(String name) {
    this.name = name;
    return this;
  }
