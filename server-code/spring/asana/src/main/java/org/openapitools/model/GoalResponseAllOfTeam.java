...
@Schema(name = "GoalResponse_allOf_team", description = "*Conditional*. This property is only present when the `workspace` provided is an organization.")
...
public class GoalResponseAllOfTeam {
  ...
  public GoalResponseAllOfTeam gid(String gid) {
    this.gid = gid;
    return this;
  }
  ...
  */
  ...
  public GoalResponseAllOfTeam resourceType(String resourceType) {
