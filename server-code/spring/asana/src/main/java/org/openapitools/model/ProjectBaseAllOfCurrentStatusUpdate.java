...
@Schema(name = "ProjectBase_allOf_current_status_update", description = "The latest `status_update` posted to this project.")
...
public class ProjectBaseAllOfCurrentStatusUpdate {
  ...
  public ProjectBaseAllOfCurrentStatusUpdate gid(String gid) {
    this.gid = gid;
    return this;
  }
  ...
  */
  ...
  public ProjectBaseAllOfCurrentStatusUpdate resourceType(String resourceType) {
  ...
  */
  ...
  public ProjectBaseAllOfCurrentStatusUpdate resourceSubtype(ResourceSubtypeEnum resourceSubtype) {
  ...
  */
  ...
  public ProjectBaseAllOfCurrentStatusUpdate title(String title) {
    this.title = title;
    return this;
  }
