...
import org.openapitools.model.GoalAddSupportingRelationshipRequest;
...
public class AddSupportingRelationshipRequest {
  ...
  public AddSupportingRelationshipRequest data(GoalAddSupportingRelationshipRequest data) {
    this.data = data;
    return this;
  }
