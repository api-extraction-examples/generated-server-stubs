...
public class ProjectBase {
  ...
  public ProjectBase gid(String gid) {
    this.gid = gid;
    return this;
  }
  ...
  */
  ...
  public ProjectBase resourceType(String resourceType) {
  ...
  */
  ...
  public ProjectBase createdAt(OffsetDateTime createdAt) {
  ...
  */
  ...
  public ProjectBase currentStatus(ProjectBaseAllOfCurrentStatus currentStatus) {
  ...
  */
  ...
  public ProjectBase currentStatusUpdate(ProjectBaseAllOfCurrentStatusUpdate currentStatusUpdate) {
  ...
  */
  ...
  public ProjectBase customFieldSettings(List<@Valid CustomFieldSettingResponse> customFieldSettings) {
  ...
  */
  ...
  public ProjectBase modifiedAt(OffsetDateTime modifiedAt) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, projectBase.gid) &&
        ...
        equalsNullable(this.currentStatus, projectBase.currentStatus) &&
        equalsNullable(this.currentStatusUpdate, projectBase.currentStatusUpdate) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, name, archived, hashCodeNullable(color), createdAt, hashCodeNullable(currentStatus), hashCodeNullable(currentStatusUpdate), customFieldSettings, defaultView, hashCodeNullable(dueDate), hashCodeNullable(dueOn), htmlNotes, isTemplate, members, modifiedAt, notes, _public, hashCodeNullable(startOn), workspace);
  }
