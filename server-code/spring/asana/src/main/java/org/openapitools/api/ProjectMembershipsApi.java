...
public interface ProjectMembershipsApi {
    ...
    @RequestMapping(
        ...
        value = "/project_memberships/{project_membership_gid}",
        produces = { "application/json" }
    )
    
    default ResponseEntity<GetProjectMembership200Response> getProjectMembership(
        @Parameter(name = "project_membership_gid", description = "", required = true, in = ParameterIn.PATH) @PathVariable("project_membership_gid") String projectMembershipGid,
