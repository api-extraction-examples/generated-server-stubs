...
public interface MetricsApi {
     ...
     *
     * @return Successfully returned Prometheus metrics (status code 200)
     */
    @Operation(
        ...
        tags = { "Metrics" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully returned Prometheus metrics", content = {
    ...
    default ResponseEntity<String> getPrometheusMetrics(
