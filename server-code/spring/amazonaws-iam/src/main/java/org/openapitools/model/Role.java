...
@Schema(name = "Role", description = "Contains information about an IAM role. This structure is returned as a response element in several API operations that interact with roles.")
...
public class Role {
   ...
   */
  public Role(String path, String roleName, String roleId, String arn, OffsetDateTime createDate) {
    this.path = path;
  ...
  */
  ...
  public Role createDate(OffsetDateTime createDate) {
    this.createDate = createDate;
    return this;
  }
  ...
  */
  ...
  public Role assumeRolePolicyDocument(String assumeRolePolicyDocument) {
  ...
  */
  ...
  public Role maxSessionDuration(Integer maxSessionDuration) {
  ...
  */
  ...
  public Role permissionsBoundary(RolePermissionsBoundary permissionsBoundary) {
  ...
  */
  ...
  public Role roleLastUsed(RoleRoleLastUsed roleLastUsed) {
