...
@Validated
@Tag(name = "#Action=PutGroupPolicy", description = "the #Action=PutGroupPolicy API")
public interface ActionPutGroupPolicyApi {
     ...
     *
     * @param groupName &lt;p&gt;The name of the group to associate the policy with.&lt;/p&gt; &lt;p&gt;This parameter allows (through its &lt;a href&#x3D;\&quot;http://wikipedia.org/wiki/regex\&quot;&gt;regex pattern&lt;/a&gt;) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+&#x3D;,.@-.&lt;/p&gt; (required)
    ...
    @RequestMapping(
        ...
        value = "/#Action=PutGroupPolicy",
        produces = { "text/xml" }
    )
    
    default ResponseEntity<Void> gETPutGroupPolicy(
        @NotNull @Pattern(regexp = "[\\w+=,.@-]+") @Size(min = 1, max = 128) @Parameter(name = "GroupName", description = "<p>The name of the group to associate the policy with.</p> <p>This parameter allows (through its <a href=\"http://wikipedia.org/wiki/regex\">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-.</p>", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "GroupName", required = true) String groupName,
     ...
     * @param xAmzSignature  (optional)
     * @param xAmzSignedHeaders  (optional)
     * @param putGroupPolicyRequest  (optional)
     * @return Success (status code 200)
     *         or LimitExceededException (status code 480)
     *         or MalformedPolicyDocumentException (status code 481)
     *         or NoSuchEntityException (status code 482)
     ...
     */
    @Operation(
        operationId = "pOSTPutGroupPolicy",
        description = "<p>Adds or updates an inline policy document that is embedded in the specified IAM group.</p> <p>A user can also have managed policies attached to it. To attach a managed policy to a group, use <a href=\"https://docs.aws.amazon.com/IAM/latest/APIReference/API_AttachGroupPolicy.html\"> <code>AttachGroupPolicy</code> </a>. To create a new managed policy, use <a href=\"https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreatePolicy.html\"> <code>CreatePolicy</code> </a>. For information about policies, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html\">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p> <p>For information about the maximum number of inline policies that you can embed in a group, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html\">IAM and STS quotas</a> in the <i>IAM User Guide</i>.</p> <note> <p>Because policy documents can be large, you should use POST rather than GET when calling <code>PutGroupPolicy</code>. For general information about using the Query API with IAM, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/IAM_UsingQueryAPI.html\">Making query requests</a> in the <i>IAM User Guide</i>.</p> </note>",
        responses = {
            @ApiResponse(responseCode = "200", description = "Success"),
            @ApiResponse(responseCode = "480", description = "LimitExceededException", content = {
    ...
    default ResponseEntity<Void> pOSTPutGroupPolicy(
        @NotNull @Parameter(name = "Action", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Action", required = true) String action,
        @NotNull @Parameter(name = "Version", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Version", required = true) String version,
        @Parameter(name = "X-Amz-Content-Sha256", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Content-Sha256", required = false) String xAmzContentSha256,
        @Parameter(name = "X-Amz-Date", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Date", required = false) String xAmzDate,
        ...
        @Parameter(name = "X-Amz-Signature", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Signature", required = false) String xAmzSignature,
        @Parameter(name = "X-Amz-SignedHeaders", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-SignedHeaders", required = false) String xAmzSignedHeaders,
        @Parameter(name = "PutGroupPolicyRequest", description = "") @Valid @RequestBody(required = false) PutGroupPolicyRequest putGroupPolicyRequest
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
