...
@Validated
@Tag(name = "#Action=ListOpenIDConnectProviderTags", description = "the #Action=ListOpenIDConnectProviderTags API")
public interface ActionListOpenIDConnectProviderTagsApi {
     ...
     *
     * @param openIDConnectProviderArn &lt;p&gt;The ARN of the OpenID Connect (OIDC) identity provider whose tags you want to see.&lt;/p&gt; &lt;p&gt;This parameter allows (through its &lt;a href&#x3D;\&quot;http://wikipedia.org/wiki/regex\&quot;&gt;regex pattern&lt;/a&gt;) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+&#x3D;,.@-&lt;/p&gt; (required)
     ...
     */
    @Operation(
        operationId = "gETListOpenIDConnectProviderTags",
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = ListOpenIDConnectProviderTagsResponse.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/#Action=ListOpenIDConnectProviderTags",
        produces = { "text/xml" }
    )
    
    default ResponseEntity<ListOpenIDConnectProviderTagsResponse> gETListOpenIDConnectProviderTags(
     ...
     * @param listOpenIDConnectProviderTagsRequest  (optional)
     * @return Success (status code 200)
     *         or NoSuchEntityException (status code 480)
     *         or ServiceFailureException (status code 481)
     *         or InvalidInputException (status code 482)
     */
    @Operation(
        operationId = "pOSTListOpenIDConnectProviderTags",
        description = "<p>Lists the tags that are attached to the specified OpenID Connect (OIDC)-compatible identity provider. The returned list of tags is sorted by tag key. For more information, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_oidc.html\">About web identity federation</a>.</p> <p>For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>",
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = ListOpenIDConnectProviderTagsResponse.class))
    ...
    default ResponseEntity<ListOpenIDConnectProviderTagsResponse> pOSTListOpenIDConnectProviderTags(
        @NotNull @Parameter(name = "Action", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Action", required = true) String action,
        @NotNull @Parameter(name = "Version", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Version", required = true) String version,
        @Parameter(name = "X-Amz-Content-Sha256", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Content-Sha256", required = false) String xAmzContentSha256,
        @Parameter(name = "X-Amz-Date", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Date", required = false) String xAmzDate,
        ...
        @Parameter(name = "ListOpenIDConnectProviderTagsRequest", description = "") @Valid @RequestBody(required = false) ListOpenIDConnectProviderTagsRequest listOpenIDConnectProviderTagsRequest
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("text/xml"))) {
