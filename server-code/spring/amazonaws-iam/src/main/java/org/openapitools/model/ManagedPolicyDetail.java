...
@Schema(name = "ManagedPolicyDetail", description = "<p>Contains information about a managed policy, including the policy's ARN, versions, and the number of principal entities (users, groups, and roles) that the policy is attached to.</p> <p>This data type is used as a response element in the <a>GetAccountAuthorizationDetails</a> operation.</p> <p>For more information about managed policies, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html\">Managed policies and inline policies</a> in the <i>IAM User Guide</i>. </p>")
...
public class ManagedPolicyDetail {
  ...
  public ManagedPolicyDetail policyName(String policyName) {
  ...
  */
  ...
  public ManagedPolicyDetail policyId(String policyId) {
  ...
  */
  ...
  public ManagedPolicyDetail arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  */
  ...
  public ManagedPolicyDetail path(String path) {
    this.path = path;
    return this;
  }
  ...
  */
  ...
  public ManagedPolicyDetail defaultVersionId(String defaultVersionId) {
  ...
  */
  ...
  public ManagedPolicyDetail attachmentCount(Integer attachmentCount) {
  ...
  */
  ...
  public ManagedPolicyDetail permissionsBoundaryUsageCount(Integer permissionsBoundaryUsageCount) {
  ...
  */
  ...
  public ManagedPolicyDetail isAttachable(Boolean isAttachable) {
  ...
  */
  ...
  public ManagedPolicyDetail description(String description) {
  ...
  */
  ...
  public ManagedPolicyDetail createDate(OffsetDateTime createDate) {
  ...
  */
  ...
  public ManagedPolicyDetail updateDate(OffsetDateTime updateDate) {
  ...
  */
  ...
  public ManagedPolicyDetail policyVersionList(List policyVersionList) {
  ...
  */
  @Valid 
  @Schema(name = "PolicyVersionList", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
