...
@Validated
@Tag(name = "#Action=DeleteVirtualMFADevice", description = "the #Action=DeleteVirtualMFADevice API")
public interface ActionDeleteVirtualMFADeviceApi {
     ...
     *
     * @param serialNumber &lt;p&gt;The serial number that uniquely identifies the MFA device. For virtual MFA devices, the serial number is the same as the ARN.&lt;/p&gt; &lt;p&gt;This parameter allows (through its &lt;a href&#x3D;\&quot;http://wikipedia.org/wiki/regex\&quot;&gt;regex pattern&lt;/a&gt;) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: &#x3D;,.@:/-&lt;/p&gt; (required)
     ...
     */
    @Operation(
        operationId = "gETDeleteVirtualMFADevice",
    ...
    @RequestMapping(
        ...
        value = "/#Action=DeleteVirtualMFADevice",
        produces = { "text/xml" }
    )
    
    default ResponseEntity<Void> gETDeleteVirtualMFADevice(
        @NotNull @Pattern(regexp = "[\\w+=/:,.@-]+") @Size(min = 9, max = 256) @Parameter(name = "SerialNumber", description = "<p>The serial number that uniquely identifies the MFA device. For virtual MFA devices, the serial number is the same as the ARN.</p> <p>This parameter allows (through its <a href=\"http://wikipedia.org/wiki/regex\">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: =,.@:/-</p>", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "SerialNumber", required = true) String serialNumber,
     ...
     * @param xAmzSignature  (optional)
     * @param xAmzSignedHeaders  (optional)
     * @param deleteVirtualMFADeviceRequest  (optional)
     * @return Success (status code 200)
     *         or NoSuchEntityException (status code 480)
     *         or DeleteConflictException (status code 481)
     *         or LimitExceededException (status code 482)
     ...
     */
    @Operation(
        operationId = "pOSTDeleteVirtualMFADevice",
        description = "<p>Deletes a virtual MFA device.</p> <note> <p> You must deactivate a user's virtual MFA device before you can delete it. For information about deactivating MFA devices, see <a>DeactivateMFADevice</a>. </p> </note>",
        responses = {
            @ApiResponse(responseCode = "200", description = "Success"),
            @ApiResponse(responseCode = "480", description = "NoSuchEntityException", content = {
    ...
    default ResponseEntity<Void> pOSTDeleteVirtualMFADevice(
        @NotNull @Parameter(name = "Action", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Action", required = true) String action,
        @NotNull @Parameter(name = "Version", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Version", required = true) String version,
        @Parameter(name = "X-Amz-Content-Sha256", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Content-Sha256", required = false) String xAmzContentSha256,
        @Parameter(name = "X-Amz-Date", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Date", required = false) String xAmzDate,
        ...
        @Parameter(name = "X-Amz-Signature", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Signature", required = false) String xAmzSignature,
        @Parameter(name = "X-Amz-SignedHeaders", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-SignedHeaders", required = false) String xAmzSignedHeaders,
        @Parameter(name = "DeleteVirtualMFADeviceRequest", description = "") @Valid @RequestBody(required = false) DeleteVirtualMFADeviceRequest deleteVirtualMFADeviceRequest
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
