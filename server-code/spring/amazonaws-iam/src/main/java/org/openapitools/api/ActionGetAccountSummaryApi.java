...
@Validated
@Tag(name = "#Action=GetAccountSummary", description = "the #Action=GetAccountSummary API")
public interface ActionGetAccountSummaryApi {
     ...
     */
    @Operation(
        operationId = "gETGetAccountSummary",
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = GetAccountSummaryResponse.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/#Action=GetAccountSummary",
        produces = { "text/xml" }
    )
    
    default ResponseEntity<GetAccountSummaryResponse> gETGetAccountSummary(
     ...
     */
    @Operation(
        operationId = "pOSTGetAccountSummary",
        description = "<p>Retrieves information about IAM entity usage and IAM quotas in the Amazon Web Services account.</p> <p> For information about IAM quotas, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html\">IAM and STS quotas</a> in the <i>IAM User Guide</i>.</p>",
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = GetAccountSummaryResponse.class))
    ...
    default ResponseEntity<GetAccountSummaryResponse> pOSTGetAccountSummary(
        @NotNull @Parameter(name = "Action", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Action", required = true) String action,
        @NotNull @Parameter(name = "Version", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Version", required = true) String version,
        @Parameter(name = "X-Amz-Content-Sha256", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Content-Sha256", required = false) String xAmzContentSha256,
        @Parameter(name = "X-Amz-Date", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Date", required = false) String xAmzDate,
