...
@Validated
@Tag(name = "#Action=UntagServerCertificate", description = "the #Action=UntagServerCertificate API")
public interface ActionUntagServerCertificateApi {
     ...
     *
     * @param serverCertificateName &lt;p&gt;The name of the IAM server certificate from which you want to remove tags.&lt;/p&gt; &lt;p&gt;This parameter allows (through its &lt;a href&#x3D;\&quot;http://wikipedia.org/wiki/regex\&quot;&gt;regex pattern&lt;/a&gt;) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+&#x3D;,.@-&lt;/p&gt; (required)
     * @param tagKeys A list of key names as a simple array of strings. The tags with matching keys are removed from the specified IAM server certificate. (required)
     ...
     */
    @Operation(
        operationId = "gETUntagServerCertificate",
    ...
    @RequestMapping(
        ...
        value = "/#Action=UntagServerCertificate",
        produces = { "text/xml" }
    )
    
    default ResponseEntity<Void> gETUntagServerCertificate(
        ...
        @NotNull @Size(max = 50) @Parameter(name = "TagKeys", description = "A list of key names as a simple array of strings. The tags with matching keys are removed from the specified IAM server certificate.", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "TagKeys", required = true) List<@Valid String> tagKeys,
     ...
     * @param xAmzSignature  (optional)
     * @param xAmzSignedHeaders  (optional)
     * @param untagServerCertificateRequest  (optional)
     * @return Success (status code 200)
     *         or NoSuchEntityException (status code 480)
     *         or InvalidInputException (status code 481)
     *         or ConcurrentModificationException (status code 482)
     ...
     */
    @Operation(
        operationId = "pOSTUntagServerCertificate",
        description = "<p>Removes the specified tags from the IAM server certificate. For more information about tagging, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html\">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p> <note> <p>For certificates in a Region supported by Certificate Manager (ACM), we recommend that you don't use IAM server certificates. Instead, use ACM to provision, manage, and deploy your server certificates. For more information about IAM server certificates, <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_server-certs.html\">Working with server certificates</a> in the <i>IAM User Guide</i>.</p> </note>",
        responses = {
            @ApiResponse(responseCode = "200", description = "Success"),
            @ApiResponse(responseCode = "480", description = "NoSuchEntityException", content = {
    ...
    default ResponseEntity<Void> pOSTUntagServerCertificate(
        @NotNull @Parameter(name = "Action", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Action", required = true) String action,
        @NotNull @Parameter(name = "Version", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Version", required = true) String version,
        @Parameter(name = "X-Amz-Content-Sha256", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Content-Sha256", required = false) String xAmzContentSha256,
        @Parameter(name = "X-Amz-Date", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Date", required = false) String xAmzDate,
        ...
        @Parameter(name = "X-Amz-Signature", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Signature", required = false) String xAmzSignature,
        @Parameter(name = "X-Amz-SignedHeaders", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-SignedHeaders", required = false) String xAmzSignedHeaders,
        @Parameter(name = "UntagServerCertificateRequest", description = "") @Valid @RequestBody(required = false) UntagServerCertificateRequest untagServerCertificateRequest
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
