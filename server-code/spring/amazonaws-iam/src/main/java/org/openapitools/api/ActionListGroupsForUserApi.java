...
@Validated
@Tag(name = "#Action=ListGroupsForUser", description = "the #Action=ListGroupsForUser API")
public interface ActionListGroupsForUserApi {
     ...
     */
    @Operation(
        operationId = "gETListGroupsForUser",
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = ListGroupsForUserResponse.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/#Action=ListGroupsForUser",
        produces = { "text/xml" }
    )
    
    default ResponseEntity<ListGroupsForUserResponse> gETListGroupsForUser(
        @NotNull @Pattern(regexp = "[\\w+=,.@-]+") @Size(min = 1, max = 128) @Parameter(name = "UserName", description = "<p>The name of the user to list groups for.</p> <p>This parameter allows (through its <a href=\"http://wikipedia.org/wiki/regex\">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "UserName", required = true) String userName,
     ...
     * @param listGroupsForUserRequest  (optional)
     * @return Success (status code 200)
     *         or NoSuchEntityException (status code 480)
     *         or ServiceFailureException (status code 481)
     */
    @Operation(
        operationId = "pOSTListGroupsForUser",
        description = "<p>Lists the IAM groups that the specified IAM user belongs to.</p> <p>You can paginate the results using the <code>MaxItems</code> and <code>Marker</code> parameters.</p>",
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = ListGroupsForUserResponse.class))
    ...
    default ResponseEntity<ListGroupsForUserResponse> pOSTListGroupsForUser(
        @NotNull @Parameter(name = "Action", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Action", required = true) String action,
        @NotNull @Parameter(name = "Version", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Version", required = true) String version,
        @Parameter(name = "X-Amz-Content-Sha256", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Content-Sha256", required = false) String xAmzContentSha256,
        @Parameter(name = "X-Amz-Date", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Date", required = false) String xAmzDate,
        ...
        @Parameter(name = "ListGroupsForUserRequest", description = "") @Valid @RequestBody(required = false) ListGroupsForUserRequest listGroupsForUserRequest
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("text/xml"))) {
