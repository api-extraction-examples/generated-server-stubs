...
@Validated
@Tag(name = "#Action=ListOpenIDConnectProviders", description = "the #Action=ListOpenIDConnectProviders API")
public interface ActionListOpenIDConnectProvidersApi {
     ...
     */
    @Operation(
        operationId = "gETListOpenIDConnectProviders",
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = ListOpenIDConnectProvidersResponse.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/#Action=ListOpenIDConnectProviders",
        produces = { "text/xml" }
    )
    
    default ResponseEntity<ListOpenIDConnectProvidersResponse> gETListOpenIDConnectProviders(
     ...
     */
    @Operation(
        operationId = "pOSTListOpenIDConnectProviders",
        description = "<p>Lists information about the IAM OpenID Connect (OIDC) provider resource objects defined in the Amazon Web Services account.</p> <note> <p>IAM resource-listing operations return a subset of the available attributes for the resource. For example, this operation does not return tags, even though they are an attribute of the returned object. To view all of the information for an OIDC provider, see <a>GetOpenIDConnectProvider</a>.</p> </note>",
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = ListOpenIDConnectProvidersResponse.class))
    ...
    default ResponseEntity<ListOpenIDConnectProvidersResponse> pOSTListOpenIDConnectProviders(
        @NotNull @Parameter(name = "Action", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Action", required = true) String action,
        @NotNull @Parameter(name = "Version", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Version", required = true) String version,
        @Parameter(name = "X-Amz-Content-Sha256", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Content-Sha256", required = false) String xAmzContentSha256,
        @Parameter(name = "X-Amz-Date", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Date", required = false) String xAmzDate,
