...
@Validated
@Tag(name = "#Action=GetCredentialReport", description = "the #Action=GetCredentialReport API")
public interface ActionGetCredentialReportApi {
     ...
     *         or CredentialReportNotPresentException (status code 480)
     *         or CredentialReportExpiredException (status code 481)
     *         or CredentialReportNotReadyException (status code 482)
     *         or ServiceFailureException (status code 483)
     */
    @Operation(
        operationId = "gETGetCredentialReport",
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = GetCredentialReportResponse.class))
            }),
            @ApiResponse(responseCode = "480", description = "CredentialReportNotPresentException", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = Object.class))
            }),
            @ApiResponse(responseCode = "481", description = "CredentialReportExpiredException", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = Object.class))
            }),
            @ApiResponse(responseCode = "482", description = "CredentialReportNotReadyException", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = Object.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/#Action=GetCredentialReport",
        produces = { "text/xml" }
    )
    
    default ResponseEntity<GetCredentialReportResponse> gETGetCredentialReport(
     ...
     */
    @Operation(
        operationId = "pOSTGetCredentialReport",
        description = " Retrieves a credential report for the Amazon Web Services account. For more information about the credential report, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/credential-reports.html\">Getting credential reports</a> in the <i>IAM User Guide</i>.",
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = GetCredentialReportResponse.class))
    ...
    default ResponseEntity<GetCredentialReportResponse> pOSTGetCredentialReport(
        @NotNull @Parameter(name = "Action", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Action", required = true) String action,
        @NotNull @Parameter(name = "Version", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Version", required = true) String version,
        @Parameter(name = "X-Amz-Content-Sha256", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Content-Sha256", required = false) String xAmzContentSha256,
        @Parameter(name = "X-Amz-Date", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Date", required = false) String xAmzDate,
