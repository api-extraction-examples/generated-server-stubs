...
@Validated
@Tag(name = "#Action=PutUserPermissionsBoundary", description = "the #Action=PutUserPermissionsBoundary API")
public interface ActionPutUserPermissionsBoundaryApi {
     ...
     *
     * @param userName The name (friendly name, not ARN) of the IAM user for which you want to set the permissions boundary. (required)
     ...
     *         or PolicyNotAttachableException (status code 482)
     *         or ServiceFailureException (status code 483)
     */
    @Operation(
        operationId = "gETPutUserPermissionsBoundary",
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "482", description = "PolicyNotAttachableException", content = {
                @Content(mediaType = "text/xml", schema = @Schema(implementation = Object.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/#Action=PutUserPermissionsBoundary",
        produces = { "text/xml" }
    )
    
    default ResponseEntity<Void> gETPutUserPermissionsBoundary(
        @NotNull @Pattern(regexp = "[\\w+=,.@-]+") @Size(min = 1, max = 64) @Parameter(name = "UserName", description = "The name (friendly name, not ARN) of the IAM user for which you want to set the permissions boundary.", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "UserName", required = true) String userName,
     ...
     * @param xAmzSignature  (optional)
     * @param xAmzSignedHeaders  (optional)
     * @param putUserPermissionsBoundaryRequest  (optional)
     * @return Success (status code 200)
     *         or NoSuchEntityException (status code 480)
     *         or InvalidInputException (status code 481)
     *         or PolicyNotAttachableException (status code 482)
     ...
     */
    @Operation(
        operationId = "pOSTPutUserPermissionsBoundary",
        description = "<p>Adds or updates the policy that is specified as the IAM user's permissions boundary. You can use an Amazon Web Services managed policy or a customer managed policy to set the boundary for a user. Use the boundary to control the maximum permissions that the user can have. Setting a permissions boundary is an advanced feature that can affect the permissions for the user.</p> <important> <p>Policies that are used as permissions boundaries do not provide permissions. You must also attach a permissions policy to the user. To learn how the effective permissions for a user are evaluated, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_evaluation-logic.html\">IAM JSON policy evaluation logic</a> in the IAM User Guide. </p> </important>",
        responses = {
            @ApiResponse(responseCode = "200", description = "Success"),
            @ApiResponse(responseCode = "480", description = "NoSuchEntityException", content = {
    ...
    default ResponseEntity<Void> pOSTPutUserPermissionsBoundary(
        @NotNull @Parameter(name = "Action", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Action", required = true) String action,
        @NotNull @Parameter(name = "Version", description = "", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "Version", required = true) String version,
        @Parameter(name = "X-Amz-Content-Sha256", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Content-Sha256", required = false) String xAmzContentSha256,
        @Parameter(name = "X-Amz-Date", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Date", required = false) String xAmzDate,
        ...
        @Parameter(name = "X-Amz-Signature", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-Signature", required = false) String xAmzSignature,
        @Parameter(name = "X-Amz-SignedHeaders", description = "", in = ParameterIn.HEADER) @RequestHeader(value = "X-Amz-SignedHeaders", required = false) String xAmzSignedHeaders,
        @Parameter(name = "PutUserPermissionsBoundaryRequest", description = "") @Valid @RequestBody(required = false) PutUserPermissionsBoundaryRequest putUserPermissionsBoundaryRequest
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
