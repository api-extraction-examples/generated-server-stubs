...
public interface ResponseHeadersApi {
    ...
    default ResponseEntity<Void> responseHeadersGet(
        @Parameter(name = "freeform", description = "", in = ParameterIn.QUERY) @Valid @RequestParam(value = "", required = false) Map<String, String> freeform
    ) {
