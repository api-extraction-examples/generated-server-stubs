...
@JsonTypeName("_api_v1_accounts__id__note_post_request")
...
public class ApiV1AccountsIdNotePostRequest {
  ...
  */
  ...
  @Schema(name = "comment", description = "The comment to be set on that user. Provide an empty string or leave out this parameter to clear the currently set note.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
