...
@JsonTypeName("_api_v1_lists_post_request")
...
public class ApiV1ListsPostRequest {
   ...
   */
  public ApiV1ListsPostRequest(String title) {
    this.title = title;
  }
  ...
  */
  @NotNull 
  @Schema(name = "title", description = "The title of the list to be created.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("title")
